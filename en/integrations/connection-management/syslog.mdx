...
<CardGroup cols={2}>
  ...
  <Card title="Parallel Connection Count" icon="layer-group">
    **Description:** Number of parallel TCP sockets opened to the syslog server.  
    **Default:** 1 — existing connections keep sending over a single socket unless changed.  
    **Unit:** sockets
  </Card>

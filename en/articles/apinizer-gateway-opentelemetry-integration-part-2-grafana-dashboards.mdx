...
:::tip Prefer not to run a javaagent?
Everything in this series takes the agent-based road. If you'd rather export straight from the product — no agent to install, and with AI token/cost telemetry built in — see the companion article, [Native OpenTelemetry Export from the Apinizer API Gateway](/en/articles/apinizer-gateway-native-opentelemetry-export).
:::

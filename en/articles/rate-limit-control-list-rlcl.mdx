...
5. **If it doesn't match**, credential validation is performed; if the identity is not defined in the RLCL, the request is rejected and an error response is returned.

---
title: "Adding Connectors to Gateway Environments"
description: "You can configure connectors to send API traffic in gateway environments to other environments. You can customize API Proxy traffic log settings, configure privacy settings, and define failover connectors."
---

<Info>
When API traffic on API Proxies in environments needs to be recorded, the setting of where the relevant logs should be stored can be made with the following settings. The following connectors can be used to send API traffic in gateway environments to other environments:
</Info>
...
**An image containing adding connectors to gateway environments is shown below:**

<img
  src="/images/admin/server-management/konnektor-ekleme.png"
  alt="Adding Connector"
  width="1000"
  height="600"
/>

...
description: "You can create Kubernetes environments, configure Gateway Engine, publish environments, and perform metric monitoring. You can configure API Proxy traffic log connectors and manage JWT token validation keys."
---
...
- Ensure network connectivity between Management Console, Gateway pods, and Cache pods
</Warning>

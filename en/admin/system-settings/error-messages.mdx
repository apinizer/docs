...
For complete documentation on the Date/Time Helper (`dtf`) function, see [Date/Time Helper (`dtf`)](/en/concepts/core-concepts/dynamic-variables#date-time-helper-dtf) in the Dynamic Variables reference.

...
{/* TODO: screenshot — Destinations tab: destination list plus the Add Destination dialog (Connector, Payload Profile, Size Policy, Privacy Profile, Stream Rules sections); old file: yok; target: /images/2026-09-2/siem-log-forwarding-destinations.png */}
...
{/* TODO: screenshot — Streams tab: the stream table with the Local Retention, Destinations and Authority columns; old file: yok; target: /images/2026-09-2/siem-log-forwarding-streams.png */}
...
{/* TODO: screenshot — Schema & Samples tab: stream/profile picker with the rendered payload and field allowlist; old file: yok; target: /images/2026-09-2/siem-log-forwarding-schema.png */}

...
| Tags *(Tags)* | Multiple tags can be added to categorize the project. Tags can represent unit names, related institutions, or any other classification you define. You can assign as many tags as you need to a project. |

## Filtering Projects by Tag

To classify and find projects more easily, you can assign multiple tags to each project. Instead of squeezing information into the description field, tags let you group projects under meaningful categories.

In the project selection popup in the top menu, you can filter projects by their tags in addition to their name. This way, when you have a large number of projects, you can quickly reach the projects belonging to the unit or institution you are interested in.

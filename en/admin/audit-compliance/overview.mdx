...
<CardGroup cols={3}>
  ...
  <Card title="ACL Audit Records" icon="clipboard-check" href="/en/admin/audit-compliance/acl-audit-records">
    History of API Proxy and API Proxy Group access permissions granted to and revoked from credentials, with the source and reason of each change.
  </Card>
  ...
  <Card title="Security Events" icon="shield-alert" href="/en/admin/audit-compliance/security-events">
    Viewing the requests the Gateway blocked or failed to process, without any payload capture.
  </Card>
  ...
  <Card title="Test Console Audit Records" icon="flask" href="/en/admin/audit-compliance/test-console-audit-records">
    Records of the requests sent through the Test Console, with user, project, API Proxy, correlation ID, and client IP information.
  </Card>

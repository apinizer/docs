...
{/* TODO: screenshot — Security Events screen: API Security tab, filter bar and result table; old file: yok; target: /images/2026-09-2/security-events-list.png */}
...
{/* TODO: screenshot — Security Events screen: API Access tab with its confirmation dialog for the Store in the Apinizer database switch; old file: yok; target: /images/2026-09-2/security-events-api-access.png */}

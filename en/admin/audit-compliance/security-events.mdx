...
Security Events can also be forwarded to a SIEM destination, as the **API Security** stream. See [SIEM & Log Forwarding](/en/admin/system-settings/siem-log-forwarding) for how to configure destinations, rules, and payload formats for this stream.

...
Audit logs (audit_event) and ACL audit logs (history_acl) can no longer be automatically deleted through purge jobs. These logs are always saved to the database for compliance purposes. For manual cleanup, refer to the database growth management scripts.

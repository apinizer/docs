...
To configure forwarding login records outside MongoDB via connectors (Elasticsearch, Kafka, Webhook, etc.), see [SIEM & Log Forwarding](/en/admin/system-settings/siem-log-forwarding) — the **Session** stream — and [Session stream — event types and legacy payload](/en/admin/system-settings/siem-log-forwarding#session-stream-event-types-and-legacy-payload) for the event types and payload.
...
<Frame caption="Login Records list screen">
  <img
    src="/images/2026-09-2/login-records-main.png"
    alt="Login Records list screen with Date, User, State, Remote Address, and Extra data columns"
    width="1000"
    height="312"
  />
</Frame>

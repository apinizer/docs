...
**Manager Request** and **Access Denied** records are not tied to a specific project, so they only appear when Audit Records is viewed without a project filter — the view available to System Admin, Project Admin and System Analyzer users, who can also open the records of any project. Every other user only sees the records of a project in which they hold the **Audit → View** permission.

...
**Manager Request** and **Access Denied** records are not tied to a specific project, so they only appear when Audit Records is viewed without a project filter — the view available to System Admin users.

...
description: "You can manage access permissions of consumers of clients that will access API Proxy Groups and configure details of these permissions. You can grant API Proxy Group-based access permission to consumers and configure quota and throttling settings."
---

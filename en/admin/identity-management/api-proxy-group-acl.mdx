...
For the details and for the automatic consolidation that runs during the upgrade, see the [API Proxy ACL](/en/admin/identity-management/api-proxy-acl#uniqueness-of-access-permissions) page.

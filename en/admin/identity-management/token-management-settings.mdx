...
Reach this screen by following **Identity → Token Settings**. These settings only affect the response body produced by the token endpoint; the default values preserve the current behavior.

...
{/* TODO: screenshot — Organizations List screen (with the list column named "Consumers", not the old "Credentials"); old file: /images/yonetici/kurum-ekle.png; target: /images/2026-09-2/organization-list.png */}
...
{/* TODO: screenshot — row action menu with Move to Global selected (with the current Organizations List, "Consumers" column, in the background); old file: /images/yonetici/kurum-global.png; target: /images/2026-09-2/organization-globalize-menu.png */}

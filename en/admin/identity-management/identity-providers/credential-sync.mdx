...
{/* TODO: screenshot — Database provider's Identity Synchronization Profile tab showing Enable Synchronization, Cron Expression, Deactivation Mode (Disable/Delete/None), the Synchronization Scope card (Users/Groups/Roles include/exclude patterns) and the Reconciliation Safety Net card (deactivation thresholds); old file: /images/yonetici/credential-sync/credential-sync-profil.png; target: /images/2026-09-2/credential-sync-profil.png */}
...
{/* TODO: screenshot — Identity > Providers > Synchronization screen with all four tabs (LDAP/Database/API/OIDC) and the Name/Schedule/Status/Last Synchronized/Upserted/Deactivated/Skipped/Errors/Result/Actions columns; old file: /images/yonetici/credential-sync/credential-sync-izleme.png; target: /images/2026-09-2/credential-sync-izleme.png */}

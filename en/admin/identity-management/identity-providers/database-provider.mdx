...
Using the **Identity Synchronization Profile** tab on the Database Provider edit screen, you can synchronize users from this source into [Credential](/en/admin/identity-management/credentials) records. For the fields shared with every source — enable/cron, deactivation mode, synchronization scope, and the reconciliation safety net — see [Credential Sync](/en/admin/identity-management/identity-providers/credential-sync).

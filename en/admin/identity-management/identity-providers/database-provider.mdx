...
Using the **Identity Synchronization Profile** tab on the Database Provider edit screen, you can synchronize users from this source into [Credential](/en/admin/identity-management/credentials) records. For field descriptions, scheduling, and monitoring, see [Credential Sync](/en/admin/identity-management/identity-providers/credential-sync).

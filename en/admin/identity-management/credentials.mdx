...
Consumers brought in by [synchronization](/en/admin/identity-management/identity-providers/credential-sync) from an identity provider, and those created by bulk import from a CSV file, are not assigned a consumer key in this version; for those records the field is simply empty. Consumers created from this screen and through the Management API always have one.

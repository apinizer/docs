...
The **Quota Usage & Alerts** screen is reached from the **Identity Management** menu. It can be opened both from the project menu (that project's own consumers only) and from the Admin menu (every project); both menus show the same screen with a different scope.

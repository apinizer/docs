...
<Info>
This page contains detailed permission matrices for project-level roles. For the general authorization model and system-level roles, see the [Authorization Matrix](/en/admin/user-access-management/authorization-matrix) page.
</Info>

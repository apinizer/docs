...
description: "You can configure role-based authorization with authentication policies and perform API Proxy/method access control. You can add a security layer after authentication control and compare user roles with method/endpoint access control."
---

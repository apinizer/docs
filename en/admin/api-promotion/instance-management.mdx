...
An Instance represents an Apinizer environment used as a target in API Promotion operations. Each instance includes target environment connection details, connection/accessibility status, approval requirements, and notification settings.

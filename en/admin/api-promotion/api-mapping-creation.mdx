...
Dependency detection is not limited to Creator objects: [Global Policies](/en/concepts/core-concepts/what-is-policy) and certificate-family records (Certificate, KeyStore, CryptoKeyInfo, JWK — see [Secrets Management](/en/admin/secrets-management/overview)) used in the source API Proxy or Proxy Group definition are also automatically scanned and listed.
...
<img
  ...
  alt="Global policy and certificate mapping screen"
  width="1000"
  height="895"
/>
...
This mapping logic mirrors the "map to existing / create new" logic in the [Export Import](/en/admin/secrets-management/export-import) wizard.

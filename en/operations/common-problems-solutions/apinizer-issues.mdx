...
**1. Scale Cache Replicas to 0 and Re-upgrade**
...
**2. Delete Old ReplicaSet Definitions**

You can perform a clean restart by deleting old replicaset definitions:

```bash
kubectl delete replicaset -l app=cache -n apinizer
```
...
**3. Change DeploymentStrategy to Recreate**
...
Applying any of these methods will resolve the error.
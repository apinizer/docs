...
* Private Docker Registry installation → [Container Registry](/en/operations/container-registry/container-images-and-registry)
...
Configuration for accessing Apinizer images through corporate or private container registries.

**Content:**
* Nexus, Harbor, and private registry scenarios
* containerd registry mirror configuration
* Deployment image path updates
* Private registry installation (CentOS 7)

**When to Use:**
* When using corporate Nexus or Harbor registry
* When configuring image access in air-gapped environments
* When setting up your own private registry
* When updating image paths before version upgrade
...
Operations Overview
    ...
    ├── Container Registry (Image registry configuration)
...
<CardGroup cols={2}>
  ...
  <Card title="Troubleshooting" href="/en/operations/troubleshooting/mongodb-troubleshooting">
  ...
  <Card title="Common Issues" href="/en/operations/common-problems-solutions/apinizer-issues">
    Common issues and solutions
  </Card>
  <Card title="Kubernetes" href="/en/setup/kubernetes">
    Kubernetes installation and management guides
  </Card>
  <Card title="Error Codes" href="/en/operations/common-problems-solutions/authentication-failures">
    Error code reference
  </Card>

...
<Info>
For Grafana Setup and Prometheus Integration as a Data Source, you can refer to [our related documentation](/en/operations/administrator-guides/grafana-prometheus-data-source.mdx).
</Info>

...
description: "You can create necessary database tables for storing traffic and audit records using DB Connector, use appropriate SQL commands for MySQL/MariaDB and Oracle databases, and configure column types according to database type."
---

...
<Info>
The DDL commands on this page use Apinizer's default table names (`log_ApiProxyTraffic`, `log_PolicyCapture`, `log_AuditEvent`, `log_Application`, `log_UnsentMessage`, `log_TokenTraffic`) and no schema prefix.

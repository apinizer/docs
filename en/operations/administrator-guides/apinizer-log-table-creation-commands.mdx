...
**If you are upgrading an existing installation to 2026.09.0**, do not run this statement; your table already exists. Use the `ALTER TABLE` script on the [2026.09.0 — Log Table ALTER Scripts](/en/release-notes/2026-09-0-log-table-alter) page instead.

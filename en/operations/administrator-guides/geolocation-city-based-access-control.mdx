...
To visualize which cities incoming requests come from on Kibana, you can check the [Geographic Visualization with Kibana Maps](/tr/operations/yonetici-kilavuzlari/kibana-maps-cografi-gorsellestirme) page.
</Warning>

...
<Warning>
If you are not using a load balancer and cannot create a virtual IP on the network, [click here](/en/setup/kubernetes) to perform this operation with **Keepalived** and **HAProxy** tools you can use for this.

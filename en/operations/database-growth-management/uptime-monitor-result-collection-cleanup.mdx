---
title: "Cleaning uptime_monitor_result Collection"
description: "Enables cleaning old records from the uptime_monitor_result collection where log records for Uptime Monitoring operation results are kept, according to the specified time period."
---
...
The following script is used to delete records older than the specified time from the `uptime_monitor_result` collection stored in MongoDB. This operation optimizes storage space by cleaning the database.
...
2. Give execute permission to the file: `chmod +x purge_uptime_monitor_result_collection.sh`
3. Run the file: `./purge_uptime_monitor_result_collection.sh`

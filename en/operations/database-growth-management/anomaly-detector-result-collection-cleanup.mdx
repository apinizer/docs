---
title: "Cleaning anomaly_detector_result Collection"
description: "Enables cleaning old records from the anomaly_detector_result collection where records kept to find anomalies in API traffic are stored, according to the specified time period."
---
...
The following script is used to delete records older than the specified time from the `anomaly_detector_result` collection stored in MongoDB. This operation optimizes storage space by cleaning the database.
...
2. Give execute permission to the file: `chmod +x purge_anomaly_detector_result_collection.sh`
3. Run the file: `./purge_anomaly_detector_result_collection.sh`

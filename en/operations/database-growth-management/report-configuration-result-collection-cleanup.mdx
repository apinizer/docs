---
title: "Cleaning report_configuration_result Collection"
description: "Enables cleaning old records from the report_configuration_result collection where records for software logs generated during report definition execution are kept, according to the specified time period."
---
...
The following script is used to delete records older than the specified time from the `report_configuration_result` collection stored in MongoDB. This operation optimizes storage space by cleaning the database.
...
# apiProxyId value the user wants to delete
statusCode=""  # You can replace this value with the value the user will enter.
...
2. Give execute permission to the file: `chmod +x purge_report_configuration_result_collection.sh`
3. Run the file: `./purge_report_configuration_result_collection.sh`

---
title: "Cleaning tcp_connectivity_test_history Collection"
description: "Enables cleaning old records from the tcp_connectivity_test_history collection where TCP connectivity test results are stored."
---
...
The following script is used to delete records older than the specified time from the `tcp_connectivity_test_history` collection stored in MongoDB. This operation optimizes storage space by cleaning the database.
...
2. Give execute permission to the file: `chmod +x purge_tcp_connectivity_test_history_collection.sh`
3. Run the file: `./purge_tcp_connectivity_test_history_collection.sh`

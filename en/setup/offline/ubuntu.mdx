...
MongoDB configurations after installation are the same as the sections in [MongoDB Installation on Ubuntu Operating System](/en/setup/mongodb/ubuntu-mongodb.mdx) document.
...
After moving the installation file from its directory to /opt/elasticsearch/ folder, apply the steps on [Elasticsearch Installation on Ubuntu Operating System](/en/setup/elasticsearch/ubuntu-elasticsearch.mdx) page.

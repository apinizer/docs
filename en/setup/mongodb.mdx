...
description: "MongoDB ReplicaSet 8.0 installation for Apinizer. Step-by-step setup, configuration, ReplicaSet and high-availability settings for Ubuntu and Red Hat Enterprise Linux / Rocky Linux distributions."
---

MongoDB ReplicaSet 8.0 installation for Apinizer. Pick the tab below for your operating system.

<Info>
Apinizer uses MongoDB on a **custom port `25080`**. This is configured via `net.port` in `/etc/mongod.conf`.
</Info>

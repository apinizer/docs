...
<Tabs>
  <TabItem value="container-environment-kubernetes-docker" label="Container Environment (Kubernetes / Docker)">
...
<TabItem value="virtual-server-linux-vm" label="Virtual Server (Linux / VM)">

...
:::
  ...
  <TabItem value="4-api-integration-optional" label="4. API Integration (Optional)">
...
:::
    ...
    | Workload | `mem_limit` |
    | --- | --- |
    | Few flows / typical install | 2 GB |
    | Heavy / many concurrent flows | 4 GB |

    Do not run the Integration with less than 2 GB of `mem_limit`; even with a single CPU core the JVM will not start on 1 GB.

...
**To run Apinizer Manager with HTTPS/SSL** — for TLS certificate preparation, JKS/PKCS12 conversion, K8s Secret creation, and SSL-enabled Deployment YAML examples, see the **[Starting API Manager with SSL](#starting-apinizer-manager-with-ssl)** tab at the bottom of the page. HTTPS is optional; TLS is recommended for production but HTTP works for PoC.

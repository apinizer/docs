...
<Info>
  **Note:** This documentation has been checked and approved for Kubernetes 1.31.0 and Flannel 0.27.4 versions. Ports may vary in different Kubernetes and Flannel versions.
</Info>
...
You can use the pages under the [/en/setup](/en/setup/overview.mdx) directory to perform installation operations. What each page is used for is explained below.
...
All documentation related to Apinizer installation is located under the [/en/setup](/en/setup/overview.mdx) directory.

...
<Info>
  You can review the data example created in this data structure on the [API Traffic Log Record Data Structure](/en/analytic/api-traffic-log-record-data-structure.mdx) page.
</Info>

...
<Info>
  To create role-based users in Elasticsearch, authentication configuration must be done. [Click for detailed information.](/en/setup/elasticsearch/simple-authentication)
</Info>
...
| manage_ilm | ILM policies cannot be created from the Apinizer interface; Lifecycle management cannot be performed; Rollover operations do not work automatically. | Create ILM policies manually. [Click for detailed information.](/en/setup/elasticsearch/manual-ilm-policy-and-template-creation) |
| manage_index_templates | Index templates cannot be created from Apinizer; New indices may be created with incorrect configuration. | Define templates manually. [Click for detailed information.](/en/setup/elasticsearch/manual-ilm-policy-and-template-creation) |

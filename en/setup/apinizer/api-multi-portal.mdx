...
You can review the [API Developer Portal SSL Configuration](/en/setup/kubernetes#starting-api-developer-portal-with-ssl) documentation for detailed information.

...
<CardGroup cols={2}>
  <Card title="Kubernetes Installation" icon="layer-group" href="/en/setup/kubernetes">
  ...
  <Card title="Elasticsearch Installation" icon="magnifying-glass-chart" href="/en/setup/installations-overview">
    Learn Elasticsearch installation
  </Card>
  <Card title="Cloud Installation" icon="cloud" href="/en/setup/installations-overview">
    Install on cloud environments
  </Card>
  <Card title="Offline Installation" icon="download" href="/en/setup/installations-overview">
...
You can perform this from the guide at [Starting Apinizer Modules with SSL/TLS](/en/operations/administrator-guides/ssl-tls-starting-apinizer-modules).
...
When creating a Gateway Runtime, you can define existing Kubernetes definitions to the Apinizer platform by selecting the **Remote Gateway** option. For detailed information, see the [Gateway Runtimes](/en/admin/server-management/gateway-runtimes) page.
...
<Warning>
  Eğer Gateway'in türü HTTP+Websocket olarak belirlenecekse **http2Enabled** parametresinin false olarak girilmesi önerilmektedir [bkz](/en/admin/server-management/gateway-runtimes).

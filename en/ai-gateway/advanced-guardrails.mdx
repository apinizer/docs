...
description: "You can protect AI, MCP, and A2A traffic with masking for personal data and secrets, protection against prompt attacks, and controls against off-topic use and request loops — plus structural-injection and oversized-request protection on AI Gateways."
---

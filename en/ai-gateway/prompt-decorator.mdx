...
The nine shipped presets are editable: you can change them or delete them like any other preset, provided you hold AI Development manage permission in the project that owns the record. Deleting one is not permanent — a shipped preset comes back on the next Apinizer upgrade, because the upgrade re-adds any shipped record that is missing and leaves the ones you have edited alone. If you would rather keep the original intact, use **Duplicate** and edit the copy instead. Your own presets are visible in the project they were created in; those created in Administration mode are shared and reachable from every project.

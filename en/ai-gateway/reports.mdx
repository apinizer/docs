...
description: "View AI usage and cost analytics with detailed breakdowns by person, team, model, deployment type, and performance metrics."
---
...
- **[Token Quotas and Rate Limiting](/en/ai-gateway/token-quotas)** — Set limits based on report insights
- **[AI Cost Settings](/en/ai-gateway/cost-settings)** — Configure pricing and currency display
- **[LLM Providers and Connections](/en/ai-gateway/llm-providers)** — Manage provider credentials

...
<img
  ...
  alt="AI Analytics — KPI cards, breakdown tabs, By Person cost table, and Download XLSX"
  width="1000"
/>
...
Alongside the breakdown tables, the AI Dashboard charts token usage as **input**, **output**, and **cached** token series, so you can see at a glance how much of your traffic is being served from the [semantic cache](/en/ai-gateway/semantic-cache) instead of billed as fresh output.

Two views are available:

- **Daily Token Usage** — one bar per day, for the selected date range (see [Time Range](#time-range) above).

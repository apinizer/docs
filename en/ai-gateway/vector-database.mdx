...
Vector database connections support full CRUD through the **APIops REST API** as well:

| Method | Path | Description |
|--------|------|-------------|
| `GET` | `/apiops/projects/{projectName}/vector-dbs/` | List every connection in the project |
| `GET` | `/apiops/projects/{projectName}/vector-dbs/{vectorDbName}/` | Get a single connection by name |
| `POST` / `PUT` | `/apiops/projects/{projectName}/vector-dbs/{vectorDbName}/` | Create / update a connection |
| `DELETE` | `/apiops/projects/{projectName}/vector-dbs/{vectorDbName}/` | Delete a connection |
| `POST` | `/apiops/projects/{projectName}/vector-dbs/{vectorDbName}/test-connection/` | Test the connection |

Passwords, API keys, and API secrets are encrypted at rest the same way as through every other APIops endpoint. See [API Reference: Vector DBs](/api-reference/vector-dbs) for full details.

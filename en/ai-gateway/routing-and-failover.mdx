...
Manage templates from **AI Gateway → Failover Templates** in the project menu. Failover templates can also be managed through the APIops REST API; see [API Reference: AI Gateway](/api-reference/ai-gateway).

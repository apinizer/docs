...
{/* TODO: screenshot — the Limit Plans catalog list, showing the Project/Platform scope control, the family filter, and a row's lifecycle badge; old file: none; target: /images/2026-09-2/limit-plans-catalog.png */}
...
{/* TODO: screenshot — a plan's revision history table (number/status/change reason/published-by columns) plus the Open New Draft / Publish actions; old file: none; target: /images/2026-09-2/revision-flow-history.png */}
...
{/* TODO: screenshot — the Assign Limit form (mode, plan/custom fields, Target/Scope panel, Activate immediately) on the Limits tab; old file: none; target: /images/2026-09-2/limits-tab-assign-form.png */}
...
{/* TODO: screenshot — the Current usage box below an Active assignment, showing the per-window table (Window/Scope/Consumed/Limit/Usage/Resets at) and the Refresh button; old file: none; target: /images/2026-09-2/limits-tab-live-usage.png */}
...
{/* TODO: screenshot — the Bulk Assignment "Assign" tab: organization tree, subject-type/search/enabled-only/existing-assignment filters, and the paged subject table with the "Select all matching the filter" toggle; old file: none; target: /images/2026-09-2/bulk-assignment-population.png */}
...
{/* TODO: screenshot — the Bulk Assignment "Runs" tab: a run row with kind/status/phase/progress/counters/deployment state columns, and an expanded row showing its issues; old file: none; target: /images/2026-09-2/bulk-assignment-runs-tab.png */}
...
{/* TODO: screenshot — the Plans / Rule assignments view toggle and the resulting Rule Assignments list (identity source, condition, target, out-of-target action columns); old file: none; target: /images/2026-09-2/rule-assignments-view.png */}
...
{/* TODO: screenshot — the Develop screen's "Rate Limit" badge and the dialog it opens, listing the Active assignments covering the proxy; old file: none; target: /images/2026-09-2/develop-rate-limit-badge-dialog.png */}

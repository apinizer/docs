...
<CardGroup cols={2}>
  ...
  <Card title="API List Management" icon="gear" href="/en/develop/api-list-management">
    API Proxy management
  </Card>
  <Card title="ACL Management" icon="lock" href="/en/admin/identity-management/api-proxy-group-acl">
    ACL management
  </Card>
</CardGroup>

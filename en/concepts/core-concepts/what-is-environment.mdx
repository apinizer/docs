...
<Info>
  For detailed environment creation and management, you can refer to the [Gateway Runtimes](/en/admin/server-management/gateway-runtimes) page.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Gateway Runtimes" icon="gear" href="/en/admin/server-management/gateway-runtimes">

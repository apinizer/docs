...
```mermaid
flowchart TD
    Environment[🌍 Environment<br/>Kubernetes Namespace]
...
<Info>
  For detailed environment creation and management, you can refer to the [Environment Management](/en/admin/server-management/ag-gecidi-ortamlari) page.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Environment Management" icon="gear" href="/en/admin/server-management/ag-gecidi-ortamlari">

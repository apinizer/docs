...
For complete documentation on timezone-aware formatting and custom patterns, see [Date/Time Helper (`dtf`)](/en/concepts/core-concepts/dynamic-variables#datetime-helper-dtf).

...
<Info>
  For all policy types and detailed descriptions, you can refer to the [Policies](/en/develop/politikalar/api-bazli-daraltma.mdx) page.
</Info>
...
<Info>
  For detailed Policy Groups information, you can refer to the [Policy Management](/en/develop/api-proxy-konfigurasyonu/politika-yonetimi) page.
</Info>
...
<Info>
  For detailed policy creation and management, you can refer to the [Policy Management](/en/develop/api-proxy-konfigurasyonu/politika-yonetimi) page.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Policies" icon="list" href="/en/develop/politikalar/api-bazli-daraltma.mdx">
    Review all policy types
  </Card>
  <Card title="Policy Management" icon="gear" href="/en/develop/api-proxy-konfigurasyonu/politika-yonetimi">
    Policy creation and management
  </Card>

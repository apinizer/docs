...
For timezone-aware or custom timestamp formatting, use the **Date/Time Helper (`dtf`)** function. See [Date/Time Helper (`dtf`)](/en/concepts/core-concepts/dynamic-variables#datetime-helper-dtf) in the Dynamic Variables reference for details.

...
<CardGroup cols={2}>
  ...
  <Card title="Connection Management" icon="gear" href="/en/integrations/baglanti-yonetimi/genel-bakis">
    Connection management details
  </Card>
  <Card title="API Integrator" icon="diagram-project" href="/en/integrations/api-integrator-task-flow-builder/task-flow-tasarimi">
    API Integrator usage
  </Card>
  <Card title="DB-2-API" icon="database" href="/en/develop/api-proxy-olusturma/api-creator-db-api-olusturma">

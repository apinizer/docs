...
For project-scoped assets (e.g. Consumers, Connections, API Proxy), the permission check is evaluated against the relevant project; for global/project-independent assets (e.g. users, roles), no project scope is required. See the [Authorization Matrix](/en/admin/user-access-management/authorization-matrix) page for the full list of categories and role permissions.

...
<CardGroup cols={2}>
  ...
  <Card title="Connectors" icon="list" href="/en/integrations/konnektorler/genel-bakis">
    Review all connector types
  </Card>
  <Card title="Connector API Proxy" icon="server" href="/en/develop/api-proxy-olusturma/connector-api-proxy-olusturma">

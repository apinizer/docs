...
For detailed information, see the [HTTP Routing](/en/develop/yonlendirme/http-yonlendirme) page.
...
For detailed information, see the [gRPC Routing](/en/develop/yonlendirme/grpc-yonlendirme) page.
...
For detailed information, see the [WebSocket Routing](/en/develop/yonlendirme/websocket-yonlendirme) page.
...
<CardGroup cols={2}>
  ...
  <Card title="HTTP Routing" icon="globe" href="/en/develop/yonlendirme/http-yonlendirme">
    HTTP Routing configuration
  </Card>

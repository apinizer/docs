...
|----|-----------------|-----|-----|------|------------|
| Server 1 | Ubuntu Server 24.04 LTS / RHEL 9.x | 4 | 16GB | 200GB | Kubernetes Control-Plane, Manager, Elasticsearch (Master+Data), Replica set MongoDB Single Instance |
...
This topology runs with 1 W4 worker node. Benchmark-based planning values:

| Metric | Value |
|--------|-------|
| **Worker Tier** | W4 (4 core / 4 GB RAM) × 1 node |
| **Daily Planning Capacity** | ~5M requests/day |
| **Usage Purpose** | Test / PoC — not for production use |
...
This topology is ideal for Proof of Concept (POC), test environments, training purposes, low-traffic applications (~5M requests/day, 1×W4), quick installation requirements, and situations with limited budget.

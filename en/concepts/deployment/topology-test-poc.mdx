...
|----|-----------------|-----|-----|------|------------|
| Server 1 | Ubuntu Server 24.04 LTS / RHEL 9.x | 6 | 24GB | 200GB | Kubernetes Control-Plane, Manager, Elasticsearch (Master+Data), Replica set MongoDB Single Instance |
| Server 2 | Ubuntu Server 24.04 LTS / RHEL 9.x | 6 | 12GB | 80GB | Kubernetes Worker |

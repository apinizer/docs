...
<CardGroup cols={2}>
  <Card title="API Proxy" icon="network-wired" href="/en/concepts/fundamental-concepts/what-is-api-proxy">
    The proxy of an API on the API Gateway. The client actually communicates with the API Proxy.
  </Card>
  <Card title="Policy" icon="shield" href="/en/concepts/fundamental-concepts/what-is-policy">
...
<AccordionGroup>
  <Accordion title="API Proxy">
    ...
    For detailed information, see the [What is API Proxy?](/en/concepts/fundamental-concepts/what-is-api-proxy) page.
  </Accordion>
  ...
  <Accordion title="Policy">
    ...
    For detailed information, see the [What is Policy?](/en/concepts/fundamental-concepts/what-is-policy) page.
  </Accordion>
...
<AccordionGroup>
  <Accordion title="Environment">
    ...
    For detailed information, see the [What is Environment?](/en/concepts/fundamental-concepts/what-is-environment) page.
  </Accordion>
  ...
  <Accordion title="Project">
    ...
    **Apinizer enables the creation of Projects, and API Proxies, Policies, or other definitions can be managed on a project basis.**
    ...
    For detailed information, see the [What is Project?](/en/concepts/fundamental-concepts/what-is-project) page.
  </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="Routing and Upstream" icon="route" href="/en/concepts/fundamental-concepts/routing-and-upstream">
    Learn about Routing and Upstream concepts
  </Card>
  <Card title="Client Route" icon="arrow-right" href="/en/concepts/fundamental-concepts/client-route">
    Learn about Client Route concept
  </Card>
  <Card title="Upstream Target" icon="arrow-left" href="/en/concepts/fundamental-concepts/routing-and-upstream#upstream-target">
    Learn about Upstream Target concept
  </Card>
  <Card title="Endpoint" icon="code" href="/en/concepts/fundamental-concepts/endpoint">
    Learn about Endpoint concept
  </Card>
  <Card title="Load Balancing" icon="route" href="/en/concepts/fundamental-concepts/routing-and-upstream#load-balancing-strategies">
    Load Balancing strategies
  </Card>
  <Card title="Message Processing and Policy Application" icon="diagram-project" href="/en/concepts/fundamental-concepts/message-processing-and-policy-application">
...
<CardGroup cols={2}>
  <Card title="Environment" icon="layer-group" href="/en/concepts/fundamental-concepts/what-is-environment">
    Learn about Environment concept
  </Card>
  <Card title="Project" icon="folder" href="/en/concepts/fundamental-concepts/what-is-project">
    Learn about Project concept
  </Card>
  <Card title="Variable" icon="code" href="/en/concepts/fundamental-concepts/variable">
    Learn about Variable concept
  </Card>
  <Card title="Environment Variable" icon="key" href="/en/concepts/fundamental-concepts/environment-variable">
    Learn about Environment Variable concept
  </Card>
  <Card title="Connection" icon="plug" href="/en/concepts/fundamental-concepts/connections">
    Learn about Connection concept
  </Card>
  <Card title="Connector" icon="plug" href="/en/concepts/fundamental-concepts/connector">
    Learn about Connector concept
  </Card>
  <Card title="API Proxy Group" icon="layer-group" href="/en/concepts/fundamental-concepts/api-proxy-group">
...
<CardGroup cols={2}>
  <Card title="API Manager" icon="gear" href="/en/concepts/fundamental-components/api-manager">
    Learn about API Manager component
  </Card>
  <Card title="API Gateway" icon="shield" href="/en/concepts/fundamental-components/api-gateway">
    Learn about API Gateway component
  </Card>
  <Card title="Identity Manager" icon="key" href="/en/concepts/fundamental-components/identity-manager">
    Learn about Identity Manager component
  </Card>
  <Card title="Analytics Engine" icon="chart-bar" href="/en/concepts/fundamental-components/analytics-engine">
    Learn about Analytics Engine component
  </Card>
  <Card title="API Portal" icon="globe" href="/en/concepts/fundamental-components/api-portal">
    Learn about API Portal component
  </Card>
  <Card title="API Designer" icon="pencil" href="/en/concepts/fundamental-components/api-designer">
    Learn about API Designer component
  </Card>
  <Card title="API Creator" icon="wand-magic-sparkles" href="/en/concepts/fundamental-components/api-creator">
    Learn about API Creator component
  </Card>
  <Card title="API Integrator" icon="diagram-project" href="/en/concepts/fundamental-components/api-integrator">
    Learn about API Integrator component
  </Card>
  <Card title="Cache Component" icon="memory" href="/en/concepts/fundamental-components/cache-component">
    Learn about Cache Component
  </Card>
  <Card title="Monitoring Component" icon="eye" href="/en/concepts/fundamental-components/monitoring-component">
...
<CardGroup cols={2}>
  <Card title="Fundamental Concepts" icon="book" href="/en/concepts/fundamental-concepts/api-proxy-group">
    Learn fundamental concepts
  </Card>
  <Card title="Fundamental Components" icon="puzzle-piece" href="/en/concepts/fundamental-components/analytics-engine">

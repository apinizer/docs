...
For a detailed explanation of these concepts in the Apinizer AI Gateway context, see the [AI Core Concepts](/en/concepts/core-concepts/ai-fundamentals) page.

<CardGroup cols={2}>
  <Card title="LLM Provider" icon="cpu" href="/en/ai-gateway/llm-providers">
    The external LLM service (OpenAI, Anthropic, etc.) that AI Gateway connects to and routes requests toward.
  </Card>
  <Card title="Token" icon="hash" href="/en/ai-gateway/token-quotas">
    The unit of text an LLM reads and generates; quotas and cost are measured per token.
  </Card>
  <Card title="Embedding" icon="sparkles" href="/en/ai-gateway/vector-database">
    A numeric vector representing the meaning of a piece of text, used for similarity search.
  </Card>
  <Card title="Vector Database" icon="database" href="/en/ai-gateway/vector-database">
    A database that stores embeddings and finds the ones most similar to a given query.
  </Card>
  <Card title="RAG (Retrieval-Augmented Generation)" icon="search" href="/en/ai-gateway/rag-injection">
    Retrieving relevant passages from a knowledge base and injecting them into a request before it reaches the model.
  </Card>
  <Card title="Knowledge Base" icon="book-open" href="/en/ai-gateway/knowledge-bases">
    Your own collection of documents, chunked and indexed, that RAG retrieves from.
  </Card>
  <Card title="Semantic Cache" icon="layers" href="/en/ai-gateway/semantic-cache">
    Reuses a cached response for an identical or highly similar request to cut latency and cost.
  </Card>
  <Card title="Virtual API Key" icon="key" href="/en/ai-gateway/virtual-api-keys">
    The credential issued to your applications that keeps the real LLM provider key hidden.
  </Card>
  <Card title="Guardrail" icon="shield-alert" href="/en/ai-gateway/advanced-guardrails">
    A protective check — such as masking personal data or blocking a prompt injection — applied to a request or response.
  </Card>
  <Card title="MCP (Model Context Protocol)" icon="plug" href="/en/ai-gateway/mcp-gateway">
    A standard protocol that lets an LLM discover and call external tools and data sources.
  </Card>
  <Card title="A2A (Agent-to-Agent)" icon="network-wired" href="/en/ai-gateway/a2a-gateway">
    A standard protocol for one AI agent to hand off a task to another agent and exchange results.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="LLM Provider" icon="cpu" href="/en/ai-gateway/llm-providers">
    Learn about LLM Provider concept
  </Card>
  <Card title="Token" icon="hash" href="/en/ai-gateway/token-quotas">
    Learn about Token concept
  </Card>
  <Card title="Embedding" icon="sparkles" href="/en/ai-gateway/vector-database">
    Learn about Embedding concept
  </Card>
  <Card title="Vector Database" icon="database" href="/en/ai-gateway/vector-database">
    Learn about Vector Database concept
  </Card>
  <Card title="RAG" icon="search" href="/en/ai-gateway/rag-injection">
    Learn about Retrieval-Augmented Generation
  </Card>
  <Card title="Knowledge Base" icon="book-open" href="/en/ai-gateway/knowledge-bases">
    Learn about Knowledge Base concept
  </Card>
  <Card title="Semantic Cache" icon="layers" href="/en/ai-gateway/semantic-cache">
    Learn about Semantic Cache concept
  </Card>
  <Card title="Virtual API Key" icon="key" href="/en/ai-gateway/virtual-api-keys">
    Learn about Virtual API Key concept
  </Card>
  <Card title="Guardrail" icon="shield-alert" href="/en/ai-gateway/advanced-guardrails">
    Learn about Guardrail concept
  </Card>
  <Card title="MCP" icon="plug" href="/en/ai-gateway/mcp-gateway">
    Learn about Model Context Protocol
  </Card>
  <Card title="A2A" icon="network-wired" href="/en/ai-gateway/a2a-gateway">
    Learn about Agent-to-Agent concept
  </Card>
</CardGroup>
...
You can search for terms in the glossary by category:
  ...
  <Accordion title="AI Gateway Terms">
    * LLM Provider, Token, Embedding
    * Vector Database, RAG, Knowledge Base
    * Semantic Cache, Virtual API Key
    * Guardrail, MCP, A2A
  </Accordion>
...
## Alphabetical Term List
  ...
  <Accordion title="A">
    ...
    * **A2A (Agent-to-Agent)** - Standard protocol for one AI agent to hand off a task to another agent
  </Accordion>
  ...
  <Accordion title="G">
    ...
    * **Guardrail** - A protective check, such as masking personal data or blocking a prompt injection, applied to a request or response
  </Accordion>
  ...
  <Accordion title="K">
    ...
    * **Knowledge Base** - Your own collection of documents, chunked and indexed, that RAG retrieves from
  </Accordion>
  
  <Accordion title="L">
    * **Load Balancing** - Load balancing strategies
    * **LLM Provider** - The external LLM service that AI Gateway connects to and routes requests toward
  </Accordion>
  ...
  <Accordion title="M">
    ...
    * **MCP (Model Context Protocol)** - Standard protocol that lets an LLM discover and call external tools and data sources
  </Accordion>
  ...
  <Accordion title="R">
    ...
    * **RAG (Retrieval-Augmented Generation)** - Retrieving relevant passages from a knowledge base and injecting them into a request before it reaches the model
  </Accordion>
  
  <Accordion title="S">
    * **Script-2-API** - Feature for creating APIs from script code
    * **Service** - Environment Service, environment service
    * **Semantic Cache** - Reuses a cached response for an identical or highly similar request
  </Accordion>
  
  <Accordion title="T">
    * **Team** - The group formed by members working on a project
    * **Task Flow** - Task flows in API Integrator
    * **Token** - The unit of text an LLM reads and generates; quotas and cost are measured per token
  </Accordion>
  ...
  <Accordion title="V">
    ...
    * **Vector Database** - A database that stores embeddings and finds the ones most similar to a given query
    * **Virtual API Key** - The credential issued to your applications that keeps the real LLM provider key hidden
  </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="Choose Your Role" icon="user" href="/en">

...
<Tabs>
  <TabItem value="es-off" label="ES Off">
  ...
  <TabItem value="es-on" label="ES On">
    | Tier | Heap Usage | Young GC | Old GC | Threads (Peak) | Blocked |
    |------|-----------:|---------:|-------:|:--------------:|:-------:|
...
<CardGroup cols={2}>
  ...
  <Card title="Message Processing and Policy Execution" icon="arrows-spin" href="/en/concepts/core-concepts/message-processing-and-policy-application">

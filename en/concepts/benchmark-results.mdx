...
<Info>
  Kubernetes master, worker, MongoDB, Elasticsearch, and Apinizer installations were done following the installation steps at [Apinizer Installation Documentation](/en/setup/overview.mdx).
</Info>

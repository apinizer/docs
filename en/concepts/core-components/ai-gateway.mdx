...
<CardGroup cols={2}>
  ...
  <Card title="API Manager" icon="gear" href="/en/concepts/core-components/api-manager">
    Learn about the Control Plane component that configures and deploys AI Gateways
  </Card>
</CardGroup>

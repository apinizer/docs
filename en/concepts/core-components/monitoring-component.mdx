...
### Alarm Management
  ...
  <Accordion title="Alarm Types">
    ...
    * **Gateway diagnostics triggers**: Live JVM/pool figures of each API Gateway worker pod, read through the Gateway Management API — Thread Count, Heap Usage Percentage, Deadlock Count, Executor Pool Saturation Percentage, Connection Pool Usage Percentage, GC Time Percentage
...
<CardGroup cols={2}>
  ...
  <Card title="Alarm Management" icon="bell" href="/en/monitor/alarm">
    Alarm management
  </Card>
  <Card title="Prometheus & Grafana" icon="chart-line" href="/en/setup/kubernetes">

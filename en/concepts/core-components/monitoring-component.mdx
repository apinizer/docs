...
<Tip>
For detailed information about Uptime Monitor, see the [Uptime Monitor](/en/tutorials/api-monitoring-scenarios/uptime-monitoring-usage.mdx) page.
</Tip>
...
<Tip>
For detailed information about Anomaly Detector, see the [Anomaly Detector](/en/monitor/anomaly-detector.mdx) page.
</Tip>
...
<AccordionGroup>
  ...
  <Accordion title="Alarm Channels">
    ...
    * **Connectors**: Actions with connectors like email, API call, notification, SNMP
    ...
    <Tip>
    Alarm channels are configured using connectors. For detailed information, see the [Actions and Connectors](/en/concepts/core-concepts/connector.mdx) page.
    </Tip>
  </Accordion>
...
<Tip>
For detailed information about alarm management, see the [Alarm (Alert)](/en/monitor/alarm.mdx) page.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Uptime Monitor" icon="clock" href="/en/tutorials/api-monitoring-scenarios/uptime-monitoring-usage.mdx">

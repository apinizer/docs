...
<img src="/images/develop/global-configurations/new-policy-group.png" alt="Policy Group Settings" style={{maxWidth: '1000px', width: '100%', height: 'auto'}} />

<img src="/images/develop/global-configurations/new-policy-grup2.png" alt="Policy Group Screen" style={{maxWidth: '800px', width: '100%', height: 'auto'}} />
...
| **Show API Key** *(Show Proxy Key)* | Opened via the link in the **API Key Information** area. When clicked, a dialog is displayed with Policy Group Client Id and Policy Group Client Secret; values can be copied, regenerated, and saved. |
...
<img src="/images/develop/global-configurations/new-policy-grup3.png" alt="Policy Group Deploy" style={{maxWidth: '1000px', width: '100%', height: 'auto'}} />

...
The Global Policies interface lists and manages not only classic API proxy policies but also **AI Gateway policies**, centrally. Some policies can be used both on classic API proxies and in the AI flow, while others are specific to AI proxies, MCP Gateways, and A2A Gateways. Five of the AI guardrail policies — personal-data masking, prompt protection, data-loss protection, off-topic protection, and retry-storm (loop) protection — can be attached to an AI proxy, MCP Gateway, or A2A Gateway; the rest (for example token quota, retrieval-augmented context) stay AI-proxy only — see [Advanced Guardrails: MCP and A2A Gateways](/en/ai-gateway/advanced-guardrails#mcp-and-a2a-gateways) for the full breakdown. AI policies are not added to classic API Proxy Groups; they are applied to AI proxies, MCP Gateways, and A2A Gateways.
...
- [Advanced Guardrails](/en/ai-gateway/advanced-guardrails) — the behavior of personal-data masking, prompt and data-loss protection, and the other security policies
- [Access Control and Roles](/en/ai-gateway/access-control-rbac) — who can manage and deploy AI policies
...
<img
  ...
  src="/images/develop/global-configurations/global-policies-1.png" alt="Global Policies Deploy" style={{maxWidth: '1000px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/global-configurations/global-policies-2.png" alt="Globalizing Local Policy" style={{maxWidth: '800px', width: '100%', height: 'auto'}}

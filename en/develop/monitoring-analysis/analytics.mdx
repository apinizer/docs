...
A bar chart showing the distribution of routing failures by reason over the selected time range. The chart's vertical axis is labelled in **requests**. Clicking a bar filters the records for that failure reason in the [API Traffic](/en/develop/monitoring-analysis/api-traffic) table.

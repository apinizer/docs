...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-1.png" alt="API Definition Document List" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
### Moving a Definition Between Projects or Installations

A definition you create here directly — not one generated from an API Proxy — can be moved to another project or installation through the [Export/Import Wizard](/en/admin/secrets-management/export-import). This is separate from **Import API Spec** described below, which reads an OpenAPI/Swagger file to create a new definition; the wizard instead moves a definition Apinizer already holds, together with its own portable package format.

- On this list, each row's menu has an **Export** action that opens the wizard with that definition preselected as an **API Specification**, and the header has an **Import** button that opens the wizard's import step with the same type preselected.
- The wizard's own type list also carries **API Specification** as its own entry under the **API Management** category, reachable independently of this screen.
- Only definitions created directly here are listed — a definition generated **from an API Proxy** is not a separate object in the wizard; it keeps traveling as part of that proxy's own package. An imported definition is never linked to a proxy, regardless of the installation it came from.
- The wizard's **Import as New** is refused when the target project already has a definition with the same title; use **Replace Existing** to update it in place instead.
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-2.png" alt="Creating New API Definition Document" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-3.png" alt="Blank API Option" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-4.png" alt="Import API Definition Document" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  src="/images/develop/spec-designer/spec-designer-5.png"
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-6.png" alt="API Definition Document Update" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-7.png" alt="API Definition Document Settings" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-8.png" alt="Overview" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-9.png" alt="Paths" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-10.png" alt="Adding Path" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-11.png" alt="Path Addition Dialog" style={{maxWidth: '180px', width: '50%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-12.png" alt="Deleting Path" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-13.png" alt="Updating Path" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-14.png" alt="Editing Path" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-15.png" alt="Path Editing Dialog" style={{maxWidth: '250px', width: '50%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-16.png" alt="Header Parameters" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-17.png" alt="Query Parameters" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-18.png" alt="Request Body" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-19.png" alt="Responses" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-20.png" alt="Adding Operation" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-21.png" alt="Deleting Operation" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-22.png" alt="Data Models" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-23.png" alt="Adding Data Model" style={{maxWidth: '250px', width: '50%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-24.png" alt="Data Model Import" style={{maxWidth: '220px', width: '50%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-25.png" alt="Deleting Data Model" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-26.png" alt="Changing Data Model Name" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-27.png" alt="Properties" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-28.png" alt="Property Addition Dialog" style={{maxWidth: '600px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-29.png" alt="Property Addition Dialog Detail" style={{maxWidth: '600px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-30.png" alt="Deleting Property" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-31.png" alt="Deleting API Definition Document" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/spec-designer/spec-designer-32.png" alt="API Proxy Creation" style={{maxWidth: '800px', width: '100%', height: 'auto'}}

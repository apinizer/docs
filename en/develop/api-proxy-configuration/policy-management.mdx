...
<img
  ...
  src="/images/develop/message-processing/istemci.png" alt="Client" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/message-processing/api-tanim-belgesi.png" alt="API Specification Document" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/message-processing/all.png" alt="All Option" style={{maxWidth: '1000px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/message-processing/hepsi-secenegi.png" alt="All Option" style={{maxWidth: '1000px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/message-processing/politika-isletilme-sirasi.png" alt="Policy Execution Order" style={{maxWidth: '1000px', width: '100%', height: 'auto'}}
...
<a id="policy-management-operations"></a>
## Policy Management Operations

<a id="adding-policy-to-flow"></a>
...
<img
  ...
  src="/images/develop/message-processing/politika-ekle.png" alt="Add Policy" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/message-processing/politika-tipi-secimi.png" alt="Policy Type Selection" style={{maxWidth: '800px', width: '100%', height: 'auto'}}

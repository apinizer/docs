...
This section will not go into the details of policies. For detailed information about policies, you can refer to the [Policies](/en/develop/policies/api-based-throttling.mdx) page.

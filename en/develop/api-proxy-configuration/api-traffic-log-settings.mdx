...
These settings apply not only to Elasticsearch but also to all [connector](/en/concepts/core-concepts/connector) types such as Kafka, RabbitMQ, Database, ActiveMQ, Syslog, Webhook, Logback, Graylog.
...
The following fields can be configured for each connector:
...
- **Add Method Override**: Define custom settings by selecting a method and connector type.

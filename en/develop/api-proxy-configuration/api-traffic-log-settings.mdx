...
<!-- 📷 SCREENSHOT REQUIRED: Log settings screen with multiple connectors of the same type -->
...
For detailed information, you can refer to the [Adding Connectors to Gateway Environments](/en/admin/server-management/adding-connectors-to-gateway-environments) page. For environment configuration, see [Gateway Runtimes](/en/admin/server-management/gateway-runtimes).

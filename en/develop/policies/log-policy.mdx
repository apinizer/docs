...
### Unsent Message Table

When a connection to a DB Connector cannot be established, undelivered log records are temporarily stored in the `log_UnsentMessage` table. When the connection is re-established, these records are automatically sent.

...
| **Step 3: Define Action Chain** | - In **Policy Definitions**, open the **Actions** dropdown and select **Add**, **Modify**, **Delete**, or **Stop**.<br />- In the dialog that opens, set Action Type, Source Data Type (NUMERIC/STRING/TEMPORAL), and operator (e.g., SUBSTRING, ADD_TEMPORAL, EXTRACT_JWT_BODY_CLAIM) and fill their parameters. |

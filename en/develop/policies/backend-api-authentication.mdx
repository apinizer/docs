...
<img src="/images/develop/politikalar/backend-api-new.png" alt="Backend API Authentication Policy Configuration" width="1000" />
...
| **Step 9: Save** | - Click **[Save]** button at top right.<br /><br />**Checklist:**<br />- Unique name<br />- Required fields filled<br />- At least one username/password definition exists<br /><br />**Result:**<br />- Policy is added to list.<br />- Can be bound to APIs.<br />- If global policy, automatically applied. |

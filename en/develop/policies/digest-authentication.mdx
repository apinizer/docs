...
<img src="/images/develop/politikalar/digest-new.png" alt="Digest Authentication Policy Configuration" width="1000" />
...
| **Step 8: Customize Error Message (Optional)** | - Go to **Error Message Customization** tab.<br />- Customize message to return when access is denied.<br /><br />**Default:**<br />`{ "statusCode": 403, "message": "[Default error message]" }`<br /><br />**Custom:**<br />`{ "statusCode": 403, "errorCode": "[CUSTOM_ERROR_CODE]", "message": "[Custom message]" }` |
| **Step 9: Save** | - Click **[Save]** button at top right.<br /><br />**Checklist:**<br />- Unique name<br />- Required fields filled<br />- At least one digest variable set selected<br /><br />**Result:**<br />- Policy is added to list.<br />- Can be bound to API Proxies.<br />- If global policy, automatically applied. |

...
<img
  ...
  alt="JOSE Application Policy — Definition tab"
  width="1000"
...
<img
  ...
  alt="JOSE Verification Policy — Definition tab"
  width="1000"
  style={{maxWidth: '1000px', width: '100%', height: 'auto'}}
/>
...
<CardGroup cols={2}>
  ...
  <Card title="Token Management Settings" icon="settings" href="/en/admin/identity-management/token-management-settings">

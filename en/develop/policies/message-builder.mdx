...
For full documentation including zone parameter formats, pattern syntax, and escape rules, see [Date/Time Helper (`dtf`)](/en/concepts/core-concepts/dynamic-variables#datetime-helper-dtf) in the Dynamic Variables reference.

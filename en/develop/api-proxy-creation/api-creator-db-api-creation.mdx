...
<img src="/images/develop/api-proxy-olusturma/db-api-proxy-yonetme.png" alt="API Proxy management" width="800" />
...
<img src="/images/develop/api-proxy-olusturma/db-api-deploy.png" alt="Deploy screen" width="800" />
...
<img src="/images/develop/api-proxy-olusturma/db-api-yeniden-yukleme-bildirimi.png" alt="Redeploy notification" width="800" />

By saying **Redeploy Required**, changes are applied to API Proxies.

<img src="/images/develop/api-proxy-olusturma/db-api-redeploy.png" alt="Redeploy screen" width="800" />
...
<img src="/images/develop/api-proxy-olusturma/db-api-redeploy-onay.png" alt="Redeploy confirmation screen" width="800" />

From the DB-2-API page, go to the API Proxy by clicking the link in the API Proxy's name.

<img src="/images/develop/api-proxy-olusturma/db-api-proxy-link.png" alt="Link from DB-2-API to API Proxy" width="800" />
...
<img src="/images/develop/api-proxy-olusturma/db-api-geri-link.png" alt="Link from API Proxy to DB-2-API" width="800" />

  ...
  <Accordion title="Scenario 1: Exposing Internal gRPC Service">
    ...
    <Steps>
      ...
      <Step title="Add Security Policies">
        Security policies supported on gRPC, such as Authentication, are added.
      </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Transport Security" icon="shield">
    gRPC services usually run on internal networks and security is critical. Use TLS on the backend connection; if the backend requires mTLS, define the client certificate through the Keystore settings.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="gRPC Routing Security" icon="lock" href="/en/develop/routing/grpc-routing">
    Learn Keystore and TLS settings for the backend connection
  </Card>
  <Card title="Deployment and Version" icon="rocket" href="/en/develop/deployment-and-version-management">
    Learn to deploy
  </Card>

  ...
  <Step title="Upload OpenAPI File">
    ...
    <AccordionGroup>
      <Accordion title="Method 1: Load from URL">
        ...
        <Info>
          **Authentication and Timeout** If the spec URL requires authentication, enable the **Use Spec Authorization** option to enter custom headers or **Basic Auth** (username/password) credentials. You can also configure the connection timeout (5-120 seconds, default: 30s) in the **SSL/Certificate Settings** section. For more details, see the [API Proxy Creation](/en/develop/api-proxy-creation/api-proxy-creation) page.
        </Info>
      </Accordion>

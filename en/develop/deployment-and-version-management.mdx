...
Every deploy and undeploy attempt, successful or failed, also writes a **Deploy** or **Undeploy** record to [Audit Records](/en/admin/audit-compliance/audit-records#operation-events) and, once a destination is configured, to a SIEM (see [SIEM & Log Forwarding](/en/admin/system-settings/siem-log-forwarding)).

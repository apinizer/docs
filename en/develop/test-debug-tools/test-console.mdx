...
<Frame caption="Secure Connection Settings">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-secure-connection-settings.png" alt="Test Console Settings tab - Secure Connection Settings" width="1000" height="700" />
</Frame>

...
<Frame caption="Test Console">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-1.png" alt="Test Console" width="800" />
</Frame>
...
<Frame caption="Test Helper Button">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-2.png" alt="Test Helper button" width="600" />
</Frame>

<Frame caption="Test Helper Settings">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-3.png" alt="Test Helper settings" width="600" />
</Frame>
...
<Frame caption="Adding Query Parameter">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-4.png" alt="Adding Query Parameter" width="600" />
</Frame>
...
<Frame caption="Adding Header">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-5.png" alt="Adding Header" width="600" />
</Frame>
...
<Frame caption="Adding Body">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-6.png" alt="Adding Body" width="600" />
</Frame>
...
<Frame caption="WS Security Sign">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-9.png" alt="WS Security Sign" width="600" />
</Frame>
...
<Frame caption="WS Security Sign Settings">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-10.png" alt="WS Security Sign settings" width="600" />
</Frame>
...
<Frame caption="Sign JSON">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-12.png" alt="Sign JSON" width="600" />
</Frame>
...
<Frame caption="Sign JSON Settings">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-11.png" alt="Sign JSON settings" width="600" />
</Frame>
...
<Frame caption="Creating Assertion">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-13.png" alt="Creating Assertion" width="600" />
</Frame>
...
<Frame caption="Secure Connection Settings">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-secure-connection-settings.png" alt="Test Console Settings tab - Secure Connection Settings" width="1000" />
</Frame>
...
<Frame caption="Creating New Test">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-16.png" alt="Creating New Test" width="600" />
</Frame>
...
<Frame caption="Response Body">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-17.png" alt="Response Body" width="600" />
</Frame>
...
<Frame caption="Request Response Headers">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-18.png" alt="Request Response Headers" width="600" />
</Frame>
...
<Frame caption="Assertion Results">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-19.png" alt="Assertion Results" width="600" />
</Frame>
...
<Frame caption="Response Logs">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-20.png" alt="Response Logs" width="600" />
</Frame>
...
<Frame caption="Test History">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-21.png" alt="Test History" width="400" />
</Frame>
...
<Frame caption="Saving Test to Collection">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-22.png" alt="Saving Test to Collection" width="600" />
</Frame>
...
<Frame caption="Collection List">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-23.png" alt="Collection List" width="400" />
</Frame>
...
<Frame caption="Collection-Based Operations">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-24.png" alt="Collection-Based Operations" width="300" />
</Frame>
...
A collection's **Export Collection** action opens a menu with two formats:

- **Apinizer package (.zip)** — sends you to the [Export/Import Wizard](/en/admin/secrets-management/export-import) with this collection preselected. This format carries the collection's dependencies and supports **Replace Existing** on the target, matching tests already there by their portable identity and reporting which of them would be removed before anything is deleted. This format only carries the one collection and its own tests — a nested sub-collection has to be selected on the wizard's dependency step separately if you also want it included, and its place under the parent is rebuilt on import.
- **Postman / Testnizer (.json)** — the collection's tests are written into a Postman v2.1-compatible file, unchanged from before this option was added; nothing about it was removed.

**Import Collection** likewise opens a two-option dialog: choose **Apinizer package** to be sent to the Export/Import Wizard's import step with this type preselected, or **Postman / Testnizer** to pick a `.json` file and import it directly here as before. If you pick the JSON option but choose a `.zip` file, the dialog recognizes it and offers to continue in the wizard instead of failing outright. The Apinizer package options are only shown to a user who holds the Export/Import permission for this project; a user without it sees only the Postman/Testnizer option.
...
<Frame caption="Record-Based Operations">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-25.png" alt="Record-Based Operations" width="300" />
</Frame>
...
<Frame caption="Save As">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-26.png" alt="Save As" width="600" />
</Frame>

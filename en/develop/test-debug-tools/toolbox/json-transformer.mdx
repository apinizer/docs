...
<Frame caption="JSON to JSON Transformer Settings">
  <img src="/images/develop/test-debug-araclari/toolbox/json-transformer-1.png" alt="JSON to JSON Transformer settings" width="800" />
</Frame>

<Frame caption="JSON to XML Transformer Settings">
  <img src="/images/develop/test-debug-araclari/toolbox/json-transformer-2.png" alt="JSON to XML Transformer settings" width="800" />
</Frame>

...
| `pxt` | Policy Execution Times (written only when the option is enabled on the log target) | List&#60;PolicyExecutionTiming&#62; | nested o: integer t: keyword d: integer f: keyword (ignore_above 1) |

...
After the DNS test is completed, Kubernetes installation on Openshift Origin 3.11 is completed. For Apinizer installation, see [Apinizer Installation](/en/setup/installations-overview) documentation.

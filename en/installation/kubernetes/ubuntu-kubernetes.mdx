---
title: "Ubuntu"
description: "You can install Kubernetes version 1.36 on Ubuntu 24.04 LTS (Noble) operating system. You can configure Containerd container runtime, create cluster network structure with Calico network plugin, and configure multi-master."
---
:::warning
...
After verifying that the manifest file was downloaded, apply it:

...
You can perform Kubernetes installation from the [Kubernetes Installation on Ubuntu Operating System](/en/installation/kubernetes/ubuntu-kubernetes) document.

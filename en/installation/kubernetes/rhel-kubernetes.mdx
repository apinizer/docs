---
title: "Red Hat"
description: "You can install Kubernetes version 1.36 on RHEL (Red Hat Enterprise Linux) 8.x / 9.x and Rocky Linux operating systems. You can configure Containerd container runtime, create cluster network structure with Calico network plugin, and configure multi-master."
---

...
After moving the installation file from its directory to /opt/elasticsearch/ folder, apply the steps on [Elasticsearch Installation on Ubuntu Operating System](/en/installation/elasticsearch/ubuntu-elasticsearch) page.

## 9) Apinizer Installation

You can perform Apinizer installation from [Apinizer Installation and Configuration](/en/setup/installations-overview) page.

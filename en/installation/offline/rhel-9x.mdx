...
After moving the installation file from its directory to /opt/elasticsearch/ folder, you can perform configurations from [Elasticsearch Installation on Red Hat Operating System](/en/installation/elasticsearch/rhel-elasticsearch) page.

## 9) Apinizer Installation

You can perform Apinizer installation from the [Installations Overview](/en/setup/installations-overview) page.

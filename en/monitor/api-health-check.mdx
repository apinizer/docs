...
{/* TODO: screenshot — new API Health Check form (Scheduling: cron + Maintenance Window + Service Level (SLA) Settings sections); old file: /images/monitor/api-saglik-kontrolu/01-ayarlar-formu.png; target: /images/2026-09-2/uptime-form.png */}
...
response-time chart, and a tabbed area at the bottom.
    ...
    <Accordion title="3. Uptime Timeline and Response Time Chart">
        ...
        {/* TODO: screenshot — monitor detail page (5 KPI cards, uptime timeline strip, p50/p95/p99 response time chart); old file: /images/monitor/api-saglik-kontrolu/02-durum-ozeti-sonuclar.png; target: /images/2026-09-2/uptime-detail.png */}
    </Accordion>

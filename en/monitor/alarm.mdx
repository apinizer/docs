...
{/* TODO: screenshot — New Alarm form (Name/Description, searchable Trigger Type with category badges, Threshold, Cron scheduling, Notification Recipients); old file: /images/monitor/alarm/01-alarm-ayarlar-formu.png; target: /images/2026-09-2/alarm-yeni-form.png */}
...
{/* TODO: screenshot — Alarm list (Name/Description search, Status and Source segment filters, table: Alert/Trigger type/Condition/Current value/Every/Project/Actions); old file: /images/monitor/alarm/02-alarm-ozeti.png; target: /images/2026-09-2/alarm-liste.png */}

...
The measured value itself is unitless on screen: for a condition built on a duration metric (e.g. response
time, total time) the number shown is in **milliseconds**.

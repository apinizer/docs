...
In JSON and XML transformation policies, conversion could be skipped silently or leave the body in the wrong format. Transformation now runs correctly, and failures are no longer silent. [See.](/en/develop/policies/json-transformation) APNZ-6484

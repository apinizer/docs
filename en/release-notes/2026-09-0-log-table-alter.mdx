---
title: "2026.09.0 — Log Table ALTER Scripts"
description: "ALTER TABLE scripts for existing SQL/JDBC traffic-log installations upgrading to Apinizer 2026.09.0."
slug: /release-notes/2026-09-0-log-table-alter
unlisted: true
---
...
ALTER TABLE log_ApiProxyTraffic ADD (
    ...
    -- MCP/A2A outbound tool/skill audit trail (APNZ-6557)

...
- **Wildcard and Case-Sensitivity Hint for API Traffic Search Fields**

A tooltip explaining wildcard usage (`*partNo=123*`) and case-sensitivity has been added to the Routing Address, From Client Body, To Backend API Body, From Backend API Body, and To Client Body search fields on the API Traffic screen. The backend already wrapped queries with wildcards automatically, but this capability was not visible to the user. APNZ-6236

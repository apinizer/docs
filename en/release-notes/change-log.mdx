...
**APNZ-6403** : On the API Proxy Group page, adding more than one API Proxy to a group at the same time failed and the selected proxies could not be added. Multiple API Proxies can now be added to a group at the same time without errors.

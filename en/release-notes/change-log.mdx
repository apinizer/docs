...
- **Memory Unit Displayed Incorrectly in Distributed Cache List**

Fixed an issue where memory values configured in GB were shown as MB on the Administration > Gateway Infrastructure > Distributed Cache list. The memory unit label is now consistent with the configured value; existing Cache Server configurations do not need to be changed. APNZ-6244

...
- **File Selection Can Be Cleared in the Portal Page Dialog**

Fixed an issue in the API Portal user interface where a file selected in the upload field of the page create and edit dialog could not be cancelled. A clear button is now displayed next to the selected file name; clicking it returns the field to the empty "Upload File" state, allowing a different file to be selected. The fix applies to both the default-language and secondary-language file fields. APNZ-6181

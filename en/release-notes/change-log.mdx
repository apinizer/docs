...
All platform components (API Manager, Gateway Worker, Cache Server, Integration, API Portal) have been upgraded to Java 25.

- **Full Elasticsearch 7, 8, and 9 Support**

Elasticsearch 7.x, 8.x, and 9.x versions are now fully supported.

- **Message Builder Policy**

A new policy has been added that allows dynamically constructing request and response messages.

- **Error Message Customization**

The return formats (JSON/XML) of error messages in policies can now be customized.

- **API Promotion Module**

A module has been added for transferring and managing API definitions between different environments.

- **Advanced Logging Features**

API Proxy-level log settings, log policy, and metadata fields have been redesigned.

- **Report Generator Scheduled Report Delivery**

Existing reports can now be selected and scheduled for delivery via connectors.

- **TCP Connectivity Test Screen**

TCP and TLS connection tests from Gateway pods to target servers are now supported.

- **API Definition File Access Control**

Three-level access control for definition files such as WSDL and OpenAPI has been added on a per-API Proxy basis.
...
- **Trace Screen Redesign:** The API tracing screen has been redesigned.
- **Security Hardening:** XSS, IDOR, and Stack Trace Leak vulnerabilities have been addressed.
- **Library Updates:** Spring Boot 3.5.x, Angular 19, PrimeNG 19, and numerous dependencies have been updated.
- **Context and Environment Variable Expansions:** Variable usage has been extended across all configuration screens.
- **mTLS Support in Test Console and API Call** has been added.
- **Import Operation Improvement:** A diff-based import option has been added.
- **System Properties Table** has been added.
- **Diff view in Deployment History** has been added.
...
Comprehensive stability, performance and usability improvements have been made across the platform. See [Release Notes 2026](/en/release-notes/release-notes-2026#version-2026040) for details.

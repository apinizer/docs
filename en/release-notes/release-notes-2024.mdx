...
New policies have been added to Management APIs. [See.](/api-reference/policies/crud/add-policy)
...
- Operations that can be performed in the Development tab of API Proxy and API Proxy Group have been customized for each pipeline. [See.](/en/develop/api-proxy-creation)
...
- In endpoint testing in API Portal, when an application is selected, Auth information now comes automatically. [See.](/en/api-portal/api-product#api-specification-and-test-console)
...
Project and Admin Overview pages have been made more interactive. [See Project](/en/develop/api-proxy-creation) [See Admin](/en/admin/overview)
...
An Error Policies pipeline has been added for policies determined in error situations to work. [See.](/en/concepts/core-concepts/message-processing-and-policy-application#error-pipeline)
...
- In the API Proxy Traffic screen, search can now be done in the advanced query field with options empty/is not empty/exists/not exists/contains/not contains/in list/not in list. [See.](/en/analytic/api-traffic#filtering)

- Organization API Visibility screen has been added to Portal Management. [See.](/en/api-portal/organization-visibility)

- It has been enabled to check values such as included/not included in a list when a list is given to Condition. [See.](/en/concepts/core-concepts/conditional-policy-execution#condition-components)

- The feature to enter specific days has been added to Time policy. [See.](/en/develop/policies/time-restriction#configuration-steps)
...
- Account registration in API Developer Portal can now be configured. [See.](/en/api-portal/api-portal-settings#security)
...
- Feature to sign request body as JSON has been added to Test console. [See.](/en/develop/test-debug-tools/test-console#sign-json)
...
- Feature to sign request body as WS Security has been added to Test console. [See.](/en/develop/test-debug-tools/test-console#ws-security-sign)
...
An API has been added to Management APIs to Export/Import API Proxies. [See.](/api-reference/api-proxies/deployment/deploy-api-proxy)
...
A new "Entire Body" option has been added to get the entire body value for message types when creating a Body type variable in variable definition. [See.](/en/concepts/core-concepts/variable#creating-body-type-variable)
...
- Data type of request/response header and parameter values kept in Elasticsearch index template, which was previously text, has been converted to nested. [See.](/en/analytic/api-traffic-log-record-data-structure#data-structure-fields)
...
- A new type called Custom Variable has been added to the Variables screen. This type provides the ability to create variables specific to the message pipeline. [See.](/en/concepts/core-concepts/variable#creating-custom-variable-type-variable)

...
- When Cache is started, loading of previous quota data from the database can now be done lazily or eagerly. [See.](/en/admin/server-management/gateway-environments#cache)

- Production and Test fields have been added to Gateway Environments. [See.](/en/admin/server-management/gateway-environments)
...
Test User role has been added. [See.](/en/admin/user-access-management/role)
...
To make log management flexible, this setting can now be made environment-based, can be disabled when needed, and simultaneous logging can be done on multiple log connectors (Database, Elasticsearch, Kafka, RabbitMQ, ActiveMQ, Syslog, Webhook). [See.](/en/admin/server-management/gateway-environments#log-connector)
...
Thus, both the problem experienced in advanced searches has been resolved and the data type sent to all connectors has been standardized. [See.](/en/integrations/connectors/overview.mdx)

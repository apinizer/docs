...
<Info>
Since an API Proxy can be loaded into multiple [Environments](/en/concepts/core-concepts/environment), metrics are **queried based on environment**. Environment selection must be made from the top of the page.
</Info>

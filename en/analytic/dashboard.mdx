...
The bottom section shows a routing diagnostics summary:

- **Failure Reason Distribution** — breakdown of error causes (e.g. Upstream HTTP Error)
- **Phase Latency (p50/p95/p99)** — phase latency for Upstream Selection, DNS, TTFB, Body Read, Pool Wait
- **Top Failing Proxies** — API Proxies with the most failures in the selected window

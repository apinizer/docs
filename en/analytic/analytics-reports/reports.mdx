...
All of the report pages listed above are available in both the Project menu and the Admin menu. The difference is scope: the Admin menu versions cover all projects and offer a project selection filter, while the Project menu versions cover only the active project.

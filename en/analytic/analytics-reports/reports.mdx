...
<img
  ...
  alt="Metrics — shared filter row, Traffic tab, API Traffic Metrics sub-report, and main tab bar"
  width="1000"
  height="300"
/>
...
<CardGroup cols={2}>
  <Card title="Metrics" icon="chart-bar" href="/en/analytic/analytics-reports/reports#the-metrics-page">
...
<CardGroup cols={2}>
  ...
  <Card title="Canary & Mirror Metrics" icon="code-branch" href="/en/analytic/analytics-reports/canary-and-mirror-metrics">

...
| Tab | Sub-reports |
|-----|-------------|
| Traffic | API Traffic Metrics, API Traffic By Interval (with interval, breakdown and value-unit selectors, a peak-windows panel and a chart/list view toggle) |

...
Among these pages, API Proxy Traffic (Over Time) and Proxy Creation Report pages are exclusive to Admin, while others are available in both Project menu and Admin menu.

...
### Interval and View Controls

Two controls specific to this report sit on the sub-report button row and are only visible while this sub-report is selected:
...
The standalone version of the report (the one not embedded in the Metrics page) additionally offers an **API Proxy** filter; that filter is not present in the Metrics page view.

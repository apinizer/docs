...
description: "You can group gateway traffic in Apinizer by a selected time interval on the Metrics page and track successful, blocked, and error request counts in either graph or table form."
---


<img
  src="/images/2026-09-2/gateway-traffic-by-interval-overview.png"
  alt="Metrics — Traffic tab, Gateway Traffic By Interval sub-report, Peak Windows panel, and stacked chart"
  width="1000"
  height="515"
/>

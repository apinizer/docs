...
<Tabs>
  <TabItem value="basic-filtering" label="Basic Filtering">
    Records can be filtered with predetermined criteria such as a specific time range, endpoint, or HTTP method.
      ...
      {/* TODO: screenshot — Gateway Traffic screen, "More options" > Basic Filtering tab, including the Canary Request/Canary Routing Status/Mirror Traffic row; old file: /images/analytic/api-traffic-basic-filter-overview.png; target: /images/2026-09-2/api-traffic-basic-filter-overview.png */}

...
<Info>
Since an API Proxy can be loaded into multiple [Environments](/en/concepts/core-concepts/environment), metrics are queried based on environment. In all analytics screens, metrics are filtered by first selecting **Environment information**.
</Info>

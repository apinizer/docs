...
<Info>
Trace operations are performed on an API Proxy basis. For detailed application steps, you can refer to the [Step-by-Step Tracking](/en/develop/monitoring-analysis/step-by-step-tracing) page.
</Info>
...
<CardGroup cols={2}>
  <Card title="Step-by-Step Tracking" icon="magnifying-glass" href="/en/develop/monitoring-analysis/step-by-step-tracing">

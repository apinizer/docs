...
{/* TODO_SCREENSHOT: Trace screen with a selected policy node, the "Execution Details" button visible in the header bar and its modal open (e.g., Cache LOOKUP HIT with Cache Key, Target Variable, cached value accordions). Filename: trace-execution-details-modal.png */}
<Frame>
  <img src="/images/develop/izleme-analiz/trace-execution-details-modal.png"
       alt="Trace screen — Execution Details button and open modal (policy-specific accordions)"
       width="1000" />
</Frame>

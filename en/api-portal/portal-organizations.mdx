...
| Action | Effect |
|--------|--------|
| **Suspend / Resume** | Temporarily disables / restores all application credentials; subscriptions and analytics are kept |
| **Revoke credentials** | Permanently revokes credentials; cannot be undone |

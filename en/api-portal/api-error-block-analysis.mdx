...
:::tip
For live quota/blocks and the request drawer use [Traffic & Usage](/en/api-portal/traffic-and-usage); for product×org×app summary metrics use [API Traffic Report](/en/api-portal/api-traffic-report).
:::

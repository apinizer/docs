...
<img
    src="/images/tutorials/nasil-yapilir-kilavuzlari/gelistirici-kilavuzlari/api-portal-mcp-kullanimi/gorsel1.png"
...
<Steps>
  ...
  <Step title="MCP Configuration">
    Click on the "MCP" expression added at the end of the box where you enter instructions and press the "Configure" button, activate the MCP field and the fields below in the opened area
      <img
          src="/images/tutorials/nasil-yapilir-kilavuzlari/gelistirici-kilavuzlari/api-portal-mcp-kullanimi/gorsel2.png"
          alt="Image 2024 9 9 15 35 35 Pn"
          width="800"
          className="mr-auto"
      />
  ...
  <Step title="Start Proxy">
    ...
    <Tabs>
<TabItem value="npx-srbhptl39-mcp-superassistant-proxy-latest-config-c-mcp-mcp-config-json" label="npx @srbhptl39/mcp-superassistant-proxy@latest --config C:\\mcp\\mcp_config.json">
...
```bash
  ...
  <Step title="Verify Connection">
    At the end of this operation, you should see the "Server Connected" expression in the new screen that opens on the side in the browser and your relevant connection definition in the "Available Tools" tab
      <img
          src="/images/tutorials/nasil-yapilir-kilavuzlari/gelistirici-kilavuzlari/api-portal-mcp-kullanimi/gorsel3.png"
          alt="Image 2024 9 9 15 35 35 Pn"
          width="800"
          className="mr-auto"
      />
  ...
  <Step title="Add Instructions">
    Press the "MCP" expression at the end of the box where you enter instructions and press insert to enter the "Instructions" it outputs as instructions. Send the instructions
      <img
          src="/images/tutorials/nasil-yapilir-kilavuzlari/gelistirici-kilavuzlari/api-portal-mcp-kullanimi/gorsel4.png"
          alt="Image 2024 9 9 15 35 35 Pn"
          width="800"
          className="mr-auto"
      />
...
<img
    src="/images/tutorials/nasil-yapilir-kilavuzlari/gelistirici-kilavuzlari/api-portal-mcp-kullanimi/gorsel5.png"
    alt="Image 2024 9 9 15 35 35 Pn"
    width="800"
    className="mr-auto"
/>
 <img
    src="/images/tutorials/nasil-yapilir-kilavuzlari/gelistirici-kilavuzlari/api-portal-mcp-kullanimi/gorsel6.png"
    alt="Image 2024 9 9 15 35 35 Pn"
    width="800"
    className="mr-auto"
/>
 <img
    src="/images/tutorials/nasil-yapilir-kilavuzlari/gelistirici-kilavuzlari/api-portal-mcp-kullanimi/gorsel7.png"
    alt="Image 2024 9 9 15 35 35 Pn"
    width="800"
    className="mr-auto"
/>
...
<img
    src="/images/tutorials/nasil-yapilir-kilavuzlari/gelistirici-kilavuzlari/api-portal-mcp-kullanimi/gorsel8.png"
    alt="Image 2024 9 9 15 35 35 Pn"
    width="800"
    className="mr-auto"
/>
<img
    src="/images/tutorials/nasil-yapilir-kilavuzlari/gelistirici-kilavuzlari/api-portal-mcp-kullanimi/gorsel9.png"
    alt="Image 2024 9 9 15 35 35 Pn"
    width="800"
    className="mr-auto"
/>
<img
    src="/images/tutorials/nasil-yapilir-kilavuzlari/gelistirici-kilavuzlari/api-portal-mcp-kullanimi/gorsel10.png"
    alt="Image 2024 9 9 15 35 35 Pn"
    width="800"
    className="mr-auto"
/>
<img
    src="/images/tutorials/nasil-yapilir-kilavuzlari/gelistirici-kilavuzlari/api-portal-mcp-kullanimi/gorsel11.png"
    alt="Image 2024 9 9 15 35 35 Pn"
    width="800"
    className="mr-auto"
/>

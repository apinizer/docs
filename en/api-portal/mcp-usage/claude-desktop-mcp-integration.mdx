...
<Tabs>
<TabItem value="how-many-apis-are-in-my-apinizer-api-portal" label="-How many APIs are in my Apinizer API portal?">
...
## Troubleshooting
  ...
  <Accordion title="Command not found Error">
    ...
    **Solution:**
    ...
    <Tabs>
<TabItem value="check-node-js-installation" label="# Check Node.js installation">

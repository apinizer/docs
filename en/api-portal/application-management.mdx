...
On API Portal, users can only see and manage their own applications. Each application is bound to the portal where it was created; in multi-portal deployments, applications created in one portal are not listed in other portals.
...
/>
<Tabs>
  <TabItem value="scenario-a-user-with-no-applications" label="Scenario A: User with No Applications">
  ...
  <TabItem value="scenario-b-user-with-existing-applications" label="Scenario B: User with Existing Applications">
...
<Tabs>
  <TabItem value="api-key-creation-flow" label="API Key Creation Flow">
  ...
  <TabItem value="api-key-revocation-flow" label="API Key Revocation Flow">

...
description: "This document explains how to automatically transfer API Proxies from one environment (for example DEMO) to another (for example QA) using CI/CD. The prepared Jenkins Pipeline uses API Manager APIs to retrieve the Proxy list, package them, and deploy them to the target environment."
---

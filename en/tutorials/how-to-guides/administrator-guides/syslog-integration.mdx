...
- **Login Audit**: Log records of sign-in, sign-out, token refresh and account-lock events on the Apinizer management application interface. They are sent to the connectors selected as **Login Log** recipients in General Settings (Syslog included).

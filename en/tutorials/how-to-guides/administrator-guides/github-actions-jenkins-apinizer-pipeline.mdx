...
For detailed information on creating an Apinizer API token, refer to the [Token Acquisition Methods](/en/develop/policies/token-service/token-acquisition-methods) documentation.

...
description: "You can configure horizontal scaling operations for pods, automatically increase and decrease the number of pods according to application demands, and optimize resource usage."
---
...
To use the scaling feature in your Kubernetes cluster, a metric-server must be installed. If it is not available, you can check the [Kubernetes Metric Server Installation](/en/setup/kubernetes) page for installation.

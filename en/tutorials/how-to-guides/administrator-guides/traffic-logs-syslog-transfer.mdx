---
title: "Transfer of Traffic Logs to Syslog"
description: "You can transfer Apinizer traffic logs to syslog server, provide centralized log management, and configure Syslog Connector from Gateway Environment settings."
---
...
- [Traffic Log Syslog Transfer — operations guide](/en/operations/administrator-guides/traffic-logs-syslog-transfer): Buffer byte ceiling, length-prefixed framing and rsyslog server-side settings for large records (request/response bodies in the hundreds of KB) and high volume.

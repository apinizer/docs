---
title: "Transfer of Apinizer System Logs with Syslog"
description: "You can transfer Apinizer system logs (application logs, token logs, audit logs) to syslog server, configure Syslog Connector from System Settings, and provide centralized log management."
---

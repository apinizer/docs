---
title: Resolving ID Reference Issue Within SOAP Message
description: "You can resolve ID reference issues within SOAP message using XSLT. You can edit ID references in request or response messages in some .NET services and convert them to correct format."
---
...
Similarly, if the same operation is desired to be done without namespace, the following example can be used:

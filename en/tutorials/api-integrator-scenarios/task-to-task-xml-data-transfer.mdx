...
<Steps>
  ...
  <Step title="Specify XPath">
    ...
    When writing XPath, add the **"#/"** sign to the key information **("xmlResponse")** to indicate that XML operations will be performed on the previous data. Then enter the path where the array elements are located as XPath. In this case, for this example, the following should be written in the XPath field: **"{{xmlResponse#/root/users/user}}"**
  </Step>

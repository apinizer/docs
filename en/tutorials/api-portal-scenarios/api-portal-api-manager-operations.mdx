...
:::tip
Full reference including **Support** and **Prod Promote**: [API Portal Settings](/en/api-portal/api-portal-settings). This tutorial keeps older overview screenshots; use the reference page for the current field list.
:::

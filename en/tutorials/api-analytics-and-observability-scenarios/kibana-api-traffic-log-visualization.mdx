...
For the Template Data Structure Table, you can visit the [Elasticsearch Manual ILM Policy and Template Creation](/en/setup/installations-overview) page and see the description of data stored by field name in ILM Policies.
...
This page visualizes Elasticsearch API traffic **logs** with Kibana. To visualize Gateway **metrics** in Grafana from Prometheus, see [Visualizing API Traffic Metrics with Grafana](/en/tutorials/api-analytics-and-observability-scenarios/grafana-api-traffic-metric-visualization).

...
description: "Implement business rules by adding values to the customVariableMap via script, then trigger throttling or other policies based on that variable content."
---

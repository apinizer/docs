...
description: "Apply the JSON Schema Validation policy to a REST-to-SOAP type API Proxy on Apinizer. Step-by-step request body validation against a JSON schema."
---

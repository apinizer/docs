...
description: "Validate a JSON Web Token sent to a REST API (Swagger PetStore) using the JOSE Validation policy. Step-by-step setup of the JWT validation workflow on an API Proxy."
---
...
Settings for the API Proxy can be made from this screen. To get detailed information about these settings, you can visit the [API Proxy Creation](/en/develop/api-proxy-creation) document.  

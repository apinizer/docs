...
description: "When HTTP and WebSocket services run on the same API Proxy, use policy conditions to apply Apinizer policies only to HTTP requests while letting WebSocket connections pass through."
---

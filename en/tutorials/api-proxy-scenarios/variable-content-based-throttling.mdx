...
description: "Apply throttling based on the content of dynamic variables in API requests. Define throttling rules that trigger when specific variable values appear."
---

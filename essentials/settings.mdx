...
<ResponseField name="api" type="API">
  Configuration for API settings. Learn more about API pages at [API Components](/api-reference/overview).
    ...
    <ResponseField name="playground" type="Playground">
      ...
      <Expandable title="Playground">
        <ResponseField name="mode" default="show" type='"show" | "simple" | "hide"'>
          ...
          Learn more at the [playground guides](/api-reference/overview)
        </ResponseField>
      </Expandable>
    </ResponseField>

---
title: "Ubuntu"
description: "Ubuntu 24.04 LTS (Noble) işletim sisteminde Kubernetes 1.36 sürümünü kurabilir. Containerd container runtime'ını yapılandırabilir, Calico network plugin'i ile cluster ağ yapısını oluşturabilir ve multi-master yapılandırması yapabilir."
---  
:::warning
...
sudo apt-get install -y kubelet=1.36.2-2.1 kubeadm=1.36.2-2.1 kubectl=1.36.2-2.1
...
Manifest dosyasının indirildiğini doğruladıktan sonra uygulayın:
...
k8s-master   Ready    master   5d    v1.36.2
k8s-worker1  Ready    <none>   5d    v1.36.2
```

---
title: "Red Hat"
description: "RHEL (Red Hat Enterprise Linux) 8.x / 9.x ve Rocky Linux işletim sistemlerinde Kubernetes 1.36 sürümünü kurabilir. Containerd container runtime'ını yapılandırabilir, Calico network plugin'i ile cluster ağ yapısını oluşturabilir ve multi-master yapılandırması yapabilir."
---
...
sudo dnf install -y kubelet-1.36.2-1.1 kubeadm-1.36.2-1.1 kubectl-1.36.2-1.1 --disableexcludes=kubernetes

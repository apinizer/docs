...
İçeriğin ilk bölümlerimde, en baştan başlayarak adım adım; AKS kurulumu, kaynaklarının oluşturulması, kullanılması ve harici MongoDb ile ElasticSearch sunucusu adımları anlatılmaktadır.
  ...
  Eğer AKS üzerinde hazır bir küme (cluster) varsa doğrudan [5. adım olan AKS'ye Apinizer'ın Kurulumu](#5-aksye-apinizerın-kurulumu) bölümünden başlanılabilir.
...
<a id="aksye-apinizerın-kurulumu"></a>
...
Ortam tanımlama ve yayın işlemleri ile ilgili detaylı bilgi almak için [Environment dokümantasyonuna](/tr/concepts/temel-kavramlar/ortam-nedir.mdx) bakınız.
...
API Proxy ile ilgili detaylı bilgi için [Geliştirici Kılavuzuna](/tr/develop/quick-start.mdx) bakınız.

Test Konsoluyla ilgili detaylı bilgi almak için [Test Konsolu dokümantasyonuna](/tr/develop/test-debug-araclari/test-console.mdx) bakınız.

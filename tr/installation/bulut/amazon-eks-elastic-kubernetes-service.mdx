...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/eks-overview.png" alt="Amazon EKS Overview" width="1000" />
</Frame>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/vpc-topology.png" alt="VPC Topology" width="1000" />
</Frame>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/vpc-subnets.png" alt="VPC Subnets" width="1000" />
</Frame>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/23-vpc-cloudformation.png" alt="AWS CloudFormation Console" width="1000" />
</Frame>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/iam-overview.jpg" alt="IAM Overview" width="1000" />
</Frame>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/55-iam-roles-page.png" alt="IAM Roles Sayfası" width="1000" />
</Frame>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/54-iam-roles.png" alt="IAM Roles" width="200" />
</Frame>

<Frame>
  <img src="/images/setup/bulut/amazon-eks/53-iam-create-role.png" alt="Create Role" width="1000" />
</Frame>

<Frame>
  <img src="/images/setup/bulut/amazon-eks/52-iam-eks-service.png" alt="EKS Service" width="1000" />
</Frame>

<Frame>
  <img src="/images/setup/bulut/amazon-eks/51-iam-permissions.png" alt="Permissions" width="1000" />
</Frame>

Gelen sayfada herhangi bir key-value bilgisi girmeden devam edilir.

<Frame>
  <img src="/images/setup/bulut/amazon-eks/50-iam-review.png" alt="Review" width="1000" />
</Frame>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/48-iam-worker-role.png" alt="Worker Node Role" width="1000" />
</Frame>

<Frame>
  <img src="/images/setup/bulut/amazon-eks/47-iam-worker-policies.png" alt="Worker Policies" width="1000" />
</Frame>

Bu Role için aşağıdaki Policy'ler seçilmelidir.

<Frame>
  <img src="/images/setup/bulut/amazon-eks/46-iam-worker-policies-alt.png" alt="Worker Policies Alt" width="1000" />
</Frame>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/45-eks-search.png" alt="EKS Search" width="1000" />
</Frame>

<Frame>
  <img src="/images/setup/bulut/amazon-eks/44-eks-create.png" alt="EKS Create" width="1000" />
</Frame>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/43-eks-cluster-config.png" alt="Cluster Config" width="1000" />
</Frame>
  </Step>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/22-eks-subnet.png" alt="Subnet" width="1000" />
</Frame>

<Frame>
  <img src="/images/setup/bulut/amazon-eks/42-eks-network.png" alt="Network" width="1000" />
</Frame>

<Frame>
  <img src="/images/setup/bulut/amazon-eks/41-eks-security-group.png" alt="Security Group" width="1000" />
</Frame>
  </Step>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/40-eks-logging.png" alt="Logging" width="1000" />
</Frame>
  </Step>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/39-eks-creating.png" alt="Creating" width="1000" />
</Frame>

<Frame>
  <img src="/images/setup/bulut/amazon-eks/38-eks-review.png" alt="Review" width="1000" />
</Frame>
  </Step>
</Steps>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/37-iam-user.png" alt="IAM User" width="1000" />
</Frame>

Gelen ekrandan **Manage access keys** butonuna tıklayarak **Access** bilgilerine gidilir.

<Frame>
  <img src="/images/setup/bulut/amazon-eks/36-iam-manage-access-keys.png" alt="Manage Access Keys" width="1000" />
</Frame>

<Frame>
  <img src="/images/setup/bulut/amazon-eks/35-access-key-dialog.png" alt="Access Key Dialog" width="1000" />
</Frame>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/34-access-key-secret.png" alt="Access Key Secret" width="1000" />
</Frame>
  </Step>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/33-aws-cli-access-key.png" alt="AWS CLI Access Key" width="1000" />
</Frame>
  </Step>
</Steps>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/32-aws-region.png" alt="AWS Region" width="200" />
</Frame>

<Frame>
  <img src="/images/setup/bulut/amazon-eks/31-eks-cluster-name.png" alt="EKS Cluster Name" width="1000" />
</Frame>
  </Step>
</Steps>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/29-node-group-create.png" alt="Node Group Create" width="1000" />
</Frame>
  </Step>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/28-node-group-config.png" alt="Node Group Config" width="1000" />
</Frame>

<Frame>
  <img src="/images/setup/bulut/amazon-eks/27-node-group-config-alt.png" alt="Node Group Config Alt" width="154" />
</Frame>
  </Step>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/26-node-group-scaling.png" alt="Node Group Scaling" width="1000" />
</Frame>

<Frame>
  <img src="/images/setup/bulut/amazon-eks/25-node-group-scaling-alt.png" alt="Node Group Scaling Alt" width="1000" />
</Frame>
  </Step>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/21-node-group-network.png" alt="Node Group Network" width="1000" />
</Frame>
  </Step>
  <Step title="İncele ve Oluştur">
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/20-node-group-review.png" alt="Node Group Review" width="1000" />
</Frame>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/19-node-group-ready-alt.png" alt="Node Group Ready Alt" width="1000" />
</Frame>

<Frame>
  <img src="/images/setup/bulut/amazon-eks/18-node-group-ready.png" alt="Node Group Ready" width="1000" />
</Frame>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/03-elasticsearch-cluster.png" alt="Elasticsearch Cluster" width="1000" />
</Frame>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/02-gateway-environment.png" alt="Gateway Environment" width="1000" />
</Frame>

Aşağıdaki değerler sunucuların varsayılan değerleridir. Cluster kaynaklarınıza uygun olarak değiştirilebilir.

<Frame>
  <img src="/images/setup/bulut/amazon-eks/15-environment-config.png" alt="Environment Config" width="1000" />
</Frame>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/14-environment-edit.png" alt="Environment Edit" width="1000" />
</Frame>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/12-api-proxy-project.png" alt="API Proxy Project" width="1000" />
</Frame>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/10-api-source.png" alt="API Source" width="1000" />
</Frame>

API Tanım dosyasının linki girilerek **Parse** edilir.

<Frame>
  <img src="/images/setup/bulut/amazon-eks/09-api-parse.png" alt="API Parse" width="1000" />
</Frame>
...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/05-api-test-endpoint.png" alt="API Test Endpoint" width="1000" />
</Frame>

Test etme diyaloğunu içeren görsele aşağıda verilmiştir.

<Frame>
  <img src="/images/setup/bulut/amazon-eks/04-api-test-dialog.png" alt="API Test Dialog" width="1000" />
</Frame>

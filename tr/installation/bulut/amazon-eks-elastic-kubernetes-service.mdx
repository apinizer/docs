...
<Frame>
  <img src="/images/setup/bulut/amazon-eks/55-iam-roles-page.png" alt="IAM Roles Sayfası" width="1000" height="225" />
</Frame>
...
Gateway Runtime ortamı tanımlama ve yayın işlemleri ile ilgili detaylı bilgi almak için [Gateway Runtime'ları sayfasına](/tr/admin/server-management/gateway-runtime-lari) bakınız.
...
API Proxy ile ilgili detaylı bilgi için [Geliştirici Kılavuzuna (Developer Guide)](/tr/develop/quick-start) bakınız.

Test Konsoluyla ilgili detaylı bilgi almak için [Test Console sayfasına](/tr/develop/test-debug-araclari/test-console) bakınız.

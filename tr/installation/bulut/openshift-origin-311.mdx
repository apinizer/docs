...
DNS testi tamamlandıktan sonra Openshift Origin 3.11 üzerinde Kubernetes kurulumu tamamlanmış olur. Apinizer kurulumu için [Kubernetes'e Kurulum](/tr/setup/kubernetes) dokümantasyonuna bakınız.

...
DNS testi tamamlandıktan sonra Openshift Origin 3.11 üzerinde Kubernetes kurulumu tamamlanmış olur. Apinizer kurulumu için [Apinizer Kurulumu](/tr/setup/apinizer/apinizer) dokümantasyonuna bakınız.

---
title: "Red Hat İşletim Sisteminde Elasticsearch 8.17.10 Kurulumu"
description: "Bu doküman, Red Hat işletim sistemine sahip bir sunucuya Elasticsearch 8.17.10 kurulumunu anlatmaktadır. Red Hat 9.6 işletim sisteminin olması tavsiye edilir."
---
...
<Warning title="Önemli - High Availability (H.A.) Kurulumu">
  Elasticsearch Master–Data mimarisinde High Availability kurulumu yapılacaksa, aşağıdaki alanlar yaml dosyasında uygun şekilde doldurulmalıdır:
```yaml
...
Detaylı bilgi için [bu linkteki dokümantasyonu](/tr/installation/elasticsearch/ubuntu-elasticsearch) inceleyebilirsiniz.

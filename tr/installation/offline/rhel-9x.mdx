...
Kurulum sonrası MongoDB konfigürasyonları [Red Hat İşletim Sisteminde MongoDB Kurulumu](/tr/setup/mongodb/rhel-mongodb.mdx) dökümanından devam edebilirsiniz. ( 2.1 kurulum adımını geçebilirsiniz.)
...
Kurulum dosyasını bulunduğu dizinden /opt/elasticsearch/ klasörüne taşıdıktan sonra [Red Hat İşletim Sisteminde Elasticsearch Kurulumu](/tr/installation/elasticsearch/rhel-elasticsearch) sayfasından konfigürasyonları gerçekleştirebilirsiniz.

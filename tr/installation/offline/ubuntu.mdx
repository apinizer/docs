...
Kurulum sonrası MongoDB konfigürasyonları [Ubuntu İşletim Sisteminde MongoDB Kurulumu](/tr/setup/mongodb/ubuntu-mongodb.mdx) dökümandaki kısımlar ile aynıdır.
...
Kurulum dosyasını bulunduğu dizinden /opt/elasticsearch/ klasörüne taşıdıktan sonra [Ubuntu İşletim Sisteminde Elasticsearch Kurulumu](/tr/installation/elasticsearch/ubuntu-elasticsearch.mdx) sayfasında ki adımları uygulayın.

## 9) Apinizer Kurulumu

Apinizer kurulumu için [Apinizer Kurulumu ve Ayarları](/tr/setup/apinizer/apinizer.mdx) sayfasından gerçekleştirebilirsiniz.

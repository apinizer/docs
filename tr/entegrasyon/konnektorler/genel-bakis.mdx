...
<CardGroup cols={3}>
  <Card title="Veritabanı" icon="database" href="/tr/entegrasyon/konnektorler/database-konnektor">
  ...
  <Card title="Elasticsearch" icon="magnifying-glass" href="/tr/entegrasyon/konnektorler/elasticsearch-konnektor">
  ...
  <Card title="Script" icon="code" href="/tr/entegrasyon/konnektorler/script-konnektor">
...
<CardGroup cols={3}>
  <Card title="Kafka" icon="layer-group" href="/tr/entegrasyon/konnektorler/kafka-konnektor">
    Apache Kafka entegrasyonu ile mesaj gönderme ve alma işlemleri. Event-driven mimariler için mesaj kuyruğu yönetimi.
  </Card>
  <Card title="RabbitMQ" icon="inbox" href="/tr/entegrasyon/konnektorler/rabbitmq-konnektor">
    RabbitMQ entegrasyonu ile mesaj kuyruğu operasyonları ve asenkron mesajlaşma.
  </Card>
  <Card title="ActiveMQ" icon="server" href="/tr/entegrasyon/konnektorler/activemq-konnektor">
...
<CardGroup cols={3}>
  <Card title="API Çağrısı" icon="globe" href="/tr/entegrasyon/konnektorler/api-call-konnektor">
    API endpoint'lerini tetikleme, veri alma ve başka endpoint'lere veri gönderme. HTTP/REST API çağrıları.
  </Card>
  <Card title="Webhook" icon="plug" href="/tr/entegrasyon/konnektorler/webhook-konnektor">
...
<CardGroup cols={2}>
  <Card title="FTP Read" icon="file-arrow-down" href="/tr/entegrasyon/konnektorler/ftp-read-konnektor">
    FTP bağlantı tanımlarını kullanarak dosya arama, okuma ve farklı formatlarda içerik alma işlemlerini gerçekleştirme.
  </Card>
  <Card title="FTP List" icon="list" href="/tr/entegrasyon/konnektorler/ftp-list-konnektor">
...
<CardGroup cols={2}>
  <Card title="E-Posta Gönderme" icon="envelope" href="/tr/entegrasyon/konnektorler/email-konnektor">
    Hata durumlarında e-posta gönderme, e-posta konfigürasyonu ve değişken kullanımı. SMTP sunucu yapılandırması.
  </Card>
  <Card title="Bildirim" icon="bell" href="/tr/entegrasyon/konnektorler/notification-konnektor">
...
<CardGroup cols={3}>
  <Card title="Syslog" icon="file-lines" href="/tr/entegrasyon/konnektorler/syslog-konnektor">
    Syslog protokolü ile log mesajları gönderme ve merkezi log yönetimi.
  </Card>
  <Card title="Logback" icon="file-code" href="/tr/entegrasyon/konnektorler/logback-konnektor">
    Logback framework'ü ile log kayıtları gönderme ve log yönetimi.
  </Card>
  <Card title="SNMP" icon="network-wired" href="/tr/entegrasyon/konnektorler/snmp-konnektor">
...
<CardGroup cols={1}>
  <Card title="Linux Script" icon="terminal" href="/tr/entegrasyon/konnektorler/linux-script-konnektor">

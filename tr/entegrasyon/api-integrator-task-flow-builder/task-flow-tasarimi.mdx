...
<CardGroup cols={3}>
    ...
    <Card title="API Çağrısı (API Call)" icon="globe" href="/tr/entegrasyon/konnektorler/api-call-konnektor">
        Harici API'lere istek göndermek için kullanılır
    </Card>

    <Card title="Veritabanı Connector" icon="database" href="/tr/entegrasyon/konnektorler/database-konnektor">
        Veritabanı işlemleri için kullanılır
    </Card>

    <Card title="Linux Script Çalıştırma" icon="terminal" href="/tr/entegrasyon/konnektorler/linux-script-konnektor">
        Linux komutları çalıştırmak için kullanılır
    </Card>

    <Card title="Script (JS/Groovy)" icon="code" href="/tr/entegrasyon/konnektorler/script-konnektor">

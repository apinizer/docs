...
Özelliklerden herhangi birinin Ad (Name) kolonundaki değerine tıklanırsa, o özelliğin güncellenebileceği pencere açılır. Güncellemeler yapıldıktan sonra **Kaydet** tuşuna basılarak güncelleme işlemi tamamlanır.

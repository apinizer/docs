...
description: "Farklı ortamlarda farklı değerler kullanılması gereken yapılandırma bilgilerini merkezi olarak yönetebilir. Ortam değişkenleri oluşturabilir, düzenleyebilir ve API Proxy yapılandırmalarında kullanabilir. Global veya ortam özelinde değişkenler tanımlayabilir, secret değerleri güvenli şekilde saklayabilir ve deployment sırasında otomatik olarak çözümlenmesini sağlayabilir."
---
...
<Tabs>
  <Tab title="Backend API Yönetimi">

...
description: "HTTP API Proxy tipi için yönlendirme ayarlarını yapılandırabilir. Backend API adreslerini yönetebilir, koşullu yönlendirme tanımlayabilir, yük dengeleme algoritmalarını seçebilir, bağlantı ayarlarını, devre kesici, SSE, indirme, proxy sunucu, mTLS ve NTLM ayarlarını yapılandırabilir."
---

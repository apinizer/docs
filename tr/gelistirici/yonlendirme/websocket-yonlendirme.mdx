...
description: "WebSocket API Proxy tipi için yönlendirme ayarlarını yapılandırabilir. Backend API adreslerini yönetebilir, bağlantı ayarlarını ve güvenli bağlantı ayarlarını yapılandırabilir."
---

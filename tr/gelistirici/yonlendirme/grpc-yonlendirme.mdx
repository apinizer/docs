...
description: "gRPC API Proxy tipi için yönlendirme ayarlarını yapılandırabilir. Backend API adreslerini yönetebilir, yük dengeleme algoritmalarını seçebilir, bağlantı ayarlarını ve güvenli bağlantı ayarlarını yapılandırabilir."
---

...
description: "API Proxy için CORS, Cache, XML Hata Mesaj Şablonları, İletilen IP Başlık Parametreleri, ProCrypt Entegrasyonu, API Tanım Dosyası Gizleme ve Bakım Modu ayarlarını yapılandırabilir."
---

## Ayarlar Sekmesi

[API Proxy](/tr/apinizer-anlama/temel-kavramlar/api-proxy-nedir) için CORS, Cache, XML Hata Mesaj Şablonları, İletilen IP Başlık Parametreleri, ProCrypt Entegrasyonu, API Tanım Dosyası Gizleme ve Bakım Modu ayarlarının yapıldığı bölümdür. Bu ayarlar [mesaj işleme ve politika uygulama](/tr/apinizer-anlama/temel-kavramlar/mesaj-isleme-ve-politika-uygulama) sürecinde kullanılır.

<Info>
API Proxy Trafik Log ayarları için [API Proxy Trafik Log Ayarları](/tr/gelistirici/api-proxy-konfigurasyonu/api-trafik-log-ayarlari) sayfasına bakabilirsiniz.
</Info>

<img
  src="../../../images/gelistirici/api-proxy-konfigurasyonu/ayarlar-sekmesi.png"
  alt="Ayarlar Sekmesi"
  width="1000"
  height="667"
/>
...
<img
  src="../../../images/gelistirici/api-proxy-konfigurasyonu/cors-ayarlari.png"
  alt="CORS Ayarları"
  width="1000"
  height="700"
/>
...
<Info>
Ön tanımlı mevcut olan Orijin ve Başlık değerlerine yenilerine eklemek için [CORS Orijin Değerleri](/tr/gelistirici/cors-orijin-degerleri) ve [CORS Başlıkları](/tr/gelistirici/cors-basliklari) sayfalarını ziyaret edebilirsiniz.
</Info>

## Önbellek Ayarları

API Proxy'den dönen yanıtlar ön belleğe alınarak istemciden gelen istekler Backend API'ye gönderilmeden önbellekten yanıtlanabilir. Buna ilişkin ayarların yönetildiği bölümdür. Önbellek anahtarı oluştururken [variable](/tr/apinizer-anlama/temel-kavramlar/variable) kullanılabilir.

<img
  src="../../../images/gelistirici/api-proxy-konfigurasyonu/onbellek-ayarlari.png"
...
<Info>
Eğer API Proxy'nin [Yönlendirme (Routing)](/tr/gelistirici/api-proxy-konfigurasyonu/routing) sekmesinde, "Hedef API'den Hata Dönmesi Durumunda Yanıt Şablonunu Uygulama (Ignore Error Response Template In Case Of Error On Backend API)" seçeneği işaretlenmiş ise bu bölümde tanımlanmış olan şablonlar kullanılmaz, Backend API'nin hata yanıtı olduğu gibi istemciye gönderilir.
</Info>
...
<Info>
API Proxy Tanım dosyalarına erişim için [Genel Bilgi Sekmesi](/tr/gelistirici/api-proxy-konfigurasyonu/overview) sayfasını ziyaret edebilirsiniz.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="API Trafik Log Ayarları" icon="database" href="/tr/gelistirici/api-proxy-konfigurasyonu/api-trafik-log-ayarlari">

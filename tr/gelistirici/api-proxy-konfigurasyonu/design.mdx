...
<Info>
Tasarım sekmesinin içeriği ve kullanımı, Genel Bakış bölümünde birkaç detay verinin istenmiyor olması dışında [Spec Tasarım Editörü](/tr/gelistirici/spec-tasarim-editoru) arayüzü ile aynıdır.
</Info>

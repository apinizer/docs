...
description: "Politika yönetimi, Pre-flow ve Post-flow politikaları, Conditional policies, Route step, Fault handler policies"
---

API Proxy Design sekmesi (Development sekmesi olarak da bilinir), API Proxy'nin mesaj işleme akışını ve politikalarını yönetmenizi sağlar. Bu sekme, pre-flow politikaları, conditional policies, route step, post-flow politikaları ve fault handler politikalarını içerir.

## Design Sekmesi

API Proxy detay sayfasında **Design** sekmesi (Development sekmesi), API Proxy'nin mesaj işleme akışını ve politikalarını içerir. Bu sekme şu bölümlerden oluşur:

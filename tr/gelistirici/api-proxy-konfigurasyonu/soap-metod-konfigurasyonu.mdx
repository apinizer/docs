...
description: "SOAP tipindeki API Proxy'lerde metod güncelleme, silme ve geçici olarak kullanımdan kaldırma işlemlerini gerçekleştirebilir. SOAP metodlarını test edebilir, WS-Addressing ayarlarını ve önbellek ayarlarını yapılandırabilir."
---

## SOAP Metod Konfigürasyonu

Bu sekmede, seçilen [API Proxy](/tr/apinizer-anlama/temel-kavramlar/api-proxy-nedir) için [politikalar](/tr/apinizer-anlama/temel-kavramlar/politika-nedir), protokol dönüşümü ayarları ve SOAP metod yönetimi işlemleri yapılabilir.
...
Her [API Proxy](/tr/apinizer-anlama/temel-kavramlar/api-proxy-nedir), önüne koyulduğu Backend API'nin metodları için vekil olarak çalışan kendi metodlarına sahiptir.
...
Eğer bir API Proxy [en az bir ortama yüklenmişse](/tr/gelistirici/yukleme-ve-surum-yonetimi), metodları bu sekmeden kolayca test edilebilir. Bunun için seçilen metod için **Metodu Test Et** _(Test Method)_ bağlantısına tıklandığında bu metod için [Test Konsolu](/tr/gelistirici/test-debug-araclari/test-console) açılır.

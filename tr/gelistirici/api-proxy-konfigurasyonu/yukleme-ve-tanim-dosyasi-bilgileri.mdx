...
description: "API Proxy'nin hangi ortamlara yüklendiğini görüntüleyebilir, erişim adreslerini kontrol edebilir ve API Tanım Dosyalarına (Swagger, OpenAPI, WSDL) erişebilir. Tanım dosyalarına API Proxy üzerinden erişim sağlayabilir."
---

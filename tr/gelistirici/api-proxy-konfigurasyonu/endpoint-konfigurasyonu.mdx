...
description: "REST tipindeki API Proxy'lerde endpoint ekleme, güncelleme, silme ve geçici olarak kullanımdan kaldırma işlemlerini gerçekleştirebilir. Endpoint'leri test edebilir ve önbellek ayarlarını yapılandırabilir."
---

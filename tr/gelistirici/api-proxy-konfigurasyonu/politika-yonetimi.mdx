...
<img src="/images/gelistirici/message-processing/politika-yeri-ve-calisma-sirasi.png" alt="Politikaların Yeri ve Çalışma Sırası" style={{maxWidth: '1000px', width: '100%', height: 'auto'}} />

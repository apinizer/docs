...
description: "API Proxy'nin istemcilerden gelen istekleri nasıl alacağını ve backend API'lere nasıl yönlendirileceğini yapılandırabilir. Client Route yapılandırması, Upstream Target ayarları, Load Balancing seçenekleri ve path-based, method-based, header-based routing seçeneklerini destekler"
---

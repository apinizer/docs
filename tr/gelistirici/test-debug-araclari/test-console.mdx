...
**Create Monitor:** İlgili testi kullanarak bir Çalışma Süresi Monitörü oluşturmak için kullanılır. Detaylı bilgi almak için [Uptime Monitor](/tr/gelistirici/monitoring-alerting/uptime-monitor) sayfasına tıklayınız.

...
description: "Birden fazla API Proxy'yi grup halinde yönetebilir, grup seviyesi ayarları yapılandırabilir ve gruba gelen isteklerde politikalar uygulayabilir. Grup üyelerini yönetebilir ve ACL yapılandırması yapabilir. Bir API Proxy birden fazla gruba dahil olabilir."
---
...
* **Ad** <em>(Name)</em>: Grubu tanımlayan benzersiz isim (zorunlu)
* **Açıklama** <em>(Description)</em>: Grubun amacı ve kapsamı (opsiyonel)

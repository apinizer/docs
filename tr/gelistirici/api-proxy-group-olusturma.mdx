...
description: "Birden fazla API Proxy'yi grup halinde yönetebilir, ortak politikaları merkezi bir noktadan uygulayabilir ve grup seviyesi ayarları yapılandırabilir. Grup üyelerini yönetebilir, grup politikalarını güncelleyebilir ve ACL yapılandırması yapabilir."
---

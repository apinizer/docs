...
<Info>
  **Grup Üyeliği** API Proxy'ler grup oluşturulduktan sonra da eklenebilir veya çıkarılabilir. Grup üyeliği dinamik olarak yönetilebilir.
</Info>
...
<Warning>
  **Politika Güncelleme Etkisi** Grup politikaları güncellendiğinde, değişiklikler tüm grup üyelerine otomatik olarak uygulanır. Bu, tüm grup üyelerini etkileyebilir.
</Warning>

...
description: 'OpenAPI/Swagger dosyasından REST API Proxy oluşturma, URL veya dosya yükleme, routing yapılandırması'
---

REST API Proxy, RESTful API'lerinizi Apinizer platformu üzerinden yönetmek ve güvenli bir şekilde expose etmek için kullanılır. Bu sayfa, OpenAPI/Swagger spesifikasyon dosyasından REST API Proxy oluşturma sürecini detaylı olarak açıklar.
...
:::info URL Erişimi
URL'den yükleme yaparken, Apinizer'in bu URL'ye erişebilmesi gerekir. Eğer URL internal bir adres ise, Apinizer'in bu adrese erişim izni olduğundan emin olun.
:::

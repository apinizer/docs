...
<Steps>
  ...
  <Step title="Yeni API Oluşturun">
    ...
    <img src="../../images/gelistirici/api-proxy-olusturma/mock-api-olusturma.png" alt="Mock API Oluşturma" width="800" />
  </Step>
...
<AccordionGroup>
  <Accordion title="Blank tipinde Mock API Oluşturma">
    ...
    <img src="../../images/gelistirici/api-proxy-olusturma/mock-api-blank.png" alt="Blank tipinde Mock API Oluşturma" width="800" />
  </Accordion>
  ...
  <Accordion title="Open API veya Swagger'dan Mock API Oluşturma">
    ...
    <img src="../../images/gelistirici/api-proxy-olusturma/mock-api-import-spec.png" alt="Import Spec tipinde Mock API Oluşturma" width="800" />
  </Accordion>
</AccordionGroup>
...
<Steps>
  <Step title="Endpoint Ekle">
    **Ekle (Add)** butonuna tıklayarak yeni metot/endpoint eklenir.
    ...
    <img src="../../images/gelistirici/api-proxy-olusturma/mock-api-endpoint-ekleme.png" alt="Endpoint Ekleme" width="800" />
  </Step>
  ...
  <Step title="Endpoint Bilgilerini Doldurun">
    ...
    <img src="../../images/gelistirici/api-proxy-olusturma/mock-api-endpoint-tanimlama.png" alt="Endpoint Tanımlama" width="800" />
  </Step>
</Steps>
...
<img src="../../images/gelistirici/api-proxy-olusturma/mock-api-yanit-tanim.png" alt="Yanıt Tanım Ayarları" width="800" />
...
<img src="../../images/gelistirici/api-proxy-olusturma/mock-api-yanit-ornek.png" alt="Örnek Yanıt Ayarları" width="800" />
...
<img src="../../images/gelistirici/api-proxy-olusturma/mock-api-proxy-olusturma.png" alt="Mock API'den API Proxy Oluşturma" width="800" />
...
<img src="../../images/gelistirici/api-proxy-olusturma/mock-api-deploy.png" alt="Deploy İşlemi" width="800" />
...
<img src="../../images/gelistirici/api-proxy-olusturma/mock-api-deploy-onay.png" alt="Deploy Onay" width="800" />
...
<img src="../../images/gelistirici/api-proxy-olusturma/mock-api-yeniden-yukleme-bilgi.png" alt="Yeniden Yükleme Bilgilendirme" width="800" />

Yeniden Yükle diyerek değişikliklerin API Proxy'lere uygulanması sağlanır.

<img src="../../images/gelistirici/api-proxy-olusturma/mock-api-yeniden-yukleme.png" alt="Yeniden Yükleme" width="800" />
...
<img src="../../images/gelistirici/api-proxy-olusturma/mock-api-redeploy-onay.png" alt="Redeploy Onay" width="800" />

Mock API sayfasından API Proxy'nin ismine tıklanarak API Proxy'e gidilir.

<img src="../../images/gelistirici/api-proxy-olusturma/mock-api-proxy-gecis.png" alt="Mock API'den API Proxy'ye Geçiş" width="800" />
...
<img src="../../images/gelistirici/api-proxy-olusturma/mock-api-proxy-geri-gecis.png" alt="API Proxy'den Mock API'ye Geçiş" width="800" />

...
description: "SOAP veya REST-SOAP-REST API Proxy\"lerde SOAP Action değerini düzeltmenizi sağlar. SOAP versiyonu belirleyebilir (Content-Type ve namespace bazlı), SOAPAction ve Content-Type ayarları yapabilir ve SOAP 1.1 ile SOAP 1.2 işlemlerini gerçekleştirebilirsiniz"
---

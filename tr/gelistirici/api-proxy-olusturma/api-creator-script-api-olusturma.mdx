...
<Steps>
  <Step title="Menüden Script-2-API Sayfasına Gidin">
    ...
    <img src="/images/gelistirici/api-proxy-olusturma/script-api-olusturma-ekrani.png" alt="Script-2-API Oluşturma Ekranı" width="1000" />
  </Step>
  ...
  <Step title="API Bilgilerini Doldurun">
    ...
    <img src="/images/gelistirici/api-proxy-olusturma/script-api-bilgileri-doldurma.png" alt="API Bilgilerini Doldurma" width="1000" />
  </Step>
  ...
  <Step title="Endpoint Ekleyin">
    ...
    <img src="/images/gelistirici/api-proxy-olusturma/script-api-endpoint-ekle.png" alt="Endpoint Ekleme" width="1000" />
  </Step>
</Steps>
...
<img src="/images/gelistirici/api-proxy-olusturma/script-api-endpoint-olusturma.png" alt="Endpoint Oluşturma Ekranı" width="1000" />
...
<img src="/images/gelistirici/api-proxy-olusturma/script-api-proxy-olustur-butonu.png" alt="Proxy Oluştur Butonu" width="1000" />

Gelen ekranda API Proxy için gerekli alanları girerek **Kaydet** butonuna tıklayarak API Proxy oluşturulur.

<img src="/images/gelistirici/api-proxy-olusturma/script-api-proxy-olusturma-ekrani.png" alt="API Proxy Oluşturma Ekranı" width="1000" />

Bu adımdan sonra yapılabilecekler API Proxy dokümanı ile aynıdır. Detaylı bilgi için [API Proxy Oluşturma](/tr/gelistirici/api-proxy-olusturma/api-proxy-olusturma) sayfasını inceleyebilirsiniz.
...
<img src="/images/gelistirici/api-proxy-olusturma/script-api-proxy-yonetme.png" alt="API Proxy'leri Yönetme" width="600" />
...
<img src="/images/gelistirici/api-proxy-olusturma/script-api-deploy-onay.png" alt="Yükleme Onay Ekranı" width="600" />
...
<img src="/images/gelistirici/api-proxy-olusturma/script-api-yeniden-yukleme-bilgi.png" alt="Yeniden Yükleme Bilgilendirmesi" width="500" />

**Yeniden Yükle (Redeploy)** diyerek değişikliklerin API Proxy'lere uygulanması sağlanır.

<img src="/images/gelistirici/api-proxy-olusturma/script-api-redeploy-onay.png" alt="Yeniden Yükleme Onay Ekranı" width="600" />
...
<img src="/images/gelistirici/api-proxy-olusturma/script-api-proxy-link.png" alt="Script-2-API Sayfasından API Proxy'ye Gitme" width="1000" />
...
<img src="/images/gelistirici/api-proxy-olusturma/script-api-geri-link.png" alt="API Proxy Sayfasından Script-2-API'ye Gitme" width="600" />

## Script-2-API Silme

Bir Script API silindiğinde ona bağlı olan tüm API Proxy'ler önce kaldırılır (undeploy) sonra silinir.

<img src="/images/gelistirici/api-proxy-olusturma/script-api-silme-uyarisi.png" alt="Script-2-API Silme Uyarısı" width="500" />

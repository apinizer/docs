...
description: "Script-2-API ile function-as-a-service yaklaşımıyla REST API oluşturabilir. Endpoint iş mantıklarını Javascript veya Groovy diliyle yazabilir, gelen mesaj öğelerini script ile işleyip sonucu istemciye gönderebilir"
---

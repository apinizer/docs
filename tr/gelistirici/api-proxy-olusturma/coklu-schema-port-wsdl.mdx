...
<AccordionGroup>
  <Accordion title="XSD Dosyalarını Belirleme ve İndirme">
    ...
    **WSDL içerisindeki yerlerin güncellenmesini gösteren görsele aşağıda yer verilmiştir:**
    ...
    <img src="/images/gelistirici/api-proxy-olusturma/wsdl-guncelleme.png" alt="WSDL güncelleme" width="800" />
  </Accordion>
  ...
  <Accordion title="Dosyaları ZIP Olarak Hazırlama">
    ...
    **Dosya dizin yollarını gösteren örnek görsele aşağıda yer verilmiştir:**
    ...
    <img src="/images/gelistirici/api-proxy-olusturma/dosya-dizin-yollari.png" alt="Dosya dizin yolları" width="600" />

    Bu dosyaların ziplenmiş halinin görseli aşağıdaki gibidir:

    <img src="/images/gelistirici/api-proxy-olusturma/zip-dosyalari.png" alt="ZIP dosyaları" width="600" />
  </Accordion>
</AccordionGroup>
...
<img src="/images/gelistirici/api-proxy-olusturma/coklu-port.png" alt="Çoklu port" width="800" />

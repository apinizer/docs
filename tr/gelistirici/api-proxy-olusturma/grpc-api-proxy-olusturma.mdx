...
description: "gRPC servislerinizi Apinizer platformu üzerinden yönetmenizi ve güvenli bir şekilde expose etmenizi sağlar. Google tarafından geliştirilen yüksek performanslı RPC framework\"ünü kullanabilir, Protocol Buffers (protobuf) formatında çalışabilirsiniz. Protobuf dosyasından gRPC API Proxy oluşturabilir, proto file import edebilir, service ve method tanımları yapabilir ve routing yapılandırması gerçekleştirebilirsiniz"
---

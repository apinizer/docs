...
description: "DB-2-API ile teknik bilgi gerektirmeden dakikalar içinde veri tabanı işlemi yapan REST API oluşturmanızı sağlar. SQL ve NoSQL sorguları çalıştırabilir, Stored Procedure çağırabilir, Batch işlemler yapabilir ve CRUD operasyonları gerçekleştirebilirsiniz"
---
...
<CardGroup cols={3}>
  <Card title="Native SQL Deyimleri" icon="database">
    SELECT, INSERT, UPDATE, DELETE, PROCEDURE, BATCH INSERT, TRUNCATE
  </Card>
  
  <Card title="NoSQL İşlemleri" icon="database">
    FIND işlem tipi desteği
  </Card>
  
  <Card title="Stored Procedure" icon="code">
    Stored Procedure çağırma desteği
  </Card>

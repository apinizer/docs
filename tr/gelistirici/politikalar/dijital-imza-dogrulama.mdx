...
| **Politika Adı** | Dijital İmza Doğrulama Politikası |
|------------------|-----------------------------------|
| **Özet** | HTTP isteğinin dijital imzasını yetkili anahtar veya sertifika ile doğrular |
| **Kategori** | Güvenlik ve Erişim Kontrolü |
| **Dönüş Durum Kodları** | <table><thead><tr><th><strong>Hata Kodu</strong></th><th><strong>Hata Mesajı</strong></th><th><strong>HTTP Durum Kodu</strong></th></tr></thead><tbody><tr><td>ERR-089</td><td>Digital Signature Validation policy failed! Error message is: {0}</td><td>500</td></tr><tr><td>ERR-090</td><td>Digital Signature Validation Error (Description of Policy Rule is: {0})</td><td>403</td></tr></tbody></table> |

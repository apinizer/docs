...
| **Politika Adı** | Backend API Kimlik Doğrulama <em>(Backend API Authentication)</em> |
|------------------|---------------------------------------------------------------------|
| **Özet** | Backend API çağrılarına otomatik kimlik doğrulama bilgisi ekler (Basic, Digest, Base64, API Auth) |
| **Kategori** | Güvenlik ve Kimlik Doğrulama |
| **Dönüş Durum Kodları** | <table><thead><tr><th><strong>Hata Kodu</strong></th><th><strong>Hata Mesajı</strong></th><th><strong>HTTP Durum Kodu</strong></th></tr></thead><tbody><tr><td>ERR-055</td><td>API Authentication failed! Detailed Exception Message is: {0}</td><td>500</td></tr><tr><td>ERR-056</td><td>API Authentication is not found!</td><td>501</td></tr></tbody></table> |

...
description: 'HTTP Digest kimlik bilgilerini doğrular, isteğe özel başlık ve yetkilendirme seçenekleri sağlar'
---
...
| **Politika Adı** | Digest Kimlik Doğrulama Politikası |
|------------------|-------------------------------------|
| **Özet** | HTTP Digest kimlik bilgilerini doğrular, isteğe özel başlık ve yetkilendirme seçenekleri sağlar |
| **Kategori** | Güvenlik ve Erişim Kontrolü |
| **Dönüş Durum Kodları** | <table><thead><tr><th><strong>Hata Kodu</strong></th><th><strong>Hata Mesajı</strong></th><th><strong>HTTP Durum Kodu</strong></th></tr></thead><tbody><tr><td>ERR-051</td><td>Authentication policy failed! Error message is: {0}</td><td>500</td></tr></tbody></table> |
...
<img src="/images/gelistirici/politikalar/digest-kimlik-dogrulama-1.png" alt="Digest Kimlik Doğrulama Politikası Yapılandırma" width="1000" />

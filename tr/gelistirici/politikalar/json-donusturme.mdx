...
| **Politika Adı** | JSON Dönüştürme Politikası |
|---|:---|
| **Özet** | JSON mesajlarını JOLT ya da JSON→XML dönüştürme ile hedef servise uyumlu hale getirir. |
| **Kategori** | Veri Dönüşümü ve Uyumlama |
| **Dönüş Durum Kodları** | <table><thead><tr><th>Hata Kodu</th><th>Hata Mesajı</th><th>HTTP Durum Kodu</th></tr></thead><tbody><tr><td>ERR-074</td><td>JSON Transformation policy failed! Error message is: {0}</td><td>500</td></tr></tbody></table> |
...
<img src="/images/gelistirici/politikalar/json-donusturme-1.png" alt="JSON Dönüştürme Politikası" width="1000" />

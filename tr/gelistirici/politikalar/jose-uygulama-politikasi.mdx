...
2. **Politika Kontrolü**: IP JOSE Uygulama politikası aktif ise, sistem aşağıdaki sırayla kontrol yapar:
...
### Yeni JOSE Uygulama Politikası Politikası Oluşturma

| Adım | Açıklama / İşlem |
|------|------------------|
| **Adım 1: Oluşturma Sayfasına Gitme** | - Sol menüden **Geliştirme → Global Settings → Global Policies → JOSE Uygulama Politikası** bölümüne gidin.<br>- Sağ üstteki **[+ Create]** butonuna tıklayın. |

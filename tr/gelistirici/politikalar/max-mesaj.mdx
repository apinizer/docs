...
| **Politika Adı** | Maksimum Mesaj Boyutu Politikası |
|---|:---|
| **Özet** | Gelen istek gövdesinin byte cinsinden üst sınırını denetleyerek aşımı engeller. |
| **Kategori** | Güvenlik ve Erişim Kontrolü |
| **Dönüş Durum Kodları** | <table><thead><tr><th>Hata Kodu</th><th>Hata Mesajı</th><th>HTTP Durum Kodu</th></tr></thead><tbody><tr><td>ERR-027</td><td>Permissible Max. Size Policy Validation failed! Permissible max. size of request must be ( {0} ) but found ( {1} ) !</td><td>403</td></tr></tbody></table> |
...
<img src="/images/gelistirici/politikalar/max-mesaj-1.png" alt="Maksimum Mesaj Boyutu Politikası" width="1000" />

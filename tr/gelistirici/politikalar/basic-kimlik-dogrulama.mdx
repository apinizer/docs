...
| **Politika Adı** | Base64 Authentication <em>(Basic Authentication)</em> |
|------------------|------------------------------------------------------|
| **Özet** | HTTP Basic Authentication standardını kullanarak API isteklerini kimlik bilgileriyle doğrular ve yetkilendirir |
| **Kategori** | Güvenlik ve Erişim Kontrolü / Kimlik Doğrulama |
| **Dönüş Durum Kodları** | <table><thead><tr><th><strong>Hata Kodu</strong></th><th><strong>Hata Mesajı</strong></th><th><strong>HTTP Durum Kodu</strong></th></tr></thead><tbody><tr><td>ERR-050</td><td>Authentication policy failed! Error message is: {0}</td><td>500</td></tr></tbody></table> |

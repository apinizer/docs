...
**Cevap:** Hayır. JWT yapısı gereği tüm metotlara tek seferde uygulanması daha doğru olan bir kimlik doğrulama yöntemidir. Metotlar için yetkilendirme yapılmak istenirse scope tanımı ile [Yetkilendirme](/tr/gelistirici/politikalar/yetkilendirme) sayfasında tarif edildiği şekilde bir yaklaşım daha doğru olur.

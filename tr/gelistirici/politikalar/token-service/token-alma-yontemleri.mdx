...
description: "OAuth2 standartlarına uygun olarak Client Credentials, Password, Authorization Code ve Implicit flow gibi farklı token alma yöntemlerini kullanabilirsiniz. Refresh token ile token yenileme işlemlerini gerçekleştirebilirsiniz"
---

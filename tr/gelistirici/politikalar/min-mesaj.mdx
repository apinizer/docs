...
| **Politika Adı** | Minimum Mesaj Boyutu Politikası |
|---|:---|
| **Özet** | İstek gövdesinin tanımlanan minimum byte değerinin altına düşmesini engelleyerek boş veya eksik payload'ları bloklar. |
| **Kategori** | Güvenlik ve Erişim Kontrolü |
| **Dönüş Durum Kodları** | <table><thead><tr><th>Hata Kodu</th><th>Hata Mesajı</th><th>HTTP Durum Kodu</th></tr></thead><tbody><tr><td>ERR-026</td><td>Permissible Min. Size Policy Validation failed! Permissible min. size of request must be ( {0} ) but found ( {1} ) !</td><td>403</td></tr></tbody></table> |

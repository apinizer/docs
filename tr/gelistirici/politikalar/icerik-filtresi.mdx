...
| **Politika Adı** | İçerik Filtresi Politikası |
|------------------|----------------------------|
| **Özet** | Regex tabanlı kurallarla istek içeriklerinden zararlı veya hassas verileri engeller ya da temizler. |
| **Kategori** | Güvenlik ve Erişim Kontrolü |
| **Dönüş Durum Kodları** | <table><thead><tr><th><strong>Hata Kodu</strong></th><th><strong>Hata Mesajı</strong></th><th><strong>HTTP Durum Kodu</strong></th></tr></thead><tbody><tr><td>ERR-099</td><td>Content Filter execution is failed! Error message is: {0}</td><td>500</td></tr><tr><td>ERR-100</td><td>Violation detected in Content Filter! Rule Name is: {0}</td><td>403</td></tr><tr><td>ERR-101</td><td>Violation detected in Content Filter! Rule Name is: {0}</td><td>403</td></tr><tr><td>ERR-102</td><td>Violation detected in Content Filter! Rule Name is: {0}</td><td>403</td></tr><tr><td>ERR-103</td><td>Violation detected in Content Filter! Rule Name is: {0}</td><td>403</td></tr></tbody></table> |

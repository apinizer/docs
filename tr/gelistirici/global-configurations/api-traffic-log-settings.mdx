...
1. İstemciden API Proxy'e Gelen İstek (Request from Client)
2. API Proxy'den Backend API'ye İletilen İstek (Request to Target)
3. Backend API'den API Proxy'e Verilen Yanıt (Response from Target)
4. API Proxy'den İstemciye Gönderilen Yanıt (Response to Client)
...
![API Trafiği Log Ayarları](/images/api-traffic-log-settings.png)

## Log Ayarları Konfigürasyonu
...
![API Trafiği Log Ayarları Dialog](/images/api-traffic-log-settings-dialog.png)

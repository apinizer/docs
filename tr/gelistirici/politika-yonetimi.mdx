...
description: "API Proxy'de mesaj akışı ve politika yönetimi hakkında kapsamlı rehber"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Condition-based Policy Execution" icon="code-branch" href="/tr/genel-bakis/apinizeri-anlamak/temel-kavramlar-ve-terminoloji/condition-based-policy-execution">

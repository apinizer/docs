...
Bu kontrol bütçenin kaydedildiği her yerde çalışır: API Proxy'nin Uygulama bütçesi, projenin Kiracı bütçesi ve AI Gateway Ayarları'ndaki global **Varsayılan** ve **Anonim Varsayılan** bütçeler (hem Manager arayüzünden hem APIops üzerinden). Global bütçelerde kapsam kurulumdaki tüm AI proxy'lerdir. Tek istisna **organizasyon** bütçesidir: kapsamı organizasyonun ve tüm alt organizasyonlarının kimlik bilgilerine yayıldığı için kayıt anında doğrulanmaz; organizasyon bütçelerinde yalnızca çalışma zamanı uyarısı geçerlidir.
:::
...
Kimlik Bilgisi katmanındaki kullanım artık typed atamanın kendisine (özne + atama anahtarı) yazılır. Daha önce hiç tüketici kaydı olmamış, saf bir API istemcisinin kullanımı **api_client** kapsamı altında, bir portal uygulamasının kullanımı ise **application** kapsamı altında ayrıca raporlanır.

...
API tarafında hiçbir aile lisans modülüne bağlı değildir: lisansında **AI Gateway** bulunmayan bir kurulum da **AI Token Bütçesi** planlarını Management API ve APIops üzerinden lisanslı bir kurulumla aynı şekilde oluşturur, listeler ve atar. Modülün hâlâ belirlediği şey **menüdür**: modül yoksa AI Gateway grubu gizlenir ve **Limit Planları** bunun yerine **Kimlik Yönetimi** altından açılır.
:::

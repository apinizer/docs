...
Bağlantıların kimlik bilgileri Apinizer'ın genel kimlik bilgisi sistemi üzerinden yönetilir; detaylar için [Kimlik Bilgileri](/tr/admin/identity-management/kimlik-bilgileri) sayfasına bakın. İstemcilerin gerçek sağlayıcı anahtarı yerine kullandığı [Sanal API Anahtarları](/tr/ai-gateway/sanal-api-anahtarlari) da bu bağlantılar üzerinden eşlenir.
...
<CardGroup cols={2}>
  ...
  <Card title="Sanal API Anahtarları" icon="key" href="/tr/ai-gateway/sanal-api-anahtarlari">
    İstemciler için kapsamlı sanal anahtar oluşturun
  </Card>

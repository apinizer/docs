...
- **Katalogda karşılığı olmayan özel modeller olduğu gibi kalır.** Apinizer bunlara varsayılan bir tip *atamaz*: yanlış sınıflandırma, model tipi doğrulamasını ve maliyet hesabını sessizce bozardı. Bu modeller AI Proxy listesinde **Belirtilmemiş** filtresiyle bulunur.
- **Kapsam korunur.** Yalnızca ürünle gelen, yönetici tarafından paylaşılmış ya da kendi projenize ait katalog kayıtları kullanılır.

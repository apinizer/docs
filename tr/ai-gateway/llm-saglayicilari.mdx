...
(sohbet tamamlama `/chat/completions`, embedding `/embeddings`, transkripsiyon `/audio/transcriptions`,
seslendirme `/audio/speech`, görsel üretim `/images/generations`, Responses `/responses`) bağlantıya

...
- **Giden (Outbound)** — Apinizer üzerinden dış A2A ajanlarına görev gönderirsiniz (**A2A Çağrısı (LLM)** politikası). Hedef ajan artık ayrı bir bağlantı kaydı değil, **politikanın kendisinin içinde** tanımlanır — bkz. [Giden Ajan Çağrısı](#giden-ajan-çağrısı).

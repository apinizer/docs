...
<Steps>
  <Step title="Giden bağlantı oluşturun">
    **A2A Gateway** sayfasında dış ajanın uç nokta adresini ve kimlik doğrulama bilgilerini tanımlayın.
  </Step>
  ...
  <Step title="Görev izleme">
    **A2A Gateway** sayfasının **Görevler** segmentinden gönderilen görevlerin durumunu canlı izleyin.
  </Step>
</Steps>

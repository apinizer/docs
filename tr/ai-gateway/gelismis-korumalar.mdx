...
- **Silinen hazır kategori geri gelir.** On dört AILuminate satırı, eksikse her sürüm yükseltmesinde yeniden oluşturulur; yani silmek kalıcı değil, bir sonraki yükseltmeye kadar gizlemektir. Değişikliğin kalıcı olmasını istiyorsanız kategoriyi pasifleştirin ya da yeniden kelimeleyin.

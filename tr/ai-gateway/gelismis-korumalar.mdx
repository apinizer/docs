...
Sınır aşıldığında varsayılan davranış isteği engellemektir; dilerseniz engellemek yerine **en eski konuşma turlarının otomatik kesilmesini** seçebilirsiniz — bkz. [İstek Başına Boyut Sınırı](/tr/ai-gateway/token-kotalari#istek-basina-boyut-siniri).

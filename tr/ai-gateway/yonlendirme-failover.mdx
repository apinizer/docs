...
Failover zinciri (sağlayıcı/model listesi, strateji, maliyet ve durum kodu ayarları), AI proxy'nin **AI Routing** sekmesinde satır satır (inline) tanımlanır ve şu bilgileri içerir:

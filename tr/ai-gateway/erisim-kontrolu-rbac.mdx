...
| İzin Grubu | Kapsam |
|------------|--------|
| **Geliştirme** | LLM sağlayıcı bağlantıları, model kataloğu, yönlendirme/failover, AI proxy, AI politikaları (İstem Koruması, PII Maskeleme, Token Hız Sınırlaması, Semantik Önbellek vb.), hazır kalıp setleri, AI ayarları |

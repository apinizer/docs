...
<CardGroup cols={2}>
  <Card title="Temel Kavramlar" icon="book" href="/tr/apinizer-anlama/temel-kavramlar/api-proxy-group.mdx">
    Temel kavramları öğrenin
  </Card>
  <Card title="Temel Bileşenler" icon="puzzle-piece" href="/tr/apinizer-anlama/temel-bilesenler/analytics-engine.mdx">
  ...
  <Card title="Rolunuzu Seçin" icon="user" href="/tr/admin/kullanici-erisim-yonetimi/rol">

...
<CardGroup cols={2}>
  ...
  <Card title="Policy (Politika)" icon="shield" href="/tr/apinizer-anlama/temel-kavramlar/politika-nedir">
...
<AccordionGroup>
  ...
  <Accordion title="Policy (Politika)">
    ...
    Detaylı bilgi için [Politika Nedir?](/tr/apinizer-anlama/temel-kavramlar/politika-nedir) sayfasına bakın.
  </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="Politika" icon="shield" href="/tr/apinizer-anlama/temel-kavramlar/politika-nedir">
  ...
  <Card title="Upstream Target" icon="arrow-left" href="/tr/apinizer-anlama/temel-kavramlar/routing-ve-upstream#upstream-target">
  ...
  <Card title="Load Balancing" icon="route" href="/tr/apinizer-anlama/temel-kavramlar/routing-ve-upstream#load-balancing-strategies">
...
<CardGroup cols={2}>
  ...
  <Card title="Önbellek Bileşeni" icon="memory" href="/tr/apinizer-anlama/temel-bilesenler/onbellek-bileseni">
    Önbellek Bileşeni'ni öğrenin
  </Card>
  <Card title="İzleme Bileşeni" icon="eye" href="/tr/apinizer-anlama/temel-bilesenler/izleme-bileseni">

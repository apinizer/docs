...
<Info>
  Kubernetes master, worker, MongoDB, Elasticsearch ve Apinizer kurulumları [Apinizer Kurulum Dokümantasyonu](/tr/kurulum/genel-bakis.mdx) adresinde yer alan kurulum adımları takip edilerek yapılmıştır.
</Info>
...
<img src="/images/gelistirici/benchmark/avg-memory-usage-concurrent-users.png" alt="Ortalama Bellek Kullanımı" width="437" height="300" />
...
<img src="/images/gelistirici/benchmark/avg-memory-usage-policy-comparison.png" alt="Ortalama Bellek Kullanımı - Politika ile ve Politika Olmadan" width="437" height="300" />
...
<CardGroup cols={2}>
  ...
  <Card title="Performance Tuning" icon="gauge" href="/tr/apinizer-anlama/deployment/kapasite-planlama">

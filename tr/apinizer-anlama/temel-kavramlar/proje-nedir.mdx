...
* **[API Proxy'ler](/tr/apinizer-anlama/temel-kavramlar/api-proxy-nedir)**: Projeye ait tüm API Proxy'ler
* **[Politikalar](/tr/apinizer-anlama/temel-kavramlar/politika-nedir)**: Projeye özel politika tanımları
* **[Bağlantılar](/tr/apinizer-anlama/temel-kavramlar/baglantilar)**: Veritabanı, mesaj kuyruğu vb. bağlantılar
* **[Konnektörler](/tr/apinizer-anlama/temel-kavramlar/konnektor)**: Entegrasyon konnektörleri
* **[Değişkenler](/tr/apinizer-anlama/temel-kavramlar/variable)**: Proje seviyesinde değişkenler
...
<AccordionGroup>
  <Accordion title="Proje Oluşturma">
    ...
    * **Proje Yükle (Import Project)**: Mevcut bir proje konfigürasyon dosyası üzerinden proje yükleme
    ...
    <Info>
      Detaylı proje oluşturma ve yönetimi için [Proje Yönetimi](/tr/admin/proje-yonetimi/proje-olusturma) sayfasına bakabilirsiniz.
    </Info>
  </Accordion>
  ...
  <Accordion title="Proje Üyeleri ve Rolleri">
    ...
    * **Geliştirici**: [API Proxy](/tr/apinizer-anlama/temel-kavramlar/api-proxy-nedir) oluşturma ve düzenleme yetkisi
...
* **[Ortam](/tr/apinizer-anlama/temel-kavramlar/ortam-nedir)**: Fiziksel/kaynak birimi (API'ler nerede çalışır?)

Bir projedeki [API Proxy'ler](/tr/apinizer-anlama/temel-kavramlar/api-proxy-nedir) farklı [ortamlara](/tr/apinizer-anlama/temel-kavramlar/ortam-nedir) yüklenebilir:
...
[Ortam](/tr/apinizer-anlama/temel-kavramlar/ortam-nedir) oluştururken, ortamın hangi projelerde kullanılabileceği belirlenebilir. Eğer proje seçimi boş bırakılırsa, ortam tüm projelerde kullanılabilir. Proje seçilmesi durumunda sadece o proje içerisinde yer alan [API Proxy'lerin](/tr/apinizer-anlama/temel-kavramlar/api-proxy-nedir) bu ortama deploy edilebileceği anlamına gelir.

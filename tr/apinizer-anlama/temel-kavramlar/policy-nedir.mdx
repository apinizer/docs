...
Politikaların mesaj akışındaki uygulama sırası, API Proxy Group/API Proxy/Endpoint seviyelerindeki çalışma mantığı ve görsel akış diyagramı hakkında detaylı bilgi için [Mesaj Akışı ve Politika Yönetimi](/tr/apinizer-anlama/temel-kavramlar/message-processing) sayfasına bakınız.

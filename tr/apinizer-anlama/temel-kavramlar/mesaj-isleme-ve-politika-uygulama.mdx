...
**İstemci (Client)**: Arayüzde sol taraftaki çerçeve içinde gösterilir. API Proxy'e istek gönderen paydaştır. Akışı başlatır. İstemciden çıkan mesaj, politikalar uygulandıktan sonra Backend API'ye ulaşır.
...
<img src="/images/gelistirici/message-processing/istemci.png" alt="İstemci" width="800" height="auto" />

<img src="/images/gelistirici/message-processing/backend-api.png" alt="Backend API" width="800" height="auto" />

Backend API kutusundaki **API** bağlantısına tıklandığı zaman Backend API'nin API Tanım Belgesi görüntülenir.

<img src="/images/gelistirici/message-processing/api-tanim-belgesi.png" alt="API Tanım Belgesi" width="800" height="auto" />
...
Koşullu politika çalıştırma hakkında detaylı bilgi için [Koşullu Politika Çalıştırma](/tr/apinizer-anlama/temel-kavramlar/kosullu-politika-calistirma) sayfasına bakabilirsiniz.
...
<img src="/images/gelistirici/message-processing/politika-yerleri.png" alt="Politika Yerleri" width="1000" height="auto" />
...
<img src="/images/gelistirici/message-processing/hepsi-seceneği.png" alt="Hepsi Seçeneği" width="1000" height="auto" />
...
<img src="/images/gelistirici/message-processing/politika-isletilme-sirasi.png" alt="Politika İşletilme Sırası" width="1000" height="auto" />
...
<img src="/images/gelistirici/message-processing/politika-ekle.png" alt="Politika Ekle" width="800" height="auto" />
</Step>
...
<img src="/images/gelistirici/message-processing/politika-tipi-secimi.png" alt="Politika Tipi Seçimi" width="800" height="auto" />
</Step>
...
<img src="/images/gelistirici/message-processing/global-politika-secimi.png" alt="Global Politika Seçimi" width="800" height="auto" />
...
<img src="/images/gelistirici/message-processing/politika-guncelleme.png" alt="Politika Güncelleme" width="800" height="auto" />
...
<img src="/images/gelistirici/message-processing/politika-deactivate.png" alt="Politika Deactivate" width="800" height="auto" />
...
<img src="/images/gelistirici/message-processing/butun-politikalari-kapat.png" alt="Bütün Politikaları Kapat" width="800" height="auto" />

Politikalar devre dışı kaldığında, ikonların renkleri değişerek gri bir görünüme kavuşur.

<img src="/images/gelistirici/message-processing/devre-disi-politikalar.png" alt="Devre Dışı Politikalar" width="800" height="auto" />
...
<img src="/images/gelistirici/message-processing/politika-silme.png" alt="Politika Silme" width="800" height="auto" />

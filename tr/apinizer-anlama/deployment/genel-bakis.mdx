...
* **[Topoloji 1: Test ve PoC](/tr/apinizer-anlama/deployment/topoloji-test-poc)** - 2 sunucu, minimum kaynak gereksinimi
* **[Topoloji 2: Profesyonel Kurulum](/tr/apinizer-anlama/deployment/topoloji-profesyonel)** - 5 sunucu, Data Plane öncelikli yük dengeleme
* **[Topoloji 3: Yüksek Erişilebilirlik](/tr/apinizer-anlama/deployment/topoloji-ha)** - 12 sunucu, tam High Available yapı
...
* **Port Gereksinimleri**: Kubernetes, [MongoDB](/tr/apinizer-anlama/temel-kavramlar/baglantilar), [Elasticsearch](/tr/apinizer-anlama/temel-bilesenler/analytics-engine) ve Apinizer bileşenleri için gerekli portlar
* **Trafik Akışı**: İstemci → Load Balancer → [Worker](/tr/apinizer-anlama/temel-bilesenler/api-gateway) → Backend arasındaki trafik akışı
...
* **LAN Koruması**: İç ağdaki hassas bileşenlerin ([Manager](/tr/apinizer-anlama/temel-bilesenler/api-manager), [MongoDB](/tr/apinizer-anlama/temel-kavramlar/baglantilar), [Elasticsearch](/tr/apinizer-anlama/temel-bilesenler/analytics-engine)) korunması
...
* **[Monitoring](/tr/apinizer-anlama/temel-bilesenler/izleme-bileseni) ve Logging**: Sistem izleme ve log toplama yapılandırması
...
* [Worker](/tr/apinizer-anlama/temel-bilesenler/api-gateway) modülleri ([API Gateway](/tr/apinizer-anlama/temel-bilesenler/api-gateway))
* Load Balancer
...
* [Manager](/tr/apinizer-anlama/temel-bilesenler/api-manager) modülü
* [MongoDB](/tr/apinizer-anlama/temel-kavramlar/baglantilar) veritabanı
* [Elasticsearch](/tr/apinizer-anlama/temel-bilesenler/analytics-engine)
* [Distributed Cache](/tr/apinizer-anlama/temel-bilesenler/onbellek-bileseni)
* Yönetim araçları

### Deployment Topolojileri

Apinizer platformu üç temel deployment topolojisi destekler. Detaylı bilgi için [Deployment Modelleri](/tr/apinizer-anlama/deployment/deployment-modelleri) sayfasına bakabilirsiniz:

1. **[Topoloji 1: Test ve PoC](/tr/apinizer-anlama/deployment/topoloji-test-poc)** - Hızlı kurulum, düşük kaynak gereksinimi ile test ve proof of concept ortamları için ideal
2. **[Topoloji 2: Profesyonel Kurulum](/tr/apinizer-anlama/deployment/topoloji-profesyonel)** - Orta ölçekli production ortamları için worker node'ları arasında yük dengeleme sağlayan yapı
3. **[Topoloji 3: Yüksek Erişilebilirlik](/tr/apinizer-anlama/deployment/topoloji-ha)** - Kritik production ortamları için %99.9+ uptime, otomatik failover ve veri replikasyonu sağlayan HA yapısı
...
<CardGroup cols={1}>
  ...
  <Card title="Firewall (1) - İlk Savunma Hattı" icon="shield-halved">
    Dış trafiği filtreleyen ilk güvenlik katmanı
  </Card>
  <Card title="DMZ Zone - Public API" icon="network-wired">
    [Worker](/tr/apinizer-anlama/temel-bilesenler/api-gateway) modülleri ve dış erişime açık servisler
  </Card>
  <Card title="Firewall (2) - İkinci Savunma Hattı" icon="shield-halved">
    DMZ'den LAN'a geçişi kontrol eden ikinci güvenlik katmanı
  </Card>
  <Card title="LAN Zone - Internal" icon="lock">
    [Manager](/tr/apinizer-anlama/temel-bilesenler/api-manager), [MongoDB](/tr/apinizer-anlama/temel-kavramlar/baglantilar), [Elasticsearch](/tr/apinizer-anlama/temel-bilesenler/analytics-engine) ve hassas yönetim bileşenleri
  </Card>
</CardGroup>
...
Detaylı kurulum adımları için [Kurulum Bölümü](/tr/kurulum/genel-bakis.mdx) altındaki ilgili sayfalara bakınız:
...
* **[MongoDB](/tr/apinizer-anlama/temel-kavramlar/baglantilar) Kurulumu**: MongoDB kurulumu ve replica set yapılandırması
* **[Elasticsearch](/tr/apinizer-anlama/temel-bilesenler/analytics-engine) Kurulumu**: Elasticsearch kurulumu ve cluster yapılandırması
...
<CardGroup cols={2}>
  ...
  <Card title="Kapasite Planlama" icon="calculator" href="/tr/apinizer-anlama/deployment/kapasite-planlama">

...
**[Deployment Modelleri](/tr/apinizer-anlama/deployment/deployment-modelleri)** sayfasında, Apinizer'ın farklı gereksinimlere göre kullanılabilecek dört temel kurulum topolojisi detaylı olarak açıklanmaktadır:
...
* **Topoloji 4: Bölgeler Arası Dağıtım** - Global dağılım, coğrafi yedekleme ve disaster recovery için multi-region kurulum
...
* **[Topoloji 2: Profesyonel Kurulum](/tr/apinizer-anlama/deployment/topoloji-2-profesyonel-kurulum)** - 3 sunucu, worker yük dengeleme
* **[Topoloji 3: Yüksek Erişilebilirlik](/tr/apinizer-anlama/deployment/topoloji-3-yuksek-erisilebilirlik)** - 12 sunucu, tam HA yapı
* **[Topoloji 4: Bölgeler Arası Dağıtım](/tr/apinizer-anlama/deployment/topoloji-4-bolgeler-arasi-dagitim)** - 24+ sunucu (3 bölge), global dağılım
...
<CardGroup cols={2}>
  <Card title="Deployment Modelleri" icon="sitemap" href="/tr/apinizer-anlama/deployment/deployment-modelleri">
    Dört farklı kurulum topolojisini karşılaştırın ve size uygun olanı seçin
  </Card>
  ...
  <Card title="Topoloji 4: Bölgeler Arası Dağıtım" icon="globe" href="/tr/apinizer-anlama/deployment/topoloji-4-bolgeler-arasi-dagitim">
    Multi-region kurulum gereksinimlerini inceleyin
  </Card>

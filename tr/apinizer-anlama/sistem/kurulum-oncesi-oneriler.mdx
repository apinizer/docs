...
- Kurulum Apinizer ekibi tarafından yapılacaksa ilgili sunucular [Ağ Topolojisi ve Port Gereksinimleri](/tr/apinizer-anlama/deployment/ag-topolojisi) sayfasındaki erişimlere sahip olmalıdır
...
<CardGroup cols={2}>
  ...
  <Card title="Ağ Topolojisi ve Port Gereksinimleri" icon="network-wired" href="/tr/apinizer-anlama/deployment/ag-topolojisi">
    Port gereksinimlerini inceleyin
  </Card>

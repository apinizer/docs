---
title: "API Manager"
description: 'API Manager (Control Plane), Apinizer platformunun yönetim, konfigürasyon ve izleme işlevlerini sağlayan ana bileşendir'
---

API Manager (API Yöneticisi), Apinizer platformunun **Control Plane** (Yönetim Düzlemi) katmanında yer alan ve platformun tüm yönetim, konfigürasyon ve izleme işlevlerini sağlayan ana bileşendir.
...
API Manager aşağıdaki alt bileşenlerden oluşur:
...
<CardGroup cols={2}>
  ...
  <Card title="SDK Desteği" icon="toolbox">
    Çeşitli programlama dilleri için SDK'lar
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Management API" icon="code" href="/tr/admin/management-api">

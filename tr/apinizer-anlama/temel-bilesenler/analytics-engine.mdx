...
description: 'Analytics Engine, API kullanım verilerini toplar, analiz eder ve görselleştirir'
---

Analytics Engine (Analitik Motoru), Apinizer platformunda API kullanım verilerini toplayan, analiz eden ve görselleştiren bileşendir.

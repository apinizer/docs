...
<Tip>
Uygulama logu temizleme görevleri saatlik veya günlük olarak çalıştırılabilir. Belirtilen tarihten önceki kayıtlar otomatik olarak silinir. Detaylı bilgi için [Uygulama Logu Temizleme Görevleri](https://docs.apinizer.com/apinizer-dokumantasyonu/uygulama-logu-temizleme-goerevleri-91685117.html) sayfasına bakabilirsiniz.
</Tip>
...
<Info>
Gönderilmemiş API trafik logları manuel olarak taşınabilir. İşlem sırasında hata alınırsa veri kaybı olmayacak şekilde yarıda kesilir ve daha sonra tekrar başlatılabilir. Detaylı bilgi için [Gönderilmemiş API Trafik Loglarını Taşı](https://docs.apinizer.com/apinizer-dokumantasyonu/goenderilmemis-api-trafik-loglarini-tasi-89686100.html) sayfasına bakabilirsiniz.
</Info>
...
<Tip>
Prometheus ve Grafana entegrasyonu hakkında detaylı bilgi için [Apinizer Metriklerinin Prometheus ve Grafana'ya Entegre Edilmesi](https://docs.apinizer.com/apinizer-dokumantasyonu/apinizer-metriklerinin-prometheus-ve-grafana-ya-entegre-edilmesi-126910789.html) sayfasına bakabilirsiniz.
</Tip>

## Sonraki Adımlar

<CardGroup cols={2}>
  <Card title="API Trafiği" icon="route" href="https://docs.apinizer.com/apinizer-dokumantasyonu/api-trafigi-1180084.html">
    API trafiği loglarını görüntüleme ve analiz
  </Card>
  <Card title="Prometheus ve Grafana" icon="chart-bar" href="https://docs.apinizer.com/apinizer-dokumantasyonu/apinizer-metriklerinin-prometheus-ve-grafana-ya-entegre-edilmesi-126910789.html">
    Prometheus ve Grafana entegrasyonu
  </Card>
  <Card title="Uygulama Logu Temizleme" icon="trash" href="https://docs.apinizer.com/apinizer-dokumantasyonu/uygulama-logu-temizleme-goerevleri-91685117.html">

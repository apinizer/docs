...
<Tip>
Uygulama logu temizleme görevleri saatlik veya günlük olarak çalıştırılabilir. Belirtilen tarihten önceki kayıtlar otomatik olarak silinir. Detaylı bilgi için [Uygulama Logu Temizleme Görevleri](/tr/admin/denetim-uyumluluk/uygulama-logu-temizleme-gorevleri.mdx) sayfasına bakabilirsiniz.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Uygulama Logu Temizleme" icon="trash" href="/tr/admin/denetim-uyumluluk/uygulama-logu-temizleme-gorevleri.mdx">

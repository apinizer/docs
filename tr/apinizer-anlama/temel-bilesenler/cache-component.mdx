...
description: 'Cache Component, API Gateway performansını artırmak için önbellekleme işlevleri sağlar'
---

Cache Component (Önbellek Bileşeni), Apinizer platformunda API Gateway performansını artırmak için önbellekleme işlevleri sağlayan bileşendir.

...
description: 'Identity Manager, kullanıcı kimlik doğrulama, yetkilendirme ve kimlik yönetimi işlevlerini sağlar'
---

Identity Manager (Kimlik Yöneticisi), Apinizer platformunda kullanıcı kimlik doğrulama, yetkilendirme ve kimlik yönetimi işlevlerini sağlayan bileşendir.

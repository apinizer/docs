...
<Tip>
Çalışma Süresi Monitörü hakkında detaylı bilgi için [Çalışma Süresi Monitörü](https://docs.apinizer.com/apinizer-dokumantasyonu/calisma-sueresi-monitoerue-1179987.html) sayfasına bakabilirsiniz.
</Tip>
...
<Tip>
Anomali Dedektörü hakkında detaylı bilgi için [Anomali Dedektörü](https://docs.apinizer.com/apinizer-dokumantasyonu/anomali-dedektoerue-1179985.html) sayfasına bakabilirsiniz.
</Tip>
...
<AccordionGroup>
  ...
  <Accordion title="Alarm Kanalları">
    ...
    * **Konnektörler**: E-posta, API çağrısı, bildirim, SNMP gibi konnektörler ile eylemler
    ...
    <Tip>
    Alarm kanalları, konnektörler kullanılarak yapılandırılır. Detaylı bilgi için [Eylemler ve Konnektörler](https://docs.apinizer.com/apinizer-dokumantasyonu/eylemler-konnektoerler-actions-connectors-26350720.html) sayfasına bakabilirsiniz.
    </Tip>
  </Accordion>
...
<Tip>
Alarm yönetimi hakkında detaylı bilgi için [Alarm (Alert)](https://docs.apinizer.com/apinizer-dokumantasyonu/alarm-alert-39742481.html) sayfasına bakabilirsiniz.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Çalışma Süresi Monitörü" icon="clock" href="https://docs.apinizer.com/apinizer-dokumantasyonu/calisma-sueresi-monitoerue-1179987.html">
    Çalışma Süresi Monitörü kullanımı
  </Card>
  <Card title="Anomali Dedektörü" icon="triangle-exclamation" href="https://docs.apinizer.com/apinizer-dokumantasyonu/anomali-dedektoerue-1179985.html">
    Anomali Dedektörü kullanımı
  </Card>
  <Card title="Alarm Yönetimi" icon="bell" href="https://docs.apinizer.com/apinizer-dokumantasyonu/alarm-alert-39742481.html">
    Alarm yönetimi
  </Card>

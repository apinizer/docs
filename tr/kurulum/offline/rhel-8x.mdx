...
Kurulum sonrası MongoDB konfigürasyonları için [Red Hat İşletim Sisteminde MongoDB Kurulumu](/tr/kurulum/mongodb/rhel-mongodb.mdx) dökümanından devam edebilirsiniz.

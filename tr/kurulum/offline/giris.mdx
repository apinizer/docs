...
<CardGroup cols={2}>
  <Card title="Ubuntu Kurulumu" icon="ubuntu" href="/tr/kurulum/mongodb/ubuntu-mongodb">
    Ubuntu işletim sisteminde MongoDB Replicaset kurulumu
  </Card>
  <Card title="Red Hat Kurulumu" icon="redhat" href="/tr/kurulum/mongodb/rhel-mongodb">

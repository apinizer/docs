...
Kurulum sonrası MongoDB konfigürasyonları [Ubuntu İşletim Sisteminde MongoDB Kurulumu](/tr/kurulum/mongodb/ubuntu-mongodb.mdx) dökümandaki kısımlar ile aynıdır.
...
Kurulum dosyasını bulunduğu dizinden /opt/elasticsearch/ klasörüne taşıdıktan sonra [Ubuntu İşletim Sisteminde Elasticsearch Kurulumu](/tr/kurulum/elasticsearch/ubuntu-elasticsearch.mdx) sayfasında ki adımları uygulayın.

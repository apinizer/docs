...
[/tr/kurulum](/tr/kurulum) dizini altında Apinizer kurulumu ile ilgili tüm dokümantasyon bulunmaktadır. Aşağıda her bölümün ne işe yaradığı açıklanmıştır.

### Kurulum Grubu

Apinizer platformunun temel kurulum işlemleri:

* **Genel Bakış**: Kuruluma başlamadan önce bilmeniz gereken tüm bilgiler için [bakınız](/tr/kurulum/genel-bakis)
* **Apinizer**: Temel Apinizer kurulumu için [bakınız](/tr/kurulum/apinizer/apinizer)
* **Multi-Region**: Çoklu bölge kurulumu için [bakınız](/tr/kurulum/apinizer/multi-region)
* **API Portal**: API Portal kurulumu için [bakınız](/tr/kurulum/apinizer/api-portal)
* **API Integration**: API entegrasyonu kurulumu için [bakınız](/tr/kurulum/apinizer/api-integration)

### Altyapı Bileşenleri Grubu

Apinizer'ın çalışması için gerekli altyapı bileşenlerinin kurulumu:

#### Kubernetes

Kubernetes cluster kurulumu ve yapılandırması:

* **Kubernetes**: Kubernetes kurulumu için [bakınız](/tr/kurulum/kubernetes/kubernetes)
* **Ubuntu Kubernetes**: Ubuntu üzerinde Kubernetes kurulumu için [bakınız](/tr/kurulum/kubernetes/ubuntu-kubernetes)
* **RHEL Kubernetes**: Red Hat Enterprise Linux üzerinde Kubernetes kurulumu için [bakınız](/tr/kurulum/kubernetes/rhel-kubernetes)
* **Kubernetes Metric Server**: Kubernetes Metric Server kurulumu için [bakınız](/tr/kurulum/kubernetes/kubernetes-metric-server)
* **Kubernetes High Availability Cluster**: Yüksek erişilebilirlik için Kubernetes cluster kurulumu için [bakınız](/tr/kurulum/kubernetes/kubernetes-high-availability-yuksek-erisim-cluster)
* **Kubernetes Dashboard**: Kubernetes Dashboard kurulumu ve kullanımı için [bakınız](/tr/kurulum/kubernetes/kubernetes-dashboard)
* **Prometheus ve Grafana**: Monitoring için Prometheus ve Grafana entegrasyonu için [bakınız](/tr/kurulum/kubernetes/prometheus-grafana)

#### Elasticsearch

Elasticsearch kurulumu ve yapılandırması:

* **Ubuntu Elasticsearch**: Ubuntu üzerinde Elasticsearch kurulumu için [bakınız](/tr/kurulum/elasticsearch/ubuntu-elasticsearch)
* **RHEL Elasticsearch**: Red Hat Enterprise Linux üzerinde Elasticsearch kurulumu için [bakınız](/tr/kurulum/elasticsearch/rhel-elasticsearch)
* **Basit Kimlik Doğrulama**: Elasticsearch güvenlik yapılandırması için [bakınız](/tr/kurulum/elasticsearch/basit-kimlik-dogrulama)
* **Yetki Gereksinimleri**: Elasticsearch yetkilendirme ayarları için [bakınız](/tr/kurulum/elasticsearch/yetki-gereksinimleri)
* **Yedekleme Politikası**: Elasticsearch yedekleme stratejileri için [bakınız](/tr/kurulum/elasticsearch/yedekleme-politikasi)
* **Manuel ILM Politikası ve Template Oluşturma**: Index Lifecycle Management yapılandırması için [bakınız](/tr/kurulum/elasticsearch/manuel-ilm-politikasi-ve-template-olusturma)

#### MongoDB

MongoDB veritabanı kurulumu ve yapılandırması:

* **Ubuntu MongoDB**: Ubuntu işletim sistemi için MongoDB kurulumu için [bakınız](/tr/kurulum/mongodb/ubuntu-mongodb)
* **RHEL MongoDB**: Red Hat Enterprise Linux için MongoDB kurulumu için [bakınız](/tr/kurulum/mongodb/rhel-mongodb)

#### Bulut

Bulut ortamlarında kurulum:

* **Amazon EKS**: Amazon Elastic Kubernetes Service üzerinde kurulum için [bakınız](/tr/kurulum/bulut/amazon-eks-elastic-kubernetes-service)
* **Microsoft AKS**: Azure Kubernetes Service üzerinde kurulum için [bakınız](/tr/kurulum/bulut/microsoft-aks-azure-kubernetes-service)
* **OpenShift Origin 3.11**: OpenShift üzerinde kurulum için [bakınız](/tr/kurulum/bulut/openshift-origin-311)

#### Helm

Helm chart'ları ile kurulum:

* **Apinizer Helm**: Apinizer için Helm chart kurulumu için [bakınız](/tr/kurulum/helm/apinizer)
* **Elasticsearch Helm**: Elasticsearch için Helm chart kurulumu için [bakınız](/tr/kurulum/helm/elasticsearch)
* **MongoDB Helm**: MongoDB için Helm chart kurulumu için [bakınız](/tr/kurulum/helm/mongo)

#### Çevrimdışı

Internet erişimi olmayan ortamlar için offline kurulum:

* **Giriş**: Offline kurulum genel bakış için [bakınız](/tr/kurulum/offline/giris)
* **Ubuntu**: Ubuntu için offline kurulum için [bakınız](/tr/kurulum/offline/ubuntu)
* **RHEL 8.x**: Red Hat Enterprise Linux 8.x için offline kurulum için [bakınız](/tr/kurulum/offline/rhel-8x)
* **RHEL 9.x**: Red Hat Enterprise Linux 9.x için offline kurulum için [bakınız](/tr/kurulum/offline/rhel-9x)

...
<Frame caption="Apinizer - Elasticsearch Connector ekleme ekranı">
  <img
    src="/images/kurulum/elasticsearch/ubuntu-8.17.10/01-elasticsearch-connector.png"
...
Detaylı bilgi için [bu linkteki dokümantasyonu](/tr/kurulum/elasticsearch/ubuntu-elasticsearch) inceleyebilirsiniz.

...
<CardGroup cols={2}>
  ...
  <Card title="Elasticsearch Kurulumu" icon="magnifying-glass-chart" href="/tr/kurulum-surum-yukseltme/elasticsearch-kurulumu/giris">
    Elasticsearch kurulumunu öğrenin
  </Card>
  <Card title="Bulut Ortamlarına Kurulum" icon="cloud" href="/tr/kurulum-surum-yukseltme/bulut-ortami-kurulum/giris">
    Bulut ortamlarına kurulum yapın
  </Card>
  <Card title="Çevrimdışı Kurulum" icon="download" href="/tr/kurulum-surum-yukseltme/offline-kurulum/giris">

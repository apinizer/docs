...
<Frame caption="Kubernetes Namespace ve Kaynak Yönetimi ayarı - General Settings sayfası">
  <img
    src="/images/kurulum/apinizer/multi-region/01-kubernetes-namespace-ayari.png"
    alt="Kubernetes Namespace ve Kaynak Yönetimi Ayarı"
    width="1200"
    height="800"
...
<Steps>
  <Step title="Gateway Environments sayfasına gidin">
    **Administration > Server Management > Gateway Environments** sayfasını açın.
    ...
    <Frame caption="Gateway Environments sayfası - Multi-region ortam yapılandırması">
      <img
        src="/images/kurulum/apinizer/multi-region/02-gateway-environments.png"
        alt="Gateway Environments Sayfası"
        width="1200"
        height="800"
        style={{ borderRadius: '0.5rem' }}
      />
  ...
  <Step title="Gateway ve Cache Management API Access URLs tanımlayın">
    **Gateway and Cache Management API Access URLs** bölümünde yeni eklenen cluster'a ait **Gateway** ve **Cache** bileşenlerinin yönetim API erişim bilgilerini tanımlayın.
    ...
    <Frame caption="Gateway and Cache Management API Access URLs - Cluster erişim bilgileri">
      <img
        src="/images/kurulum/apinizer/multi-region/03-gateway-cache-api-access.png"
  ...
  <Step title="Erişimi test edin ve kaydedin">
    ...
    <Frame caption="Try it butonu ile erişim testi - Bağlantı doğrulama">
      <img
        src="/images/kurulum/apinizer/multi-region/04-try-it-test.png"
        alt="Try it Butonu ile Erişim Testi"
        width="1200"
        height="700"
        style={{ borderRadius: '0.5rem' }}
      />

  ...
  <Accordion title="Apinizer'ın ihtiyaç duyduğu Kubernetes Cluster ve MongoDB gibi uygulamalar kurulacak mı hazırda var ve onlar kullanılacak mı?">
    <CardGroup cols={1}>
      <Card title="Önerilerimiz">
        ...
        * Kurulum Apinizer ekibi tarafından yapılacaksa ilgili sunucular [Kurulum için Erişim ve Port Gereksinimleri](/tr/kurulum/kurulum-icin-erisim-ve-port-gereksinimleri) sayfasındaki erişimlere sahip olmalıdır
      </Card>
    </CardGroup>
  </Accordion>
...
<CardGroup cols={2}>
  <Card title="Kurulum Topolojileri" icon="sitemap" href="/tr/kurulum/kurulum-topolojileri">

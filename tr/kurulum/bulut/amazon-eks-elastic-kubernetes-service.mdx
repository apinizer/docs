...
<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/55-iam-roles-page.png" alt="IAM Roles Sayfası" width="1000" height="225" />
</Frame>
...
<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/54-iam-roles.png" alt="IAM Roles" width="200" height="186" />
</Frame>

<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/53-iam-create-role.png" alt="Create Role" width="1000" height="1049" />
</Frame>

<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/52-iam-eks-service.png" alt="EKS Service" width="1000" height="524" />
</Frame>

<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/51-iam-permissions.png" alt="Permissions" width="1000" height="1113" />
</Frame>

Gelen sayfada herhangi bir key-value bilgisi girmeden devam edilir.

<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/50-iam-review.png" alt="Review" width="1000" height="1097" />
</Frame>
...
<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/48-iam-worker-role.png" alt="Worker Node Role" width="1000" height="41" />
</Frame>

<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/47-iam-worker-policies.png" alt="Worker Policies" width="1000" height="532" />
</Frame>

Bu Role için aşağıdaki Policy'ler seçilmelidir.

<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/46-iam-worker-policies-alt.png" alt="Worker Policies Alt" width="1000" height="41" />
</Frame>
...
<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/45-eks-search.png" alt="EKS Search" width="1000" height="215" />
</Frame>

<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/44-eks-create.png" alt="EKS Create" width="1000" height="284" />
</Frame>
...
<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/43-eks-cluster-config.png" alt="Cluster Config" width="1000" height="1093" />
</Frame>
  </Step>
...
<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/22-eks-subnet.png" alt="Subnet" width="1000" height="788" />
</Frame>

<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/42-eks-network.png" alt="Network" width="1000" height="361" />
</Frame>

<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/41-eks-security-group.png" alt="Security Group" width="1000" height="870" />
</Frame>
  </Step>
...
<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/40-eks-logging.png" alt="Logging" width="1000" height="757" />
</Frame>
  </Step>
...
<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/39-eks-creating.png" alt="Creating" width="1000" height="351" />
</Frame>
...
<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/37-iam-user.png" alt="IAM User" width="1000" height="208" />
</Frame>

Gelen ekrandan **Manage access keys** butonuna tıklayarak **Access** bilgilerine gidilir.

<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/36-iam-manage-access-keys.png" alt="Manage Access Keys" width="1000" height="447" />
</Frame>

<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/35-access-key-dialog.png" alt="Access Key Dialog" width="1000" height="392" />
</Frame>
...
<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/34-access-key-secret.png" alt="Access Key Secret" width="1000" height="375" />
</Frame>
  </Step>
...
<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/33-aws-cli-access-key.png" alt="AWS CLI Access Key" width="1000" height="257" />
</Frame>
  </Step>
</Steps>
...
<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/32-aws-region.png" alt="AWS Region" width="200" height="422" />
</Frame>
...
<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/28-node-group-config.png" alt="Node Group Config" width="1000" height="1112" />
</Frame>

<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/27-node-group-config-alt.png" alt="Node Group Config Alt" width="154" height="44" />
</Frame>
  </Step>
...
<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/26-node-group-scaling.png" alt="Node Group Scaling" width="1000" height="1013" />
</Frame>

<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/25-node-group-scaling-alt.png" alt="Node Group Scaling Alt" width="1000" height="587" />
</Frame>
  </Step>
...
<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/21-node-group-network.png" alt="Node Group Network" width="1000" height="551" />
</Frame>
  </Step>
  <Step title="İncele ve Oluştur">
...
<Frame>
  <img src="/images/kurulum/bulut/amazon-eks/20-node-group-review.png" alt="Node Group Review" width="1000" height="70" />
</Frame>
...
<Note>
API Proxy ile ilgili detaylı bilgi için [Geliştirici Kılavuzuna (Developer Guide)](/tr/gelistirici/api-listesi-yonetimi.mdx) bakınız.

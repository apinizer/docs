---
title: "Ubuntu"
description: "Ubuntu işletim sisteminde Kubernetes 1.31 sürümünü kurabilir. Containerd container runtime'ını yapılandırabilir, Flannel network plugin'i ile cluster ağ yapısını oluşturabilir ve multi-master yapılandırması yapabilir."
---
...
>>>>>>> 5ee96ec (kubelet 1.34 dokumani guncelledim)

...
<Frame caption="ArgoCD - Git Repository ekleme ekranı">
  <img
    src="/images/operasyon/kubernetes/argocd/04-git-repo.png"
...
<Frame caption="ArgoCD - Git Repository bağlantı detayları">
  <img
    src="/images/operasyon/kubernetes/argocd/05-git-repo-detail.png"
...
<Frame caption="ArgoCD - Pod log görüntüleme">
  <img
    src="/images/operasyon/kubernetes/argocd/09-pod-logs.png"
    alt="Pod Logları"
    width="1200"
    height="600"
    style={{ borderRadius: '0.5rem' }}

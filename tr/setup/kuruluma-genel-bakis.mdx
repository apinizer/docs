...
<Tabs>
  <TabItem value="yontem-secimi" label="Yöntem Seçimi">
...
:::
  ...
  <TabItem value="kurulum-oncesi-kararlar" label="Kurulum Öncesi Kararlar">
    ...
    <CardGroup cols={1}>
      <Card title="Önerilerimiz">
        ...
        * Kurulum Apinizer ekibi tarafından yapılacaksa ilgili sunucular [Kurulum için Erişim ve Port Gereksinimleri](#erisim-ve-port) bölümündeki erişimlere sahip olmalıdır
      </Card>
    </CardGroup>
...
:::
  ...
  <TabItem value="erisim-ve-port" label="Erişim ve Port">
...
:::
  ...
  <TabItem value="kurulum-topolojileri" label="Kurulum Topolojileri">
    :::warning

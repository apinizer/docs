...
<Note>
Ortam tanımlama ve yayın işlemleri ile ilgili detaylı bilgi almak için [Environment sayfasına](/tr/admin/server-management/ortamlar) bakınız.
</Note>
...
<Note>
API Proxy ile ilgili detaylı bilgi için [Geliştirici Kılavuzuna (Developer Guide)](/tr/develop/api-listesi-yonetimi.mdx) bakınız.

---
title: "Dashboard"
description: "Kubernetes Dashboard'ı deploy ederek cluster kaynaklarını görselleştirebilir ve yönetebilir. RBAC yapılandırması ile güvenli erişim sağlayabilir ve NodePort üzerinden dışarıdan erişilebilir hale getirebilir."
---

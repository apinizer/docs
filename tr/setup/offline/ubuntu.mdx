...
Kurulum dosyasını bulunduğu dizinden /opt/elasticsearch/ klasörüne taşıdıktan sonra [Ubuntu İşletim Sisteminde Elasticsearch Kurulumu](/tr/setup/elasticsearch/ubuntu-elasticsearch.mdx) sayfasında ki adımları uygulayın.

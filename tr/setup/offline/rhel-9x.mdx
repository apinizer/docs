...
Kurulum dosyasını bulunduğu dizinden /opt/elasticsearch/ klasörüne taşıdıktan sonra [Red Hat İşletim Sisteminde Elasticsearch Kurulumu](/tr/setup/elasticsearch/rhel-elasticsearch.mdx) sayfasından konfigürasyonları gerçekleştirebilirsiniz.

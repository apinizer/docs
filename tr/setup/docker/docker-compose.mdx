...
- [API Manager](/tr/setup/docker/apimanager) — sizing, ağ, TLS, güncelleme
- [Worker](/tr/setup/docker/apiworker) — load test sizing, çoklu replika
- [Cache](/tr/setup/docker/apicache) — çoklu node cluster
- [Integration](/tr/setup/docker/apiintegration) — clustered Quartz ile HA
- [API Portal](/tr/setup/docker/apiportal) — TLS sonlandırma, yatay ölçeklendirme

Güncelleme akışı için: [Docker Üzerinde Güncelleme](/tr/upgrade/docker-uzerinde-guncelleme).

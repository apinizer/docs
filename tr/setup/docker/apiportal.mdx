...
3. Bu API key'in sahibi olan Manager kullanıcısının portal adına işlem yapmasına izin verin: kullanıcı adını **Portal Ayarları → Güvenlik → Management API Anahtarı Kullanıcıları** listesine ekleyin ya da liste boşsa kullanıcıya bir portal rolü (Portal Manager / Business / Developer) verin. Aksi halde Portal'ın tüm çağrıları 403 ile reddedilir. Bkz. [Portal Ayarları → Güvenlik](/tr/api-portal/api-portal-ayarlari#güvenlik).

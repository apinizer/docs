...
<CardGroup cols={2}>
  <Card title="Cache" href="#cache-kurulumu-ve-tanmlanmas">
  ...
  <Card title="Integration" href="#integration-kurulumu-ve-tanmlanmas">
  ...
  <Card title="SSL ile API Manager" href="#api-manager-i-ssl-ile-balatmak">

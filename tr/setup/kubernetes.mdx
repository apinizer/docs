...
:::
  ...
  <TabItem value="helm" label="Helm">
    ...
    <Tabs>
      <TabItem value="api-manager-ve-worker" label="API Manager ve Worker">
        :::info
...
Helm kurulu değilse, [Helm Kurulum Dokümanı](/tr/setup/kubernetes) sayfasını inceleyebilirsiniz.

...
:::
          ...
          <TabItem value="remote-cache-server-manuel-deploy" label="Remote Cache Server (Manuel Deploy)">
            ...
            - Cache uygulaması Gateway ile aynı namespace içerisinde, aynı `gateway-serviceaccount` üzerinden çalışır. Yetki ve namespace adımlarının "Gateway Kurulumu ve Tanımlanması" sekmesindeki Remote Gateway alt-sekmesindeki **Gateway için Role ve RoleBinding'leri Oluşturma** bölümünden uygulanmış olduğu varsayılır.

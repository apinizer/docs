...
<Info>
  Bu veri yapısında oluşan veri örneğini [API Trafiği Log Kaydı Veri Yapısı](/tr/analytic/api-trafigi-log-kaydi-veri-yapisi.mdx) sayfasında inceleyebilirsiniz.
</Info>

...
<CardGroup cols={2}>
  <Card title="Kubernetes Kurulumu" icon="layer-group" href="/tr/setup/kubernetes">
  ...
  <Card title="Elasticsearch Kurulumu" icon="magnifying-glass-chart" href="/tr/setup/kuruluma-genel-bakis">
    Elasticsearch kurulumunu öğrenin
  </Card>
  <Card title="Bulut Ortamlarına Kurulum" icon="cloud" href="/tr/setup/kuruluma-genel-bakis">
    Bulut ortamlarına kurulum yapın
  </Card>
  <Card title="Çevrimdışı Kurulum" icon="download" href="/tr/setup/kuruluma-genel-bakis">
...
[SSL/TLS ile Apinizer Modüllerini Başlatma](/tr/operations/yonetici-kilavuzlari/ssl-tls-apinizer-modulleri-baslatma) adresindeki kılavuzdan gerçekleştirebilirsiniz.
...
Gateway Runtime oluştururken **Uzak Gateway (Remote Gateway)** seçeneğini seçerek mevcut Kubernetes tanımlarını Apinizer platformuna tanımlayabilirsiniz. Detaylı bilgi için [Gateway Runtime'ları](/tr/admin/server-management/gateway-runtime-lari) sayfasına bakabilirsiniz.

---
title: "API Developer Multi Portal Kurulumu"
...
<Frame caption="Token oluşturma - Profilim sayfasından kişisel API token oluşturma">
  <img
    src="/images/setup/apinizer/api-portal-new/01-token-olusturma.png"
...
<Frame caption="Kubernetes Resources sayfası - API Portal etkinleştirme">
  <img
    src="/images/setup/apinizer/api-portal-new/02-kubernetes-resources.png"
...
<Frame caption="Portal ID'nin bulunduğu ayarlar ekranı">
  <img
    src="/images/setup/apinizer/api-portal-new/portal-id-location.png"

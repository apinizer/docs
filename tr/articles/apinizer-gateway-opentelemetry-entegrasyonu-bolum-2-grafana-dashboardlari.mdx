...
:::tip javaagent çalıştırmamayı mı tercih ediyorsunuz?
Bu serinin tamamı agent-tabanlı yolu izler. Bunun yerine doğrudan üründen dışa aktarmayı — kurulacak bir agent olmadan ve AI token/maliyet telemetrisi yerleşik — tercih ederseniz, tamamlayıcı makaleye bakın: [Apinizer API Gateway'den Native OpenTelemetry Dışa Aktarımı](/tr/articles/apinizer-gateway-native-opentelemetry-disa-aktarim).
:::

...
:::info Tarihsel yazı
Burada karşılaştırılan Rate Limit Kontrol Listesi 2026.09 sürümünde emekliye ayrıldı, ekranı 2026.09.3 sürümünde kaldırıldı. Rolünü artık [Limit Planları](/tr/ai-gateway/limit-planlari) ve atamalar üstlenir; portal Abonelik Planı da doğrudan platform kapsamlı bir Limit Planına referans verir. Karşılaştırma, iki modelin arkasındaki gerekçe için korunmaktadır.
:::
...
Daha ayrıntılı bilgi için [Rate Limit Kontrol Listesi (RLCL) Makalesi](/tr/articles/rate-limit-kontrol-listesi-rlcl) başvurun.
...
- Şüpheli IP blokları (`123.45.` ile başlayan): Saniyede en fazla 5 istek
- Premium müşteriler: Saniyede en fazla 50 istek ama mesai saatleri dışında 30
- Özel partnerler (`API-XYZ-` ile başlayan): Saniyede en fazla 100 istek

...
description: 'Apinizer\'da memory leak ve out of memory hatalarının tespiti ve çözümü'
---

# Memory Leaks ve OOM (Out of Memory) Hataları

Bu sayfa, Apinizer'da karşılaşılabilecek memory leak ve Out of Memory (OOM) hataları ile ilgili sorunların tespiti ve çözümlerini içermektedir.

## Sorunun Belirtileri

Memory leak ve OOM hatalarının belirtileri:
...
- [JVM Tuning](/tr/sorun-giderme/performans-tuning/jvm-tuning)
- [Performans Tuning](/tr/sorun-giderme/performans-tuning)
- [Log Analizi](/tr/sorun-giderme/log-analizi-kilavuzu)

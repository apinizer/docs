...
Bir kontrol için başlangıç ve bitiş saati tanımlayarak **bakım penceresi** belirleyebilirsiniz. Bu aralıkta
kontroller çalışmaya devam eder, ancak bildirimler bastırılır; planlı bakım sırasındaki beklenen
kesintilerin gereksiz uyarı üretmesini önlemek için kullanılır. Tanımlanmamışsa alan boş bırakılır.

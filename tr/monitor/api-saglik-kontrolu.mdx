...
{/* TODO: ekran görüntüsü — yeni API Sağlık Kontrolü formu (Zamanlama: cron + Bakım Penceresi + Servis Seviyesi (SLA) Ayarları bölümleriyle); eski dosya: /images/monitor/api-saglik-kontrolu/01-ayarlar-formu.png; hedef: /images/2026-09-2/uptime-form.png */}
...
{/* TODO: ekran görüntüsü — monitor Detay sayfası (5 özet metrik kartı, uptime zaman çizelgesi şeridi, p50/p95/p99 yanıt süresi grafiği); eski dosya: /images/monitor/api-saglik-kontrolu/02-durum-ozeti-sonuclar.png; hedef: /images/2026-09-2/uptime-detail.png */}

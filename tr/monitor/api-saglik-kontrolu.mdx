...
Sağlık kontrolü listesi sayfasında tüm kontrollerinizi görüntüleyebilir ve yönetebilirsiniz.
    ...
    <Accordion title="Tablo Sütunları">
        ...
        - **Durum**: Pasif kontroller bir rozetle gösterilir; durum işlemler menüsündeki **Etkinleştir/Devre Dışı Bırak** ile değiştirilir
        - **Proje** (Admin modunda): Kontrolün ait olduğu proje (Actions'tan önceki kolon)

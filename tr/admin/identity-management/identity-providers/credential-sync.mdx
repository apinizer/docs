...
{/* TODO: ekran görüntüsü — Database sağlayıcının Kimlik Senkronizasyon Profili sekmesi: Senkronizasyonu Etkinleştir, Cron İfadesi, Deaktivasyon Modu (Devre Dışı Bırak/Sil/Hiçbiri), Senkronizasyon Kapsamı kartı (Kullanıcılar/Gruplar/Roller kabul-ret desenleri) ve Uzlaştırma Emniyet Ağı kartı (deaktivasyon eşikleri); eski dosya: /images/yonetici/credential-sync/credential-sync-profil.png; hedef: /images/2026-09-2/credential-sync-profil.png */}
...
{/* TODO: ekran görüntüsü — Kimlik > Sağlayıcılar > Senkronizasyon ekranı, dört sekmenin tamamıyla (LDAP/Veritabanı/API/OIDC) ve Ad/Zamanlama/Durum/Son Senkronizasyon/Eklenen-Güncellenen/Deaktif Edilen/Atlanan/Hata/Sonuç/İşlemler sütunlarıyla; eski dosya: /images/yonetici/credential-sync/credential-sync-izleme.png; hedef: /images/2026-09-2/credential-sync-izleme.png */}

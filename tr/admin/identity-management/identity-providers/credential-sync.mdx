...
| Eklenen/Güncellenen, Değişmeyen, Deaktif Edilen, Atlanan, Hata | Son koşuda işlenen kayıt sayılarıdır — **Değişmeyen** için bkz. [Değişmeyeni Atlama](#değişmeyeni-atlama). |
...
İptal isteği anında uygulanmaz: motor bayrağı bir sonraki sayfa sınırında görür ve kaynaktan veri çekmeyi orada keser. O ana kadar yazılmış sayfalar **kalır** — geri alınmaz — ve devre dışı bırakma/silme (uzlaştırma) adımı **atlanır**, çünkü kısmi bir listenin kimseyi devre dışı bırakmaması gerekir.

...
Ortak alanlar (etkinleştirme, cron, deaktivasyon modu), API’ye özgü alanlar (kullanıcı listeleme URL’si, JSON Path ifadeleri vb.) ve senkronizasyon durumu/geçmişi için [Kimlik Bilgisi Senkronizasyonu](/tr/admin/identity-management/identity-providers/credential-sync) sayfasını inceleyebilirsiniz.
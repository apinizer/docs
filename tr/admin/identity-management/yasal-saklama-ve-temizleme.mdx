...
**Özneyi seçme.** Hem önizleme hem de yasal saklama diyalogunda özne listesi sunucu tarafında aranıyor: liste, geçerli projenin ilk 50 öznesiyle açılıyor ve siz yazdıkça yeniden sorgulanıyor; böylece binlerce tüketicisi olan bir proje de küçük bir proje kadar hızlı açılıyor. Bir sayfaya sığandan daha çok özne eşleşiyorsa listenin altında bunu belirten bir not çıkıyor — aramayı daraltmak için yazmaya devam edin. Listeden seçim yapmak yalnızca altındaki **Subject ID** (Özne ID) alanını dolduruyor; bu alan her zaman elle de doldurulabiliyor: kaydın ID'si elinizdeyse ya da katalog size kapalıysa doğrudan yapıştırın. API istemcileri her zaman ID ile giriliyor, çünkü sunulabilecek proje geneli bir istemci listesi yok.
...
| Var olduğunu bildiğiniz bir tüketici özne listesinde görünmüyor | Yalnızca ilk 50 eşleşme listeleniyor — adın bir kısmını yazarak aramayı daraltın ya da öznenin ID'sini listenin altındaki alana yapıştırın |

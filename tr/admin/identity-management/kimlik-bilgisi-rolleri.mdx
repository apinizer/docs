...
{/* TODO: ekran görüntüsü — Rol Listesi ekranı (Project sütunu ve Global etiketi dahil, güncel breadcrumb ile); eski dosya: /images/yonetici/role-liste.png; hedef: /images/2026-09-2/credential-role-list.png */}
...
**Rol kapsamı.** Bir rol ya proje kapsamlıdır ya da globaldir:

- Proje içinde oluşturulan rol o projeye aittir ve yalnızca orada görünür.
- Yönetim menüsünden oluşturulan rol **global**dir ve her projede kullanılabilir.

Projenin **Tüketici Rolleri** listesi ile tüketici düzenleme ekranındaki **Rol** seçicisi aynı kümeyi gösterir: projenin kendi rolleri + global roller. Global roller listede **Global** etiketiyle, seçicide **(Global)** ekiyle ayırt edilir. Global rolü düzenlemek/silmek yönetim seviyesinde kimlik yetkisi gerektirir; proje kullanıcısı salt okunur görür.
...
**Yetkilendirme ayarlarını içeren görsele aşağıda yer verilmiştir:**
...
Rol tanımlamaları hakkında detaylı bilgi almak için [Tüketici Rolleri](/tr/admin/identity-management/kimlik-bilgisi-rolleri)
 ve [Kimlik Sağlayıcılar (Identity Providers)](/tr/admin/identity-management/identity-providers/api-authentication-provider)

...
| Trafiği loglama *(Do not log traffic)* | Bu uygulamaya bağlı tüm tüketicilerin API trafiğinin trafik log konnektörlerine yazılmasını durdurur. Varsayılanı kapalıdır. Bkz. [Bir Uygulamanın Trafik Logunu Kapatma](#bir-uygulamanin-trafik-logunu-kapatma). |

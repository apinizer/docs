...
Bu sürümde API istemcisi bir **kayıttır**, henüz gateway'den geçiş yolu değildir. Bir istemci oluşturmak ve ona client secret üretmek, herhangi bir şeyin bir API Proxy'ye kimlik doğrulaması yapmasını **sağlamaz**; gateway hâlâ mevcut kimlik bilgisi mekanizması üzerinden doğrulama yapar.

...
Kurumlar da aynı metadata yapısını destekler. Kurum metadata'sı, o kuruma bağlı tüm kimlik bilgileri için **varsayılan** olarak uygulanır. Token üretiminde önce kurum metadata'sı uygulanır; aynı anahtar kimlik bilgisi üzerinde de tanımlıysa kimlik bilgisinin değeri öncelik kazanır (kimlik bilgisi seviyesi, kurum seviyesini geçersiz kılar).

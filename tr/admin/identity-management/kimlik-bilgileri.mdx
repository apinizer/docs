...
Bu sürümde API istemcisi bir **kayıttır**, henüz gateway'den geçiş yolu değildir. Bir API istemcisi oluşturmak ve ona client secret üretmek, herhangi bir istemcinin bir API Proxy'ye kimlik doğrulaması yapmasını **sağlamaz**: gateway hâlâ mevcut kimlik bilgisi mekanizması üzerinden doğrulama yapar. Burada yazılan kayıtlar, gateway'i bu yola geçirecek sürüm için hazırlanır.

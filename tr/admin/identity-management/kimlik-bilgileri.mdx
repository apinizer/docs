...
{/* TODO: ekran görüntüsü — Tüketici Listesi ekranı (Consumer/E-mail/Organization/Account/App/Portal/Roles/Status/Actions sütunları, Kaynak etiketi dahil); eski dosya: /images/yonetici/kimlik-bilgisi.png; hedef: /images/2026-09-2/consumer-list.png */}
...
{/* TODO: ekran görüntüsü — CSV ile İçe Aktar diyaloğu (güncel Tüketici Listesi arka planıyla); eski dosya: /images/yonetici/ice-aktar.png; hedef: /images/2026-09-2/csv-import.png */}

## Tüketiciyi Dışa Aktarma

Tüketiciyi dışa aktarmak için satır sonundaki menüden **Dışa Aktar _(Export)_** seçilir.

{/* TODO: ekran görüntüsü — satır işlem menüsünden Dışa Aktar seçimi (güncel Tüketici Listesi arka planıyla); eski dosya: /images/yonetici/disa-aktar.png; hedef: /images/2026-09-2/export-menu.png */}
...
{/* TODO: ekran görüntüsü — satır işlem menüsünden Globalleştir seçimi (güncel Tüketici Listesi arka planıyla); eski dosya: /images/yonetici/global.png; hedef: /images/2026-09-2/globalize-menu.png */}
## Tüketici Oluşturma

**Tüketiciler eklemek için** **Oluştur (Create) tuşuna basıldığında aşağıda görseli paylaşılan ekran gelir:**

{/* TODO: ekran görüntüsü — Tüketici Oluşturma ekranı, Information sekmesi (API Clients/Access Control/Synchronization/Metadata/Token Settings/Secrets sekme çubuğu dahil); eski dosya: /images/yonetici/credentials-new.png; hedef: /images/2026-09-2/consumer-create.png */}
...
{/* TODO: ekran görüntüsü — Access Control sekmesi (API Clients sekmesi dahil güncel sekme çubuğuyla, + Add API Proxy tuşu görünür); eski dosya: /images/yonetici/kimlik-ayarlari.png; hedef: /images/2026-09-2/access-control-tab.png */}

Açılan ekrandan ayarlamak istenilen API Proxy(ler) seçilir ve **Ekle (Add)** tuşuna basılır.

{/* TODO: ekran görüntüsü — Add API Proxy diyaloğu (güncel sekme çubuğu arka planıyla); eski dosya: /images/yonetici/add-kimlik.png; hedef: /images/2026-09-2/add-api-proxy-dialog.png */}
...
{/* TODO: ekran görüntüsü — sağ üst köşede Kaydet ve Yükle (Save and Deploy) tuşu, güncel breadcrumb/sekme çubuğuyla; eski dosya: /images/yonetici/save-and-deploy.png; hedef: /images/2026-09-2/save-and-deploy.png */}
...
{/* TODO: ekran görüntüsü — Access Control sekmesinde bir API Proxy seçiliyken sağdaki API Proxy Bazlı Özel Ayarlar paneli (AI Model Erişimi bölümü dahil); eski dosya: /images/yonetici/ozel-ayarlar.png; hedef: /images/2026-09-2/api-proxy-custom-settings.png */}
...
{/* TODO: ekran görüntüsü — Metadata sekmesi (API Clients sekmesi dahil güncel sekme çubuğuyla); eski dosya: /images/admin/identity-management/credential-metadata.png; hedef: /images/2026-09-2/metadata-tab.png */}
...
{/* TODO: ekran görüntüsü — Token Settings sekmesi (güncel sekme çubuğu ve Security alt-başlığıyla); eski dosya: /images/yonetici/token-ayarlari.png; hedef: /images/2026-09-2/token-settings-tab.png */}
...
{/* TODO: ekran görüntüsü — Secrets sekmesi, JOSE JWK kartları (Sign & Validation / Encryption & Decryption); eski dosya: /images/yonetici/credential-secrets.png; hedef: /images/2026-09-2/secrets-jwk.png */}
...
{/* TODO: ekran görüntüsü — Secrets sekmesi, Truststore (mTLS) kartı; eski dosya: /images/yonetici/credential-secrets.png; hedef: /images/2026-09-2/secrets-mtls.png */}

...
Secret materyali de bu taşımanın parçası değildir — taşınmış bir istemci, elle oluşturulmuş biri gibi, hiç secret'ı olmadan Taslak (Draft) olarak oluşturulur. Ayrı ve tek seferlik bir adım olan [Secret Taşıma](/tr/admin/identity-management/api-client-tasima#secret-tasima), eski kaydı ya da halihazırda verilmiş hiçbir şeyi bozmadan, istemciye eski kaydın zaten kullandığı secret'ın aynısını ayrıca kazandırabilir.

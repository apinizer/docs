...
<Frame caption="Tüketici oluşturma — Information sekmesi">
  <img
    src="/images/2026-09-2/consumer-create.png"
    alt="Tüketici oluşturma formu Information sekmesi: kimlik, kurum ve erişim alanları"
  width="1000"
    height="708"
/>
</Frame>
...
<Frame caption="API Proxy bazlı özelleştirme paneli">
  <img
    ...
    alt="Access Control sekmesinde calculator seçiliyken sağdaki yapılandırma paneli: kota, daraltma ve AI Model Access"
    width="1000"
    height="833"
  />
</Frame>

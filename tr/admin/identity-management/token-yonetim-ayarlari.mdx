...
**Kimlik → Token Ayarları** yolunu izleyerek bu ekrana erişebilirsiniz. Buradaki ayarlar yalnızca token uç noktasının ürettiği yanıt gövdesini etkiler; varsayılan değerler mevcut çalışma şeklini bozmaz.

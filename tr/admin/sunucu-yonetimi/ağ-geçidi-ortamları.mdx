...
description: "Apinizer'da Kubernetes ortamları oluşturma, Gateway Engine ve Cache sunucu yapılandırması, ortam yayımlama ve metrik izleme hakkında bilgi edinin."
---
...
Ortama konnektör ekleme hakkında daha fazla bilgi için [bu sayfaya](/tr/admin/sunucu-yonetimi/ağ-geçidi-ortamlarına-konnektör-eklenmesi) bakın.
...
<Info>
Eğer tüm ortamların metriklerine erişmek isterseniz [tüm ortam metrikleri sayfasına](/tr/admin/sunucu-yonetimi/kubernetes-resources) tıklayınız.
</Info>

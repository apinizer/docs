---
title: "Ortamlar"
description: "API Proxy çalışma zamanı yürütme bağlamı ve ortam yönetimi"
---


## Ortam (Environment) Nedir?

Ortam , bir kuruluttaki API Proxy'leri (API Proxy) için bir çalışma zamanı yürütme bağlamıdır (Runtime Execution Context).

...
description: "Apinizer API Manager'ı Kubernetes'te SSL/HTTPS ile yapılandırabilir, sertifika yükleyebilir, PKCS12 formatı dönüştürebilir ve deployment ayarlarını yapılandırabilir. Sertifika oluşturabilir ve Kubernetes secret olarak yönetebilir."
---

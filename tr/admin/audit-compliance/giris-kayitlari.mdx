...
| `CAPTCHA_REQUIRED` | Hiçbir kaynakta (ne veritabanında ne de yapılandırılmış LDAP dizininde) bulunmayan bir kullanıcı adıyla yapılan, o adres eşiğinin altındaki giriş denemesi. Ad kayda yazılmaz. |

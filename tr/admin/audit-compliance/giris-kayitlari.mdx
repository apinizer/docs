...
Login kayıtlarının MongoDB dışına konnektörlerle (Elasticsearch, Kafka, Webhook vb.) iletilmesi için bkz. [SIEM ve Log Yönlendirme](/tr/admin/system-settings/siem-log-yonlendirme) — `SESSION` hattı — ve olay tipleri ile yük biçimi için [SESSION hattı — olay tipleri ve legacy yük](/tr/admin/system-settings/siem-log-yonlendirme#session-hatti-olay-tipleri-ve-legacy-yuk).
...
<Frame caption="Giriş Kayıtları liste ekranı">
  <img
    src="/images/2026-09-2/login-records-main.png"
    alt="Giriş Kayıtları liste ekranı: tarih, kullanıcı, durum, uzak adres ve veri sütunları"
    width="1000"
    height="312"
  />
</Frame>

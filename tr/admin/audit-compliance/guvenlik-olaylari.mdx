...
<Frame caption="Güvenlik Olayları — API Güvenliği sekmesi">
  <img
    src="/images/2026-09-2/security-events-list.png"
    alt="Güvenlik Olayları API Güvenliği sekmesi: filtre çubuğu ve sonuç tablosu"
    width="1000"
    height="504"
  />
</Frame>
...
<Frame caption="Güvenlik Olayları — API Erişimi sekmesi">
  <img
    src="/images/2026-09-2/security-events-api-access.png"
    alt="Güvenlik Olayları API Erişimi sekmesi: yerel saklama kapalıyken boş liste ve bilgi bandı"
    width="1000"
    height="358"
  />
</Frame>

---
title: "API Proxy ACL"
description: "Apinizer'da API Proxy'lere erişim sağlayacak istemcilerin kimlik bilgilerinin erişim izinlerini yönetme ve API Proxy bazında erişim kontrolü ayarları hakkında bilgi edinin."
---

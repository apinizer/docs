...
Analitik ve rapor ekranlarındaki API Proxy ve Proxy Group seçim listeleri, sistem seviyesi rolü olmayan kullanıcılar için yalnızca **API Yönetimi** kategorisinde Görüntüle yetkisine sahip oldukları projelerin kayıtlarını listeler. Hiçbir proje seçilmediğinde de bu kişisel kapsam geçerlidir; Admin menüsündeki "tüm projeler" görünümü bu kullanıcılar için boş liste döner.

...
Apinizer'da kullanıcılara atanabilecek roller ve bu rollerin yetkileri aşağıda detaylı olarak açıklanmıştır:
    ...
    <Accordion title="Promotion Manager">
        Bu yetkiye sahip kullanıcı, Administration menüsündeki Promotion Manager ekranlarına (Instances, Mappings, Executions) ve projelerdeki Promotion ekranına erişip API'lerin ortamlar arası taşıma (promotion) işlemlerini yönetebilir.
    </Accordion>


:::note

Kurulumla birlikte gelen yerleşik **admin** hesabı, Sistem Yöneticisi, System Analyzer ve Portal Yöneticisi yetkilerine ek olarak artık **Promotion Manager**, **Portal İş Kullanıcısı** ve **Portal Geliştirici Kullanıcısı** yetkileriyle gelir. Önceki bir sürümden yükseltilen kurulumlarda bu üç yetki **admin** hesabına otomatik olarak eklenir; bir yöneticinin bu hesapta bilinçli olarak kaldırdığı başka bir yetki (örn. System Analyzer) bu ekleme ile yeniden işaretlenmez. Proje Yöneticisi yetkisi bu ekleme kapsamında değildir.

...
### Metrik Detay Penceresi

Diagnostics tablosundaki metrik butonlarına tıkladığınızda ilgili verinin ayrıntılı içeriği bir pencerede açılır.

- Pencere açıldığında imleç doğrudan içerik alanına gelir. Bu sayede **Ctrl+A** (macOS'te **Cmd+A**) kısayolu yalnızca penceredeki içeriği seçer, arka plandaki sayfayı etkilemez.
- Pencerenin alt kısmındaki **Panoya Kopyala** butonu içeriğin tamamını tek tıkla panoya kopyalar. Kopyalama tamamlandığında ekranda bir bilgi mesajı görüntülenir.
- İçerik salt okunurdur; pencere üzerinde değişiklik yapılamaz.

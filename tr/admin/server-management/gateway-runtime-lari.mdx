...
Bu ayar, bir Gateway, Cache, Integration veya Portal deployment'ı oluşturulduğunda veya yeniden uygulandığında devreye girer — yukarıdaki **Yayınla** (Publish) ve **Yeniden Yayınla** (Republish) işlemleri de buna dahildir. Salt bir pod **Restart**'ı veya Manager ekranlarından yeniden yayınlamadan kaynak/ortam değişkeni düzenlemesi, bu ayardan önce oluşturulmuş bir deployment'a ayarı EKLEMEZ. Yükseltme sonrasında, ayarın etkinleşmesi için mevcut her ortamı **Yeniden Yayınla** (ve Cache/Integration/Portal deployment'larını yeniden uygulayın).
:::

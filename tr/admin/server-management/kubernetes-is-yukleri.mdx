...
### Özel Görüntü Öneki (Custom Image Prefix)

**Özel Görüntü Öneki (Custom Image Prefix)** bölümünün altında sağ tarafta yer alan **Yapılandır (Configure)** butonuna basılarak bu bölüme ait ayarlar yapılabilir.

Özel görüntü öneki ayarlarını içeren görsele aşağıda yer verilmiştir:

<img
  src="/images/yonetici/custom-image.png"
  alt="Özel Görüntü Öneki Yapılandırması"
  width="800"
  height="500"
/>

Özel görüntü öneki ayarları için kullanılan alanlar aşağıdaki tabloda görülmektedir.

| Alan | Açıklama |
|------|----------|
| **Özel Görüntü Öneki Etkin** (Enable Custom Image Prefix) | Kubernetes görüntüleri için özel bir önek kullanılmasını sağlayan ayardır. Etkinleştirildiğinde, tüm görüntü adları belirtilen önek ile başlar. |
| **Özel Görüntü Öneki** (Custom Image Prefix) | Kubernetes görüntüleri için kullanılacak önek değeridir. Örnek: `my-registry.com/apinizer/` veya `registry.example.com:5000/` |

<Info>
**Özel Görüntü Öneki Kullanımı:**

Özel görüntü öneki özelliği, özel Docker registry'ler veya iç ağ görüntü depoları kullanıldığında faydalıdır. Bu özellik etkinleştirildiğinde, Apinizer tarafından oluşturulan tüm Kubernetes deployment'ları belirtilen önek ile görüntü adlarını kullanır.
</Info>

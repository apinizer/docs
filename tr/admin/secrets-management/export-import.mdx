...
<AccordionGroup>
  ...
  <Accordion title="AI Nesnesi Bağımlılığı Tespiti ve Eşleme">
    ...
    - Bir Virtual Key, kendi üzerinde secret bir değer taşımasa da, bağlı olduğu LLM Provider'ı ve Credential'ı birer bağımlılık olarak yüzeye çıkarır — bir istemcinin hangi credential'ı kullanacağını belirlediği için yine de incelemeniz amacıyla işaretlenir.
...
- [Sanal API Anahtarları](/tr/ai-gateway/sanal-api-anahtarlari)

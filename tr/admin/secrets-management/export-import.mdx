  ...
  <TabItem value="ice-aktarma" label="İçe Aktarma">
    <Steps>
      ...
      <Step title="Seçenekler">
        ...
        **Kimlik Bilgisi (Credential/Consumer)** tipinde hedef listesi artık **sunucu taraflı arama** ile çalışır: kayıt sayısı 50'yi aştığında listenin üstünde "ilk 50 kayıt gösteriliyor" bilgisi görünür ve arama kutusuna yazdıkça sunucudan eşleşen kayıtlar getirilir. Paketteki kullanıcı adı hedefte zaten varsa o kayıt otomatik olarak en üstte ve önerilmiş biçimde seçili gelir. Sistem yöneticisi hedefi **Admin (global)** seçtiğinde arama tüm projeleri kapsar ve isteğe bağlı bir **Proje** filtresi görünür; başka bir projeye ait tüketiciler listede görünür ama gri/seçilemezdir, ipucu o projeyi hedef seçerek sihirbazı yeniden başlatmanız gerektiğini söyler. Paketteki tüketici bir API İstemcisine taşınmışsa hedef seçiminin altında bilgi kutusu çıkar: kullanıcı adı, parola, anahtar ve organizasyon korunur, yalnızca diğer alanlar güncellenir. Paket ile hedefin organizasyonu farklıysa ayrıca "hedefin organizasyonu korunacak" notu görünür.

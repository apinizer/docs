...
Dışa aktarma dosyasını açıp içindeki bir dosyayı düzenleyip yeniden sıkıştırmaya dayanan bir akışınız varsa, o paket artık içe aktarılamaz. Değişikliği kaynak kurulumda yapıp paketi yeniden dışa aktarın ve Apinizer'ın ürettiği dosyayı olduğu gibi kullanın.

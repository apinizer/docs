...
Sihirbazda dışa/içe aktarılabilecek nesne tipleri üç kategoride toplanır. **Bağımlılık** sütunu, o tipin dışa aktarımında ek bir bağımlılık adımı olup olmadığını gösterir:
...
- **Bağımlılığı olmayan tipler** (Ayar Grubu, Ortam Değişkeni, Sertifika ailesi, IP Grubu) için ek bir bağımlılık/eşleştirme adımı yoktur — nesne seçildiği anda doğrudan dışa aktarılır; içe aktarımda ise dosya yüklendiği anda doğrudan seçeneklere (Options) geçilir.
  ...
  <TabItem value="ice-aktarma" label="İçe Aktarma">
    <Steps>
      ...
      <Step title="Paketi Yükle">
        ...
        Seçtiğiniz paketin şifreli olduğu otomatik olarak tespit edilir; bu durumda **Bu paket şifreli** başlığıyla bir parola alanı ve **Kilidi aç** düğmesi çıkar. Paket ancak kilidi açıldıktan sonra analiz edilir, dolayısıyla doğru parola girilmeden içeriği listelenemez. Yanlış parolada paket açılmaz.
      </Step>

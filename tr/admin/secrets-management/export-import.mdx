...
<AccordionGroup>
  ...
  <Accordion title="Dışlanan (Exclude Edilen) Bağımlılık Davranışı">
    ...
    - Dışa aktarım öncesinde otomatik bir uyarı taraması yapılır: yakında süresi dolacak sertifikalar, gizli ortam değişkenleri, sertifika/bağlantı/kimlik bilgisi secret hatırlatmaları ve (içe aktarım tarafında) hedef projede eksik olan ortam değişkenleri bu taramada raporlanır.
  </Accordion>

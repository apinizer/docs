...
Bir kullanıcıyı herhangi bir projeye üye olarak nasıl ekleyebileceğinizi öğrenmek için [tıklayınız](/apinizer-dokumantasyonu/ueyeler-1180069.html).

## Kullanıcı Listesi

**Kullanıcılar sayfası ilk açıldığında mevcut kullanıcıların listelendiği görsele aşağıda yer verilmiştir:**

<img
  src="/images/yonetici/kullanici-listesi.png"
  alt="Kullanıcı Listesi"
  width="800"
  className="mr-auto"
/>

Kullanıcı listesi ekranında şu işlemler gerçekleştirilebilir:

* **Arama**: Kullanıcı adı, e-posta veya tam adına göre arama yapılabilir
* **Filtreleme**: Kullanıcı tipi, rol veya duruma göre filtreleme yapılabilir
* **Düzenleme**: Mevcut kullanıcı bilgileri güncellenebilir
* **Silme**: Kullanıcı sistemden silinebilir
* **Kilit Açma**: Kilitli kullanıcıların kilidi açılabilir

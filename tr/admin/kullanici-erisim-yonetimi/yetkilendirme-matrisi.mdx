...
<Info>
Rol tanımlamaları hakkında detaylı bilgi almak için [Kimlik Bilgisi Rolleri](/tr/admin/kimlik-yonetimi/rol)
 ve [Kimlik Sağlayıcılar (Identity Providers)](/tr/admin/kullanici-erisim-yonetimi/rol)

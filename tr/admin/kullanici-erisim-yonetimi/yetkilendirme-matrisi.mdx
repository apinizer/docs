...
description: "Apinizer'da kimlik doğrulama politikaları ile rol bazlı yetkilendirme yapılandırması ve API Proxy/metot erişim kontrolü hakkında bilgi edinin."
---
...
![Yetkilendirme Ayarları](/images/image2021-6-15_14-45-4.png)
...
<Info>
Rol tanımlamaları hakkında detaylı bilgi almak için [Kimlik Bilgisi Rolleri](/kimlik-bilgisi-rolleri) ve [Kimlik Sağlayıcılar (Identity Providers)](/kimlik-saglayicilar-identity-providers) sayfalarını ziyaret edebilirsiniz.
</Info>
...
<CardGroup cols={3}>
    <Card title="Integration Flow" icon="diagram-project" href="/tr/entegrasyon-otomasyon/api-integrator-task-flow-builder/task-flow-tasarimi">
        Flow'lar içinde scheduled job oluşturma
    </Card>
    <Card title="Alert Konfigürasyonu" icon="bell" href="/tr/izleme/alarm">
        Alert job'larını yapılandırma
    </Card>
    <Card title="Monitoring" icon="chart-line" href="/tr/entegrasyon-otomasyon/api-integrator-task-flow-builder/taskflow-monitor">

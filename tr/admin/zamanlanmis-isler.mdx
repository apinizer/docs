...
<CardGroup cols={3}>
    <Card title="Integration Flow" icon="diagram-project" href="/tr/entegrasyon/api-integrator-task-flow-builder/task-flow-tasarimi">
    ...
    <Card title="Monitoring" icon="chart-line" href="/tr/entegrasyon/api-integrator-task-flow-builder/taskflow-monitor">

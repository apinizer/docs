...
description: 'API/Web Servis saldırılarına karşı içerik kontrol tabanlı savunma için filtre tanımlamaları.'
---
...
![Filtre Kuralları Ekranı](/images/filter-rules.png)
...
![Filtre Oluşturma](/images/filter-creation.png)

## Filtre Oluşturma Konfigürasyonu

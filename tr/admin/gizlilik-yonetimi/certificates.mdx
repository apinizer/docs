...
Sertifikalar sayfası, politikalarda ve/veya bağlantılarda kullanılan sertifikaların tanımlanmasını ve yönetilmesini sağlar.
...
![Sertifika Oluşturma](/images/certificates/create-certificate.png)
...
![Sertifika Konfigürasyonu](/images/certificates/certificate-config.png)
...
![Sertifika Kaydet ve Yükle](/images/certificates/save-deploy.png)
...
![Sertifika Düzenleme](/images/certificates/edit-certificate.png)

Yaptığınız değişiklikleri kaydetmek için **Uygula (Apply)** butonuna tıklayınız.

![Sertifika Uygula](/images/certificates/apply-changes.png)

## Sertifika Silme

Varolan bir sertifikayı silmek için o sertifikanın menüsünden **Sil (Delete)** butonuna tıklayınız.

![Sertifika Silme](/images/certificates/delete-certificate.png)

Açılan pencerede tekrar **Sil (Delete)** butonuna tıklayarak onaylayınız.

![Sertifika Silme Onay](/images/certificates/delete-confirm.png)

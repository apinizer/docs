...
<CardGroup cols={3}>
  <Card title="Sistem Ayarları ve Limitler" icon="sliders" href="/tr/admin/system-settings/sistem-ayarlari-ve-limitler">
  ...
  <Card title="Genel Ayarlar" icon="gear" href="/tr/admin/system-settings/global-yapilandirma">
    API Proxy erişim adresi, Kubernetes yönetimi ve trafik log anahtarları gibi platform genelinde geçerli konfigürasyonlar.
  </Card>
  <Card title="SIEM ve Log Yönlendirme" icon="shield" href="/tr/admin/system-settings/siem-log-yonlendirme">
    Denetim, oturum, token ve uygulama olayları için hedefler, hat başına filtre kuralları, yük profilleri, gizlilik profili ve olay boyutu politikası.
  </Card>

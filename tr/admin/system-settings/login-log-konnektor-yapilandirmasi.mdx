...
- **Graylog:** Giriş logu hattı şu an Graylog konnektörlerine ulaşmamaktadır; düzeltilene kadar giriş logları için Syslog, Kafka, RabbitMQ, ActiveMQ, Webhook, Elasticsearch veya Veritabanı konnektörlerini kullanın.

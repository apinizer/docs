...
| **Oturum** | Çıkış ve başarılı token yenileme 1 · başarılı giriş 2 · parola değiştirildi, parola değişimi zorunlu ve parola sıfırlama talebi 3 · parola politikası ihlali 4 · başarısız giriş ve başarısız token yenileme 5 · hesap kilitlendi 7 — `PORTAL_` ikizleri de aynı değeri taşır, artı `PORTAL_ACCOUNT_DISABLED` 5 ve `PORTAL_ACCOUNT_UNLOCKED` 7 (geri aldığı kilitle aynı ağırlık) |

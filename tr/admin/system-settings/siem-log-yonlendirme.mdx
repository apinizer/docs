...
| **Portal** | Her zaman saklanır — kapatılamaz | Otomatik temizleme yok — yukarıdaki Denetim ile aynı; on altı alan olayı `audit_event` koleksiyonunu Denetim ile paylaşır ve aşağıdaki Portal Login Logs saklama anahtarının kapsamı dışındadır. |

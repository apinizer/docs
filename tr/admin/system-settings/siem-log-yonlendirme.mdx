...
Ekranda **Planlandı** rozetiyle görünen ve henüz yapılandırılamayan iki hat daha vardır: **API Erişimi (API Access)** ve **Portal**. Ağ geçidinde engellenen veya hata veren isteklerin kendisi artık yukarıdaki **API Güvenliği** hattı üzerinden SIEM'e yönlendirilebilir; başarılı isteklerin tam trafik metadata'sı ise (API Erişimi hattı) henüz yapılandırılamaz — trafik logları ağ geçidi ortamının log konnektörleri üzerinden iletilmeye devam eder.
...
| **Oturum** | Çıkış ve başarılı token yenileme 1 · başarılı giriş 2 · parola değiştirildi, parola değişimi zorunlu ve parola sıfırlama talebi 3 · parola politikası ihlali 4 · başarısız giriş ve başarısız token yenileme 5 · hesap kilitlendi 7 |
...
- **API Erişimi ve Portal hatları** rezervedir ve yapılandırılamaz. Başarılı isteklerin tam trafik metadata'sı SIEM hatlarına henüz dahil değildir; trafik logları ağ geçidi ortamının log konnektörleri üzerinden iletilmeye devam eder.

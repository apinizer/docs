...
`old` ve `new` gizli bir alanı hiçbir zaman taşımaz — gizli olduğu bilinen bir alan `"[REDACTED]"` değeriyle gönderilir. 512 karakterden uzun değerler kırpılır.

...
|---|---|---|---|---|
| **Denetim (Audit)** | Yönetimsel değişiklikler, Yönetim Konsolu istekleri, reddedilen istekler ve hassas erişim olayları (gizli değer görüntüleme, dışa aktarma, API token yaşam döngüsü, PII maskesi kaldırma) | `audit_event` | `ENTITY`, `MANAGER_REQUEST`, `ACCESS_DENIED`, `SECRET_REVEALED`, `EXPORT`, `API_TOKEN_CREATED`, `API_TOKEN_REVOKED`, `PII_UNMASK` | `SUCCESS`, `FAILURE`, `DENIED` |
...
| Hat | Değer |
|---|---|
| **Denetim** | Yönetim Konsolu isteği başarılı 1 · varlık değişikliği 3 · varlık silme 4 · Yönetim Konsolu isteği başarısız 5 · erişim reddi 6 · gizli değer görüntüleme 6 · dışa aktarma 6 · API token oluşturma 4 · API token iptali 3 · PII maskesi kaldırma 6 |

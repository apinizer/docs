---
title: "Genel Ayarlar"
description: "Uygulama bazında API Proxy erişim adresi tanımlayabilir, trafik log anahtarlarını yapılandırabilir, yönetim isteklerinin denetim kaydını açabilir, yerel yönetilen kullanıcılar için parola politikasını yapılandırabilir, API istemcisi secret'ları için varsayılan saklama modunu seçebilir, Kubernetes namespace ve resource yönetimini etkinleştirebilir ve platform genelindeki temel davranışları yönetebilirsiniz."
---
...
## API İstemcisi Secret Saklama {#api-istemcisi-secret-saklama}
...
Bu ayarı taşımayan bir sürümden yükseltilen bir kurulum, varsayılanı **Encrypted** olarak okur; herhangi bir taşıma adımı gerekmez. Halihazırda saklı her eski kimlik bilgisi parolası ve [otomatik eski-kayıt taşımasının](/tr/admin/identity-management/kimlik-bilgileri#eski-kayitlar-envanter-ve-tasima) bir eski kayıttan taşıdığı her secret aynı şekilde ele alınır: Encrypted doğar ve kurulumda kurtarma anahtarı yapılandırılmamış olsa bile platform tarafından şifrelenmiş bir kopya sayesinde gösterilebilir kalır.

Varsayılan doğrudan da okunabilir ve yazılabilir:
...
Ayarı okumak için özel bir yetki gerekmez. Değiştirmek — bu ekrandan ya da yukarıdaki uç noktadan — sistem yöneticisi yetkisi ister.

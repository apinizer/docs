...
**API Product** tanımlamayla ilgili alanları daha detaylı olarak **[API Ürünü](/tr/api-portal/api-urunu)** sayfasından inceleyebilirsiniz.
...
**Visibility** ve **Plans** alanları API Product tanımlaması için fazlasıyla önem arz etmektedir.

:::note

İlgili alanlar hakkında daha detaylı bilgi edinmek için **[API Ürünü](/tr/api-portal/api-urunu)** sayfasını inceleyebilirsiniz. Planlar oluşturma sihirbazında veya kayıttan sonra Manager **Plans** sekmesinde yönetilir; abonelik onayı plan seviyesindedir.
...
**Free**: Ücretsiz tüketim.

**Flat rate**: Sabit ücretli plan (eski “Subscription” adı değildir).

**Metered**: Kullanım bazlı ücretlendirme.

**Tiered**: Kademeli ödeme planı.

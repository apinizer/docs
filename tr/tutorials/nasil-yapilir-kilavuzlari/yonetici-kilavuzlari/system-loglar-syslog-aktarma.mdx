...
Administration > Bağlantı Konfigürasyonlar > Syslog sayfasına gidilir ve bir Syslog bağlantı tanımı oluşturulur. [Detalı bilgi için Syslog Bağlantı Yönetimi](/tr/entegrasyon/baglanti-yonetimi/syslog) sayfasına bakabilirsiniz.

...
- **A (Toplam İstekler):** `sum(rate(apinizer_api_traffic_total_count_total[5m]))`
  ...
  <img src="/images/tutorials/nasil-yapilir-kilavuzlari/yonetici-kilavuzlari/gateway-grafana-dashboard/grafana-1.png" alt="Grafana - Toplam İstekler" width="1000"/>

- **B (Başarılı İstekler):** `sum(rate(apinizer_api_traffic_success_count_total[5m]))`

<img src="/images/tutorials/nasil-yapilir-kilavuzlari/yonetici-kilavuzlari/gateway-grafana-dashboard/grafana-2.png" alt="Grafana - Başarılı İstekler" width="1000"/>
...
<img src="/images/tutorials/nasil-yapilir-kilavuzlari/yonetici-kilavuzlari/gateway-grafana-dashboard/grafana-3.png" alt="Grafana - Hatalı İstekler" width="1000"/>
...
<img src="/images/tutorials/nasil-yapilir-kilavuzlari/yonetici-kilavuzlari/gateway-grafana-dashboard/grafana-4.png" alt="Grafana - En Yüksek Trafiğe Sahip 5 API" width="1000"/>
...
<img src="/images/tutorials/nasil-yapilir-kilavuzlari/yonetici-kilavuzlari/gateway-grafana-dashboard/grafana-5.png" alt="Grafana - API İşlem Süreleri" width="1000"/>
...
<img src="/images/tutorials/nasil-yapilir-kilavuzlari/yonetici-kilavuzlari/gateway-grafana-dashboard/grafana-6.png" alt="Grafana - Ortalama İstek Boyutu" width="1000"/>
...
<img src="/images/tutorials/nasil-yapilir-kilavuzlari/yonetici-kilavuzlari/gateway-grafana-dashboard/grafana-7.png" alt="Grafana - Ortalama Yanıt Boyutu" width="1000"/>
...
```
<img src="/images/tutorials/nasil-yapilir-kilavuzlari/yonetici-kilavuzlari/gateway-grafana-dashboard/grafana-8.png" alt="Grafana - Pod CPU Kullanımı" width="1000"/>

...
| `DEPLOYMENT_NAME` | Kubernetes deployment adı | `example-service` |
| `CONTAINER_NAME` | Kubernetes container adı | `health-api` |
| `DOCKER_IMAGE` | Docker image adı (kullanıcı adı/image) | `myusername/health-api` |
...
| `APINIZER_BASE_URL` | Apinizer platform URL'i | `https://qa.apinizer.com` |
| `APINIZER_GATEWAY_URL` | Apinizer gateway URL'i | `https://apiqa.apinizer.com/apigateway` |
| `APINIZER_PROJECT` | Apinizer proje adı | `prod-cid` |
| `APINIZER_ENVIRONMENT` | Deploy edilecek environment | `tester` |
| `APINIZER_PROXY_NAME` | API Proxy adı | `health-api-proxy` |
| `APINIZER_PROXY_PATH` | Gateway'deki relative path | `/health-api` |

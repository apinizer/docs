---
title: "Podların Anlık Thread Sayılarının Periyodik İzlenmesi"
description: "Kubernetes ortamında çalışan Apinizer podlarının thread sayılarını periyodik olarak izleyebilir, bash script'i ile otomatik izleme yapılandırması yapabilirsiniz."
---

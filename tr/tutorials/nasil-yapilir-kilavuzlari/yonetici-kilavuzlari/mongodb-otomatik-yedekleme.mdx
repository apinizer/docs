...
description: "MongoDB veritabanını otomatik olarak yedekleyebilir, eski yedekleri temizleyebilir ve cron ile periyodik yedekleme işlemlerini yapılandırabilirsiniz."
---

...
description: "Apinizer Cache için Prometheus kurulumu ve scraping yapılandırması yapabilir. Cache metriklerini 9091 portu üzerinden Prometheus'a aktarabilir. Constant ve dynamic scraping yöntemlerini kullanarak metrikleri toplayabilir."
---
...
**Dosya:** `apinizer-prometheus-svc.yaml`

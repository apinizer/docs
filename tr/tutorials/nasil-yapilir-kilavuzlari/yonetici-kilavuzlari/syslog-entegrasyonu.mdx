...
İlk olarak Syslog bağlantı ayarlarının yapılması gerekmektedir bu bağlantı ayarları için [Syslog Bağlantı Yönetimi](/tr/entegrasyon-otomasyon/baglanti-yonetimi/syslog) sayfasına göz atabilirsiniz.

Apinizer trafik loglarının syslog'a aktarım ayarları için [Trafik Loglarını Syslog'a Aktarma](/tr/operasyon/yonetici-kilavuzlari/traffic-loglar-syslog-aktarma) sayfasını ziyaret edebilirsiniz.

Apinizer sistem loglarının syslog'a aktarım ayarları için [Sistem Loglarını Syslog'a Aktarma](/tr/operasyon/yonetici-kilavuzlari/system-loglar-syslog-aktarma) sayfasını ziyaret edebilirsiniz.

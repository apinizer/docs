...
İlk olarak Syslog bağlantı ayarlarının yapılması gerekmektedir bu bağlantı ayarları için [Syslog Bağlantı Yönetimi](/tr/entegrasyon/baglanti-yonetimi/syslog) sayfasına göz atabilirsiniz.

---
title: "Apinizer Ortamlarının Otomatik Ölçeklendirilmesi"
description: "Podların yatay ölçeklendirme işlemlerini yapılandırabilir, uygulamanın taleplerine göre otomatik olarak pod sayısını artırıp azaltarak kaynak kullanımını optimize edebilirsiniz."
---
...
Kubernetes kümenizde ölçeklendirme özelliğini kullanabilmek için bir metric-server kurulu olması gerekmektedir. Eğer mevcut değil ise kurulum için [Kubernetes Metric Server Kurulumu](/tr/setup/kubernetes/kubernetes-metric-server) sayfasına bakabilirsiniz.

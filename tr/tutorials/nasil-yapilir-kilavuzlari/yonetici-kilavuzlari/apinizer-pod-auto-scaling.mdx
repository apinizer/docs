...
Kubernetes kümenizde ölçeklendirme özelliğini kullanabilmek için bir metric-server kurulu olması gerekmektedir. Eğer mevcut değil ise kurulum için [Kubernetes Metric Server Kurulumu](/tr/setup/kubernetes) sayfasına bakabilirsiniz.

...
<Warning>
  Kibana üzerinden gelen isteklerin hangi şehirlerden geldiğini görselleştirmek için [Kibana Maps ile Coğrafi Görselleştirme](/tr/operations/yonetici-kilavuzlari/kibana-maps-cografi-gorsellestirme) dokümantasyonuna bakınız.
</Warning>

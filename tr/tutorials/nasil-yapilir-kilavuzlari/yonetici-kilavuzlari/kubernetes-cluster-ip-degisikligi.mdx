...
<Warning>
  Eğer load balancer kullanmıyorsanız ve ağ üzerinde sanal ip oluşturamıyorsanız bunun için kullanabileceğiniz **Keepalived** ve **HAProxy** araçları ile bu işlemi gerçekleştirmek için [Kubernetes Yüksek Erişilebilirlik Cluster Kurulumu](/tr/kurulum/kubernetes/kubernetes-high-availability-yuksek-erisim-cluster) sayfasına bakabilirsiniz.

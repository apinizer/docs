...
description: "Grafana'yı Kubernetes üzerinde kurabilir, Prometheus'u veri kaynağı olarak yapılandırabilir ve metrikleri görselleştirmek için dashboard'lar oluşturabilirsiniz."
---
...
echo -n ${GF_SECURITY_ADMIN_USER} | base64 //Bunun çıktısını bir sonraki adımda <ENCODED_GF_SECURITY_ADMIN_USER> değişkeni yerine koyacağız
echo -n ${GF_SECURITY_ADMIN_PASSWORD} | base64 //Bunun çıktısını bir sonraki adımda <ENCODED_GF_SECURITY_ADMIN_PASSWORD> değişkeni yerine koyacağız
```

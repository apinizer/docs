---
title: SOAP Mesajı üzerinden Mail Atma
description: "Groovy script ile SOAP mesajı içeriğinden e-posta bilgilerini çıkararak e-posta gönderme işlemi"
---
...
1. **SOAP Parse**: Request body'den gelen SOAP mesajı parse edilir
2. **E-posta Bilgileri Çıkarma**: SOAP mesajından alıcı, gönderen, konu ve içerik bilgileri çıkarılır
3. **Doğrulama**: Gönderen ve alıcı bilgileri kontrol edilir
4. **E-posta Gönderme**: SMTP üzerinden e-posta gönderilir
5. **SOAP Yanıt**: İşlem sonucu SOAP formatında yanıt olarak döner

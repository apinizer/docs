---
title: SOAP Mesajı İmza Doğrulaması (İstemci Sertifikası ile)
---

# SOAP Mesajı İmza Doğrulaması (İstemci Sertifikası ile)

Bu script, SOAP mesajlarının imza doğrulamasını istemci sertifikası kullanarak gerçekleştirir. Script, gelen SOAP mesajının dijital imzasını doğrular ve sertifika geçerliliğini kontrol eder.

**ÖNEMLİ:** Bu politikanın çalışması için öncesinde istemci kimliği (client identity) belirtilmiş olmalıdır.
...
- **ERR-01**: Gönderen üye için sertifika bulunamadı
- **ERR-02**: İstemci sertifikası süresi dolmuş
- **ERR-03**: İstek imzalanmamış
- **ERR-04**: İmza doğrulaması başarısız
- **ERR-05**: İmza doğrulama sırasında hata oluştu

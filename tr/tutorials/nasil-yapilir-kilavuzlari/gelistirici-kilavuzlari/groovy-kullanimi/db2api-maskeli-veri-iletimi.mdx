...
Bu örnek, DB2-API'den gelen bir web servis cevabındaki verilerin maskelenerek iletilmesini gösterir. Özellikle hassas verilerin (ad, soyad, numara gibi) belirli karakterlerinin gizlenmesi için kullanılabilir.

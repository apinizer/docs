...
<Note>
  ChatGPT ve Gemini gibi web tabanlı yapay zeka araçları ile kullanım örnekleri için ekran görüntüleri ve adım adım kullanım senaryoları buraya eklenebilir.
</Note>

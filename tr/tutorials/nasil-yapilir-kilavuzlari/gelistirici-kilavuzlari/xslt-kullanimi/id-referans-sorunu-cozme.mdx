...
---
title: "SOAP Mesajı İçerisindeki ID Referans Sorununu Çözme"
description: 'XSLT kullanarak SOAP mesajı içerisindeki ID referans sorunlarını çözme'
---

# SOAP Mesajı İçerisindeki ID Referans Sorununu Çözme

Bazı .net servislerinde istek veya cevap bazen gerçekte istediklerinden farklı olabiliyor. Bu işlem ile bu istek mesajı düzenlenerek gönderilir.

...
---
title: "WSA Ayarını Belirli Bir Değer ile Gönderme"
description: 'XSLT kullanarak WS-Addressing (WSA) ayarlarını belirli değerlerle SOAP header\'a ekleme'
---

# WSA Ayarını Belirli Bir Değer ile Gönderme

Bu sayfa, XSLT kullanarak WS-Addressing (WSA) ayarlarını belirli değerlerle SOAP header'a ekleme işlemini açıklamaktadır.

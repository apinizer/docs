...
<Info>
XML/SOAP bir web servisi JSON/REST olarak sunmak için Apinizer üzerindeki Rest-2-Soap özelliği kullanılabilir. Detaylı bilgi için [SOAP/REST API Proxy Oluşturma](/tr/develop/api-proxy-olusturma/soaprest-api-proxy-olusturma) sayfasını inceleyebilirsiniz.
</Info>

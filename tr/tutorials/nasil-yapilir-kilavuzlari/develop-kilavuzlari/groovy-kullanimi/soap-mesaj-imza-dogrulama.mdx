...
description: "Groovy script ile SOAP mesajlarının dijital imza doğrulamasını istemci sertifikası kullanarak gerçekleştirme işlemi"
---

<Warning>
Bu politikanın çalışması için öncesinde istemci kimliği (client identity) belirtilmiş olmalıdır.
</Warning>

...
description: "Groovy script ile XML formatındaki yanıt verisini ayrıştırarak JSON formatına dönüştürme ve başka bir API'ye POST isteği ile gönderme işlemi"
---

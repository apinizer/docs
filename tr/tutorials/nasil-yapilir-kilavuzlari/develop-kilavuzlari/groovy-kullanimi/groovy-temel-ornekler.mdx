...
description: "Groovy programlama dili ile temel işlemler, string kullanımı, döngüler, fonksiyonlar, XML ve JSON işlemleri gibi yaygın kullanım senaryoları için örnekler"
---
...
## 25) Groovy'de Jsonpath Kullanımı

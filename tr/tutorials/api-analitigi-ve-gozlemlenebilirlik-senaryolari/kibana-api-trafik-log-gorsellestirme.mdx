...
Template Veri Yapısı Tablosu için [Elasticsearch Manuel ILM Politikası ve Template Oluşturma](/tr/setup/kuruluma-genel-bakis) sayfasını ziyaret edebilir, ILM Politikalarının alan adına göre tutulan verilerin açıklamasına bakabilirsiniz.
...
Bu sayfa Elasticsearch API trafik **loglarını** Kibana ile görselleştirir. Gateway **metriklerini** Prometheus üzerinden Grafana ile görselleştirmek için [API Trafik Metriklerini Grafana İle Görselleştirme](/tr/tutorials/api-analitigi-ve-gozlemlenebilirlik-senaryolari/grafana-api-trafik-metrik-gorsellestirme) sayfasına bakabilirsiniz.

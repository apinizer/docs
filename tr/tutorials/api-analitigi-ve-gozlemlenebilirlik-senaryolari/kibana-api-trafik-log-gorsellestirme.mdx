...
<Note>
Template Veri Yapısı Tablosu için [Elasticsearch Manuel ILM Politikası ve Template Oluşturma](/tr/setup/elasticsearch/manuel-ilm-politikasi-ve-template-olusturma) sayfasını ziyaret edebilir, ILM Politikalarının alan adına göre tutulan verilerin açıklamasına bakabilirsiniz.
</Note>

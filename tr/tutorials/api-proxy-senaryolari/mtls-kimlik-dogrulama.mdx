...
![HTTPS Enabled mTLS](/images/https-enabled-mtls.png)
...
![Server Keystore Truststore](/images/server-keystore-truststore.png)
...
![Add Policy](/images/add-policy-mtls.png)

Politikalardan **mTLS** seçilir.

![Select mTLS Policy](/images/select-mtls-policy.png)

Politika ayarları aşağıdaki gibi yapılır ve **Kaydet (Save)** butonuna tıklanır.

![mTLS Policy Settings](/images/mtls-policy-settings.png)
...
![Credential mTLS Settings](/images/credential-mtls-settings.png)

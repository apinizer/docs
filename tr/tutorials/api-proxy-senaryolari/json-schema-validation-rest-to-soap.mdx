...
description: "Apinizer üzerinde REST-to-SOAP tipinde bir API Proxy'ye JSON Schema Validation politikasının uygulanması. Request body'sinin JSON şemasına göre adım adım doğrulanması."
---

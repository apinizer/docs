...
<img src="/images/tutorials/json-schema-validation-politika-all-ekleme.png" alt="JSON Schema Validation politikasını All kısmına ekleme" />

Politika olarak JSON Schema Validation ekliyoruz.

<img src="/images/tutorials/json-schema-validation-politika-ekleme.png" alt="JSON Schema Validation politikası ekleme" />
...
<img src="/images/tutorials/json-schema-validation-schema-alani.png" alt="JSON Schema Validation Schema alanı" />
...
<img src="/images/tutorials/json-schema-validation-test-sonucu.png" alt="JSON Schema Validation test sonucu" />

---
title: "REST API'ye Plain-Text Authentication Uygulanması"
description: "Swagger PetStore REST API'sine Security Manager Provider aracılığıyla Plain-Text Authentication politikasının nasıl uygulanacağı adım adım gösterilir: API Proxy oluşturma, Security Manager yapılandırma ve test."
---

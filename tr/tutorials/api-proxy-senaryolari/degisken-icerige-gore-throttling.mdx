...
description: "API isteklerindeki dinamik değişken içeriklerine göre throttling uygulama. Belirli değişken değerlerine göre tetiklenen throttling kuralları tanımlanması."
---

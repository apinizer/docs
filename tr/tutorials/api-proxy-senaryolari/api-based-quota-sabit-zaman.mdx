...
description: "Apinizer üzerinde oluşturulan bir Mock API'ye API Based Quota politikasının uygulanması. Sabit zaman aralıkları (saat, gün, ay) için kota yapılandırması."
---

...
description: "Aynı API Proxy'de HTTP ve WebSocket servisleri çalıştığında, politika koşulları kullanarak Apinizer politikalarının yalnızca HTTP isteklerine uygulanması, WebSocket bağlantılarının etkilenmemesi."
---

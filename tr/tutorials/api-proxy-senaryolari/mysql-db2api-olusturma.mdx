...
<img src="/images/tutorials/db1.png" alt="Veri tabanı bağlantısı sayfası" width="200" />
...
- Bu alanlar haricinde kalan diğer alanlar hakkında bilgi için [veritabanı bağlantısı](/tr/integrations/baglanti-yonetimi/database) sayfasına bakabilirsiniz.
...
<img src="/images/tutorials/db4.png" alt="DB-2-API seçeneği seçildikten sonra boş sayfa" width="200" />

...
description: "Apinizer üzerinde REST tipinde bir Mock API'ye JSON Schema Validation politikasının uygulanması. Gelen JSON request body'sinin şemaya göre doğrulanması."
---

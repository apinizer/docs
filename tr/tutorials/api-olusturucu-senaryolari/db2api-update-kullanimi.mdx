...
![Metot Oluşturma Ayarları](/images/method-creation-settings-update.png)

Gerekli parametreler girilip **Dene (Try It)** butonu ile yazılan sorgu denenebilir.

![Try It Butonu](/images/try-it-button-update.png)

**Test sonucu dönen mesajı** içeren görsele aşağıda yer verilmiştir:

![Test Sonucu](/images/test-result-update.png)
...
![Spec Bilgisi](/images/spec-info-update.png)

...
description: "Başarısız istek oranı artışında anomali tespiti için farklı senaryoları uygulayabilir. Başarısız istek sayısındaki artış, başarısız istek oranındaki artış ve Bollinger bantları kullanarak anomali tespiti yapabilir."
---

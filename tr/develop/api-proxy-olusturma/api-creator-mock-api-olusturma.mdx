...
:::
        ...
        <img
            src="/images/develop/api-proxy-olusturma/mpck-api-create-ekrani.png"
            alt="Image 2024 9 9 15 35 35 Pn"
            width="1000"
            className="mr-auto"
        /> </Accordion>
...
Bu adımdan sonra yapılabilecekler API Proxy dokümanı ile birebir aynıdır. Detayına gitmek için [API Proxy Oluşturma](/tr/develop/api-proxy-olusturma) sayfasına bakabilirsiniz.
...
Açılan pencerede Mock API ile oluşturulan API Proxy'ler Yükle/Kaldır ve Yeniden Yükle işlemleri bu bölümde yapılır. Detayına gitmek için [Yükleme, Yeniden Yükleme, Kaldırma, Deployment Geçmişi ve Rollback](/tr/develop/yukleme-ve-surum-yonetimi) sayfasına bakabilirsiniz.
...
Mock API'ye yeni bir endpoint eklendiğinde veya endpoint içinde değişiklik yapıldığında değişikliğin geçerli
    olabilmesi için bu API'den oluşturulan tüm API Proxy'lerin yeniden yüklenmesi gerekir.

...
Client Route, API Proxy'lerinize gelen isteklerin nasıl yönlendirileceğini belirleyen yapılandırma ayarlarıdır. Client Route kavramı hakkında detaylı bilgi için [Client Route](/tr/concepts/temel-kavramlar/client-route) sayfasına bakabilirsiniz.
...
<CardGroup cols={3}>
  <Card title="Client Route" icon="route" href="/tr/concepts/temel-kavramlar/client-route">
  ...
  <Card title="Routing ve Upstream" icon="network-wired" href="/tr/concepts/temel-kavramlar/routing-ve-upstream">

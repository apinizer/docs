...
<Steps>
  ...
  <Step title="API Bilgilerini Doldurun">
    ...
    <img src="/images/develop/api-proxy-olusturma/script2api-new.png" alt="API Bilgilerini Doldurma" width="1000" />
  </Step>
  ...
  <Step title="Endpoint Ekleyin">
    ...
    <img src="/images/develop/api-proxy-olusturma/script2api-neww.png" alt="Endpoint Ekleme" width="1000" />
  </Step>
</Steps>
    ...
    <CardGroup cols={2}>
      <Card title="HTTP Metot" icon="list">
        **Alan:** HTTP Metot (HTTP Method)
        ...
        REST API'ler için HTTP Metodu seçilir: GET, POST, PUT, HEAD, OPTIONS, DELETE, PATCH, TRACE, ALL, QUERY
      </Card>
...
Bu adımdan sonra yapılabilecekler API Proxy dokümanı ile aynıdır. Detaylı bilgi için [API Proxy Oluşturma](/tr/develop/api-proxy-olusturma) sayfasını inceleyebilirsiniz.

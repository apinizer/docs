...
<img src="/images/develop/api-proxy-olusturma/db-api-proxy-yonetme.png" alt="API Proxy yönetme" width="800" />
...
<img src="/images/develop/api-proxy-olusturma/db-api-deploy.png" alt="Deploy ekranı" width="800" />
...
<img src="/images/develop/api-proxy-olusturma/db-api-yeniden-yukleme-bildirimi.png" alt="Yeniden yükleme bildirimi" width="800" />

**Yeniden Yükle (Redeploy Required)** diyerek değişikliklerin API Proxy'lere uygulanması sağlanır.

<img src="/images/develop/api-proxy-olusturma/db-api-redeploy.png" alt="Redeploy ekranı" width="800" />
...
<img src="/images/develop/api-proxy-olusturma/db-api-redeploy-onay.png" alt="Redeploy onay ekranı" width="800" />

DB-2-API sayfasından API Proxy'nin ismindeki link tıklanarak API Proxy'e gidilir.

<img src="/images/develop/api-proxy-olusturma/db-api-proxy-link.png" alt="DB-2-API'dan API Proxy'ye link" width="800" />
...
<img src="/images/develop/api-proxy-olusturma/db-api-geri-link.png" alt="API Proxy'den DB-2-API'ye link" width="800" />

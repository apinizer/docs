...
:::
  ...
  <Step title="gRPC Routing Yapılandırması">
    gRPC için özel routing yapılandırması yapılabilir. Daha fazla bilgi için [gRPC Routing](/tr/develop/yonlendirme/grpc-yonlendirme) sayfasına bakılabilir.
  </Step>
...
<CardGroup cols={2}>
  <Card title="gRPC Routing Yapılandırması" icon="route" href="/tr/develop/yonlendirme/grpc-yonlendirme">
  ...
  <Accordion title="Senaryo 1: Internal gRPC Servisini Expose Etme">
    ...
    <Steps>
      ...
      <Step title="Güvenlik Politikaları Ekleyin">
        Authentication gibi gRPC'de desteklenen güvenlik politikaları eklenir.
      </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Aktarım Güvenliği" icon="shield">
    gRPC servisleri genellikle internal network'te çalışır ve güvenlik kritiktir. Backend bağlantısında TLS kullanın; arka uç mTLS istiyorsa Keystore ayarlarından istemci sertifikasını tanımlayın.
  </Card>
...
<CardGroup cols={2}>
  <Card title="gRPC Routing" icon="route" href="/tr/develop/yonlendirme/grpc-yonlendirme">
  ...
  <Card title="gRPC Yönlendirme Güvenliği" icon="lock" href="/tr/develop/yonlendirme/grpc-yonlendirme">
    Backend bağlantısında Keystore ve TLS ayarlarını öğrenin
  </Card>
  <Card title="Yükleme ve Sürüm" icon="rocket" href="/tr/develop/yukleme-ve-surum-yonetimi">

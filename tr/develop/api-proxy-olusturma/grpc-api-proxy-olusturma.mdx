    ...
    <AccordionGroup>
      ...
      <Accordion title="Yöntem 2: URL'den Yükleme">
        **URL Gir** bağlantısına tıklanır. Protobuf dosyasının URL'si girilir ve **Parse** butonuna tıklanır. Dosya parse edilir ve servis bilgileri görüntülenir.
        ...
        <Info>
          **Kimlik Doğrulama ve Zaman Aşımı** Spec URL'si kimlik doğrulama gerektiriyorsa, **Spec Authorization Kullan** seçeneğini etkinleştirerek özel header'lar veya **Basic Auth** (kullanıcı adı/şifre) bilgilerini girebilirsiniz. Ayrıca **SSL/Sertifika Ayarları** bölümünde bağlantı zaman aşımı süresini (5-120 saniye, varsayılan: 30s) ayarlayabilirsiniz.
        </Info>
      </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="mTLS Güvenliği" icon="lock" href="/tr/develop/politikalar/mTLS">

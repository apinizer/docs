...
:::note
Bu API Proxy bir [Global Ayar Grubu](/tr/develop/global-configurations/global-settings-group)na bağlıysa Bakım Modu ekranında **"Global Setting aktif!"** rozeti görünür, anahtar ve **Yapılandır** düğmesi kapanır; gösterilen durum kodu ve mesaj her zaman ayar grubunun değeridir. Değişiklik ayar grubundan yapılır. Ayar grubuna bağlamak veya gruptan koparmak, deploy edilmiş ortamları **"Yeniden Yükle"** olarak işaretler.
:::

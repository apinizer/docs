...
Mesaj akışı, politika pipeline'ı ve politika uygulama sırası hakkında kavramsal bilgi için [Mesaj İşleme ve Politika Uygulama](/tr/concepts/temel-kavramlar/mesaj-isleme-ve-politika-uygulama) temel kavramlar sayfasına bakabilirsiniz.
...
Bu bölümde politikaların detaylarına girilmeyecektir. Politikalarla ilgili detaylı bilgi için [Politikalar (Policies)](/tr/develop/politikalar/plain-text) sayfasına bakılabilir.
...
<img
  ...
  src="/images/develop/message-processing/istemci.png" alt="İstemci" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/message-processing/backend-api.png" alt="Backend API" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/message-processing/api-tanim-belgesi.png" alt="API Tanım Belgesi" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
Bu bölümde API Proxy'nin geliştirme sekmesinde politikalar üzerinde yapılabilecek yönetimsel işlemler anlatılmaktadır. [Politika Nedir?](/tr/concepts/temel-kavramlar/politika-nedir) kavramı hakkında detaylı bilgi için temel kavramlar sayfasına bakabilirsiniz. Herhangi bir politika hakkında detaylı bilgi edinmek için [Politikalar (Policies)](/tr/develop/politikalar/plain-text) bölümünden ilgili politikaya ilişkin dokümantasyona bakabilirsiniz.

### Politikaların Yeri ve Çalışma Sırası

Politikalar 3 farklı noktaya eklenebilir:

* **[API Proxy Grubu](/tr/concepts/temel-kavramlar/api-proxy-group)**: Bir API Proxy Grubuna eklenen bir politika, sadece istek API Proxy Grup üzerinden gelmiş ise işletilir.
* **[API Proxy](/tr/concepts/temel-kavramlar/api-proxy-nedir)**: Bir API Proxy'ye eklenen bir politika, o API Proxy'nin bütün metot/endpoint'leri için işletilir.
* **[Metot/Endpoint](/tr/concepts/temel-kavramlar/endpoint)**: Bir metot/endpoint'e eklenen bir politika, yalnızca o metot/endpoint için işletilir.
...
<img
  ...
  src="/images/develop/message-processing/all.png" alt="Hepsi Seçeneği" style={{maxWidth: '1000px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/message-processing/hepsi-secenegi.png" alt="Hepsi Seçeneği" style={{maxWidth: '1000px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/message-processing/politika-isletilme-sirasi.png" alt="Politika İşletilme Sırası" style={{maxWidth: '1000px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/message-processing/politika-ekle.png" alt="Politika Ekle" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<img
  ...
  src="/images/develop/message-processing/politika-tipi-secimi.png" alt="Politika Tipi Seçimi" style={{maxWidth: '800px', width: '100%', height: 'auto'}}
...
<CardGroup cols={2}>
  ...
  <Card title="Global Politikalar" icon="cog" href="/tr/develop/global-configurations/global-policies">

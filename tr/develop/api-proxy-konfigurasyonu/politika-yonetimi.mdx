...
Bu bölümde politikaların detaylarına girilmeyecektir. Politikalarla ilgili detaylı bilgi için [Politikalar (Policies)](/tr/develop/politikalar/api-bazli-daraltma.mdx) sayfasına bakılabilir.
...
<CardGroup cols={2}>
  ...
  <Card title="Politikalar" icon="list" href="/tr/develop/politikalar/api-bazli-daraltma.mdx">

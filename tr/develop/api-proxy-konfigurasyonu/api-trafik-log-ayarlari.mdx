...
<Info>
Global ayarlar ekranında da log ayarları yapılandırılabilir. Detaylı bilgi için [Global Trafik Log Ayarları](/tr/develop/api-proxy-konfigurasyonu/api-trafik-log-ayarlari) sayfasına bakabilirsiniz.
</Info>
...
Detaylı bilgi için [Ağ Geçidi Ortamlarına Konnektör Eklenmesi](/tr/admin/server-management/ag-gecidi-ortamlarina-konnektor-eklenmesi) sayfasına bakabilirsiniz.

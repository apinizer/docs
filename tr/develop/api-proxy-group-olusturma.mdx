...
<CardGroup cols={3}>
  ...
  <Card title="API Proxy Oluşturma" icon="plus" href="/tr/develop/api-proxy-olusturma/api-proxy-olusturma">
    API Proxy oluşturma
  </Card>

...
Bu ayar yalnızca **HTTP/1.1** backend bağlantıları için geçerlidir. Proxy streaming/HTTP2 (OkHttp) yolu kullanılıyorsa ayar etkisizdir; bu durumda 301/302/303 yönlendirmelerinde istek yine GET metoduna düşer.

...
| **Sıkıştırma Geçersiz Kılma** | Yanıt gövdesini istemciye göndermeden önce sıkıştırmak için kullanılacak algoritma. Sıkıştırmayı atlamak için **Uygulanmasın (atla)** seçin. |

...
| **SOAP Action ve Namespace bilgisini düzelt** | SOAP ve Rest2Soap servislerde aktif olan bu seçenek ile SOAP action ve namespacelerinin WSDL'a göre varsayılan olarak düzeltilmesi işlemi gerçekleştirilir. Daha detaylı bilgi için [bu sayfayı](/tr/develop/api-proxy-olusturma/soap-api-proxy-olusturma#namespace-ile-belirleme) ziyaret edebilirsiniz. Ayarın devre dışı bırakılması durumunda istemcinin gönderdiği istek üzerinde bir değişiklik yapılmaz. |

...
| **Stale Connection Kontrolü** | Belirtilen süre (milisaniye) boyunca kullanılmayan bağlantılar yeniden kullanılmadan önce doğrulanır. Backend load balancer keep-alive timeout'una göre ayarlayın. Varsayılan: 2000 ms. |
| **Idle Connection Temizliği** | Belirtilen süreden (saniye) fazla boşta kalan bağlantılar havuzdan temizlenir. Backend load balancer keep-alive timeout'una göre ayarlayın. Varsayılan: 30 saniye. |

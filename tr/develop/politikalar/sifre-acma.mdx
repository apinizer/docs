...
<img src="/images/develop/politikalar/decryption-new.png" alt="Şifre Açma Politikası" width="1000" />
...
| **Adım 6: IV ve Kodlama Ayarlarını Yapma** | Algoritma IV gerektiriyorsa `ivExists` otomatik işaretlenir; IV değişkenini ve `ivEncodingType` değerini seçin. Şifreli içerik formatını `inputEncodingType` (BASE64/HEXADECIMAL) ile belirleyin.<br /><br />**! Yanlış encoding seçimi çözülemeyen veri doğurur.** |
...
| **Adım 9: Kaydetme** | - Sağ üstteki **[Save]** butonuna tıklayın.<br /><br />**Kontrol Listesi:** Benzersiz isim. Zorunlu alanlar dolu. En az bir şifre açma tanımı mevcut<br /><br />**Sonuç:**<br />- Politika listeye eklenir.<br />- API'lere bağlanabilir.<br />- Global politikaysa otomatik uygulanır. |

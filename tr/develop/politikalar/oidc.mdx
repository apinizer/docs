...
| **Adım 4: OIDC Sağlayıcı ve Uç Nokta Yapılandırması** | - Issuer veya Discovery URL'sini tanımlayın.<br />- Discovery devre dışı ise Authorization, Token, UserInfo, JWKS ve Introspection endpoint adreslerini manuel girin.<br />- Client ID/Secret, Redirect URI, Realm ve scopes alanlarını doldurun.<br />- PKCE ve zorunlu scope ihtiyaçlarını değerlendirerek işaretleyin. |

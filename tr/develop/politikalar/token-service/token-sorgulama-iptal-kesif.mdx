...
Bir çağrı yapan taraf yalnızca kendisine ait olan token'ları sorgulayabilir; başka bir uygulama, kimlik bilgisi veya [API istemcisi](/tr/admin/identity-management/kimlik-bilgileri#api-istemcisi-ile-token-alma) için çıkarılan bir token her zaman `active: false` olarak bildirilir, böylece token ayrıntıları istemciler arasında sızıntıya uğramaz.
...
- [Token Yönetim Ayarları](/tr/admin/identity-management/token-yonetim-ayarlari)

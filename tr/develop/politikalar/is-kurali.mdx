...
| **Adım 3: Aksiyon Zincirini Tanımlama** | - **Policy Definitions** bölümünde **Actions** açılır menüsünden **Add**, **Modify**, **Delete** veya **Stop** seçin.<br />- Açılan diyalogda Action Type, Source Data Type (NUMERIC/STRING/TEMPORAL) ve operatörü (örn. SUBSTRING, ADD_TEMPORAL, EXTRACT_JWT_BODY_CLAIM) seçip parametrelerini doldurun. |

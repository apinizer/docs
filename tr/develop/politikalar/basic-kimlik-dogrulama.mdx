...
**Identity Role Group** seçim listesinde [OIDC Kimlik Sağlayıcı](/tr/admin/identity-management/identity-providers/oidc-provider) yer almaz. Base64 Authentication, istekten çözülen kullanıcı adı/şifre çiftini doğrudan doğrular; OIDC kimlik modelinde ise parola Apinizer'a hiç gelmez, doğrulama yalnızca bir token üzerinden yapılır. Kullanıcı adı/şifre yerine OIDC token'ı kabul etmek gerekiyorsa [OIDC Kimlik Doğrulama](/tr/develop/politikalar/oidc) veya [JWT Kimlik Doğrulama](/tr/develop/politikalar/jwt) politikaları kullanılmalıdır.

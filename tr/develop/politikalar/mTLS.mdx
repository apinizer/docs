...
| **Proxy türü** | Politika yalnızca **HTTP/HTTPS** API Proxy'lerinde çalışır. gRPC API Proxy'lerinde desteklenmez; tanımlanmışsa istek reddedilir. |
...
| **Teknik** | Politika gRPC API Proxy'lerinde çalışır mı? | Hayır. Politika yalnızca HTTP/HTTPS API Proxy'lerinde çalışır; gRPC proxy'lerinde tanımlıysa istek reddedilir. |

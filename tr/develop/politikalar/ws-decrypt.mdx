...
<img src="/images/develop/politikalar/ws-decrypt-new.png" alt="WS Güvenlik Şifre Çözme Politikası" width="1000" />
...
| **Adım 4: WS-Security Decryption Parametreleri** | **Decryption KeyStore (Zorunlu):** Listeden ilgili keystore'u seçin. Keystore, şifre çözme anahtarını içerir.<br />**KeyStore Tooltipleri:** Seçilen kaynağın proje kapsamına uygun olduğunu doğrular. |
...
| **Adım 9: Kaydetme** | - Sağ üstteki **[Save]** butonuna tıklayın.<br /><br />**Kontrol Listesi:** Benzersiz isim. Zorunlu alanlar dolu. En az bir WS-Security anahtar yapılandırması mevcut<br /><br />**Sonuç:**<br />- Politika listeye eklenir.<br />- API'lere bağlanabilir.<br />- Global politikaysa otomatik uygulanır. |

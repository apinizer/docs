...
<img src="/images/develop/politikalar/ws-security-sign-new.png" alt="WS Güvenlik İmza Doğrulama Politikası" width="1000" />
...
| **Adım 4: KeyStore Seçimi** | - **Verification KeyStore** alanından imza doğrulamada kullanılacak sertifikayı seçin.<br />- Listede aktif projeye ait KeyStore kayıtları alfabetik sıralı gelir.<br />- Seçim yapılmazsa istekler doğrulanamaz ve politika kaydedilemez. |
| **Adım 5: Gelişmiş Doğrulama Seçenekleri** | - **Enable Enhanced Signature Validation** kutucuğu ile ekstra WS-Security kontrollerini devreye alın.<br />- Bu seçenek aktifken **Allow Case Insensitive ID** alanı görünen hale gelir ve ID karşılaştırmasını harf duyarsızlaştırır.<br />- Dereference hatalarını önlemek için **Enable Signature Removal for Dereferencing** seçeneğini kullanın. |
| **Adım 6: SOAP Davranışı Parametreleri** | - **Must Understand** seçeneği zorunlu WS-Security başlıklarını denetler.<br />- **Remove Signature** ile doğrulama sonrasında Signature elementini mesajdan kaldırabilirsiniz.<br />- Bu seçenek arka uç servislerin sadece iş verisine odaklanmasını sağlar. |
...
| **Adım 9: Kaydetme** | - Sağ üstteki **[Save]** butonuna tıklayın.<br /><br />**Kontrol Listesi:** Benzersiz isim. Zorunlu alanlar dolu. En az bir KeyStore seçimi mevcut<br /><br />**Sonuç:**<br />- Politika listeye eklenir.<br />- API'lere bağlanabilir.<br />- Global politikaysa otomatik uygulanır. |

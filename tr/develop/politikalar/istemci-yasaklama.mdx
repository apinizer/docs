...
<img src="/images/develop/politikalar/client-ban.png" alt="İstemci Yasaklama Politikası Yapılandırma" width="1000" />
...
| **Adım 4: İstemci Kimliği Parametreleri** | - **Client Identity Variables** tablosunda kimliği tanımlayan değişkenleri seçin (header, query, JWT claim vb.).<br />- Değişkenleri Variable dialog ile projeden ekleyin; gerekirse çıkarın.<br />- Seçim yapılmadıysa politika kaydedilemez. |
| **Adım 5: Eşik ve Yasak Zamanlaması** | - `thresholdWindowInSeconds` ve `thresholdCountPerWindow` değerlerini saniye ve adet bazında girin.<br />- `thresholdCalculationType` için COUNT veya PERCENT modunu seçin.<br />- `banTimeInSeconds` ile yasak süresini belirleyin.<br />- `enableRetryAfterHeader`/`ignoreWhenKeyIsEmpty` toggle'larını ihtiyaca göre açın. |
| **Adım 6: Assertion Condition Tanımı** | - Assertion Query Builder'da ban hesaplamasına dahil edilecek olayları tanımlayın (örn: statusCode, header, body).<br />- Tanım boş bırakılırsa tüm istekler pencereye dahil edilir.<br />- Koşula uyum sağlayan kayıtlar sayaçta tutulur. |
...
| **Adım 9: Kaydetme** | - Sağ üstteki **[Save]** butonuna tıklayın.<br /><br />**Kontrol Listesi:**<br />- Benzersiz isim<br />- Zorunlu alanlar dolu<br />- En az bir istemci kimlik değişkeni mevcut<br /><br />**Sonuç:**<br />- Politika listeye eklenir.<br />- API'lere bağlanabilir.<br />- Global politikaysa otomatik uygulanır. |

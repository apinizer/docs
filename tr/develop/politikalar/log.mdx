...
Log politikası verileri için Elasticsearch index template'i ve ILM politikası Apinizer UI'dan otomatik oluşturulmaz. ILM politikası, index template ve data stream kurulum komutları için bakınız: [Apinizer Log Tabloları Oluşturma Komutları — Log Politikası](/tr/operations/yonetici-kilavuzlari/apinizer-log-tablolari-olusturma-komutlari#log-politikası).
...
- [Log Konnektörü Eklenmesi](/tr/admin/server-management/gateway-ortamlarina-konnektor-eklenmesi)

...
Tam belgeler ve zaman dilimi parametreleri için [Dinamik Değişkenler](/tr/concepts/temel-kavramlar/dinamik-degiskenler#tarihsaat-yardımcısı-dtf) sayfasının "Tarih/Saat Yardımcısı (dtf)" bölümüne bakabilirsiniz.

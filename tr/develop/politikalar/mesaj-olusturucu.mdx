...
| **Çoklu Kaynak Birleştirme** | - Template modunda birden fazla kaynak kullanın.<br />- Örnek: `ID: #{body.$.id}, Name: #{header.X-User-Name}, Time: #{dateTime.formattedText}`<br />- Birleşik değer tek bir hedef değişkene yazılır. |

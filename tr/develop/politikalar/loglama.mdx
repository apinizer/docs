...
### Gönderilemeyen Mesaj Tablosu

DB Connector konnektörüne bağlantı kurulamadığında, iletilemeyen log kayıtları `log_UnsentMessage` tablosunda geçici olarak saklanır. Bağlantı yeniden kurulduğunda bu kayıtlar otomatik olarak gönderilir.

...
description: "HTTP isteğinin dijital imzasını yetkili anahtar veya sertifika ile doğrulayabilirsiniz. İstek bütünlüğünü ve gönderenin kimliğini doğrulayarak güvenli iletişim sağlayabilirsiniz"
---
...
<img src="/images/develop/politikalar/digital-sign-veritification.png" alt="Dijital İmza Doğrulama Politikası Yapılandırma" width="1000" />
...
| **Adım 4: Dijital İmza Tanımlarını Oluşturma** | **[+ Add Verification]** ile modal açın.<br />- **Signature Var**: İmzanın bulunduğu değişkeni seçin.<br />- **Source Var**: İmzanın üretildiği ham veriyi temsil eden değişkeni seçin.<br />- **Input Encoding Type**: İmzanın BASE64 veya HEX olduğunu belirtin.<br />- Açıklama girerek tanımı gruplayın. |
...
| **Adım 6: Çoklu Tanım ve Öncelik Yönetimi** | - Birden fazla imza tanımı ekleyin.<br />- Tanımlar listedeki sırayla değerlendirilir.<br />- Her tanım için düzenleme/silme işlemleri aynı modal üzerinden yapılır.<br />- Öneri: Farklı endpoint'ler için anlamlı açıklamalar kullanın |

...
<img src="/images/develop/izleme-analiz/trace-detailed-view-button.png" alt="Detaylı Görüntüleme" width="600" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
...
<img src="/images/develop/izleme-analiz/trace-detailed-view-dialog.png" alt="Detaylı Görüntüleme Dialog" width="800" style={{maxWidth: '800px', width: '100%', height: 'auto'}} />
...
<img src="/images/develop/izleme-analiz/trace-json-view.png" alt="JSON Görüntüleme" width="600" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
...
<img src="/images/develop/izleme-analiz/trace-download.png" alt="İndirme" width="600" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
...
<img src="/images/develop/izleme-analiz/trace-quick-test.png" alt="Hızlı Test" width="600" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
...
<img src="/images/develop/izleme-analiz/trace-select.png" alt="Seçme" width="600" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
...
<img src="/images/develop/izleme-analiz/trace-successful-flow.png" alt="Başarılı Politika Akışı" width="800" style={{maxWidth: '800px', width: '100%', height: 'auto'}} />
...
<img src="/images/develop/izleme-analiz/trace-failed-flow.png" alt="Başarısız Politika Akışı" width="800" style={{maxWidth: '800px', width: '100%', height: 'auto'}} />
...
<img src="/images/develop/izleme-analiz/trace-detailed-logs.png" alt="Detaylı Log Kayıtları" width="800" style={{maxWidth: '800px', width: '100%', height: 'auto'}} />
...
<img src="/images/develop/izleme-analiz/trace-client-logs-1.png" alt="İstemci Log Kayıtları 1" width="800" style={{maxWidth: '800px', width: '100%', height: 'auto'}} />

İkinci sekmede istemciden API Proxy'e gönderilen mesajın detayları bulunur.

<img src="/images/develop/izleme-analiz/trace-client-logs-2.png" alt="İstemci Log Kayıtları 2" width="800" style={{maxWidth: '800px', width: '100%', height: 'auto'}} />

Üçüncü sekmede ise API Proxy'den istemciye döndürülen mesajın detayları vardır.

<img src="/images/develop/izleme-analiz/trace-client-logs-3.png" alt="İstemci Log Kayıtları 3" width="800" style={{maxWidth: '800px', width: '100%', height: 'auto'}} />
...
<img src="/images/develop/izleme-analiz/trace-policy-logs.png" alt="Politika Log Kayıtları" width="800" style={{maxWidth: '800px', width: '100%', height: 'auto'}} />
...
<img src="/images/develop/izleme-analiz/trace-backend-logs-1.png" alt="Backend API Log Kayıtları 1" width="800" style={{maxWidth: '800px', width: '100%', height: 'auto'}} />

İkinci sekmede Backend API'ye yapılan yönlendirme detayları görünür (yönlendirme seçenekleri için [Yönlendirme Sekmesi - HTTP (Routing Tab)](/tr/develop/yonlendirme/http-yonlendirme) bölümüne bakabilirsiniz).

<img src="/images/develop/izleme-analiz/trace-backend-logs-2.png" alt="Backend API Log Kayıtları 2" width="800" style={{maxWidth: '800px', width: '100%', height: 'auto'}} />

Üçüncü sekmede ise Backend API'den API Proxy'e döndürülen mesajın detayları vardır.

<img src="/images/develop/izleme-analiz/trace-backend-logs-3.png" alt="Backend API Log Kayıtları 3" width="800" style={{maxWidth: '800px', width: '100%', height: 'auto'}} />

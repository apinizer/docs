...
:::note Span'ler her proxy türünü kapsar, OTLP metrikleri kapsamaz
...
<Steps>
  ...
  <Step title="Bağlantıyı test edin">
    Connector'ün üst aksiyon şeridinden bir ortam seçin, ardından yanındaki **Bağlantıyı Test Et**'i kullanın. Bu bir TCP ping değildir — Apinizer kaydedilmiş ayarlardan geçici bir dışa aktarıcı kurar ve toplayıcıya gerçek bir sentetik span gönderir; böylece toplayıcının Apinizer'ın OTLP yükünü (kimlik doğrulama, TLS ve yol dahil) gerçekten kabul ettiği, dağıtımdan önce kanıtlanır.
  </Step>

...
| **Dialog Erişimi**    | Var — sayfa üstündeki araç çubuğunda kod ikonlu **"Ortam"** butonuna tıklandığında **"Ortam Değişkeni Seç"** penceresi açılır; listeden bir değişkene tıklandığında değeri (`${değişkenAdı}` biçiminde) panoya kopyalanır ve ilgili alana elle yapıştırılır (alan bazında otomatik doldurma yoktur, buton sayfa geneli tek bir giriş noktasıdır) |

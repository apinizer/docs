...
| Özellik              | Açıklama                                                        |
| -------------------- | ---------------------------------------------------------------- |
| **Konum**            | **MCP Gateway** — bir MCP proxy'sinin MCP Routing sekmesi ya da MCP Araç Çağrısı / MCP Araç Çağırma politikasının satır içi sunucu alanları (Uç Nokta, Bearer Token veya OAuth2 istemci kimlik bilgileri) · **A2A Gateway** — bir A2A proxy'sinin A2A Routing sekmesi ya da A2A Ajan Çağrısı / A2A Ajan Çağırma politikasının satır içi ajan alanları (Uç Nokta, Bearer Token veya OAuth2 istemci kimlik bilgileri) · **AI Gateway > LLM Sağlayıcılar** (Uç Nokta URL, API Anahtarı, API Gizli Anahtarı, Organizasyon ID) · **AI Gateway > RAG > Vector Veritabanları** tab'ı (Varsayılan Koleksiyon Adı) |

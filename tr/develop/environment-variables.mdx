...
:::                                                                                                                                                                                                      |
| Adım 4: Değer Tanımlama             | **Environment-Specific Değişkenler İçin:**<br/>**Ortam Ekleme**: "Ortam Ekle" butonuna tıklayarak yeni ortam ekleyin<br/>**Ortam Seçimi**: Her değer için bir ortam seçin<br/>Mevcut ortamlar listeden seçilir<br/>"Custom..." seçeneği ile özel ortam adı girilebilir<br/>**Değer Girme**: Her ortam için değer girin<br/>**Secret Ayarlama**: Hassas bilgiler için "Secret" checkbox'ını işaretleyin<br/>Secret değerler kaydedildikten sonra maskelenir (\*\*\*\*\*\*\*\*\*\*\*\*)<br/>Secret değerler şifrelenerek saklanır<br/>Güncelleme sırasında değer değiştirilmemişse mevcut değer korunur<br/><br/>**Global Değişkenler İçin:**<br/>**Global Değer**: Tek bir değer girin (tüm ortamlar için geçerli)<br/>**Secret Ayarlama**: Hassas bilgiler için "Secret" checkbox'ını işaretleyin |
...
| Özellik              | Açıklama                                                        |
| -------------------- | ---------------------------------------------------------------- |
| **Konum**            | **MCP Gateway** — bir MCP Gateway'inin MCP Routing sekmesi ya da MCP Araç Çağrısı / MCP Araç Çağırma politikasının satır içi sunucu alanları (Uç Nokta, Bearer Token veya OAuth2 istemci kimlik bilgileri) · **A2A Gateway** — bir A2A Gateway'inin A2A Routing sekmesi ya da A2A Ajan Çağrısı / A2A Ajan Çağırma politikasının satır içi ajan alanları (Uç Nokta, Bearer Token veya OAuth2 istemci kimlik bilgileri) · **AI Gateway > LLM Sağlayıcılar** (Uç Nokta URL, API Anahtarı, API Gizli Anahtarı, Organizasyon ID) · **AI Gateway > RAG > Vector Veritabanları** tab'ı (Varsayılan Koleksiyon Adı) |

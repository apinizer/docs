---
title: "Test Console"
description: "Postman veya SOAP UI gibi harici araçlar kullanmadan SOAP ve REST API'leri test edebilirsiniz, test senaryolarını kaydedebilirsiniz, teyit (assertion) tanımlayabilirsiniz, istek ve yanıtları inceleyebilirsiniz ve ortam değişkenlerini yönetebilirsiniz."
---
...
<Frame caption="Test Konsolu">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-1.png" alt="Test Konsolu" width="800" />
</Frame>
...
<CardGroup cols={3}>
  ...
  <Card title="Yanıt" icon="arrow-left">
...
<Frame caption="Test Helper Butonu">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-2.png" alt="Test Helper butonu" width="600" />
</Frame>

<Frame caption="Test Helper Ayarları">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-3.png" alt="Test Helper ayarları" width="600" />
</Frame>
...
| Alan | Açıklama |
|------|----------|
| **İstek Tipi**  | Proxy, Proxy Group, Swagger, OpenApi, WADL, WSDL seçeneklerinden biri seçilerek test edilecek API tipi belirlenir. Bu tipler:<br/><br/>**Proxy, Proxy Group**<br/><br/>Bu tipler, Apinizer üzerinde seçili projenizde bulunan API Proxy'ler test edilmek istendiğinde seçilir.<br/><br/>Ayrıca, seçili API Proxy'nin deploy edildiği ortamlardan test edilir.<br/><br/>**Swagger, OpenApi, WADL, WSDL**<br/><br/>Bu tipler, API tanım dosyası üzerinden test yapılmak istendiğinde seçilir. |
| **Proxy Grup Listesi**  | Aynı proje içindeki test edilebilecek API Proxy grupları listelenir. |
| **Proxy Listesi**  | Aynı proje içindeki test edilebilecek API Proxy'ler listelenir.<br/><br/>Proxy'nin test edilebilmesi için deploy edilmiş olması gerekir. |
...
<Frame caption="Sorgu Parametresi Ekleme">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-4.png" alt="Sorgu Parametresi Ekleme" width="600" />
</Frame>
...
<Frame caption="Başlık Ekleme">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-5.png" alt="Başlık Ekleme" width="600" />
</Frame>
...
<Frame caption="Gövde Ekleme">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-6.png" alt="Gövde Ekleme" width="600" />
</Frame>
...
<Frame caption="Format XML">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-7.png" alt="Format XML" width="600" />
</Frame>
...
<Frame caption="Format JSON">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-8.png" alt="Format JSON" width="600" />
</Frame>

#### WS Security İmzala

<a id="ws-security-imza"></a>
...
<Frame caption="WS Security İmzala">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-9.png" alt="WS Security İmzala" width="600" />
</Frame>
...
<Frame caption="WS Security İmzala Ayarları">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-10.png" alt="WS Security İmzala ayarları" width="600" />
</Frame>
...
| **WS Encryption Part** | Verinin nerelerinin imzalanacağı bilgisidir. Birden fazla değer girilebilir.<br/><br/>İmzalanacak XML elemanı adı, XML elemanının namespace bilgisi ve Element olarak mı İçerik olarak mı imzalanacağı bilgisidir. |
...
<Frame caption="JSON İmzala">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-12.png" alt="JSON İmzala" width="600" />
</Frame>
...
<Frame caption="JSON İmzala Ayarları">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-11.png" alt="JSON İmzala ayarları" width="600" />
</Frame>
...
<Frame caption="Teyit Oluşturma">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-13.png" alt="Teyit Oluşturma" width="600" />
</Frame>
...
<Frame caption="Güvenli Bağlantı Ayarları">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-secure-connection-settings.png" alt="Test Konsolu Ayarlar sekmesi - Güvenli Bağlantı Ayarları" width="1000" />
</Frame>
...
Aşağıdaki başlıkların sağındaki **+** ile paneller açılır; TrustStore, PEM sertifikası, istemci KeyStore ve protokol/hostname doğrulaması bu paneller üzerinden yapılandırılır:
...
Sunucu sertifikasını doğrulamak için kullanılır:
...
PEM formatında sertifika kullanımı:
...
Hedef sunucu mTLS doğrulaması istiyorsa istemci sertifikası gönderimi:
...
Yüklenen TrustStore, Sertifika veya KeyStore dosyasını daha sonra diğer ekranlarda kullanmak için **KeyStore Havuzuna Ekle** veya **Sertifika Havuzuna Ekle** seçeneğini işaretleyip bir isim verebilirsiniz.

:::

:::info

KeyStore ve TrustStore havuzu hakkında detaylı bilgi için [Key Stores](/tr/admin/secrets-management/keystore-yonetimi) sayfasına bakınız.
...
<Frame caption="Code Snippet">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-15.png" alt="Code Snippet" width="600" />
</Frame>
...
<Frame caption="Yeni Test Oluşturma">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-16.png" alt="Yeni Test Oluşturma" width="600" />
</Frame>
...
<Frame caption="Yanıt Gövdesi">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-17.png" alt="Yanıt Gövdesi" width="600" />
</Frame>
...
<Frame caption="İstek Yanıtı Başlıkları">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-18.png" alt="İstek Yanıtı Başlıkları" width="600" />
</Frame>
...
<Frame caption="Teyit Sonuçları">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-19.png" alt="Teyit Sonuçları" width="600" />
</Frame>
...
<Frame caption="Yanıt Logları">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-20.png" alt="Yanıt Logları" width="600" />
</Frame>

## Geçmiş

Test Konsolu'nda test edilen her isteğin geçmişi saklanır. Testin geçmişi, test edildikleri günlere göre kategorilere ayrılır.

Testin loguna ait linke tıklandığında, istek tekrar test edilebilir.

<Frame caption="Test Geçmişi">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-21.png" alt="Test Geçmişi" width="400" />
</Frame>
...
<Frame caption="Testi Koleksiyona Kaydetme">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-22.png" alt="Testi Koleksiyona Kaydetme" width="600" />
</Frame>

Sonrasında açılan **Koleksiyon Listesi ** adlı dialogda testin atanacağı koleksiyonun linkine tıklanır.
...
<Frame caption="Koleksiyon Listesi">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-23.png" alt="Koleksiyon Listesi" width="400" />
</Frame>
...
<Frame caption="Koleksiyon Bazlı İşlemler">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-24.png" alt="Koleksiyon Bazlı İşlemler" width="300" />
</Frame>

**Yeniden Adlandır:** İlgili koleksiyonun adını değiştirmek için kullanılır. Tıklandığında çıkan ekrana yeni ad verilir ve kaydedilir.

**Yeni Koleksiyon Ekle:** İlgili koleksiyonun içine yeni bir koleksiyon eklenmek için kullanılır.

**Koleksiyonu Sil:** İlgili koleksiyonu silmek için kullanılır. Eğer bir koleksiyonu silinirse, ilgili koleksiyona bağlı bütün kayıtlar silinecektir.

### Koleksiyonu Dışa/İçe Aktarma

**Koleksiyonu Dışa Aktar** artık iki biçimli bir menü açar:

- **Apinizer paketi (.zip)** — [Dışa/İçe Aktarma Sihirbazı](/tr/admin/secrets-management/export-import)'na, koleksiyon Test Koleksiyonu tipiyle ön-seçili olarak açılır; sihirbazın Replace/Import as New, bağımlılık eşleme ve testleri silme önizlemesi yetenekleri kullanılabilir. Alt koleksiyonlu bir ağacı taşımak için sihirbazın nesne listesinden alt koleksiyonları da işaretlemeniz gerekir.
- **Postman / Testnizer (.json)** — önceki sürümdeki tek biçim; bu yetenek **kaldırılmadı**, biçim menüsünün ikinci kalemi oldu.

**Koleksiyon İçe Aktar** düğmesi de aynı şekilde iki seçenekli bir pencere açar: **Apinizer paketi (.zip)** seçilirse sihirbazın ilgili adımına yönlendirilirsiniz; **Postman / Testnizer (.json)** seçilirse önceki satır içi içe aktarma ve sonuç raporu akışı aynen çalışır. Yanlış yuvaya dosya seçmek — JSON yuvasına bir .zip, sihirbaza bir Postman/Testnizer .json — artık anlamsız bir hata yerine doğru yere yönlendiren bir bilgi mesajı verir.

Apinizer paketi seçenekleri yalnızca **Dışa/İçe Aktarma** yetkisi (API Yönetimi veya Proje Yönetimi kategorisinde) olan kullanıcılara görünür; bu yetkisi olmayan kullanıcı yalnızca Postman/Testnizer seçeneğini görür.

:::note
Sihirbazın taşıdığı Apinizer paketi, bir klasör ve o klasörün doğrudan testlerini kapsar (alt koleksiyonlar ayrıca seçilmelidir); Postman biçimi ise alt ağacın tamamını tek dosyada taşır. İki biçim de doğru şekilde geri alınabilir, ancak iç içe koleksiyon ağaçlarında kapsam farkına dikkat edin.
:::
...
<Frame caption="Kayıt Bazlı İşlemler">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-25.png" alt="Kayıt Bazlı İşlemler" width="300" />
</Frame>
...
**Create Monitor:** İlgili testi kullanarak bir Çalışma Süresi Monitörü oluşturmak için kullanılır. Detaylı bilgi almak için [Uptime Monitor](/tr/monitor/api-saglik-kontrolu) sayfasına tıklayınız.

**Delete Test:** İlgili testi silmek için kullanılır.

**Farklı Kaydetme:** Kaydedilmiş bir testi başka bir koleksiyona kaydedebilmek için görselde işaretlenen butona tıklanır.

<Frame caption="Farklı Kaydetme">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-26.png" alt="Farklı Kaydetme" width="600" />
</Frame>

...
<Frame caption="Test Konsolu">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-1.png" alt="Test Konsolu" width="800" height="600" />
</Frame>
...
<Frame caption="Test Helper Butonu">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-2.png" alt="Test Helper butonu" width="600" height="400" />
</Frame>

<Frame caption="Test Helper Ayarları">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-3.png" alt="Test Helper ayarları" width="600" height="500" />
</Frame>
...
<Frame caption="Sorgu Parametresi Ekleme">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-4.png" alt="Sorgu Parametresi Ekleme" width="600" height="400" />
</Frame>
...
<Frame caption="Başlık Ekleme">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-5.png" alt="Başlık Ekleme" width="600" height="400" />
</Frame>
...
<Frame caption="Gövde Ekleme">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-6.png" alt="Gövde Ekleme" width="600" height="400" />
</Frame>
...
<Frame caption="WS Security İmzala">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-9.png" alt="WS Security İmzala" width="600" height="400" />
</Frame>
...
<Frame caption="WS Security İmzala Ayarları">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-10.png" alt="WS Security İmzala ayarları" width="600" height="500" />
</Frame>
...
<Frame caption="JSON İmzala">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-12.png" alt="JSON İmzala" width="600" height="400" />
</Frame>
...
<Frame caption="JSON İmzala Ayarları">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-11.png" alt="JSON İmzala ayarları" width="600" height="500" />
</Frame>
...
<Frame caption="Teyit Oluşturma">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-13.png" alt="Teyit Oluşturma" width="600" height="500" />
</Frame>
...
Ayarlar tabında zaman aşımı ve güvenli bağlantı (SSL/TLS/mTLS) ayarları yönetilir.

<Frame caption="Ayarlar - Güvenli Bağlantı Ayarları">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-settings-secure.png" alt="Güvenli Bağlantı Ayarları" width="900" height="500" />
</Frame>

**Güvenli Bağlantı Ayarları** bölümünde aşağıdaki özellikler bulunur:

* **Etkinleştir**: Güvenli bağlantı ayarlarını açıp kapatır. Etkinleştirildiğinde KeyStore ve TrustStore ile mTLS tabanlı kimlik doğrulaması yapılandırılabilir.
* **Yapılandır**: Tıklandığında **Güvenli Bağlantı Ayarlarını Düzenle** penceresi açılır.

Ayarlar sekmesinde Connection Timeout, KeyStore, TrustStore, Desteklenen Protokoller ve Hostname Verifier gibi güncel yapılandırma özeti gösterilir.

<Frame caption="Güvenli Bağlantı Ayarlarını Düzenle">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-settings-edit.png" alt="Güvenli Bağlantı Ayarlarını Düzenle" width="900" height="600" />
</Frame>
...
| Alan | Açıklama |
|------|----------|
| **Zaman Aşımı** | İstek gönderildikten sonra yanıt beklenen süre. |
| **SSL Doğrulamayı Atla** | İşaretlendiğinde sunucu sertifikası doğrulanmaz. Self-signed sertifika kullanan ortamlar için kullanışlıdır. Etkin olduğunda TrustStore, Sertifika ve KeyStore panelleri gizlenir. |
| **Bağlantı Zaman Aşımı** | SSL/mTLS bağlantısı için beklenecek azami süre (saniye). SSL/mTLS etkinken genel zaman aşımını geçersiz kılar. |
...
<Frame caption="Yeni Test Oluşturma">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-16.png" alt="Yeni Test Oluşturma" width="600" height="400" />
</Frame>
...
<Frame caption="Yanıt Gövdesi">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-17.png" alt="Yanıt Gövdesi" width="600" height="400" />
</Frame>
...
<Frame caption="İstek Yanıtı Başlıkları">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-18.png" alt="İstek Yanıtı Başlıkları" width="600" height="400" />
</Frame>
...
<Frame caption="Teyit Sonuçları">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-19.png" alt="Teyit Sonuçları" width="600" height="400" />
</Frame>
...
<Frame caption="Yanıt Logları">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-20.png" alt="Yanıt Logları" width="600" height="400" />
</Frame>
...
<Frame caption="Test Geçmişi">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-21.png" alt="Test Geçmişi" width="400" height="500" />
</Frame>
...
<Frame caption="Testi Koleksiyona Kaydetme">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-22.png" alt="Testi Koleksiyona Kaydetme" width="600" height="400" />
</Frame>
...
<Frame caption="Koleksiyon Listesi">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-23.png" alt="Koleksiyon Listesi" width="400" height="500" />
</Frame>
...
<Frame caption="Koleksiyon Bazlı İşlemler">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-24.png" alt="Koleksiyon Bazlı İşlemler" width="300" height="400" />
</Frame>
...
<Frame caption="Kayıt Bazlı İşlemler">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-25.png" alt="Kayıt Bazlı İşlemler" width="300" height="400" />
</Frame>
...
<Frame caption="Farklı Kaydetme">
  <img src="/images/develop/test-debug-araclari/test-console/test-console-26.png" alt="Farklı Kaydetme" width="600" height="400" />
</Frame>

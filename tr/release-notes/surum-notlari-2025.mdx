...
API Portal'e yapay zeka destekli bir chatbot entegresi sağlandı. [Bkz.](/tr/api-portal/api-portal-ayarlari)
...
API Portal'a çerezler yönetimi eklendi. [Bkz.](/tr/api-portal/api-portal-ayarlari)
...
- API Proxy'lere bakım modu özelliği eklendi. [Bkz.](/tr/develop/api-proxy-konfigurasyonu/settings#api-bakım-modu)
...
- Log yapısına location verisi eklendi. Bu veri içerisinde latitude (enlem) ve longitude (boylam) alanları bulunmaktadır. [Bkz.](/tr/analytic/api-trafigi-log-kaydi-veri-yapisi#veri-yapısı-alanları)

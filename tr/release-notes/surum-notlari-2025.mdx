...
- API Proxy'lere bakım modu özelliği eklendi. [Bkz.](/tr/gelistirici/api-proxy-konfigurasyonu/settings#api-bakim-modu)

- Deployment süresi için timeout değerleri, parametrik olarak yapılandırılabilir hale getirildi. [Bkz.](/tr/admin/sunucu-yonetimi/ag-gecidi-ortamlari)

- TLS ayarları JVM parametreleri ile parametrik verilebilir hale getirildi. [Bkz.](/tr/admin/sunucu-yonetimi/ag-gecidi-ortamlari#guvenlik-yapilandirmasi)

...
## Sürüm 2025.11.0
<span className="text-green-600">ÖNE ÇIKAN YENİ ÖZELLİK</span>
...
- Api Manager ile yapılabilen işlevselliğin tamamına yakınının Management API'ler ile yapılabilmesi sağlandı ve tüm dökümantasyonu yenilendi.

<span className="text-green-600">YENİ ÖZELLİK</span>
...
API Portal üzerinde İngilizce sayfa içerikleri için özel alanlar tanımlandı. Böylece her sayfanın başlık, açıklama ve metin içerikleri çok dilli olarak ayrı ayrı girilebilmekte ve Portal arayüzü üzerinden yönetilebilmesi sağlandı. Bkz.
...
<span className="text-blue-600">ÖNEMLİ DEĞİŞİKLİKLER VE İYİLEŞTİRMELER</span>
...
<span className="text-red-700">HATA DÜZELTMELERİ</span>

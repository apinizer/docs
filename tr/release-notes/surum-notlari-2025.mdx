...
- Api Manager ile yapılabilen işlevselliğin tamamına yakınının Management API'ler ile yapılabilmesi sağlandı ve tüm dökümantasyonu yenilendi. [Bkz.](/api-reference/api-proxies/deployment/deploy-api-proxy.mdx)
...
Toplam 107 Management API Endpoint ile 163 farklı özellik yapılandırması hizmete açıldı. [Bkz.](/api-reference/api-proxies/deployment/deploy-api-proxy.mdx)
...
Birden fazla lokasyondaki Kubernetes kümelerinde Active-Active mimari ile yüksek erişilebilirlik ve bölgesel yük dağılımı desteği eklendi. [Bkz.](/tr/setup/apinizer/multi-region)

...
Sistem altyapısına FTP Connection desteği eklendi. [Bkz.](/tr/entegrasyon/baglanti-yonetimi/ftp)

- ### FTP Connector'a "Read" ve "List" İşlevleri Eklendi

FTP Connector artık dosya okuma (Read) ve listeleme (List) işlemlerini desteklemektedir. [Bkz. Read](/tr/entegrasyon/konnektorler/ftp-read-konnektor) [Bkz. List](/tr/entegrasyon/konnektorler/ftp-list-konnektor)

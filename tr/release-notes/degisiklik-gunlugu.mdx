...
- **Allowed IP List Politikası Ekleme Ekranında Silinmiş IP Beyaz Listesi Referansı Hatası Düzeltildi**

API proxy politikalarında Allowed IP List global politikası ekleme veya düzenleme ekranında, daha önce seçilmiş ancak sonradan silinmiş bir IP beyaz listesine başvurulduğunda kullanıcıya hata mesajı gösterilmesi sorunu giderildi. Eksik referans durumunda hata bildirimi bastırılarak ekran sorunsuz biçimde açılır ve kullanıcı yeni bir IP beyaz listesi seçimini sürdürebilir. APNZ-6192

...
- **Dağıtık Cache Listesinde Bellek Birimi Yanlış Görüntüleniyor**

Administration > Gateway Infrastructure > Distributed Cache sayfasındaki listede, GB olarak yapılandırılan bellek değerlerinin MB olarak gösterilmesi sorunu giderildi. Bellek birimi etiketi artık yapılandırılan değerle tutarlı şekilde gösterilir; mevcut Cache Server yapılandırmalarında herhangi bir değişiklik yapılması gerekmez. APNZ-6244

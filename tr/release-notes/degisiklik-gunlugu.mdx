...
- **İstek Atmayan Client'lar Raporunda JOSE Doğrulamayla Engellenen İstekler Doğru Sayılıyor**

İstek Atmayan Client'lar raporundaki Engellenen sütunu, JOSE Doğrulama politikası tarafından reddedilen istekleri artık doğru biçimde içerir. Önceden bu istekler Hata olarak sınıflandırılıyor ve raporda Engellenen sütununa yansımıyordu; bu nedenle yalnızca JOSE Doğrulama ile engellenen istemciler "istek atmayan" listesinde görünmeye devam edebiliyordu. Düzeltme ile JOSE doğrulaması başarısız olan istekler rapor genelinde tutarlı biçimde Engellenen kategorisinde sayılır. [Bkz.](/tr/analytic/analytics-reports/istek-atmayan-client'lar) APNZ-6242

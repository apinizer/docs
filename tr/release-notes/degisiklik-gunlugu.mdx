...
**APNZ-6403** : API Proxy Grubu sayfasında bir gruba aynı anda birden fazla API Proxy eklenmek istendiğinde işlem hata ile sonuçlanıyor ve seçilen proxy'ler gruba eklenemiyordu. Bir gruba artık aynı anda birden fazla API Proxy sorunsuz biçimde eklenebiliyor.

...
- **API Yönlendirme Application Logs Sekmesinde Environment Filtresinin Boş Gelmesi**

API yönlendirme detay ekranındaki **Application Logs** sekmesinde **Environment** filtresine tıklandığında listenin boş gelmesi (**No results found**) ve dolayısıyla uygulama loglarının görüntülenememesi sorunu giderildi. Filtre artık ekranı açan yönlendirmenin ait olduğu projeye bağlı ortamları doğru biçimde listeler ve seçilen ortamın logları ekrana düşer. APNZ-6245

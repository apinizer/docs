...
- **API Trafik Arama Alanlarına Wildcard ve Büyük/Küçük Harf İpucu**

API Trafik ekranındaki Routing Address, From Client Body, To Backend API Body, From Backend API Body ve To Client Body arama alanlarına; wildcard kullanımı (`*partNo=123*`) ve büyük/küçük harf duyarlılığı hakkında tooltip eklendi. Backend zaten otomatik wildcard sarmalama uyguluyordu fakat kullanıcıya bu yetenek görünür değildi. APNZ-6236

...
**APNZ-6244** : Administration > Gateway Infrastructure > Distributed Cache sayfasındaki listede, GB olarak yapılandırılan bellek değerlerinin MB olarak gösterilmesi sorunu giderildi. Bellek birimi etiketi artık yapılandırılan değerle tutarlı şekilde gösterilir; mevcut Cache Server yapılandırmalarında herhangi bir değişiklik yapılması gerekmez.
...
- **WS Security To Target Politikası "Ad" Alanı Düzeltildi**

WS Security To Target politikası oluşturma ekranında "Ad" alanının otomatik olarak varsayılan bir değerle dolu gelmesi sorunu giderildi. Yeni politika oluşturulurken alan artık boş gelir ve kullanıcı tarafından belirlenen değer korunur. APNZ-6148

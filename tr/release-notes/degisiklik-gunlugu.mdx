...
- **Portal Sayfa Diyaloğunda Seçilen Dosya İptal Edilebilir**

API Portal arayüzünde sayfa oluşturma ve düzenleme diyaloğundaki dosya yükleme alanına bir dosya seçildikten sonra seçimin iptal edilememesi sorunu giderildi. Seçilen dosya adının yanında artık temizleme butonu görüntülenir; butona tıklandığında alan yeniden boş "Dosya Yükle" durumuna döner ve farklı bir dosya seçilebilir. Düzeltme hem varsayılan dil hem ikincil dil dosya alanlarında geçerlidir. APNZ-6181

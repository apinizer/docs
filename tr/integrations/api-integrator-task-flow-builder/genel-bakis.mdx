...
<CardGroup cols={2}>
  <Card title="Görev Akışı Oluşturma" icon="plus-circle" href="/tr/integrations/api-integrator-task-flow-builder/task-flow-tasarimi">
    Görev akışı oluşturma ve görev tipleri hakkında detaylı bilgi almak için tıklayınız.
  </Card>

  <Card title="Log Detayları" icon="file-search" href="/tr/integrations/api-integrator-task-flow-builder/taskflow-monitor">

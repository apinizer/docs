...
<Steps>
    <Step title="Task Flows Sayfasına Git">
        Ekranınızda solda bulunan navigasyon çubuğundan **Development** sekmesi altında bulunan **API Integration** içerisindeki **Task Flows** sayfasına gidin.
            ...
            <img src="/images/develop/api-integrator/task-flow1.png" alt="Task Flows Listesi" width="800" />
    ...
    <Step title="Görev Akışını İsimlendir ve Kaydet">
        ...
        <img src="/images/develop/api-integrator/task-flow2.png" alt="Görev Akışı Oluşturma Formu" width="800" />
    </Step>
</Steps>
...
<img src="/images/develop/api-integrator/task-flow3.png" alt="Görev Akışı Konfigürasyon Ekranı" width="800" />
...
<Steps>
    ...
    <Step title="Değer ve Birim Alanlarını Doldur">
        ...
        <img src="/images/develop/api-integrator/task-flow5.png" alt="Görev Akışı Tanım Ayarları" width="800" />
...
<img src="/images/develop/api-integrator/task-flow6.png" alt="Görev Akışı Tanım Ayarları" width="800" />

<img src="/images/develop/api-integrator/task-flow7.png" alt="Görev Akışı Tanım Ayarları Detay" width="800" />
...
<CardGroup cols={3}>
    <Card title="E-Posta Gönderme" icon="envelope" href="/tr/integrations/konnektorler/email-konnektor">
        E-posta gönderimi için kullanılır
    </Card>

    <Card title="API Çağrısı (API Call)" icon="globe" href="/tr/integrations/konnektorler/api-call-konnektor">
        Harici API'lere istek göndermek için kullanılır
    </Card>

    <Card title="Veritabanı Connector" icon="database" href="/tr/integrations/konnektorler/database-konnektor">
        Veritabanı işlemleri için kullanılır
    </Card>

    <Card title="Linux Script Çalıştırma" icon="terminal" href="/tr/integrations/konnektorler/linux-script-konnektor">
        Linux komutları çalıştırmak için kullanılır
    </Card>

    <Card title="Script (JS/Groovy)" icon="code" href="/tr/integrations/konnektorler/script-konnektor">
        JavaScript veya Groovy script çalıştırmak için kullanılır
    </Card>

    <Card title="Bildirim" icon="bell" href="/tr/integrations/konnektorler/notification-konnektor">
        Bildirim göndermek için kullanılır
    </Card>

    <Card title="SNMP" icon="network-wired" href="/tr/integrations/konnektorler/snmp-konnektor">
...
<Steps>
    <Step title="Görev Ekleme Butonuna Tıkla">
        ...
        <img src="/images/develop/api-integrator/task-flow8.png" alt="Görev Ekleme" width="800" />
    </Step>
    ...
    <Step title="Görev Tipini Seç">
        ...
        <img src="/images/develop/api-integrator/task-flow9.png" alt="Görev Seçimi" width="800" />
        Hangi görev eklenmek isteniyorsa o görev seçilerek görev tanımlama işlemine devam edilir.
        <img src="/images/develop/api-integrator/task-flow10.png" alt="Görev Seçimi" width="800" />
    </Step>
...
:::
        ...
        <img src="/images/develop/api-integrator/task-flow11.png" alt="API Call Konfigürasyonu" width="800" />
        <img src="/images/develop/api-integrator/task-flow12.png" alt="API Call Konfigürasyonu" width="800" />
    </Step>
</Steps>
...
<img src="/images/develop/api-integrator/task-flow13.png" alt="Veri Aktarımı" width="800" />
...
<img src="/images/develop/api-integrator/task-flow14.png" alt="Output Key Kullanımı" width="800" />
...
<img src="/images/develop/api-integrator/task-flow15.png" alt="Script Değişken Erişimi" width="800" />
...
<img src="/images/develop/api-integrator/task-flow16.png" alt="Değişken Kullanımı" width="800" />
...
<img src="/images/develop/api-integrator/task-flow17.png" alt="Değişken Kullanımı" width="800" />
...
<Steps>
    <Step title="Detaylar Menüsünü Aç">
        ...
        <img src="/images/develop/api-integrator/task-flow18.png" alt="Detaylar Menüsü" width="800" />
    </Step>

    <Step title="Log Kayıtlarını İncele">
        Görev Akışının log detayını içeren ekrana ulaşılır.

        <img src="/images/develop/api-integrator/task-flow19.png" alt="Log Detayları" width="800" />
    </Step>
    ...
    <Step title="Çalışma Detaylarını Görüntüle">
        ...
        <img src="/images/develop/api-integrator/task-flow20.png" alt="Çalışma Detayları" width="800" />
    </Step>
    ...
    <Step title="Görev Çıktılarını Görüntüle">
        ...
        <img src="/images/develop/api-integrator/task-flow22.png" alt="Görev Çıktıları" width="800" />

        <img src="/images/develop/api-integrator/task-flow23.png" alt="Görev Çıktıları Detay" width="800" />

        API Call görevinin çıktısı:

        <img src="/images/develop/api-integrator/task-flow24.png" alt="API Call Görev Çıktısı" width="800" />
...
<Tabs>
    <TabItem value="soz-dizimi-1-veriyi-sorgulama" label="Söz Dizimi 1: Veriyi Sorgulama">
    ...
    <TabItem value="soz-dizimi-2-dongudeki-veriyi-kullanma" label="Söz Dizimi 2: Döngüdeki Veriyi Kullanma">
...
<Tabs>
    <TabItem value="manuel-tetikleme" label="Manuel Tetikleme">
        Sağ üst köşede bulunan işaretli **Execute** butonuna her tıklandığında görev akışı tetiklenir.

        <img src="/images/develop/api-integrator/task-flow25.png" alt="Manuel Tetikleme" width="800" />
    </TabItem>

    <TabItem value="otomatik-tetikleme" label="Otomatik Tetikleme">
        ...
        <img src="/images/develop/api-integrator/task-flow26.png" alt="Otomatik Tetikleme" width="800" />
    </TabItem>

    <TabItem value="endpoint-uzerinden-tetikleme" label="Endpoint Üzerinden Tetikleme">
        ...
        <img src="/images/develop/api-integrator/task-flow27.png" alt="Endpoint Tetikleme" width="800" />
...
<img src="/images/develop/api-integrator/task-flow28.png" alt="Görev Akışını Silme" width="800" />
...
<Steps>
    ...
    <Step title="Token Oluştur">
        ...
        Token bir kullanıcıya aittir; o kullanıcı kilitlendiğinde veya pasifleştirildiğinde, token iptal edildiğinde ya da geçerlilik tarihine ulaştığında çalışmayı bırakır.

        Token, **APINIZER-TOKEN** header'ı ile de gönderilebilir. İstemci `Authorization` header'ını başka bir şeyle dolduruyorsa — tarayıcı oturumu, kayıtlı bir Basic kimlik bilgisi ya da kendi header'ını ekleyen bir ters vekil sunucu — token'ı bu header ile gönderin; böylece görev akışı token'ı diğerinin arkasında kalmaz.
    </Step>
</Steps>

:::note

Endpoint yalnızca yukarıdaki seçenek açıkken yanıt verir. Endpoint'i aktifleştirilmemiş bir görev akışı, geçerli bir token ile bile HTTP üzerinden tetiklenemez; istek, görev akışı hiç yokmuş gibi yanıtlanır. Yayımlanmış bir görev akışını geri çekmek için bu seçeneği kapatmak yeterlidir.

:::

:::info

İstek, görev akışı aranmadan önce kimlik doğrulamasından geçer; bu nedenle geçerli token'ı olmayan bir çağrı her zaman `401` alır ve hangi görev akışlarının var olduğuna dair hiçbir bilgi edinemez. Geçerli bir token ile, var olmayan bir görev akışı ile endpoint'i kapalı bir görev akışı birebir aynı şekilde `404` döner. Çağrının tamamı — kabul edilen header'lar, kontrol sırası ve tüm yanıt kodları — [Task Flow Trigger Endpoint](/api-reference/integration-task-flow-endpoint) sayfasında belgelenmiştir.
...
<Steps>
    <Step title="Eylem Ekleme">
        **Eylemler (Actions)** bölümünden **+** butonuna basılarak olası bir hata durumunda gerçekleşmesi istenen görevleri tanımlayabilirsiniz.
        ...
        <img src="/images/develop/api-integrator/task-flow30.png" alt="Eylem Ekleme" width="800" />
    </Step>
    ...
    <Step title="Eylem Tipini Seç">
        ...
        <img src="/images/develop/api-integrator/task-flow31.png" alt="Eylem Tipi Seçimi" width="800" />
    </Step>
</Steps>

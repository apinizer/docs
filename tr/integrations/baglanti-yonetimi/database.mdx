    ...
    <Accordion title="Timeout ve Connection Pool Parametreleri">
        <CardGroup cols={2}>
            ...
            <Card title="Pool Size" icon="layer-group">
                ...
                **Varsayılan:** 5
                **Notlar:** UI'da `min: 1` zorunluluğu yalnızca Initial Pool Size ve Min Pool Size alanlarında var; Max Pool Size alanında min/max sınırı yok.
                **Birim:** adet
            </Card>
...
<img
    src="/images/yonetici/baglantilar/database-variable-new.png"
    ...
    <Accordion title="İçe Aktarma (Import)">
        <CardGroup cols={2}>
            <Card title="İçe Aktarma Adımları" icon="upload">
                - Ana listedeki **[Import Veritabanı Connection Havuzu]** butonuna tıklayın — bu buton artık tip **Bağlantı (Connection)** ön-seçili olarak Dışa/İçe Aktarma Sihirbazı'nın içe aktarma adımını açar (Administration'dan açıldığında Admin kapsamında); eski yükleme diyaloğu kaldırıldı.
...
Tablo yapısı referansı için [Apinizer Logları için Tablo Oluşturma Komutları](/tr/operations/yonetici-kilavuzlari/apinizer-log-tablolari-olusturma-komutlari) sayfasına bakın.
...
## Best Practices
    ...
    <Accordion title="Yapılması Gerekenler ve En İyi Uygulamalar">
        <CardGroup cols={2}>
            <Card title="Pool Kapasite Planlama" icon="layer-group">
                ...
                **En İyi:** Trafiğe göre Max Pool Size değerini ayarlayıp Increment Count ile elastik ölçekleme sağlamak.
            </Card>
    ...
    <Accordion title="Kaçınılması Gerekenler">
        <CardGroup cols={2}>
            ...
            <Card title="Havuzu Yanlış Boyutlandırma" icon="layer-group">
                **Neden kaçınılmalı:** Connection pool her zaman aktiftir; Max Pool Size trafiğe göre çok düşük ayarlanırsa istekler havuz boşalana kadar bekler, çok yüksek ayarlanırsa hedef veritabanında gereksiz oturum açılır ve kaynaklar tükenir.
                **Alternatif:** Initial Pool Size / Min Pool Size / Max Pool Size / Increment Count değerlerini trafik hacmine göre belirleyin, Idle Connection Test Period ve Max Idle Time ile boşta kalan bağlantıları düzenli tahliye edin.
            </Card>
        </CardGroup>
    </Accordion>
...
<CardGroup cols={2}>
    ...
    <Card title="Connection Pool Optimizasyonu" icon="layer-group">
        **Öneri:** Max Pool Size değerini trafik hacmine göre ayarlayın, Idle Connection Test Period ve Max Idle Time değerlerini bağlantı sağlığına göre belirleyin.
        **Etki:** Bağlantı açma maliyeti azalır, yanıt süreleri düşer, kaynak kullanımı optimize edilir.
    </Card>
...
:::
        ...
        <Steps>
            <Step title="Pool Size">
                Max Pool Size değerini artırın.
            </Step>

...
## Teknik Özellikler ve Yetenekler
  ...
  <Accordion title="Temel Özellikler">
    <CardGroup cols={2}>
      ...
      <Card title="Bağlantı Havuzu ve TLS Kontrolü" icon="shield-check">
      ...
      <Card title="Ayrıştırılmış Zaman Aşımları" icon="timer">
        Bağlantı kurma, yanıt bekleme ve gövde gönderimi için ayrı zaman aşımı süreleri tanımlanabilir.
      </Card>

      <Card title="Toplu Gönderim, Sıkıştırma ve Splunk HEC" icon="package-check">
...
<CardGroup cols={2}>
  ...
  <Card title="Bağlantı Havuzu - Host Başına" icon="network-wired">
  ...
  <Card title="Bağlantı Havuzu - Toplam" icon="layers">
    **Açıklama:** Bu Connection için havuzdaki maksimum toplam bağlantı sayısı  
    **Varsayılan:** 48  
    **Kural:** Host başına değerinden küçük olamaz  
    **Birim:** adet
  </Card>
</CardGroup>
...
Zorunlu **Timeout** alanı tüm bağlantı aşamaları için tek bir değer sağlar. Aşağıdaki alanlar boş bırakılırsa bu tek değere düşer; doldurulduğunda ilgili aşamayı ayrı ayrı sınırlandırır:

<CardGroup cols={2}>
  <Card title="Bağlantı Kurma Süresi" icon="clock">
    TCP bağlantısının kurulması için beklenecek süre. Boşsa Timeout değerine düşer.
  </Card>

  <Card title="Yanıt Süresi" icon="hourglass">
    Sunucudan yanıtın tamamlanması için beklenecek süre. Boşsa Timeout değerine düşer.
  </Card>

  <Card title="Bağlantı İsteği Süresi" icon="timer">
    Havuzdan boş bir bağlantı alınması için beklenecek süre. Boşsa Timeout değerine düşer.
  </Card>

  <Card title="Soket Süresi" icon="plug-zap">
    Veri okuma/yazma sırasında soket üzerinde beklenecek süre. Boşsa Timeout değerine düşer.
  </Card>

  <Card title="Gövde Gönderim Fren Süresi" icon="octagon-alert">
    **Açıklama:** İstek gövdesinin gönderimi bu süreyi aşarsa istek iptal edilir  
    **Varsayılan:** 30 saniye  
    **Not:** 0 veya negatif değer verildiğinde bu koruma devre dışı kalır
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Tampon Doluyken Bekleme Süresi" icon="timer">
    **Açıklama:** Tampon doluyken gönderen tarafın bekleyeceği en fazla süre. Bu süre dolduğunda kayıt failover connector'a yönlendirilir. Toplu gönderimdeki bekleme süresinden bağımsız çalışır.  
...
<CardGroup cols={2}>
  <Card title="Maksimum Yeniden Deneme Sayısı" icon="rotate-ccw">
    **Açıklama:** Başarısız bir çağrının en fazla kaç kez tekrar denenmesi  
    **Varsayılan:** 1
  </Card>

  <Card title="Yeniden Deneme Bekleme Süresi" icon="hourglass">
    **Açıklama:** Denemeler arasındaki bekleme süresi  
    **Varsayılan:** 200 milisaniye
  </Card>

  <Card title="Maksimum Retry-After Süresi" icon="clock-alert">
    **Açıklama:** Sunucu 429/503 yanıtıyla birlikte Retry-After döndürdüğünde uygulanacak üst sınır  
    **Varsayılan:** 5 saniye
  </Card>

  <Card title="Idempotent Olmayan İsteklerde Yeniden Deneme" icon="ban">
...
<CardGroup cols={2}>
  <Card title="Splunk HEC Modu" icon="webhook">
    **Açıklama:** Kayıtların Splunk HEC zarfıyla gönderilip gönderilmeyeceği  
    **Varsayılan:** Kapalı
  </Card>

  <Card title="Index / Sourcetype / Source / Host" icon="database">
    **Açıklama:** Splunk HEC zarfında taşınacak Index, Sourcetype, Source ve Host alanları  
    **Varsayılan:** Boş
  </Card>

  <Card title="Onay (ACK) Kullanımı" icon="badge-check">
    **Açıklama:** Splunk'tan olay bazlı onay bekleyip beklenmeyeceği  
    **Varsayılan:** Kapalı
  </Card>

  <Card title="Onay Zaman Aşımı" icon="timer">
    **Açıklama:** Onay bekleme süresi  
    **Varsayılan:** 30 saniye
  </Card>

  <Card title="Maksimum Onay Tekrar Gönderimi" icon="repeat-2">
    **Açıklama:** Onayı gelmeyen toplu kaydın en fazla kaç kez yeniden gönderileceği  
    **Varsayılan:** 2
  </Card>
</CardGroup>

Onay kullanımı açıldığında Splunk'tan onay beklenir; onay belirtilen sürede gelmezse toplu kayıt sınırlı sayıda yeniden gönderilir, sınır aşıldığında kayıt failover connector'a yönlendirilir.

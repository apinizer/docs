...
<CardGroup cols={2}>
  <Card title="Bağlantı Kurma Süresi (Connect Timeout)" icon="clock">
  ...
  <Card title="Yanıt Süresi (Response Timeout)" icon="hourglass">
  ...
  <Card title="Bağlantı İsteği Süresi (Connection Request Timeout)" icon="timer">
  ...
  <Card title="Soket Süresi (Socket Timeout)" icon="plug-zap">
  ...
  <Card title="Gövde Gönderim Fren Süresi (Write Stall Timeout)" icon="octagon-alert">
...
## Best Practices
  ...
  <Accordion title="Kaçınılması Gerekenler">
    <CardGroup cols={2}>
      ...
      <Card title="Bağlantı Havuzu Boyutunu Trafiğe Göre Ayarlamamak" icon="alert-triangle">
  ...
  <Accordion title="Performans İpuçları">
    <CardGroup cols={2}>
      ...
      <Card title="Bağlantı Havuzu Optimizasyonu" icon="database">
...
:::
  ...
  <Accordion title="Bağlantı Havuzu Tükendi (Pool Exhausted)">
    :::warning
...
:::
    ...
    <Steps>
      <Step title="Bağlantı Havuzu Boyutunu Artırın">
        Host Başına ve Toplam bağlantı sayısını gerçek eşzamanlı istek hacmine göre yükseltin.
      </Step>
      
      <Step title="Bağlantı İsteği Süresini Kontrol Edin">
...
:::
  ...
  <Accordion title="Bağlantı havuzunu kapatabilir miyim?">
    :::info

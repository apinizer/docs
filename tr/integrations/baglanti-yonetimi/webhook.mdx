...
<CardGroup cols={2}>
  <Card title="Tampon Doluyken Bekleme Süresi" icon="timer">
    **Açıklama:** Tampon doluyken gönderen tarafın bekleyeceği en fazla süre. Bu süre dolduğunda kayıt, tanımlıysa failover connector'a yönlendirilir; failover tanımlı değilse düşürülür. Toplu gönderimdeki bekleme süresinden bağımsız çalışır.  

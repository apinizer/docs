...
<CardGroup cols={3}>
  <Card title="Veritabanı" icon="database" href="/tr/integrations/konnektorler/database-konnektor">
  ...
  <Card title="Elasticsearch" icon="magnifying-glass" href="/tr/integrations/konnektorler/elasticsearch-konnektor">
  ...
  <Card title="Script" icon="code" href="/tr/integrations/konnektorler/script-konnektor">
...
<CardGroup cols={3}>
  <Card title="Kafka" icon="layer-group" href="/tr/integrations/konnektorler/kafka-konnektor">
    Apache Kafka entegrasyonu ile mesaj gönderme ve alma işlemleri. Event-driven mimariler için mesaj kuyruğu yönetimi.
  </Card>
  <Card title="RabbitMQ" icon="inbox" href="/tr/integrations/konnektorler/rabbitmq-konnektor">
    RabbitMQ entegrasyonu ile mesaj kuyruğu operasyonları ve asenkron mesajlaşma.
  </Card>
  <Card title="ActiveMQ" icon="server" href="/tr/integrations/konnektorler/activemq-konnektor">
...
<CardGroup cols={3}>
  <Card title="API Çağrısı" icon="globe" href="/tr/integrations/konnektorler/api-call-konnektor">
    API endpoint'lerini tetikleme, veri alma ve başka endpoint'lere veri gönderme. HTTP/REST API çağrıları.
  </Card>
  <Card title="Webhook" icon="plug" href="/tr/integrations/konnektorler/webhook-konnektor">
...
<CardGroup cols={2}>
  <Card title="FTP Read" icon="file-arrow-down" href="/tr/integrations/konnektorler/ftp-read-konnektor">
    FTP bağlantı tanımlarını kullanarak dosya arama, okuma ve farklı formatlarda içerik alma işlemlerini gerçekleştirme.
  </Card>
  <Card title="FTP List" icon="list" href="/tr/integrations/konnektorler/ftp-list-konnektor">
...
<CardGroup cols={3}>
  <Card title="Syslog" icon="file-lines" href="/tr/integrations/konnektorler/syslog-konnektor">
    Syslog protokolü ile log mesajları gönderme ve merkezi log yönetimi.
  </Card>
  <Card title="Logback" icon="file-code" href="/tr/integrations/konnektorler/logback-konnektor">
...
<CardGroup cols={1}>
  <Card title="Linux Script" icon="terminal" href="/tr/integrations/konnektorler/linux-script-konnektor">

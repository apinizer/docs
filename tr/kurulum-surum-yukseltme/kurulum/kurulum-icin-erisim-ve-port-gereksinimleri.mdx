...
description: 'Kubernetes kurulumu için gerekli port ve erişim gereksinimleri'
---

Bu sayfa, Apinizer'ın Kubernetes üzerinde kurulumu için gerekli port ve erişim gereksinimlerini açıklar. Bu gereksinimler, Kubernetes cluster'ının doğru şekilde çalışması için kritik öneme sahiptir.
...
<CardGroup cols={2}>
  <Card title="Ağ Bağlantı Matrisi" icon="diagram-project" href="/tr/apinizer-anlama/sistem/ag-baglanti-matrisi">
    Apinizer bileşenleri arası port gereksinimlerini öğrenin
  </Card>
  <Card title="Port İzinleri" icon="lock" href="/tr/apinizer-anlama/sistem/port-izinleri">

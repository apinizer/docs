...
description: 'Openshift Origin 3.11 platformu üzerine Kubernetes kurulumu için gerekli adımlar ve yapılandırmalar.'
---
...
DNS testi tamamlandıktan sonra Openshift Origin 3.11 üzerinde Kubernetes kurulumu tamamlanmış olur. Apinizer kurulumu için [Apinizer Kurulumu](/tr/kurulum-surum-yukseltme/apinizer-kurulumu/giris) dokümantasyonuna bakınız.

...
### 2.1.1) Apinizer Api Manager Uygulamasının Güncellenmesi
...
Apinizer Api Manager uygulamasının imajının güncellendiğinden emin olduktan sonra Apinizer Worker ve Cache uygulamaları güncellenir.
...
### 2.2.3) Apinizer Api Manager Uygulamasının Güncellenmesi

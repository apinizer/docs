...
Kurulum sonrası MongoDB konfigürasyonları [Ubuntu İşletim Sisteminde MongoDB Kurulumu](https://docs.apinizer.com/apinizer-dokumantasyonu/ubuntu-isletim-sisteminde-mongodb-kurulumu-120520788.html) dökümandaki kısımlar ile aynıdır.
...
Kurulum dosyasını bulunduğu dizinden /opt/elasticsearch/ klasörüne taşıdıktan sonra [Ubuntu İşletim Sisteminde Elasticsearch Kurulumu](https://docs.apinizer.com/apinizer-dokumantasyonu/ubuntu-isletim-sisteminde-elasticsearch-kurulumu-70849466.html) sayfasında ki adımları uygulayın.

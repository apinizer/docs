...
Bir portalı dışa aktarıp aynı ya da başka bir kurulumda yeni portal olarak oluşturabilirsiniz. Portal paketi düz JSON biçimindedir ve kurulumun dışına çıkar; bu nedenle pakete hiçbir gizli değer yazılmaz. Gizli alanlar dışa aktarım sırasında paketten çıkarılır.

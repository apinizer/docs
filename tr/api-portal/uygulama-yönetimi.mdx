...
![Uygulama Yönetimi](/images/image-2025-11-6_15-43-52.png)

<Steps>
  <Step title="Create Butonuna Tıklayın">
...
![Portal App Detay](/images/image-2025-11-6_17-9-31.png)

<Tabs>
  <Tab title="Üst Bilgi Bölümü">
...
durumları [Onay İstekleri](/onay-istekleri) sayfasında anlatılmıştır.
</Info>
...
<Note>Bu işlem API Manager'dan yapılır. Portal kullanıcıları detay sayfasında kayıtlarını iptal edemez.</Note>
...
![Portal Uygulama Oluşturma](/images/image-2025-11-6_17-47-29.png)

![Portal Uygulama Listesi](/images/image-2025-11-6_17-59-6.png)
...
<Info>
Kayıt işlemi tamamlandıktan sonra API Product'ın durumuna göre yapılacak adımlar için [Onay İstekleri sayfasındaki API Ürünü Erişim Ayarları](/onay-istekleri#erişim-ayarları) bölümünde detaylı olarak anlatılmıştır.
</Info>
...
![Portal Uygulamalarım](/images/image-2025-11-13_16-54-46.png)
...
![API Key Akışı](/images/image-2025-11-7_10-30-5.png)
...
<Tabs>
  ...
  <Tab title="API Product Kayıtları Hakkında">
  ...
  <Tab title="Yönetim ve Güvenlik Hakkında">

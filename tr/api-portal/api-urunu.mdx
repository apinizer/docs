...
* **Manager > API Product > Planlar** ve **Abonelikler** sekmelerinin üstünde sarı uyarı: bağlı proxy'de aktif kimlik doğrulama politikası yoksa plan limitlerinin uygulanmayacağını söyler. Proxy kayıtlı yapılandırmada uygun ama henüz yeniden yüklenmemişse, yeniden yükleme gerektiğini belirten ayrı bir uyarı görünür.

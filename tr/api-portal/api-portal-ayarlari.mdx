...
Olay tipleri, JSON örneği ve konnektör ekleme adımları için bkz. [Login Log Konnektör Yapılandırması](/tr/admin/system-settings/login-log-konnektor-yapilandirmasi) (Portal bölümü). Giriş kayıtlarını görüntüleme ve filtreleme için bkz. [API Portal Giriş Kayıtları](/tr/api-portal/giris-kayitlari).

...
<Tabs>
  <Tab title="Sistem Tarafından Otomatik Oluşturulan Sayfalar">
    **Otomatik Oluşturulan Sayfalar:**
    ...
    - Silinemez veya devre dışı bırakılamaz
    - Sadece içerikleri düzenlenebilir
...
- **Varsayılan Dil:** Portal Ayarları → Genel Ayarlar'dan belirlenir
- **Dil Seçenekleri:** Türkçe ve İngilizce dil seçenekleri aktif edilebilir
...
<Info>
Çoklu dil özelliği aktif olduğunda, Portal Home, Footer, How It Works ve Pending Page için her dilde ayrı içerik hazırlanabilir.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Çoklu Dil Yönetimi" icon="globe">
    Her sayfa için Türkçe ve İngilizce içerik hazırlayın
  </Card>
...
| **Çoklu Dil** | Türkçe ve İngilizce içerik hazırlanabilir |
...
<Steps>
  ...
  <Step title="Çoklu Dil Desteği">
    Portal ayarlarında çoklu dil aktifse, iki sekme görürsünüz:

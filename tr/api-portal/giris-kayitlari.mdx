...
| **LOCKED** | Art arda çok fazla yanlış şifre | `Authentication failed -> LOCKED` | "Hesabınız kilitlenmiştir" | *Kilit Süresi*ni bekleyin veya admin **Unlock** yapsın |
...
| **Yanlış Şifre** | Şifre yanlış | `Account user@... failed authentication due to N failed login attempts` | "Email veya şifre hatalı." | Doğru şifre girilmeli |

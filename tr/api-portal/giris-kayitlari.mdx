...
| Hesap Kilitlendi, Parola Değiştirildi, Parola Değişimi Zorunlu, Parola Sıfırlama Talep Edildi, Parola Politikası İhlali | Portal parola politikası ve hesap kilitleme özelliği için ayrılmış olay tipleri. Bu sürümde üretilmez. | — |

### Sebep kodları

Yalnızca **Giriş Başarısız** ve otomatik **Hesap Devre Dışı Bırakıldı** olayında gösterilir.

| Sebep kodu | Anlamı |
|---|---|
| **Hatalı e-posta veya parola** | E-posta var ama parola eşleşmedi. |
| **Hesap devre dışı** | Hesabın durumu Disabled (tekrarlanan başarısız denemeler sonrası kilit veya bir yönetici tarafından devre dışı bırakma). |
| **Hesap onaylanmamış** | Hesap var ama aşağıdaki iki sebep dışında bir nedenle henüz onaylanmamış. |
| **E-posta onayı gerekli** | Hesap kaydedildi ama e-posta adresi henüz onaylanmadı. |
| **Onay bekleniyor** | Kayıt yönetici onayı gerektiriyor ve henüz onaylanmadı. |
| **Hesap reddedildi** | Bir yönetici kaydı reddetti. |
| **Bu e-postayla eşleşen hesap yok** | Gönderilen e-posta adresiyle eşleşen bir hesap yok. |
| **Hesap başka bir portala ait** | E-posta ve parola geçerli, ama *farklı* bir portalda kayıtlı bir hesaba ait — portal hesapları portal başına izole edilir. |
| **Hesap uzun süre işlem görmedi** | Otomatik **Hesap Devre Dışı Bırakıldı** olayında [inaktif-hesap görevi](/tr/api-portal/api-portal-ayarlari#güvenlik) tarafından yazılır, hiçbir zaman bir giriş denemesinde değil. |
| Hesap kilitli, Hesap sahibi tarafından değiştirildi, Yönetici tarafından değiştirildi, Parola sıfırlama bağlantısıyla değiştirildi, Zorunlu süre dolumu sonrası değiştirildi, Parolanın süresi doldu, Yönetici tarafından sıfırlandı | Portal parola politikası ve hesap kilitleme özelliği için ayrılmış sebep kodları. Bu sürümde üretilmez. |

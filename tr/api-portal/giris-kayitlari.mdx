...
Portal bazlı login logların veritabanı ve harici konnektör ayarları için aşağıdaki [Konnektör teslimi ve yük biçimi](#konnektor-teslimi-ve-yuk-bicimi) bölümüne bakabilirsiniz (Portal Ayarları → Login Log sekmesi).
...
## Konnektör teslimi ve yük biçimi {#konnektor-teslimi-ve-yuk-bicimi}
...
<Frame caption="API Portal Ayarları — Login Log sekmesi">
  <img
    src="/images/2026-09-2/portal-login-log-settings.png"
    alt="API Portal Login Log sekmesi: veritabanına her zaman kaydedilir uyarısı ve konnektör tablosu"
    width="1000"
    height="397"
  />
</Frame>
...
Bu profilin alan listesi dondurulmuştur. Kanonik zarf, alan bazlı maskeleme ve boyut sınırları için hedefi SIEM sayfasından **APINIZER_JSON_V2** profiline geçirin. Bu yükün Yönetim Konsolu karşılığı ile Graylog/GELF ve veritabanı tablosu ayrıntıları için bkz. [SESSION hattı — olay tipleri ve legacy yük](/tr/admin/system-settings/siem-log-yonlendirme#session-hatti-olay-tipleri-ve-legacy-yuk); bu ayrıntılar portal olayları için de aynıdır.

...
- API Manager'ın kurulu olması gerekmektedir. API Manager Kurulumu için [Apinizer Kurulumu ve Ayarları](/tr/setup/apinizer/apinizer) dökümanını inceleyiniz.
...
[Detaylı bilgi için tıklayınız](/tr/operations/yonetici-kilavuzlari/api-developer-portal-ssl).

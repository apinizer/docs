...
**Önemli:** Ana sayfa (Home), "Nasıl Çalışır" (How It Works) ve Footer içerik yönetimi artık bu sayfadan kaldırılmıştır. Bu içeriklerin yönetimi için [API Portal Ayarları](/tr/api-portal/api-portal-ayarlari) sayfasındaki "Portal İçerik Yönetimi" bölümünü kullanabilirsiniz.
...
- Bu içeriklerin yönetimi artık [API Portal Ayarları](/tr/api-portal/api-portal-ayarlari) sayfasındaki "Portal İçerik Yönetimi" bölümünden yapılmaktadır

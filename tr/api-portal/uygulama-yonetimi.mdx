...
API Portal'da kullanıcılar sadece kendi uygulamalarını görebilir ve yönetebilir. Her uygulama oluşturulduğu portala bağlıdır; çoklu portal kurulumlarında bir portalda oluşturulan uygulamalar diğer portallerde listelenmez.

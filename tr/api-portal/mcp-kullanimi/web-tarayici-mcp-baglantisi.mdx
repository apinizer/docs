...
<img
    src="/images/tutorials/nasil-yapilir-kilavuzlari/develop-kilavuzlari/api-portal-mcp-kullanimi/görsel1.png"
...
<Steps>
  ...
  <Step title="MCP Konfigürasyonu">
    Yönergeleri girdiğiniz kutucuğun sonuna eklenmiş olan "MCP" ifadesine tıklayın ve "Configure" butonuna basın, açılan alanda MCP alanını ve altındaki alanları aktifleştirin
      <img
          src="/images/tutorials/nasil-yapilir-kilavuzlari/develop-kilavuzlari/api-portal-mcp-kullanimi/görsel2.png"
          alt="Image 2024 9 9 15 35 35 Pn"
          width="800"
          className="mr-auto"
      />
  ...
  <Step title="Bağlantıyı Doğrula">
    Bu işlem sonunda tarayıcıda yan tarafa açılan yeni ekranda "Server Connected" ifadesini ve "Available Tools" sekmesinde ilgili bağlantı tanımınızı görmeniz gerekiyor
      <img
          src="/images/tutorials/nasil-yapilir-kilavuzlari/develop-kilavuzlari/api-portal-mcp-kullanimi/görsel3.png"
          alt="Image 2024 9 9 15 35 35 Pn"
          width="800"
          className="mr-auto"
      />
  ...
  <Step title="Instructions'ı Ekle">
    Yönergeleri girdiğiniz kutucuğunun sonundaki "MCP" ifadesine basın ve size çıkardığı "Instructions"'ı yönerge olarak girmek için insert'e basın. Yönergeleri gönderin
      <img
          src="/images/tutorials/nasil-yapilir-kilavuzlari/develop-kilavuzlari/api-portal-mcp-kullanimi/görsel4.png"
          alt="Image 2024 9 9 15 35 35 Pn"
          width="800"
          className="mr-auto"
      />
...
<img
    src="/images/tutorials/nasil-yapilir-kilavuzlari/develop-kilavuzlari/api-portal-mcp-kullanimi/görsel5.png"
    alt="Image 2024 9 9 15 35 35 Pn"
    width="800"
    className="mr-auto"
/>
 <img
    src="/images/tutorials/nasil-yapilir-kilavuzlari/develop-kilavuzlari/api-portal-mcp-kullanimi/görsel6.png"
    alt="Image 2024 9 9 15 35 35 Pn"
    width="800"
    className="mr-auto"
/>
 <img
    src="/images/tutorials/nasil-yapilir-kilavuzlari/develop-kilavuzlari/api-portal-mcp-kullanimi/görsel7.png"
    alt="Image 2024 9 9 15 35 35 Pn"
    width="800"
    className="mr-auto"
/>
...
<img
    src="/images/tutorials/nasil-yapilir-kilavuzlari/develop-kilavuzlari/api-portal-mcp-kullanimi/görsel8.png"
    alt="Image 2024 9 9 15 35 35 Pn"
    width="800"
    className="mr-auto"
/>
<img
    src="/images/tutorials/nasil-yapilir-kilavuzlari/develop-kilavuzlari/api-portal-mcp-kullanimi/görsel9.png"
    alt="Image 2024 9 9 15 35 35 Pn"
    width="800"
    className="mr-auto"
/>
<img
    src="/images/tutorials/nasil-yapilir-kilavuzlari/develop-kilavuzlari/api-portal-mcp-kullanimi/görsel10.png"
    alt="Image 2024 9 9 15 35 35 Pn"
    width="800"
    className="mr-auto"
/>
<img
    src="/images/tutorials/nasil-yapilir-kilavuzlari/develop-kilavuzlari/api-portal-mcp-kullanimi/görsel11.png"
    alt="Image 2024 9 9 15 35 35 Pn"
    width="800"
    className="mr-auto"
/>

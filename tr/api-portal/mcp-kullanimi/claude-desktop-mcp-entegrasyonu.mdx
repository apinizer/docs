...
<Tabs>
<TabItem value="node-version" label="node --version">
...
<Tabs>
<TabItem value="npm-install-g-modelcontextprotocol-sdk" label="npm install -g @modelcontextprotocol/sdk">
...
<Tabs>
<TabItem value="chmod-x-claude-mcp-apinizer-http-proxy-js" label="chmod +x ~/.claude/mcp/apinizer_http_proxy.js">
...
<Tabs>
<TabItem value="apinizer-api-portalimde-kac-api-var" label="-Apinizer API portalimde kaç API var?">
...
## Sorun Giderme
  ...
  <Accordion title="Command not found Hatası">
    ...
    **Çözüm:**
    ...
    <Tabs>
<TabItem value="node-js-kurulumunu-kontrol-edin" label="# Node.js kurulumunu kontrol edin">

...
[Uygulama Yönetimi](/tr/api-portal/uygulama-yonetimi) modülü, portal kullanıcılarının API'lere erişmek için oluşturdukları uygulamaları yönetir.
...
[API Portal](/tr/api-portal/api-portal-ayarlari) modülü, portal'ın temel konfigürasyonlarını yönetir.

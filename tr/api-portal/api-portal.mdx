...
API Portal ayarları, API Manager üzerinden **Portal → Ayarlar → Portal** menüsünden yapılandırılır. Bu ayarlar sayesinde Portal'ın görünümü, dil seçenekleri, organizasyon görünürlüğü ve diğer temel konfigürasyonlar yönetilir.

### Portal Ayarları Bölümleri

API Portal ayarları aşağıdaki ana bölümlerden oluşur:

- **Genel Ayarlar**: Portal adı, açıklama, logo ve temel görünüm ayarları
- **Dil Ayarları**: Portal'da kullanılacak dillerin yapılandırılması (Türkçe/İngilizce)
- **Organizasyon Görünürlüğü**: Portal'da organizasyonların görünürlük ayarları
- **Tema ve Görünüm**: Portal'ın görsel teması ve renk ayarları

<Info>
  Portal ayarları hakkında detaylı bilgi için [Portal Ayarları](/tr/api-portal/genel-bakis) sayfasını inceleyebilirsiniz.
</Info>

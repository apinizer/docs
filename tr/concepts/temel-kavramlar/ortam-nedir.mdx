...
<Info>
  Detaylı ortam oluşturma ve yönetimi için [Gateway Runtime'ları](/tr/admin/server-management/gateway-runtime-lari) sayfasına bakabilirsiniz.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Gateway Runtime'ları" icon="gear" href="/tr/admin/server-management/gateway-runtime-lari">
    Gateway Runtime oluşturma ve yönetimi
  </Card>

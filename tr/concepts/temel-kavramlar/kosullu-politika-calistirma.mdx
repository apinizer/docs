...
<Info>
Koşullar, [Politika Nedir?](/tr/concepts/temel-kavramlar/politika-nedir) sayfasında açıklandığı gibi, politika yapılandırmasının bir parçasıdır. Politika oluştururken veya düzenlerken koşullar bölümünden koşul tanımları yapılır.
</Info>

## Koşullu Politika Çalıştırma Kavramı

Koşullu politika çalıştırma, politikaların belirli koşullara göre çalıştırılmasını sağlar. Apinizer'da koşullar kod yazmadan, **[Variable](/tr/concepts/temel-kavramlar/variable) kullanarak ve form tabanlı yapılandırma** ile oluşturulur.
...
Bu yaklaşım sayesinde kod yazmadan, form alanlarını doldurarak ve [Variable](/tr/concepts/temel-kavramlar/variable)'ları seçerek koşullu politikalar oluşturabilirsiniz.

## Koşul Türleri ve Değişken Kullanımı

Koşullar, [Variable](/tr/concepts/temel-kavramlar/variable) kullanılarak oluşturulur. Değişkenler mesaj içeriğinden, header'lardan, query parametrelerinden veya context'ten değer alabilir.
...
<AccordionGroup>
  <Accordion title="Environment Variable">
    [Ortam değişkenlerine](/tr/develop/environment-variables) göre kontrol için:
...
Koşullar, [Variable](/tr/concepts/temel-kavramlar/variable) kullanılarak ve form tabanlı yapılandırma ile oluşturulur. Her koşul aşağıdaki bileşenlerden oluşur:
...
<CardGroup cols={2}>
  <Card title="Değişken Seçimi" icon="list-check">
    - Mevcut [Variable](/tr/concepts/temel-kavramlar/variable)'ları kullanın, gereksiz yeni değişken oluşturmayın
...
<CardGroup cols={2}>
  <Card title="Değişkenler (Variables)" icon="code" href="/tr/concepts/temel-kavramlar/variable">

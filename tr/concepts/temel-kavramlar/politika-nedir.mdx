...
| 3 | Hata satırı bazlı alan özelleştirmesi | Satır bazlı Özelleştirilmiş Mesaj, Özelleştirilmiş Hata Kodu, Özelleştirilmiş HTTP Durum Kodu alanları |
| 4 | Platform geneli hata mesajı özelleştirmesi | Sistem Ayarları > [Hata Mesajları](/tr/admin/system-settings/hata-mesajlari) sayfasından yapılan özelleştirme |
...
**Örnek şablon:** `Hata oluştu: #{error.effectiveErrorCode} - İstek yolu: #{request.uri}`
...
Hata Kodu: #{error.effectiveErrorCode}

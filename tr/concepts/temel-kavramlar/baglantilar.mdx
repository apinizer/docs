...
<CardGroup cols={2}>
  <Card title="Konnektör" icon="puzzle-piece" href="/tr/concepts/temel-kavramlar/konnektor">
    Konnektör kavramını öğrenin
  </Card>
  <Card title="Endpoint" icon="location-dot" href="/tr/concepts/temel-kavramlar/endpoint">
    Endpoint kavramını öğrenin
  </Card>
  <Card title="Bağlantı Yönetimi" icon="gear" href="/tr/integrations/baglanti-yonetimi/genel-bakis">

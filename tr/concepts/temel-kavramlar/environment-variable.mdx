...
<CardGroup cols={2}>
  <Card title="Secret Olmayan" icon="eye">
    Yapılandırma değerleri için kullanılır
    
    URL'ler, port numaraları, flag'ler gibi değerler. Şifreli saklanır; ekranda maskeli gösterilir, göz
    ikonuyla açılabilir ve kopyalanabilir. Okuma API'lerinde ve dışa aktarma paketinde düz metin olarak yer alır.
  </Card>
...
:::
  ...
  <Accordion title="Secret Olarak İşaretlenmesi Gerekenler">
  ...
  <Accordion title="Secret İşaretlenmesi Gerekmeyenler">

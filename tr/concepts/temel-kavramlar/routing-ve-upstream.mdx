...
Detaylı bilgi için [HTTP Yönlendirme](/tr/develop/yonlendirme/http-yonlendirme) sayfasına bakın.
...
Detaylı bilgi için [gRPC Yönlendirme](/tr/develop/yonlendirme/grpc-yonlendirme) sayfasına bakın.
...
Detaylı bilgi için [WebSocket Yönlendirme](/tr/develop/yonlendirme/websocket-yonlendirme) sayfasına bakın.

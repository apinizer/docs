...
description: "Apinizer AI Gateway'de karşılaşacağınız LLM sağlayıcı, token, embedding, RAG, sanal API anahtarı gibi temel kavramları kısa tanımlarla öğrenebilir, her biri için ilgili yapılandırma sayfasına ulaşabilirsiniz."
---
...
İstemcilerin gerçek sağlayıcı anahtarı yerine kullandığı, kullanıcı/rol/proje/takım kapsamında tanımlanabilen Apinizer-üretimi anahtardır. Gerçek sağlayıcı kimlik bilgisi hiçbir zaman istemciye ulaşmaz.

...
<Info>
  Detaylı API Proxy oluşturma ve yönetimi için [API Proxy Oluşturma](/tr/develop/api-proxy-olusturma/api-proxy-olusturma) sayfasına bakabilirsiniz.
</Info>
...
<Info>
  API Proxy'lerin proje ve ortam ile ilişkisi hakkında daha fazla bilgi için [Proje Nedir?](/tr/concepts/temel-kavramlar/proje-nedir) ve [Ortam Nedir?](/tr/concepts/temel-kavramlar/ortam-nedir) sayfalarına bakabilirsiniz.
</Info>
...
<Info>
  Detaylı deployment bilgisi için [Deployment Modelleri](/tr/concepts/deployment/deployment-modelleri) sayfasına bakabilirsiniz.
</Info>

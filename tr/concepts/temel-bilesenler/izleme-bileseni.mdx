...
<Tip>
Anomali Dedektörü hakkında detaylı bilgi için [Anomali Dedektörü](/tr/monitor/anomali-tespit-edici.mdx) sayfasına bakabilirsiniz.
</Tip>
...
<AccordionGroup>
  ...
  <Accordion title="Alarm Kanalları">
    ...
    * **Konnektörler**: E-posta, API çağrısı, bildirim, SNMP gibi konnektörler ile eylemler
    ...
    <Tip>
    Alarm kanalları, konnektörler kullanılarak yapılandırılır. Detaylı bilgi için [Eylemler ve Konnektörler](/tr/concepts/temel-kavramlar/konnektor.mdx) sayfasına bakabilirsiniz.
    </Tip>
  </Accordion>
...
<Tip>
Alarm yönetimi hakkında detaylı bilgi için [Alarm (Alert)](/tr/monitor/alarm.mdx) sayfasına bakabilirsiniz.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Anomali Dedektörü" icon="triangle-exclamation" href="/tr/monitor/anomali-tespit-edici.mdx">
    Anomali Dedektörü kullanımı
  </Card>
  <Card title="Alarm Yönetimi" icon="bell" href="/tr/monitor/alarm.mdx">
    Alarm yönetimi
  </Card>
  <Card title="Prometheus & Grafana" icon="chart-line" href="/tr/setup/kubernetes/prometheus-grafana">

...
Çalışma Süresi Monitörü hakkında detaylı bilgi için [Çalışma Süresi Monitörü](/tr/tutorials/api-izleme-senaryolari/calisma-suresini-izleme-kullanimi) sayfasına bakabilirsiniz.
...
Anomali Dedektörü hakkında detaylı bilgi için [Anomali Dedektörü](/tr/monitor/anomali-tespit-edici) sayfasına bakabilirsiniz.
...
### Alarm Yönetimi
  ...
  <Accordion title="Alarm Türleri">
    ...
    * **Gateway Thread Count**: Her API Gateway worker pod'unun Gateway Management API üzerinden okunan anlık JVM thread sayısı
    * **Gateway Heap Usage Percentage**: Her pod'un JVM heap kullanım yüzdesi
    * **Gateway Deadlock Count**: Her pod'da tespit edilen deadlock'a giren thread sayısı
    * **Gateway Executor Pool Saturation Percentage**: Her pod'daki executor havuzlarının doluluk yüzdesi
    * **Gateway Connection Pool Usage Percentage**: Her pod'daki bağlantı havuzlarının kullanım yüzdesi
    * **Gateway GC Time Percentage**: Her pod'un JVM başlangıcından beri kümülatif GC süresi oranı
...
Alarm kanalları, konnektörler kullanılarak yapılandırılır. Detaylı bilgi için [Eylemler ve Konnektörler](/tr/concepts/temel-kavramlar/konnektor) sayfasına bakabilirsiniz.
...
Alarm yönetimi hakkında detaylı bilgi için [Alarm (Alert)](/tr/monitor/alarm) sayfasına bakabilirsiniz.
...
<CardGroup cols={2}>
  ...
  <Card title="Çalışma Süresi Monitörü" icon="clock" href="/tr/tutorials/api-izleme-senaryolari/calisma-suresini-izleme-kullanimi">
  ...
  <Card title="Alarm Yönetimi" icon="bell" href="/tr/monitor/alarm">
    Alarm yönetimi
  </Card>
  <Card title="Prometheus & Grafana" icon="chart-line" href="/tr/setup/kubernetes">

...
<CardGroup cols={2}>
  <Card title="DB-2-API" icon="database" href="/tr/develop/api-proxy-olusturma/api-creator-db-api-olusturma">
    DB-2-API kullanım kılavuzu
  </Card>
  <Card title="Script-2-API" icon="code" href="/tr/develop/api-proxy-olusturma/api-creator-script-api-olusturma">
    Script-2-API kullanım kılavuzu
  </Card>
  <Card title="Mock API Creator" icon="wand-magic-sparkles" href="/tr/develop/api-proxy-olusturma/api-creator-mock-api-olusturma">

...
<Tip>
Konnektörler hakkında detaylı bilgi için [Konnektör](/tr/concepts/temel-kavramlar/konnektor) sayfasına bakabilirsiniz.
</Tip>
...
<AccordionGroup>
  <Accordion title="Konfigürasyon Adımları">
    ...
    <img src="/images/develop/api-integrator/api-integrator-ayarlari.png" alt="API Integrator Ayarları" width="800" height="450" />
  ...
  <Accordion title="Erişim">
    ...
    <img src="/images/develop/api-integrator/api-integrator-erisim.png" alt="API Integrator Erişim" width="800" height="450" />
...
<CardGroup cols={2}>
  ...
  <Card title="Task Flow Builder" icon="diagram-project" href="/tr/integrations/api-integrator-task-flow-builder/genel-bakis.mdx">

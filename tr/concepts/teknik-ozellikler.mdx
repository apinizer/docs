...
<CardGroup cols={3}>
  ...
  <Accordion title="Routing (Yönlendirme) Özellikleri">
    ...
    - Connection Settings (Connect Timeout, Read Timeout, Connection Pool Wait Timeout)
    - Redirect desteği (Follow Redirects, Enable Relative Redirects, Max Redirects)

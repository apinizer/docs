...
Detaylı bilgi için [API Proxy Trafik Gizlilik Ayarları](/tr/develop/api-proxy-konfigurasyonu/api-trafik-log-ayarlari) sayfasına bakın.
...
<CardGroup cols={2}>
  ...
  <Card title="Test Konsol Denetim Kayıtları" icon="flask">
    ...
    * İstemci IP'si (testi test konsolundan çalıştıran kullanıcının IP adresi; load balancer veya reverse proxy arkasında X-Forwarded-For başlığı dikkate alınır; alan eklenmeden önce yazılmış kayıtlarda boştur; filtre olarak da kullanılabilir)
    * Tarih aralığı filtreleme (tarihler takvimden seçilebilir veya doğrudan elle girilebilir)
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Denetim" icon="file-lines" href="/tr/admin/audit-compliance/genel-bakis">
    Denetim kayıtlarını inceleyin
  </Card>
  <Card title="Uygulama Logları" icon="file-lines" href="/tr/develop/izleme-analiz/uygulama-loglari">
    Uygulama loglarını yönetin
  </Card>
  <Card title="API Proxy Trafik Gizlilik Ayarları" icon="eye-slash" href="/tr/develop/api-proxy-konfigurasyonu/api-trafik-log-ayarlari">
    Trafik gizlilik ayarlarını yapılandırın
  </Card>
  <Card title="Güvenlik Yönetimi" icon="shield" href="/tr/admin/secrets-management/genel-bakis">

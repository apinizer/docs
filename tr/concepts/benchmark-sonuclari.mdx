...
<img src="/images/develop/benchmark/yuk-testi-topolojisi.png" alt="Yük Testi Topolojisi" width="807" height="536" />
...
<Info>
  Kubernetes master, worker, MongoDB, Elasticsearch ve Apinizer kurulumları [Apinizer Kurulum Dokümantasyonu](/tr/setup/genel-bakis.mdx) adresinde yer alan kurulum adımları takip edilerek yapılmıştır.
</Info>
...
<img src="/images/develop/benchmark/throughput-concurrent-users.png" alt="Throughput ve Eş Zamanlı Kullanıcı Sayısı" width="577" height="345" />

**Ortalama Bellek Kullanımı:**

<img src="/images/develop/benchmark/avg-memory-usage-concurrent-users.png" alt="Ortalama Bellek Kullanımı" width="437" height="300" />
...
<img src="/images/develop/benchmark/throughput-policy-comparison.png" alt="Throughput Karşılaştırması - Politika ile ve Politika Olmadan" width="577" height="345" />

**Ortalama Bellek Kullanımı:**

<img src="/images/develop/benchmark/avg-memory-usage-policy-comparison.png" alt="Ortalama Bellek Kullanımı - Politika ile ve Politika Olmadan" width="437" height="300" />
...
<CardGroup cols={2}>
  ...
  <Card title="Performance Tuning" icon="gauge" href="/tr/concepts/deployment/kapasite-planlama">

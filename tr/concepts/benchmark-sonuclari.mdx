...
<Tabs>
  ...
  <TabItem value="post-1kb" label="POST 1KB">
    | Tier | ES Kapalı | ES Açık | Maliyet |
    |------|----------:|--------:|--------:|
    | W1 | 1.480 | 1.342 | %9,3 |
    | W2 | 3.322 | 2.498 | %24,8 |
  ...
  <TabItem value="post-5kb" label="POST 5KB">
    | Tier | ES Kapalı | ES Açık | Maliyet |
    |------|----------:|--------:|--------:|
    | W1 | 1.352 | 1.148 | %15,1 |
    | W2 | 3.097 | 2.237 | %27,8 |
...
<Tabs>
  <TabItem value="w1-1-cpu-2gb" label="W1 (1 CPU / 2GB)">
    **GET**
  ...
  <TabItem value="w2-2-cpu-2gb" label="W2 (2 CPU / 2GB)">
    **GET**
  ...
  <TabItem value="w4-4-cpu-4gb" label="W4 (4 CPU / 4GB)">
    **GET**
  ...
  <TabItem value="w8-8-cpu-8gb" label="W8 (8 CPU / 8GB)">
    **GET**
...
<Tabs>
  <TabItem value="es-kapali" label="ES Kapalı">
  ...
  <TabItem value="es-acik" label="ES Açık">
    | Tier | Heap Kullanımı | Young GC | Old GC | Thread (Peak) | Blocked |
    |------|---------------:|---------:|-------:|:-------------:|:-------:|

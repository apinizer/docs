...
<Tip>
Dikey ölçeklendirme sonrası Gateway Worker pod'larının thread ve connection pool ayarlarını yeni kaynaklara göre güncelleyin. Tier bazlı öneriler için [Gateway Performans Ayarlama](/tr/operations/yonetici-kilavuzlari/gateway-performans-ayarlama) sayfasına bakın.
</Tip>

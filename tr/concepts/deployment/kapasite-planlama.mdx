...
<AccordionGroup>
  <Accordion title="Trafik Tahmini">
  ...
  <Accordion title="Deployment Modeli">
  ...
  <Accordion title="Yüksek Erişilebilirlik">
...
<CardGroup cols={1}>
  <Card title="Tier 1 (2 Core / 2 GB RAM) Önerilen Ayarlar" icon="server">
    * **IO Threads**: 2
  ...
  <Card title="Tier 2 (4 Core / 4 GB RAM) Önerilen Ayarlar" icon="server">
    * **IO Threads**: 4
  ...
  <Card title="Tier 3 (8 Core / 8 GB RAM) Önerilen Ayarlar" icon="server">
    * **IO Threads**: 16
    * **Routing Connection Pool - Min Thread Count**: 1.024
...
<Steps>
  <Step title="Trafik Analizi">
    Trafik seviyesi belirlendi (Tier 1/2/3), günlük/saatlik/peak trafik tahmini yapıldı ve trafik büyüme projeksiyonu hazırlandı
  </Step>
  <Step title="Worker Node Planlaması">
    Worker node gereksinimleri hesaplandı (CPU, RAM, Disk, Network, Node sayısı)
  </Step>
  <Step title="Manager Node Planlaması">
    Manager node gereksinimleri belirlendi (Standalone veya HA)
  </Step>
  <Step title="MongoDB Planlaması">
    MongoDB veri büyüklüğü tahmin edildi (API Proxy sayısı, Audit Log)
  </Step>
  <Step title="Elasticsearch Planlaması">
    Elasticsearch log verisi tahmin edildi (günlük/aylık/yıllık retention)
  </Step>
  <Step title="Cache Cluster Planlaması">
    Cache cluster boyutu belirlendi (cache'lenecek veri hacmine göre)
  </Step>
  <Step title="Network Planlaması">
    Network bandwidth gereksinimleri hesaplandı
  </Step>
  <Step title="Toplam Kaynak Hesaplaması">
    Toplam kaynak hesaplaması yapıldı (CPU, RAM, Disk) ve node sayıları belirlendi (HA ve ölçeklendirme için)
  </Step>
  <Step title="Deployment Modeli Seçimi">

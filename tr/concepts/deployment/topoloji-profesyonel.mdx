...
* **Sunucu 1**: Kubernetes Control-Plane, [Manager](/tr/concepts/temel-bilesenler/api-manager), [MongoDB](/tr/concepts/temel-kavramlar/baglantilar) ve [Elasticsearch](/tr/concepts/temel-bilesenler/analytics-engine) bileşenlerini barındırır.

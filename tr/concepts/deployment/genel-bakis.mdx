...
* **[Topoloji 1: Test ve PoC](/tr/concepts/deployment/topoloji-test-poc)** - 2 sunucu, minimum kaynak gereksinimi
* **[Topoloji 2: Profesyonel Kurulum](/tr/concepts/deployment/topoloji-profesyonel)** - 5 sunucu, Data Plane öncelikli yük dengeleme
* **[Topoloji 3: Yüksek Erişilebilirlik](/tr/concepts/deployment/topoloji-ha)** - 12 sunucu, tam High Available yapı
...
<a id="apinizerın-ihtiyaç-duyduğu-bileşenler"></a>
...
* **Port Gereksinimleri**: Kubernetes, [MongoDB](/tr/concepts/temel-kavramlar/baglantilar), [Elasticsearch](/tr/concepts/temel-bilesenler/analytics-engine) ve Apinizer bileşenleri için gerekli portlar
* **Trafik Akışı**: İstemci → Load Balancer → [Worker](/tr/concepts/temel-bilesenler/api-gateway) → Backend arasındaki trafik akışı
...
* **LAN Koruması**: İç ağdaki hassas bileşenlerin ([Manager](/tr/concepts/temel-bilesenler/api-manager), [MongoDB](/tr/concepts/temel-kavramlar/baglantilar), [Elasticsearch](/tr/concepts/temel-bilesenler/analytics-engine)) korunması
...
* **[Monitoring](/tr/concepts/temel-bilesenler/izleme-bileseni) ve Logging**: Sistem izleme ve log toplama yapılandırması
...
* [Worker](/tr/concepts/temel-bilesenler/api-gateway) modülleri ([API Gateway](/tr/concepts/temel-bilesenler/api-gateway))
* Load Balancer
...
* [Manager](/tr/concepts/temel-bilesenler/api-manager) modülü
* [MongoDB](/tr/concepts/temel-kavramlar/baglantilar) veritabanı
* [Elasticsearch](/tr/concepts/temel-bilesenler/analytics-engine)
* [Distributed Cache](/tr/concepts/temel-bilesenler/onbellek-bileseni)
* Yönetim araçları

### Deployment Topolojileri

Apinizer platformu üç temel deployment topolojisi destekler. Detaylı bilgi için [Deployment Modelleri](/tr/concepts/deployment/deployment-modelleri) sayfasına bakabilirsiniz:

1. **[Topoloji 1: Test ve PoC](/tr/concepts/deployment/topoloji-test-poc)** - Hızlı kurulum, düşük kaynak gereksinimi ile test ve proof of concept ortamları için ideal
2. **[Topoloji 2: Profesyonel Kurulum](/tr/concepts/deployment/topoloji-profesyonel)** - Orta ölçekli production ortamları için worker node'ları arasında yük dengeleme sağlayan yapı
3. **[Topoloji 3: Yüksek Erişilebilirlik](/tr/concepts/deployment/topoloji-ha)** - Kritik production ortamları için %99.9+ uptime, otomatik failover ve veri replikasyonu sağlayan HA yapısı
...
<CardGroup cols={1}>
  ...
  <Card title="DMZ Zone - Public API" icon="network-wired">
    [Worker](/tr/concepts/temel-bilesenler/api-gateway) modülleri ve dış erişime açık servisler
  </Card>
  ...
  <Card title="LAN Zone - Internal" icon="lock">
    [Manager](/tr/concepts/temel-bilesenler/api-manager), [MongoDB](/tr/concepts/temel-kavramlar/baglantilar), [Elasticsearch](/tr/concepts/temel-bilesenler/analytics-engine) ve hassas yönetim bileşenleri
  </Card>
</CardGroup>
...
Detaylı kurulum adımları için [Kurulum Bölümü](/tr/setup/kuruluma-genel-bakis) altındaki ilgili sayfalara bakınız:
...
* **[MongoDB](/tr/concepts/temel-kavramlar/baglantilar) Kurulumu**: MongoDB kurulumu ve replica set yapılandırması
* **[Elasticsearch](/tr/concepts/temel-bilesenler/analytics-engine) Kurulumu**: Elasticsearch kurulumu ve cluster yapılandırması

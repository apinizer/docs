...
<CardGroup cols={2}>
  ...
  <Card title="MongoDB" icon="database">
    ...
    **Port Gereksinimleri:**
    * 25080 (MongoDB) - Manager ve Worker'lardan
...
| Worker | MongoDB | 25080 | TCP | Veri okuma/yazma |

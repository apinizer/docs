...
<Info>
  Detaylı Kubernetes kurulum adımları ve sistem yapılandırması (kernel ayarları, network ayarları, zaman senkronizasyonu) için [Kurulum Öncesi Öneriler](/tr/concepts/deployment/kurulum-oncesi-oneriler) ve [Kubernetes Kurulum](/tr/setup/kubernetes/argocd-ile-versiyon-yonetimi) sayfalarına bakabilirsiniz.
</Info>
...
<Info>
  Detaylı MongoDB kurulum adımları ve yapılandırma örnekleri için [MongoDB Kurulum](/tr/setup/mongodb/rhel-mongodb) sayfalarına bakabilirsiniz.
</Info>
...
<Info>
  Detaylı Elasticsearch kurulum adımları, yapılandırma örnekleri ve ILM politikaları için [Elasticsearch Kurulum](/tr/setup/elasticsearch/basit-kimlik-dogrulama) sayfalarına bakabilirsiniz. Sistem yapılandırması (kernel ayarları, network ayarları, zaman senkronizasyonu) için [Kurulum Öncesi Öneriler](/tr/concepts/deployment/kurulum-oncesi-oneriler) sayfasına bakabilirsiniz.
</Info>

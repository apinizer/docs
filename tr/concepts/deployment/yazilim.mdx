...
<Info>
  Detaylı Kubernetes kurulum adımları ve sistem yapılandırması (kernel ayarları, network ayarları, zaman senkronizasyonu) için [Kurulum Öncesi Öneriler](/tr/concepts/deployment/kurulum-oncesi-oneriler) ve [Kubernetes Kurulum](/tr/setup/kubernetes) sayfalarına bakabilirsiniz.
</Info>
...
<Info>
  Detaylı Elasticsearch kurulum adımları, yapılandırma örnekleri ve ILM politikaları için [Elasticsearch Kurulum](/tr/setup/kuruluma-genel-bakis) sayfalarına bakabilirsiniz. Sistem yapılandırması (kernel ayarları, network ayarları, zaman senkronizasyonu) için [Kurulum Öncesi Öneriler](/tr/concepts/deployment/kurulum-oncesi-oneriler) sayfasına bakabilirsiniz.
</Info>

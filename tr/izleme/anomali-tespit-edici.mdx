...
description: "API trafiğindeki anormal davranışları otomatik olarak tespit edebilir, performans metriklerindeki sapmaları izleyebilir, istatistiksel analiz yapabilir ve anomali tespit edildiğinde bildirim gönderebilir."
---

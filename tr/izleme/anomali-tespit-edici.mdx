...
<AccordionGroup>
    <Accordion title="Eylem Ekleme">
        ...
        <Note>
            Eylemler hakkında detaylı bilgi için [Konnektörler](/tr/entegrasyon/konnektorler/genel-bakis)
            sayfasına bakınız.
        </Note>
    </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
    ...
    <Card title="Konnektörler" icon="bolt" href="/tr/entegrasyon/konnektorler/genel-bakis">

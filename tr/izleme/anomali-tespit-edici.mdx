...
description: "API trafiğinizde anormal davranışları otomatik olarak tespit eden gelişmiş izleme sistemi"
---

## Genel Bakış

**Anomali Tespit Edici**, API trafiğinizde anormal davranışları otomatik olarak tespit eden gelişmiş bir izleme sistemidir. Bu sistem sayesinde:

...
<AccordionGroup>
  <Accordion title="Eylem Ekleme">
    ...
    <Note>
      Eylemler hakkında detaylı bilgi için [Eylemler/Konnektörler](/tr/gelistirici/eylemler-konnektorler) sayfasına bakınız.
    </Note>
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Eylemler/Konnektörler" icon="bolt" href="/tr/gelistirici/eylemler-konnektorler">

...
<AccordionGroup>
  <Accordion title="Temel Özellikler">
    ...
    - **Konfigürasyon**: Monitörün Adı, Açıklaması, Aktif (Enabled) durumu ve işletilme sıklığı (Trigger Every) belirlenir
    - **İstek Bilgileri**: Test edilecek URL'nin Metot tipi ve URL'i girilir
    - **Teyitler (Assertions)**: Monitör sonuçlarını doğrulamak için kullanılır
    - **Eylem**: Monitör işletildiğinde yapılacak olan eylemin seçilmesi sağlanır
  </Accordion>

  <Accordion title="Teyitler (Assertions)">
...
<AccordionGroup>
  <Accordion title="Temel Özellikler">
    ...
    - **Koşullar (Conditions)**: Bir anomaliyi belirlemek için birden çok koşul kullanılabilir ve bunlar 've' operatörü ile bağlanır

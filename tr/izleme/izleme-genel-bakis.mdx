---
title: "Genel bakış"
description: "Sistemin genel sağlık durumunu izleyebilir, anormallikleri tespit edebilir, belirlenen eşik değerleri aşıldığında eylemler tetikleyebilir ve API'lerin sürekli çalışıp çalışmadığını kontrol edebilir."
---

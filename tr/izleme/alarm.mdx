...
<AccordionGroup>
  <Accordion title="Bildirim Ekleme">
    ...
    <Note>
      Eylemler hakkında detaylı bilgi için [Konnektörler](/tr/entegrasyon/konnektorler/genel-bakis) sayfasına bakınız.
    </Note>
  </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="Bağlantı Yönetimi" icon="network-wired" href="/tr/entegrasyon/baglanti-yonetimi/genel-bakis">

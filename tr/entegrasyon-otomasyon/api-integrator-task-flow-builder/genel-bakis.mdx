---
title: "Genel Bakış"
description: "API Entegratörü ve Task Flow Manager hakkında genel bilgiler, temel özellikler ve kullanım senaryoları sunar. Birden fazla görevi belirli bir sıraya göre otomatik olarak işletebilen bir iş akış yönetim sistemi kullanabilirsiniz. Her görev, kendisinden önceki adımın ürettiği çıktıyı kullanabilir, dış sistemlerle haberleşebilir veya iç sistemlerde tanımlanan işlemleri gerçekleştirebilir"
---

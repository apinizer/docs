...
description: "Birden fazla görevi entegre ederek akış şeklinde çalıştırmanızı sağlar. Birçok görev (task) bir işi yerine getirmek için entegre edilerek bir akış (flow) şeklinde çalıştırabilirsiniz. Akışta, sırasıyla çalışan görevler kendi API\"leri üzerinden entegre edilirler. Aktaki her bir görev, kendinden önce çalışan görev çıktısını kullanabilir ve görevi bir kere ya da birden fazla çalıştırabilir"
---

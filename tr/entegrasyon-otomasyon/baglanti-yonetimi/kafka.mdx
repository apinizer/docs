---
title: 'Kafka'
description: 'Kafka bağlantılarını yapılandırın ve yönetin'
---
...
| Alan | Değer |
|------|-------|
| Connection Adı | Kafka |
| Özet | Integration Flow adımlarının tekil Kafka topic erişimini güvenli ve yönetilebilir kılan Connection (Bağlantı) tanımı. |

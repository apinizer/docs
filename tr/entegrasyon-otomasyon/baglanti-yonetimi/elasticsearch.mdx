---
title: "Elasticsearch"
description: "Elasticsearch bağlantılarını yapılandırmanızı ve yönetmenizi sağlar. REST tabanlı log, metrik ve arama verilerini merkezi cluster\"a iletebilir, index ve yaşam döngüsü yönetimi gerçekleştirebilirsiniz"
---
  ...
  <Accordion title="Dışa Aktarma (Export)">
    <CardGroup cols={2}>
      ...
      <Card title="Dosya Formatı" icon="file-zipper">
        Format: `Tarih-connection-ConnectionAdı-export.zip`  
        Örnek: `13 Nov 2025-connection-Production_ElasticLog-export.zip`
      </Card>

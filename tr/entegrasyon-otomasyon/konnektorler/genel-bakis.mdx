---
title: "Genel Bakış"
description: "Apinizer'da Task Flow'larda ve API trafik log yönetiminde kullanılan konnektörler ile veritabanı, mesaj kuyrukları, e-posta, dosya transferi ve loglama işlemleri için entegrasyon bileşenlerini kullanabilir. Konnektörler, farklı sistemlere bağlanabilir, bu sistemlere veri gönderebilir veya bu sistemlerden veri çekebilir."
---

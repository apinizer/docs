---
title: "user_token_blackList Koleksiyonun Temizlenmesi"
description: 'user_token_blackList Koleksiyonun Temizlenmesi'
---
...
*   *   *   *   * 
  ...
  * Current: user_token_blackList Koleksiyonun Temizlenmesi

# user_token_blackList Koleksiyonun Temizlenmesi

`user_token_blackList` koleksiyonunda, Kullanıcıların çoklu giriş yapmaları durumunda tutulan kayıtlar bulunmaktadır. 

  

**Kayıt Temizleme Scripti:**

Aşağıdaki script, MongoDB'deki `user_token_blackList` koleksiyonunda depolanan uygulama loglarından belirtilen saat öncesine kadar olan kayıtları silmek için kullanılır.
...
### Kullanım:
  ...
  * Dosyaya çalıştırma yetkisi verilir: `chmod +x purge_apinizer_log_collection.sh`
  * Dosya çalıştırılır: `./purge_apinizer_log_collection.sh`
    * Uzun sürecek bir işlem yapacağınızı düşünüyorsanız komut sonuna boşluk bırakıp `&` karakterini ekleyerek arkaplanda çalışmasını sağlayabilirsiniz: `./purge_apinizer_log_collection.sh &`

...
description: 'taskflow_execution_log Koleksiyonunun temizlenmesi'
---
...
*   *   *   *   * 
  ...
  * Current: taskflow_execution_log Koleksiyonunun temizlenmesi

# taskflow_execution_log Koleksiyonunun temizlenmesi
...
Aşağıdaki script, MongoDB'deki `taskflow_execution_log `koleksiyonunda depolanan uygulama loglarından belirtilen saat öncesine kadar olan kayıtları silmek için kullanılır.
...
### Kullanım:
  ...
  * Dosyaya çalıştırma yetkisi verilir: `chmod +x purge_taskflow_execution_log_collection.sh`
  * Dosya çalıştırılır: `./purge_taskflow_execution_log_collection.sh` Uzun sürecek bir işlem yapacağınızı düşünüyorsanız komut sonuna boşluk bırakıp `&` karakterini ekleyerek arkaplanda çalışmasını sağlayabilirsiniz: `./purge_taskflow_execution_log_collection.sh &`

...
description: 'notification_user Koleksiyonunun Temizlenmesi'
---
...
*   *   *   *   * 
  ...
  * Current: notification_user Koleksiyonunun Temizlenmesi

# notification_user Koleksiyonunun Temizlenmesi

`notification_user` koleksiyonunda, Kullanıcı bildirimlerinin tutulduğu kayıtlar bulunmaktadır. 

  

**Kayıt Temizleme Scripti:**

Aşağıdaki script, MongoDB'deki `notification_user` koleksiyonunda depolanan uygulama loglarından belirtilen saat öncesine kadar olan kayıtları silmek için kullanılır.

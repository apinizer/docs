---
title: "anomaly_detector_result Koleksiyonunun temizlenmesi"
description: 'anomaly_detector_result Koleksiyonunun temizlenmesi'
---
...
*   *   *   *   * 
  ...
  * Current: anomaly_detector_result Koleksiyonunun temizlenmesi

# anomaly_detector_result Koleksiyonunun temizlenmesi
...
Aşağıdaki script, MongoDB'deki `anomaly_detector_result` koleksiyonunda depolanan uygulama loglarından belirtilen saat öncesine kadar olan kayıtları silmek için kullanılır.
...
### Kullanım:
  ...
  * Dosyaya çalıştırma yetkisi verilir: `chmod +x purge_anomaly_detector_result_collection.sh`
  * Dosya çalıştırılır: `./purge_anomaly_detector_result_collection.sh` Uzun sürecek bir işlem yapacağınızı düşünüyorsanız komut sonuna boşluk bırakıp `&` karakterini ekleyerek arkaplanda çalışmasını sağlayabilirsiniz: `./purge_anomaly_detector_result_collection.sh &`

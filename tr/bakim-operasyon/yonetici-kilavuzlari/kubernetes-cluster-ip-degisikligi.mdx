...
Eğer load balancer kullanmıyorsanız ve ağ üzerinde sanal ip oluşturamıyorsanız bunun için kullanabileceğiniz **Keepalived** ve **HAProxy** araçları ile bu işlemi gerçekleştirmek için [tıklayınız.](https://docs.apinizer.com/apinizer-dokumantasyonu/kubernetes-high-availability-yueksek-erisim-cluster-kurulumu-93356176.html)

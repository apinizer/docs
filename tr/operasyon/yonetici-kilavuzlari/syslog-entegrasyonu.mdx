...
İlk olarak Syslog bağlantı ayarlarının yapılması gerekmektedir bu bağlantı ayarları için [Syslog dökümanına](/tr/bakim-operasyon/yonetici-kilavuzlari/syslog-entegrasyonu) göz atabilirsiniz.

Apinizer trafik loglarının syslog'a aktarım ayarları için [bu sayfayı](/tr/bakim-operasyon/yonetici-kilavuzlari/traffic-loglar-syslog-aktarma) ziyaret edebilirsiniz.

Apinizer sistem loglarının syslog'a aktarım ayarları için [bu sayfayı](/tr/bakim-operasyon/yonetici-kilavuzlari/system-loglar-syslog-aktarma) ziyaret edebilirsiniz.

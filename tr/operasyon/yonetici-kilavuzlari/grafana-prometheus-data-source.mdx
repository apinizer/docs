...
description: "Grafana'yı Kubernetes ortamında kurarak Prometheus'u veri kaynağı olarak yapılandırabilir, PersistentVolume ve PersistentVolumeClaim ile veri kalıcılığını sağlayabilir ve dashboard'lar oluşturarak metrikleri görselleştirebilir."
---
...
Grafana'nın verileri Kubernetes cluster'ındaki bir node üzerinde depolanacağı için **PersistentVolume (PV)** ve **PersistentVolumeClaim (PVC)** tanımlamalarının yapılması gerekmektedir.

<Info>
Bu yapılandırma, Grafana'nın kapanma veya yeniden başlatılma durumlarında verilerini korumasını sağlar.
</Info>
...
<Tip>
`<NODE_HOSTNAME>` değerini kendi node hostname'iniz ile değiştirmeyi unutmayın.
</Tip>
...
## Grafana Üzerinde Data Source Olarak Prometheus'un Ayarlanması

<Steps>
  <Step>
    **Grafana'da Oturum Açın**

    Grafana arayüzüne admin kullanıcısı ile giriş yapın.
  </Step>
  <Step>
    **Data Source Ekleme**

    Sol Menüden Data Source sekmesine tıklayın ve Add new data source seçeneğini seçin.
      <img
          src="/images/operasyon/entg1.png"
  ...
  <Step>
    **Prometheus Seçimi**
    ...
    Data source olarak Prometheus seçilir. Prometheus Connection url'si ve gerekli diğer ayarlar girilip kaydedilir.

      <img
          src="/images/operasyon/entg2.png"
          alt="Panel 2: En Yüksek Bellek Kullanımına Sahip Önbellek Özellikleri"
          width="800"
          height="400"
      />
      <img
          src="/images/operasyon/entg3.png"
          alt="Panel 2: En Yüksek Bellek Kullanımına Sahip Önbellek Özellikleri"
          width="800"
          height="400"
      />
  ...
  <Step>
    **Dashboard Oluşturma**
    ...
    Sol Menüden Dashboard sekmesine tıklayın ve new dashboard seçeneğini seçin.

      <img
          src="/images/operasyon/entg4.png"
          alt="Panel 2: En Yüksek Bellek Kullanımına Sahip Önbellek Özellikleri"
          width="800"
          height="400"
      />  </Step>
  <Step>
    **Data Source Seçimi**
    ...
    Yeni dashboard oluşturulur ve data source olarak prometheus seçilir.

      <img
          src="/images/operasyon/entg5.png"
          alt="Panel 2: En Yüksek Bellek Kullanımına Sahip Önbellek Özellikleri"
          width="800"
          height="400"
      />  </Step>

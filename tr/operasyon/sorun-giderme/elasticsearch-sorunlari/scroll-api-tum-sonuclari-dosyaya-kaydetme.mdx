...
description: "Elasticsearch'te 1000'den fazla kayıt içeren sorgu sonuçlarını Scroll API kullanarak alabilir ve bash script ile dosyaya kaydedebilir. Apinizer'da tutulan logları başka ortamlara aktarabilir, farklı ürünlerle inceleyebilir ve büyük veri setlerini veri kaybı olmadan dışa aktarabilir."
---
...
<Info>
Bu sorgu içerisinde yer alan alanların ne anlama geldiğine bakmak için [bu sayfayı](/tr/kurulum/elasticsearch/manuel-ilm-politikasi-ve-template-olusturma) ziyaret edebilirsiniz.
</Info>
...
<Frame caption="Script Çalıştırma Örneği">
  <img
    src="/images/elasticsearch/scroll-api-output.png"
    alt="Scroll API Script Çıktısı"
    width="900"
    height="400"

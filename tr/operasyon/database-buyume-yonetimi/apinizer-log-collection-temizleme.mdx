...
description: 'apinizer_log Koleksiyonunun temizlenmesi'
---
...
*   *   *   *   * 
  ...
  * Current: apinizer_log Koleksiyonunun temizlenmesi

# apinizer_log Koleksiyonunun temizlenmesi
...
Aşağıdaki script, MongoDB'deki `apinizer_log` koleksiyonunda depolanan uygulama loglarından belirtilen saat öncesine kadar olan kayıtları silmek için kullanılır.

...
description: "API trafiğinde anomali bulmak için tutulan kayıtların bulunduğu anomaly_detector_result koleksiyonunda depolanan kayıtlardan belirtilen zaman dilimine göre eski kayıtların temizlenmesini sağlar."
---

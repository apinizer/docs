...
description: 'report_configuration_result Koleksiyonunun temizlenmesi'
---
...
*   *   *   *   * 
  ...
  * Current: report_configuration_result Koleksiyonunun temizlenmesi

# report_configuration_result Koleksiyonunun temizlenmesi
...
Aşağıdaki script, MongoDB'deki `report_configuration_result` koleksiyonunda depolanan uygulama loglarından belirtilen saat öncesine kadar olan kayıtları silmek için kullanılır.
...
### Kullanım:
  ...
  * Dosyaya çalıştırma yetkisi verilir: `chmod +x purge_report_configuration_result_collection.sh`
  * Dosya çalıştırılır: `./purge_report_configuration_result_collection.sh` Uzun sürecek bir işlem yapacağınızı düşünüyorsanız komut sonuna boşluk bırakıp `&` karakterini ekleyerek arkaplanda çalışmasını sağlayabilirsiniz: `./purge_report_configuration_result_collection.sh &`

...
description: "uptime_monitor_result Koleksiyonunun temizlenmesi"
---
...
*   *   *   *   * 
  ...
  * Current: uptime_monitor_result Koleksiyonunun temizlenmesi

# uptime_monitor_result Koleksiyonunun temizlenmesi
...
Aşağıdaki script, MongoDB'deki `uptime_monitor_result `koleksiyonunda depolanan uygulama loglarından belirtilen saat öncesine kadar olan kayıtları silmek için kullanılır.
...
### Kullanım:
  ...
  * Dosyaya çalıştırma yetkisi verilir: `chmod +x purge_uptime_monitor_result_collection.sh`
  * Dosya çalıştırılır: `./purge_uptime_monitor_result_collection.sh` Uzun sürecek bir işlem yapacağınızı düşünüyorsanız komut sonuna boşluk bırakıp `&` karakterini ekleyerek arkaplanda çalışmasını sağlayabilirsiniz: `./purge_uptime_monitor_result_collection.sh &`

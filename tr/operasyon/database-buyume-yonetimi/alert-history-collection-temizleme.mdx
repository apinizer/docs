...
description: "alert_history Koleksiyonunun temizlenmesi"
---
...
*   *   *   *   * 
  ...
  * Current: alert_history Koleksiyonunun temizlenmesi

# alert_history Koleksiyonunun temizlenmesi

Apinizer üzerinde belirli koşullarda action kullanılarak Alarm'lar oluşturulabilmektedir. Bu alarmlar'ın işlem saati, action içerisindeki mesaj bilgileri ve hangi obje üzerinden tetiklendiği gibi bilgiler `alert_history `koleksiyonunda tutulmaktadır.

  

**Kayıt Temizleme Scripti:**

Aşağıdaki script, MongoDB'deki `alert_history `koleksiyonunda depolanan uygulama loglarından belirtilen saat öncesine kadar olan kayıtları silmek için kullanılır.
...
### Kullanım:
  ...
  * Dosyaya çalıştırma yetkisi verilir: `chmod +x purge_alert_history_collection.sh`
  * Dosya çalıştırılır: `./purge_alert_history_collection.sh` Uzun sürecek bir işlem yapacağınızı düşünüyorsanız komut sonuna boşluk bırakıp `&` karakterini ekleyerek arkaplanda çalışmasını sağlayabilirsiniz: `./purge_alert_history_collection.sh &`

...
description: "history_acl Koleksiyonunun temizlenmesi"
---
...
*   *   *   *   * 
  ...
  * Current: history_acl Koleksiyonunun temizlenmesi

# history_acl Koleksiyonunun temizlenmesi
...
Aşağıdaki script, MongoDB'deki `history_acl `koleksiyonunda depolanan uygulama loglarından belirtilen saat öncesine kadar olan kayıtları silmek için kullanılır.
...
### Kullanım:
  ...
  * Dosyaya çalıştırma yetkisi verilir: `chmod +x purge_history_acl_collection.sh`
  * Dosya çalıştırılır: `./purge_history_acl_collection.sh` Uzun sürecek bir işlem yapacağınızı düşünüyorsanız komut sonuna boşluk bırakıp `&` karakterini ekleyerek arkaplanda çalışmasını sağlayabilirsiniz: `./purge_history_acl_collection.sh &`

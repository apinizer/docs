...
Tekil istek düzeyinde aynı sinyaller için [Gateway Trafiği](/tr/analytic/api-trafigi) detay penceresindeki **Yönlendirme Teşhisi** bölümüne bakabilirsiniz.
...
2. [Gateway Trafiği](/tr/analytic/api-trafigi) sayfasından hatalı istekleri filtreleyin
...
3. [Gateway Trafiği](/tr/analytic/api-trafigi) ile şüpheli istekleri inceleyin
...
<CardGroup cols={2}>
  ...
  <Card title="Detaylı Analiz Araçlarını Kullanın" icon="magnifying-glass-chart">
    ...
    - [Gateway Trafiği](/tr/analytic/api-trafigi) ile detaylı inceleyin

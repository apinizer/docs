...
<Warning>
Apinizer Yönetim Konsolunda API Trafiğinin sorgulanması ve analitik olarak görselleştirilmesi ancak ilgili ortama [Elasticsearch Konnektörü](/tr/admin/baglanti-yonetimi/elasticsearch-monitor) eklenmesi ile mümkün olmaktadır.
</Warning>

...
<Info>
Bir API Proxy birden fazla [Ortam](/tr/concepts/temel-kavramlar/ortam-nedir)'a yüklenebildiği için metrikler, **ortam bazlı sorgulanmaktadır**. Sayfanın üst kısmından ortam seçimi yapılmalıdır.
</Info>

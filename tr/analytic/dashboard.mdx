...
Sayfanın alt bölümünde yönlendirme teşhis özeti yer alır:

- **Failure Reason Distribution** — hata nedenlerinin dağılımı (ör. Upstream HTTP Error)
- **Phase Latency (p50/p95/p99)** — Upstream Selection, DNS, TTFB, Body Read, Pool Wait faz gecikmeleri
- **Top Failing Proxies** — seçilen pencerede en çok hata veren API Proxy'ler

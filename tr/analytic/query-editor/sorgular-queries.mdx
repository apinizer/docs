...
**Keyword** koşulu tek bir mesaj bölgesinin tek bir parçasında arar. Önce bölge, sonra parça seçilir; koşul yalnız o bölgenin verisiyle eşleşir.
...
- **Başlık** ve **Parametre** parçalarında başlık/parametre adı girilir; operatör değerine uygulanır. Yanıtlarda sorgu parametresi bulunmaz.
...
:::tip
İsteğin hangi hedefe yönlendirildiğini görmek isterseniz, **Sorgu Sonucu Alanları** bölümünden yönlendirme adresi alanını seçmeniz yeterlidir. Bu bilgi tüm trafik kayıtlarında tutulur.
:::

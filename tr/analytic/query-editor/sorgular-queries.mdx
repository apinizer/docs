---
title: "Sorgular"
description: "Sorgular ile Apinizer'da bulunan log kayıtlarını analiz edebilirsiniz. HTTP Metodu, HTTP Durum Kodu, Hata Tipi, İstemci IP gibi alanlardan beklenen durumlar ile ve (must), ya da (should), değil (must not) tiplerindeki kriterlerin birleşiminden oluşturabilirsiniz. Sorgu oluşturabilirsiniz, test edebilirsiniz ve sonuçlarını görüntüleyebilirsiniz."
---

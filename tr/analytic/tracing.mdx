...
{/* TODO_SCREENSHOT: Trace ekranında bir politika düğümü seçili, üst bar'da "Execution Details" butonu görünüyor ve modal açık (örnek: Cache LOOKUP HIT — Cache Key, Target Variable, cached value accordion'ları). Dosya adı: trace-execution-details-modal.png */}
<Frame>
  <img src="/images/develop/izleme-analiz/trace-execution-details-modal.png"
       alt="Trace ekranı — Execution Details butonu ve açık modal (politika-spesifik accordion'lar)"
       width="1000" />
</Frame>

...
<Info>
**"rt"** alanında yer alan değerlerin listesini [Hata Mesajları](/tr/admin/system-settings/hata-mesajlari) sayfasında yer alan "Sonuç Tipi Enum Değerleri" tablosunda inceleyebilirsiniz.

**"pet"** alanında yer alan değerlerin listesini [Hata Mesajları](/tr/admin/system-settings/hata-mesajlari) sayfasında yer alan "Hata Üst Tipi Enum Değerleri" tablosunda inceleyebilirsiniz.

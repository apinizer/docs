...
description: "API trafik log kayıtlarının veri yapısını inceleyebilir, alan tanımlarını görüntüleyebilir ve JSON formatını anlayabilir. Konnektörlere gönderilen JSON mesajlarının yapısını öğrenebilir."
---

---
title: "Gateway Trafiği"
description: "Projedeki tüm API Proxy'lere gelen istek ve yanıtları Gateway Trafiği ekranında detaylarıyla listeleyebilirsiniz. Mesajlardaki sorunları araştırabilir, filtreleyebilir, detaylı ve JSON görünümü kullanabilir, kayıtları indirebilir ve hızlı test çalıştırabilirsiniz."
---
...
<img
  ...
  alt="Gateway Trafiği — liste görünümü, filtre satırı ve tablo kolonları"
  width="1000"
  height="424"
/>
  ...
  <TabItem value="basit-filtreleme-basic" label="Basit Filtreleme (Basic)">
    Kayıtlara, belirli bir zaman aralığı, uç nokta (endpoint) ya da HTTP metodu gibi belirlenmiş kriterler ile filtre uygulanabilir.
      ...
      <img
        ...
        alt="Gateway Trafiği — Basit Filtreleme sekmesi, Canary ve Mirror Traffic filtreleri"
        width="1000"
        height="358"
      />

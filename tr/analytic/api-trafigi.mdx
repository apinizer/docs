...
<Tabs>
  <TabItem value="basit-filtreleme-basic" label="Basit Filtreleme (Basic)">
    Kayıtlara, belirli bir zaman aralığı, uç nokta (endpoint) ya da HTTP metodu gibi belirlenmiş kriterler ile filtre uygulanabilir.
      ...
      {/* TODO: ekran görüntüsü — Gateway Traffic ekranı "Daha fazla filtre" > Basit Filtreleme sekmesi, Canary İsteği/Canary Durumu/Yansıtma Trafiği satırı dahil; eski dosya: /images/analytic/api-traffic-basic-filter-overview.png; hedef: /images/2026-09-2/api-traffic-basic-filter-overview.png */}

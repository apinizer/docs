...
<Info>
Bir API Proxy birden fazla [Ortam](/tr/apinizer-anlama/temel-kavramlar/ortam-nedir)'a yüklenebileceği için metrikler, ortam bazlı sorgulanır. Tüm analitik ekranlarında öncelikle **Ortam bilgisi seçilerek** metrikler filtrelenir.
</Info>
...
<Info>
Varsayılan olarak **Genel Bakış (Overview)** bölümü açık gelir. İncelenmek istenen bölümün adına tıklandığında o alana ilişkin log kayıtları görüntülenir.
</Info>

## JSON Görünüm (JSON View)

Kaydın sağ tarafında yer alan **JSON Görünüm (JSON View)** tuşuna basıldığında log kaydın JSON hali ekrana gelir.
...
Kaydın sağ tarafında yer alan **Hızlı Test** tuşuna basıldığında kayda gelen orijinal mesaj içeriği [Test Konsola](/tr/gelistirici/test-debug-araclari/test-console) yerleştirilmiş şekilde Test Konsol ekranı açılır.
...
<CardGroup cols={2}>
  <Card title="API Proxy API Trafiği" icon="chart-line" href="/tr/gelistirici/izleme-analiz/api-trafigi">

...
description: "Apinizer'da API Proxy endpoint'lerinin istek ve yanıt boyut metriklerini analiz eder. Projedeki API Proxy'lerin metot/uç nokta bilgisine göre gruplayarak veri trafiği oluşturan endpoint'leri tespit edebilir ve performans optimizasyonu için gerekli aksiyonları alabilir."
---

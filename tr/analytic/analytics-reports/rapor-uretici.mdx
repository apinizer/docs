...
| **Kırılım boyutu** | Ağ Geçidi Trafiği (Zamana Göre) | Raporu boyut değeri başına ayrı bir seriye böler: API Proxy, HTTP Metodu veya Kimlik Bilgisi. Varsayılan *Yok (sistem geneli)* değeri, tüm trafiği kapsayan tek bir seri üretir. Seçildiğinde çıktıya **Kırılım** sütunu eklenir. |

...
**Tespit:**
- Manager'da "undeployed" görünen proxy'nin Gateway adresine istek atın. `404` yerine `200` dönüyorsa bu durumla karşı karşıyasınız
- Adresi tahmin etmeyin; Management API'nin `invoke-info` ucundan okuyun — bu uç, deploy edilmemiş görünen kayıtlar için de gerçek çağrı adresini döndürür

...
description: "Apinizer'da veritabanı bağlantı sorunlarını tespit edebilir, connection pool ayarlarını optimize edebilir, ağ bağlantı sorunlarını çözebilir ve DNS çözümleme sorunlarını yönetebilir."
---
...
- [Altyapı Sorunları](/tr/operations/sorun-giderme/kubernetes-docker-containerd-sorunlari)

...
Alanları elle doldurmak yerine ekranın üst kısmındaki **Hazır Ayar Uygula** menüsünden dizin türünüzü
(Active Directory, OpenLDAP, 389 Directory Server / FreeIPA) seçin. Önerilen değerler alanlara
otomatik dolar; hiçbir şey kaydedilmez. Değerleri gözden geçirin, sonra kaydedin. Bilgileri girdikten
sonra **Bağlantıyı test et (adım adım)** butonuna tıklayın. Bu buton bağlantıyı 7 ayrı adımda (sunucu
bağlantısı, güvenli bağlantı, servis hesabı girişi, şema kontrolü gibi) test eder. Ardından girdiğiniz
kullanıcı adı/parola ile bir oturum açma denemesi de yapabilirsiniz.

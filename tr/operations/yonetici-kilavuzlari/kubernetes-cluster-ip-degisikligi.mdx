...
<Warning>
Eğer load balancer kullanmıyorsanız ve ağ üzerinde sanal ip oluşturamıyorsanız bunun için kullanabileceğiniz **Keepalived** ve **HAProxy** araçları ile bu işlemi gerçekleştirmek için [tıklayınız.](/tr/setup/kubernetes/kubernetes-high-availability-yuksek-erisim-cluster.mdx)

...
description: "Apinizer ortamlarının yatay otomatik ölçeklendirilmesi (horizontal auto-scaling) için Kubernetes HPA yapılandırması. Metric server kurulumu, CPU/memory bazlı pod scaling kurulumu."
---
...
Kubernetes kümenizde ölçeklendirme özelliğini kullanabilmek için bir metric-server kurulu olması gerekmektedir. Eğer mevcut değil ise kurulum için [buraya tıklayabilirsiniz.](/tr/setup/kubernetes)

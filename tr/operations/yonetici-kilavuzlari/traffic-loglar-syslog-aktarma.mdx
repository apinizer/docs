...
Alıcı sunucunun mesaj boyutu sınırını hiç yükseltmek istemiyorsanız — veya çerçevelemenin uzatılacağı bir yer olmayan UDP kullanıyorsanız — Syslog connection'ı büyük bir kaydı tek mesaj yerine birden fazla syslog mesajına bölebilir; bkz. [Büyük Mesajları Bölme](/tr/integrations/baglanti-yonetimi/syslog#buyuk-mesajlari-bolme).

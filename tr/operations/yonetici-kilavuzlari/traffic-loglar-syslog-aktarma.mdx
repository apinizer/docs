...
Syslog bağlantısında bir yedek (failover) connector tanımlamanız önerilir: kuyruk dolduğunda veya rsyslog sunucusuna erişilemediğinde kayıtlar bu bağlayıcı üzerinden aktarılmaya devam eder, kayıt kaybı yaşanmaz.

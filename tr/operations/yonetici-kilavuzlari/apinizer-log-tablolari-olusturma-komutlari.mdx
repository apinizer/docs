...
**Mevcut bir kurulumu 2026.09.0'a yükseltiyorsanız** bu komutu çalıştırmayın; tablonuz zaten var. Bunun yerine [2026.09.0 — Log Tablosu ALTER Scriptleri](/tr/release-notes/2026-09-0-log-tablosu-alter) sayfasındaki `ALTER TABLE` komutunu kullanın.

...
Trafik listesi ekranlarında toplam kayıt sayısı, indeks çok büyük olduğunda kesin bir sayı yerine **"10.000'den fazla"** biçiminde gösterilir. Bu bilinçli bir davranıştır: her sayfa değişiminde milyarlarca kaydı baştan saymak, sorgunun en pahalı kısmıdır ve ekranda gösterilen ilk sayfaya hiçbir katkısı yoktur.

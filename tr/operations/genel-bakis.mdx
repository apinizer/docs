...
<CardGroup cols={2}>
  ...
  <Card title="Yaygın Sorunlar" href="/tr/operations/yaygın-sorunlar-cozumleri/apinizer-sorunlari">
    Sık karşılaşılan sorunlar ve çözümleri
  </Card>
  <Card title="Kubernetes" href="/tr/setup/kubernetes/ubuntu-kubernetes">
    Kubernetes kurulum ve yönetim kılavuzları
  </Card>
  <Card title="Hata Kodları" href="/tr/operations/yaygın-sorunlar-cozumleri/authentication-failures">
    Hata kodları referansı
  </Card>

...
* Private Docker Registry kurulumu → [Container Registry](/tr/operations/container-registry/container-imajlari-ve-registry)
...
Kurumsal veya private container registry üzerinden Apinizer imajlarına erişim yapılandırması.

**İçerik:**
* Nexus, Harbor ve private registry senaryoları
* containerd registry mirror yapılandırması
* Deployment imaj path güncellemesi
* Private registry kurulumu (CentOS 7)

**Ne Zaman Kullanılır:**
* Kurumsal Nexus veya Harbor registry kullanılırken
* İnternete kapalı ortamlarda imaj erişimi yapılandırılırken
* Kendi private registry kurulurken
* Sürüm yükseltme öncesi imaj path'leri güncellenirken
...
Operasyon Genel Bakış
    ...
    ├── Container Registry (İmaj registry yapılandırması)
...
<CardGroup cols={2}>
  <Card title="Yedekleme ve Geri Yükleme" href="/tr/operations/yedek-ve-geri-yukleme/yedekleme">
    MongoDB yedekleme ve geri yükleme işlemleri
  </Card>
  <Card title="Veritabanı Büyüme Yönetimi" href="/tr/operations/database-buyume-yonetimi/genel-bakis">
    MongoDB koleksiyon temizleme ve yönetimi
  </Card>
  <Card title="Faydalı Komutlar" href="/tr/operations/faydali-komutlar/mongodb">
    MongoDB, Kubernetes ve Elasticsearch komutları
  </Card>
  <Card title="Sorun Giderme" href="/tr/operations/sorun-giderme/mongodb-sorunlari">
    Sorun tespiti ve çözüm kılavuzları
  </Card>
  <Card title="Performans Tuning" href="/tr/operations/yonetici-kilavuzlari/pod-thread-sayisi-periyodik-izleme">
    Sistem optimizasyonu rehberleri
  </Card>
  <Card title="Healthcheck ve Versiyon" href="/tr/operations/healthcheck-versiyon-adresleri">
    Sistem sağlık kontrolleri
  </Card>
  <Card title="Log Analizi" href="/tr/operations/log-analizi-kilavuzu/kibana-log-search">
    Log analizi ve arama kılavuzları
  </Card>
  <Card title="Yaygın Sorunlar" href="/tr/operations/yaygin-sorunlar-cozumleri/apinizer-sorunlari">
    Sık karşılaşılan sorunlar ve çözümleri
  </Card>
  <Card title="Kubernetes" href="/tr/setup/kubernetes">
    Kubernetes kurulum ve yönetim kılavuzları
  </Card>
  <Card title="Hata Kodları" href="/tr/operations/yaygin-sorunlar-cozumleri/authentication-failures">
    Hata kodları referansı
  </Card>
  <Card title="Yönetici Kılavuzları" href="/tr/operations/yonetici-kilavuzlari/prometheus-grafana-entegrasyonu">

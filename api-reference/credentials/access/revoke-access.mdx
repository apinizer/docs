---
title: 'Revoke Access'
description: 'Revokes access from a credential for one or more API Proxies or API Proxy Groups. The credential will no longer be able to access the specified resources. Access revocation is automatically deployed to all environments.'
---
...
Same as Grant Access. See [Grant Access](/api-reference/credentials/access/grant-access) for field descriptions.

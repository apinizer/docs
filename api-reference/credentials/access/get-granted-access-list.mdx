---
title: "Get Granted Access List"
description: "Retrieves the list of API Proxies and API Proxy Groups that a credential has access to. This endpoint shows which resources the credential can access."
---
...
| type | string | Type of access. See [EnumAccessType](#enumaccesstype-type) |

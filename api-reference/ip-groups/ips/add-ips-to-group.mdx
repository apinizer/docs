---
title: "Add IPs to Group"
description: "Adds IP addresses or CIDR ranges to an existing IP Group. IPs are added to the existing list (duplicates are ignored)."
---
...
- [Delete IPs from Group](/api-reference/ip-groups/ips/delete-ips-from-group) - Remove IPs from group

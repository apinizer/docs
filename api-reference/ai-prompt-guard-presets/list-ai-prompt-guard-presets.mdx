...
- **Built-in Presets**:
  - Rows with `builtIn: true` come from the seeded OWASP LLM Top 10 / MITRE ATLAS signature pack. They are editable and deletable like any other row — see [Built-in Presets Are Editable](/api-reference/ai-prompt-guard-presets#built-in-presets-are-editable).

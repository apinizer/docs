...
| builtIn | boolean | `true` for system-provided built-in templates, `false` for user-created connections. Responses also carry a deprecated `isBuiltIn` alias for pre-2026.04 clients. |

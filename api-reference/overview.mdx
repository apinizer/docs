---
title: "API Reference"
description: "Comprehensive documentation for all Management API endpoints organized by functionality."
---
...
This section documents the **Management API** used to administer Apinizer. For runtime token endpoints (OAuth2, JWT issuance, introspection, revocation, and discovery), see the **Gateway Token Endpoints** section.

:::

:::info

This reference covers the public Management API endpoints documented in this site. Additional `/apiops` routes (for example utility, promotion, or portal helpers) may exist in the product but are not listed here unless they have a dedicated page.
...
- [Environments Overview](/api-reference/environments/get-environments-by-project) - Complete environment management documentation
...
- [Policies Overview](/api-reference/policies/crud/add-policy) - Complete policy management documentation
...
- [Connections Overview](/api-reference/connections/connections/connection-activemq) - Complete connection management documentation
...
- [Credentials Overview](/api-reference/credentials/access/get-granted-access-list) - Complete credential management documentation
...
- [API Proxy Groups Overview](/api-reference/api-proxy-groups/api-proxies/add-api-proxy-to-group) - Complete API Proxy Group management documentation
...
- [Environment Variables Overview](/api-reference/environment-variables/crud/create-environment-variable) - Complete environment variable management documentation
...
- [RLCL Overview](/api-reference/rlcl/condition/add-condition) - Complete RLCL management documentation
- Manage rate limits and connection limits
- Configure conditions, credentials, and endpoints

### GeoLocation

- [GeoLocation Overview](/api-reference/geolocation/disable-geolocation) - Complete geolocation management documentation
- Enable/disable geolocation
- Upload MMDB files

### Reports

- [Reports Overview](/api-reference/reports/api-report) - Complete reporting documentation
- API reports
- Organization API data model access reports

### Test

- [Test Overview](/api-reference/test/healthcheck) - Test endpoints
- Health check
- Secure hello

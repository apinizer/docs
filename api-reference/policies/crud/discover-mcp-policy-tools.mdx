...
description: "Preview-only tools/list discovery for an existing MCP Tool Call or MCP Tool Invoke policy's inline mcpServer — probes the live catalog without persisting anything on the policy."
---

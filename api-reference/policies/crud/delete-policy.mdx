---
title: "Delete Policy"
description: "Deletes an existing policy from an API Proxy. The policy can be deleted from the request, response, or error pipeline, and can be deleted from all endpoints or a specific endpoint."
---
## Endpoint
...
- [Deploy API Proxy](/api-reference/api-proxies/deployment/deploy) - Deploy API Proxy after changes

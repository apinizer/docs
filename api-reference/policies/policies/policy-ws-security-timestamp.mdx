---
title: "WS Security Timestamp Policy"
description: "WS Security Timestamp policy adds WS-Security Timestamp element to SOAP requests before forwarding to the backend service. It provides timestamp-based replay attack prevention according to WS-Security standards."
---
...
- [WS Security To Target Policy](/api-reference/policies/policies/policy-ws-security-to-target) - Complete WS-Security configuration

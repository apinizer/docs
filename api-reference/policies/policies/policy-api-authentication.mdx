---
title: "API Authentication Policy"
description: "API Authentication policy adds authentication credentials to outgoing requests to target APIs. It supports BASIC, BASE64, DIGEST, and API authentication types, and can send credentials via headers, parameters, body message, or body injection."
---
...
- [Basic Authentication Policy](/api-reference/policies/policies/policy-auth-basic) - Authenticate incoming requests with Basic Auth
- [Digest Authentication Policy](/api-reference/policies/policies/policy-auth-digest) - Authenticate incoming requests with Digest Auth

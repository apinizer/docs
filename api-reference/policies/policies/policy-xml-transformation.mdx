---
title: "XML Transformation Policy"
description: "XML Transformation policy transforms XML request/response bodies. It supports XML-to-XML transformation using XSLT and XML-to-JSON conversion with configurable options."
---
...
- [JSON Transformation Policy](/api-reference/policies/policies/policy-json-transformation) - Transform JSON messages

---
title: 'API Based Throttling Policy'
description: 'API Based Throttling policy limits the number of requests that can be made within a specified time interval. It uses a variable (such as API key, user ID, or IP address) to identify and throttle individual clients.'
---
...
For complete list of context values, see [EnumVariableContextValue](/api-reference/appendix/variable-definition).

---
title: "WS Security From Target Policy"
description: "WS Security From Target policy processes WS-Security headers from SOAP responses received from the backend service. It can decrypt encrypted content and verify signatures according to WS-Security standards."
---
...
- [WS Security To Target Policy](/api-reference/policies/policies/policy-ws-security-to-target) - Add WS-Security to requests

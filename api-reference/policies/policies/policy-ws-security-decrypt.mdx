---
title: "WS Security Decrypt Policy"
description: "WS Security Decrypt policy decrypts encrypted SOAP message parts from backend responses. It processes WS-Security Encryption elements according to WS-Security standards."
---
...
- [WS Security Encrypt Policy](/api-reference/policies/policies/policy-ws-security-encrypt) - Encrypt WS-Security content

---
title: 'Max Message Size Policy'
description: 'Max Message Size policy limits the maximum size of request or response messages. Messages exceeding the specified size are rejected before processing. This policy helps prevent DoS attacks and ensures efficient resource usage.'
---
...
- [Min Message Size Policy](/api-reference/policies/policies/policy-min-message-size) - Set minimum message size

---
title: "WS Security Encrypt Policy"
description: "WS Security Encrypt policy encrypts SOAP message parts before forwarding to the backend service. It adds WS-Security Encryption elements to the SOAP message according to WS-Security standards."
---
...
- [WS Security Decrypt Policy](/api-reference/policies/policies/policy-ws-security-decrypt) - Decrypt WS-Security content

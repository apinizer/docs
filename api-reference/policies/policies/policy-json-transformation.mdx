---
title: 'JSON Transformation Policy'
description: 'JSON Transformation policy transforms JSON request/response bodies. It supports JSON-to-JSON transformation using JOLT specification and JSON-to-XML conversion with configurable options.'
---
...
- [XML Transformation Policy](/api-reference/policies/policies/policy-xml-transformation) - Transform XML messages

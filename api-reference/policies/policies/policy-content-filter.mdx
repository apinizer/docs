---
title: 'Content Filter Policy'
description: 'Content Filter policy filters request/response content based on regex patterns. It can block or delete content matching specified patterns in headers, body, or parameters.'
---

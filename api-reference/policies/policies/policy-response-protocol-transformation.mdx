...
description: "Response Protocol Transformation policy transforms SOAP responses to REST responses. This policy is used when you need to convert SOAP responses from the backend service to JSON/XML REST format."
---

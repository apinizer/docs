...
description: 'Retrieves an organization-level report showing API and data model access information. This report includes information about which APIs are shared externally or both internally and externally.'
---
## Endpoint
...
| result | object | Report result. See [Report Result Object](#report-result-object-result) |
...
- [API Report](/api-reference/reports/api-report) - API Proxy report

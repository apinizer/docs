---
title: 'API Report'
description: 'Retrieves a comprehensive report of all API Proxies and API Proxy Groups with detailed metadata. This report includes information about API configurations, endpoints, and other relevant details.'
---
## Endpoint

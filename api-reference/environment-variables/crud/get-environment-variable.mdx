...
description: "Retrieves a specific environment variable by name. Values that are not marked Secret are returned decrypted; Secret values are always returned as null."
---
## Endpoint

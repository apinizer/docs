...
- **Built-in Presets**:
  - Rows with `builtIn: true` come from the seeded Türkiye PII catalog. They are editable and deletable like any other row — see [Built-in Presets Are Editable](/api-reference/ai-privacy-presets#built-in-presets-are-editable).
- **Scope**:

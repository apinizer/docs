...
description: 'Updates an existing API Proxy Group. The name cannot be changed (it is used as the identifier). All other fields can be updated.'
---
...
Same structure as Create API Proxy Group. See [Create API Proxy Group](/api-reference/api-proxy-groups/crud/create-api-proxy-group) for field descriptions.

---
title: "Create API Proxy Group"
description: "Creates a new API Proxy Group. API Proxy Groups allow you to group multiple API Proxies together and manage them as a single unit with shared client routes, CORS settings, and cache settings."
---
## Endpoint
...
| clientRoute | object | Yes | - | Client route configuration. See [Client Route Object](#client-route-object-clientroute) |
...
| methodList | array[string] | No | null | List of HTTP methods to match. See [EnumHttpRequestMethod](#enumhttprequestmethod-methodlist) |
| hostList | array[string] | No | null | List of host names to match |
| headerList | array[object] | No | null | List of headers to match. See [Header Object](#header-object-headerlist) |
...
{
  "status": "FAILURE",
  "resultMessage": "clientRoute value can not be empty!"
}
```
...
{
  "status": "FAILURE",
  "resultMessage": "clientRoute value needs at least one relativePath!"
}
```
...
{
  "status": "FAILURE",
  "resultMessage": "relativePath value in clientRoute object can not be empty!"
}
```
...
{
  "status": "FAILURE",
  "resultMessage": "ApiProxyGroup: (PaymentAPIGroup) is already created! If you want to udate it use update endpoint!"
}
```
...
- [Update API Proxy Group](/api-reference/api-proxy-groups/crud/update-api-proxy-group) - Update an API Proxy Group
- [Add API Proxy to Group](/api-reference/api-proxy-groups/api-proxies/add-api-proxy-to-group) - Add API Proxies to group

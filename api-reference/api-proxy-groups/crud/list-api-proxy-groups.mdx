---
title: "List API Proxy Groups"
description: "Retrieves all API Proxy Groups for a specified project. API Proxy Groups allow you to group multiple API Proxies together and manage them as a single unit."
---
## Endpoint

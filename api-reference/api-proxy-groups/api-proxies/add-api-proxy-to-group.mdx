---
title: "Add API Proxy to Group"
description: "Adds an API Proxy to an API Proxy Group. The API Proxy becomes a member of the group and can be managed together with other members."
---
## Endpoint
...
{
  "status": "FAILURE",
  "resultMessage": "ApiProxy (MyAPI) is not found or user does not have privilege to access it!"
}
```

---
title: "Remove API Proxy from Group"
description: "Removes an API Proxy from an API Proxy Group. The API Proxy is no longer a member of the group but remains in the project."
---

---
title: "List Proxy Group Deploy History"
description: "Returns the deploy/undeploy history list of the specified API Proxy Group. Each record includes the revision number, deployment timestamp, user, environment, description, and persistent flag."
---

...
To configure token validity periods, grant types, JWT signing algorithms, and scope handling behavior, see [Token Management Settings](/en/admin/identity-management/token-management-settings) in the Administration section.

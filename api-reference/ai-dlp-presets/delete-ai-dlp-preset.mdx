...
description: "Deletes an AI DLP (secret/credential) preset by name from the given scope, built-in or custom. Requires an admin API token. Deleting a built-in preset is permanent — it does not come back on a version upgrade."
---

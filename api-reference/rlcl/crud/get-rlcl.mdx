...
| outOfTargetAction | enum | `BLOCK`, `GENERAL_QUOTA` or `NONE` - behaviour for requests outside the target audience. `NONE` means the list does not apply to them at all |

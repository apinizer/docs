---
title: "Add Credentials to RLCL"
description: "Adds credentials to an existing RLCL. Credentials added to the RLCL will be subject to the rate limiting rules defined in the RLCL."
---
## Endpoint
...
{
  "status": "FAILURE",
  "resultMessage": "credentialNameList value can not be empty!"
}
```
...
{
  "status": "FAILURE",
  "resultMessage": "Credential with name (api-user) is not found in project!"
}
```
...
- [Delete Credentials](/api-reference/rlcl/credentials/delete-credentials) - Remove credentials

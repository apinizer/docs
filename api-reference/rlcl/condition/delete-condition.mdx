---
title: "Delete Condition from RLCL"
description: "Removes all conditions from an RLCL and resets it to the default condition. The default condition is an AND rule with an empty condition rule list, which means the RLCL will be applied unconditionally (always)."
---
## Endpoint

...
{
  "status": "FAILURE",
  "resultMessage": "endpointRateLimitList value can not be empty!"
}
```
...
{
  "status": "FAILURE",
  "resultMessage": "API Proxy with name (MyAPI) is not found in project!"
}
```
...
{
  "status": "FAILURE",
  "resultMessage": "API Endpoint with name (/users) and method type (GET) is not found in API Proxy!"
}
```

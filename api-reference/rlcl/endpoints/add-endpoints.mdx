---
title: 'Add Endpoints to RLCL'
description: 'Adds API endpoints to an existing RLCL. Endpoints added to the RLCL will be subject to the rate limiting rules defined in the RLCL.'
---
## Endpoint
...
| endpointHTTPMethod | string | Yes* | - | HTTP method. See [EnumHttpRequestMethod](#enumhttprequestmethod-endpointhttpmethod). Required if endpointName is not "ALL" |
...
| timeInterval | string | Yes | - | Time interval unit. See [EnumRateLimitTimeInterval](#enumratelimittimeinterval-timeinterval) |
...
| cacheErrorHandlingType | string | Yes | - | Cache error handling type. See [EnumCacheErrorHandlingType](#enumcacheerrorhandlingtype-cacheerrorhandlingtype) |
| timeIntervalWindowType | string | Yes | - | Time interval window type. See [EnumIntervalWindowType](#enumintervalwindowtype-timeintervalwindowtype) |

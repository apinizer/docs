---
title: "Update Endpoints in RLCL"
description: "Replaces all endpoints in an RLCL with the provided list. This completely replaces the existing endpoint list."
---
## Endpoint
...
Same structure as Add Endpoints. See [Add Endpoints](/api-reference/rlcl/endpoints/add-endpoints) for field descriptions.
...
Same as Add Endpoints. See [Add Endpoints](/api-reference/rlcl/endpoints/add-endpoints) for response format.
...
- [Add Endpoints](/api-reference/rlcl/endpoints/add-endpoints) - Add endpoints without removing existing ones
- [Delete Endpoints](/api-reference/rlcl/endpoints/delete-endpoints) - Remove specific endpoints

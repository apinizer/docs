---
title: 'List Keystores'
description: 'Retrieves all keystores for a specified project. Keystores are containers for cryptographic keys and certificates used for secure communication and authentication.'
---

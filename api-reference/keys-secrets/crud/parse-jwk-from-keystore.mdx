---
title: "Parse JWK from Keystore"
description: "Parses a JWK (JSON Web Key) from a keystore alias and creates it. This is a convenience endpoint for extracting JWKs from keystores."
---
...
- [Create JWK](/api-reference/keys-secrets/crud/create-jwk) - Create JWK with source type KEYSTORE

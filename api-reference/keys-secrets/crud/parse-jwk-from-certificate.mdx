---
title: 'Parse JWK from Certificate'
description: 'Parses a JWK (JSON Web Key) from an existing certificate and creates it. This is a convenience endpoint for extracting JWKs from certificates.'
---
...
- [Create JWK](/api-reference/keys-secrets/crud/create-jwk) - Create JWK with source type CERTIFICATE

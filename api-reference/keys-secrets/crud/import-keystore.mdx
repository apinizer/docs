...
description: "Imports a keystore from a ZIP file. Encrypted and plain packages are both accepted — whether the uploaded file is encrypted is detected automatically, and the matching passphrase is required only in that case."
---
...
- [Export Keystore](/api-reference/keys-secrets/crud/export-keystore) - Export a keystore to a ZIP file

---
title: "Get JWK"
description: "Retrieves detailed information about a specific JWK (JSON Web Key) including its key material. This endpoint returns the complete JWK data including cryptographic key material."
---

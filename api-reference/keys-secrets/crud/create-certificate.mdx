...
description: "Creates a new certificate and deploys it to specified environments. The certificate must be provided as a PEM-encoded file. The certificate is automatically deployed to all specified environments."
---
...
{
  "status": "FAILURE",
  "resultMessage": "certificateName value can not be empty!"
}
```
...
{
  "status": "FAILURE",
  "resultMessage": "alias value can not be empty!"
}
```
...
{
  "status": "FAILURE",
  "resultMessage": "pemEncodedFile value can not be empty!"
}
```
...
{
  "status": "FAILURE",
  "resultMessage": "Certificate (name: my-certificate) is already exist!"
}
```
...
{
  "status": "FAILURE",
  "resultMessage": "Alias (my-cert-alias) is already used for another certificate, try changing this value!"
}
```
...
- [Update Certificate](/api-reference/keys-secrets/crud/update-certificate) - Update a certificate

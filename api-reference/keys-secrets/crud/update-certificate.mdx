...
Same as [Create Certificate](/api-reference/keys-secrets/crud/create-certificate). See [Create Certificate](/api-reference/keys-secrets/crud/create-certificate) for field descriptions.
...
Same as [Create Certificate](/api-reference/keys-secrets/crud/create-certificate). See [Create Certificate](/api-reference/keys-secrets/crud/create-certificate) for response format.

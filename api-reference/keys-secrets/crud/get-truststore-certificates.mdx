...
Same as [List Certificates](/api-reference/keys-secrets/crud/list-certificates). See [List Certificates](/api-reference/keys-secrets/crud/list-certificates) for field descriptions.

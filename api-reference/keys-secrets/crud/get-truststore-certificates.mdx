---
title: "Get Truststore Certificates"
description: "Retrieves all certificates from the truststore of a specific environment. This endpoint is only available for the admin project and returns certificates stored in the environment truststore."
---
...
Same as List Certificates. See [List Certificates](/api-reference/keys-secrets/crud/list-certificates) for field descriptions.
...
{
  "status": "FAILURE",
  "resultMessage": "environmentName value can not be empty!"
}
```

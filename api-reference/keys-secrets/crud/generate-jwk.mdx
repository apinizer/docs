---
title: "Generate JWK"
description: "Generates a new JWK (JSON Web Key) programmatically and deploys it to environments. This endpoint creates a cryptographically secure JWK based on the specified type and parameters."
---
...
{
  "status": "FAILURE",
  "resultMessage": "JWK type can not be empty!"
}
```
...
{
  "status": "FAILURE",
  "resultMessage": "JWK (name: generated-jwk) is already exist! Try update operation if want to change its value."
}
```
...
- [Create JWK](/api-reference/keys-secrets/crud/create-jwk) - Create JWK from other sources

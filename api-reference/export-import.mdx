...
| AI Gateway | `LLM_PROVIDER`, `MODEL_DEFINITION`, `VECTOR_DB`, `KNOWLEDGE_BASE`, `PROMPT_TEMPLATE`, `PROMPT_DECORATOR`, `TOPIC_CATEGORY`, `PII_PATTERN`, `PROMPT_GUARD_PATTERN`, `DLP_PATTERN` |
...
- [Import API Proxy](/api-reference/api-proxies/crud/import-api-proxy) - The API Proxy specific import endpoint

...
| builtIn | boolean | `true` = Apinizer-shipped seed entry (price-only edit, no delete); `false` = custom. Responses also carry a deprecated `isBuiltIn` alias for pre-2026.04 clients. |

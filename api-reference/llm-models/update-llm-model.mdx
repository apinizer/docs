...
| builtIn | boolean | No | false | See the built-in note below. The pre-2026.04 name `isBuiltIn` is still accepted. |
...
- **Built-in price-only edit**: For `builtIn=true` entries, editing anything other than the price

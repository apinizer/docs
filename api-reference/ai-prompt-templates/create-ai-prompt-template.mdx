...
description: "Creates a AI prompt template, or updates the existing one with the same name in the scope (upsert). Requires an admin API token."
---

## Endpoint

```
POST /apiops/settings/ai-prompt-templates/{entryName}/
```

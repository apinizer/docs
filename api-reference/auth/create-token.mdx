---
title: 'Create Token'
description: 'Creates a Personal API Access Token using OAuth2 client credentials flow. This token can be used to authenticate all subsequent API requests.'
---
...
- [Using Tokens](/api-reference/getting-started/authentication) - How to use tokens in API requests

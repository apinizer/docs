---
title: 'Base URL and Endpoint Structure'
description: 'Learn how to construct the Management API base URL and understand endpoint structure, path parameters, query parameters, and URL encoding.'
---
...
- [Learn about authentication](/api-reference/getting-started/authentication)

...
- **Built-in Presets**:
  - Rows with `builtIn: true` come from the seeded responsible-AI catalog. They are editable and deletable through this API the same as a custom preset — see [Update](/api-reference/ai-prompt-decorator-presets/update-ai-prompt-decorator-preset) and [Delete](/api-reference/ai-prompt-decorator-presets/delete-ai-prompt-decorator-preset).
- **Scope**:

...
description: "Creates a custom AI prompt-decorator preset, or updates it when one with the same name already exists in the scope (upsert by name). Requires an admin API token. Built-in presets are read-only and reject this call."
---

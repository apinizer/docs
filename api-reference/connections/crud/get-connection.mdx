...
description: "Retrieves detailed information about a specific connection. Unlike list operations, secret fields (passwords, API keys, etc.) are returned in full when getting a single connection."
---

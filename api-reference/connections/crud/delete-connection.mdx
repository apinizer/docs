...
description: "Deletes an existing connection from a project. The connection is permanently removed and cannot be recovered."
---
...
| deploymentResult | object | Deployment result (when connection was deployed to worker) |

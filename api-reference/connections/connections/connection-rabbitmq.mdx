...
description: "RabbitMQ connection for sending messages to RabbitMQ brokers. Used by policies and other components that need to publish messages to RabbitMQ queues or exchanges."
---

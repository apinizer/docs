...
description: "FTP connection for file transfer operations. Supports FTP, SFTP, and FTPS protocols. Used by policies and other components that need to download files from FTP servers."
---

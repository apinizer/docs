---
title: 'Logback Connection'
description: 'Logback connection for writing log messages to local files using Logback logging framework. Supports file rolling based on size and time with configurable patterns and retention policies. Used by logging policies and connectors to write structured log data to local file systems.'
---

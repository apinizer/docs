---
title: "Graylog Connection"
description: "Graylog connection for sending log messages to Graylog servers using the GELF (Graylog Extended Log Format) protocol. Supports TCP and UDP transports with optional TLS encryption and compression. Used by logging policies and connectors to send structured log data to Graylog."
---

---
title: "Apache ActiveMQ Connection"
description: "Apache ActiveMQ connection for sending and receiving messages via JMS (Java Message Service). Supports both queue (point-to-point) and topic (publish-subscribe) messaging patterns. Used by policies and connectors to integrate with ActiveMQ message brokers for asynchronous messaging."
---

...
- **Difference from Get API Proxy**: This endpoint returns the API proxy wrapped in the standard `resultList` response format with endpoints included
...
- [Get API Proxy](/api-reference/api-proxies/crud/get-api-proxy) - Get basic API proxy information

---
title: "Get API Proxy"
description: "Retrieves detailed information about a specific API proxy. The API proxy information includes endpoints, policies, settings, and deployment status."
---
...
- **Detailed Information**: For complete API proxy details including endpoints and optional policy details, use the [Get API Proxy Detail](/api-reference/api-proxies/crud/get-api-proxy-detail) endpoint with the `withPolicies` query parameter

## Related Documentation

- [Get API Proxy Detail](/api-reference/api-proxies/crud/get-api-proxy-detail) - Get API proxy with endpoints and optional policies

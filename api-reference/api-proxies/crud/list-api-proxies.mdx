---
title: "List API Proxies"
description: "Retrieves all API proxies for a specific project. API proxies are returned ordered by name."
---
...
- [Get API Proxy](/api-reference/api-proxies/crud/get-api-proxy) - Get detailed API proxy information

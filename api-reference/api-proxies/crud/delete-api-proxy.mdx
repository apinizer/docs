---
title: 'Delete API Proxy'
description: 'Deletes an API proxy from a project. The API proxy is permanently removed and automatically undeployed from all environments.'
---

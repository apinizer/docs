...
`methodOverrideList` is omitted from the JSON when empty (NON_EMPTY serialization).
...
- [Update Traffic Log Settings](/api-reference/api-proxies/settings/update-traffic-log-settings) - Update via PUT endpoint

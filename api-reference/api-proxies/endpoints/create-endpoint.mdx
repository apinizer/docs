...
description: "Creates a new REST endpoint (API method) in an API proxy. This operation is only available for REST API proxies."
---
...
{
  "status": "FAILURE",
  "resultMessage": "Endpoint can only be added to REST API Proxies!"
}
```

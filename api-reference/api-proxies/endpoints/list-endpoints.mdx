...
description: "Retrieves all endpoints (API methods) for a specific API proxy. Endpoints are returned without policy details."
---
...
**Note:** Policy lists (`requestPolicyList`, `responsePolicyList`, `errorPolicyList`) are not included in list operations. Use [Get Endpoint](/api-reference/api-proxies/endpoints/get-endpoint) or [List Endpoint Policies](/api-reference/api-proxies/endpoints/list-endpoint-policies) to retrieve policy details.
...
- [Get Endpoint](/api-reference/api-proxies/endpoints/get-endpoint) - Get detailed endpoint information

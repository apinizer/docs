---
title: "List Endpoint Policies"
description: "Retrieves all policies (request, response, and error) for a specific endpoint (API method). This endpoint returns the same information as Get Endpoint but includes policy details."
---
...
**Note:** Policy objects contain only basic information. For full policy details, use the [Policies API](/api-reference/policies/crud/add-policy).
...
- **Policy Details**: Policy objects contain basic information only. For full policy configuration, use the [Policies API](/api-reference/policies/crud/add-policy)
...
- [Get Endpoint](/api-reference/api-proxies/endpoints/get-endpoint) - Get endpoint details (without policies)
- [Policies API](/api-reference/policies/crud/add-policy) - Policy management API

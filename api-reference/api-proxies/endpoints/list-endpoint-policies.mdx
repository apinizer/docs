...
**Note:** Policy objects contain only basic information. For full policy details, use the [Policies API](/api-reference/policies/crud/add-policy.mdx).
...
- **Policy Details**: Policy objects contain basic information only. For full policy configuration, use the [Policies API](/api-reference/policies/crud/add-policy.mdx)
...
- [Policies API](/api-reference/policies/crud/add-policy.mdx) - Policy management API

...
**Note:** Policy objects contain only basic information. For full policy details, use the [Policies API](/api-reference/policies).
...
- **Policy Details**: Policy objects contain basic information only. For full policy configuration, use the [Policies API](/api-reference/policies)
...
- [Policies API](/api-reference/policies) - Policy management API

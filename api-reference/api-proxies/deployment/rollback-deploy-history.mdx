...
description: "Rollback the API Proxy configuration to a specific deploy history revision. Optionally deploy the rolled-back version to an environment in the same request."
---
...
{
  "status": "FAILURE",
  "resultMessage": "Rollback failed for deploy history revision (12)!"
}
```

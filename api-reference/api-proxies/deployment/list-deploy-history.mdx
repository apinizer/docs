...
description: "Returns the deploy/undeploy history list of the specified API Proxy. Each record includes the deployment timestamp, user, environment, description, persistent flag, and backend API version at the time of deployment."
---

---
title: "Update Proxy Server Settings"
description: "Updates proxy server settings for an API proxy. Proxy server settings configure how the API proxy connects to backend services through a proxy."
---
...
{
  "status": "FAILURE",
  "resultMessage": "Proxy host and port are required when proxy is enabled"
}
```

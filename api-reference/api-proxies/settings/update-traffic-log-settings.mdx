...
Connectors must be created and configured before enabling them. See [Connections API](/api-reference/connections) for connector management.
...
- **Connectors**: Connectors must be created before enabling (see [Connections API](/api-reference/connections))
...
- [Connections API](/api-reference/connections) - Manage connectors for log export

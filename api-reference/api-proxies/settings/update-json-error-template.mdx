---
title: 'Update JSON Error Response Template'
description: 'Updates JSON error response template for an API proxy. JSON error template defines the format of error responses for REST/JSON APIs.'
---
...
- [Update XML Error Template](/api-reference/api-proxies/settings/update-xml-error-template) - Update XML error template

---
title: "Update XML Error Response Template"
description: "Updates XML error response template for an API proxy. XML error template defines the format of error responses for SOAP/XML APIs."
---
...
Only the field in the body is written. The stored `xmlValue`, `contentType` and
`xmlErrorResponseTemplateActive` are left exactly as they were.
...
- [Update JSON Error Template](/api-reference/api-proxies/settings/update-json-error-template) - Update JSON error template

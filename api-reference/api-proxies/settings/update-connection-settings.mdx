...
This setting only applies to backend connections using HTTP/1.1. If the API Proxy is configured to use the streaming/HTTP2 backend connection path, this field has no effect and 301/302/303 redirects still downgrade the request to GET.

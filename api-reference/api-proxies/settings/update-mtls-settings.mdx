---
title: "Update mTLS Settings"
description: "Updates mTLS (mutual TLS) settings for an API proxy. mTLS settings configure client certificate authentication for backend connections."
---
...
{
  "status": "FAILURE",
  "resultMessage": "KeyStore ID is required when mTLS is enabled"
}
```
...
- [Update NTLM Settings](/api-reference/api-proxies/settings/update-ntlm-settings) - Update NTLM settings

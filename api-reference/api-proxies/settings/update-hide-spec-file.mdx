---
title: "Update Hide Spec File Setting"
description: "Updates the hide API specification file setting for an API proxy. When enabled, the API specification file (OpenAPI/Swagger/WSDL) is hidden from public access."
---

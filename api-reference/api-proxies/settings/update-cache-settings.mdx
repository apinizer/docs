...
description: "Updates cache settings for an API proxy. Cache settings control how API responses are cached and retrieved."
---
...
| Field | Type | Required | Default | Description |
|-------|------|----------|---------|-------------|
| name | string | No | - | Cache settings name |
...
| handlingAction | string | No | - | Cache handling action when cache hit occurs |
...
- [Update CORS Settings](/api-reference/api-proxies/settings/update-cors-settings) - Update CORS settings

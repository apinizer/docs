...
description: "Variable is a structure used to extract data from API traffic messages for policy needs. It is used to extract data from different parts of HTTP requests (header, parameter, body, etc.). Variables are used in policies, conditions, and other API configurations to dynamically access request/response data."
---
...
| paramType | string | Yes | Parameter type. See [EnumVariableParameterType](#enumvariableparametertype-paramtype) |
...
| messageContentType | string | Yes | Content type. See [EnumMessageContentType](#enummessagecontenttype-messagecontenttype) |
...
| scriptLanguage | string | Yes* | - | Script language (required if initWithScript=true). See [EnumScriptType](/api-reference/policies/policies/policy-script) |
...
- [Enum Reference](/api-reference/appendix/enum-reference) - Enumeration values used in variables (EnumVariableType, EnumVariableParameterType, etc.)
- [Glossary](/api-reference/appendix/glossary) - Terms and definitions
- [API Based Throttling Policy](/api-reference/policies/policies/policy-api-based-throttling) - Uses variables for client identification
- [RLCL API](/api-reference/rlcl/condition/add-condition.mdx) - Uses variables for rate limit control
- [Script Policy](/api-reference/policies/policies/policy-script) - Script language types

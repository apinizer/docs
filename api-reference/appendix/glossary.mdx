---
title: 'Glossary'
description: 'Definitions of terms and concepts used throughout the Apinizer Management API documentation.'
---
...
A reference to data that can be extracted from requests, responses, or context. See [Variable Definition](/api-reference/appendix/variable-definition) for complete documentation.
...
An enumeration - a fixed set of named values used in API requests and responses. See [Enum Reference](/api-reference/appendix/enum-reference) for complete list.
...
- [Enum Reference](/api-reference/appendix/enum-reference) - Complete enumeration reference
- [Variable Definition](/api-reference/appendix/variable-definition) - Variable documentation

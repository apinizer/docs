---
title: 'Secure Hello'
description: 'Returns a personalized greeting message if the user is authenticated. This endpoint is useful for testing authentication tokens and verifying API access.'
---
...
- [Healthcheck](/api-reference/test/healthcheck) - Check API availability
- [Authentication Guide](/api-reference/getting-started/authentication) - How to obtain tokens
